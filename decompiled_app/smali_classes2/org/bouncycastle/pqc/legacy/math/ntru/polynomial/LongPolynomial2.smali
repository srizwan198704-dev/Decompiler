...
.method public constructor <init>(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/IntegerPolynomial;)V
    ...
    :cond_0
    iget v4, p0, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->numCoeffs:I
    ...
    :cond_2
    iget-object v5, p0, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J
...
.method private multRecursive(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;)Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;
    ...
    .line 0
    iget-object v1, v0, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J

    move-object/from16 v2, p1

    iget-object v2, v2, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J
    ...
    invoke-static {v1, v4}, Lorg/bouncycastle/util/Arrays;->copyOf([JI)[J
    ...
    invoke-static {v1, v4, v3}, Lorg/bouncycastle/util/Arrays;->copyOfRange([JII)[J

    move-result-object v1

    invoke-direct {v9, v1}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;-><init>([J)V
    ...
    invoke-direct {v1, v10}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;-><init>([J)V

    new-instance v10, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;

    invoke-static {v2, v4, v3}, Lorg/bouncycastle/util/Arrays;->copyOfRange([JII)[J

    move-result-object v2

    invoke-direct {v10, v2}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;-><init>([J)V

    invoke-virtual {v8}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->clone()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;

    invoke-direct {v2, v9}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->add(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;)V

    invoke-virtual {v1}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->clone()Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;

    invoke-direct {v11, v10}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->add(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;)V

    invoke-direct {v8, v1}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->multRecursive(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;)Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;
    ...
    invoke-direct {v2, v11}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->multRecursive(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;)Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;

    move-result-object v2

    invoke-direct {v2, v1}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->sub(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;)V

    invoke-direct {v2, v8}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->sub(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;)V

    new-instance v9, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;

    mul-int/lit8 v3, v3, 0x2

    invoke-direct {v9, v3}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;-><init>(I)V

    const/4 v3, 0x0

    :goto_2
    iget-object v10, v1, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J

    array-length v11, v10

    if-ge v3, v11, :cond_3

    iget-object v11, v9, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J
    ...
    iget-object v10, v9, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J
    ...
    :cond_4
    :goto_4
    iget-object v1, v8, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J

    array-length v2, v1

    if-ge v7, v2, :cond_5

    iget-object v2, v9, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->coeffs:[J
...
.method public toIntegerPolynomial()Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/IntegerPolynomial;
    ...
    iget v3, p0, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/LongPolynomial2;->numCoeffs:I
