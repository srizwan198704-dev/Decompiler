.class public Lorg/bouncycastle/pqc/crypto/sphincsplus/HT;
...
.field public wots:Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;
...
.method public sign([BJI)[B
    ...
    invoke-virtual {v9, v14}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setLayerAddress(I)V
    ...
    iget-object v2, v1, Lorg/bouncycastle/pqc/crypto/sphincsplus/SIG_XMSS;->sig:[B

    iget-object v1, v1, Lorg/bouncycastle/pqc/crypto/sphincsplus/SIG_XMSS;->auth:[[B
...
.method public treehash([BII[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
    ...
    invoke-virtual {v1, p5}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTypeAndClear(I)V

    add-int v4, p2, v2

    invoke-virtual {v1, v4}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setKeyPairAddress(I)V

    iget-object v5, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/HT;->wots:Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;

    invoke-virtual {v5, p1, p4, v1}, Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;->pkGen([B[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B

    move-result-object v5

    const/4 v6, 0x2

    invoke-virtual {v1, v6}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTypeAndClear(I)V

    invoke-virtual {v1, v3}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTreeHeight(I)V

    invoke-virtual {v1, v4}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTreeIndex(I)V
    ...
    iget-object v9, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/HT;->engine:Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine;

    iget-object v8, v8, Lorg/bouncycastle/pqc/crypto/sphincsplus/NodeEntry;->nodeValue:[B

    invoke-virtual {v9, p4, v1, v8, v5}, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine;->H([BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;[B[B)[B
    ...
    :cond_1
    new-instance v3, Lorg/bouncycastle/pqc/crypto/sphincsplus/NodeEntry;

    invoke-direct {v3, v5, v7}, Lorg/bouncycastle/pqc/crypto/sphincsplus/NodeEntry;-><init>([BI)V
...
.method public xmss_PKgen([B[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
    .locals 7
...
.method public xmss_pkFromSig(ILorg/bouncycastle/pqc/crypto/sphincsplus/SIG_XMSS;[B[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
    .locals 5
    ...
    invoke-virtual {v0, p5}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTypeAndClear(I)V
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTypeAndClear(I)V
...
.method public xmss_sign([B[BI[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)Lorg/bouncycastle/pqc/crypto/sphincsplus/SIG_XMSS;
    .locals 10
    ...
    invoke-direct {v7, p5}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;-><init>(Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)V

    const/4 v1, 0x2

    invoke-virtual {v7, v1}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTypeAndClear(I)V
    ...
    invoke-virtual {v1, v8}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setTypeAndClear(I)V

    invoke-virtual {v1, p3}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setKeyPairAddress(I)V

    iget-object p3, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/HT;->wots:Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;

    invoke-virtual {p3, p1, p2, p4, v1}, Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;->sign([B[B[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
