...
.method public static validatedOcspResponse(Lorg/bouncycastle/asn1/ocsp/BasicOCSPResponse;Lorg/bouncycastle/jcajce/PKIXCertRevocationCheckerParameters;[BLjava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)Z
    ...
    .line 0
    invoke-static {p0, p3}, Ll/۫۠۟;->᩷(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public check(Ljava/security/cert/Certificate;)V
    ...
    invoke-static {v0}, Ll/ۗ᩶;->᩷(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/util/Map;
    ...
    invoke-static {v1}, Ll/᩵᩶;->᩷(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/net/URI;
    ...
    invoke-static {v1}, Ll/ܶ᩶;->᩷(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/security/cert/X509Certificate;

    move-result-object v5

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/ProvOcspRevocationChecker;->parent:Lorg/bouncycastle/jce/provider/ProvRevocationChecker;

    invoke-static {v1}, Ll/᩶ۚ;->᩷(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/util/List;
    ...
    invoke-static {v4}, Lorg/bouncycastle/jce/provider/OcspCache$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/security/cert/Extension;

    move-result-object v4

    invoke-static {v4}, Lorg/bouncycastle/jce/provider/OcspCache$$ExternalSyntheticApiModelOutline2;->m(Ljava/security/cert/Extension;)[B
    ...
    invoke-static {v4}, Lorg/bouncycastle/jce/provider/OcspCache$$ExternalSyntheticApiModelOutline1;->m(Ljava/security/cert/Extension;)Ljava/lang/String;
