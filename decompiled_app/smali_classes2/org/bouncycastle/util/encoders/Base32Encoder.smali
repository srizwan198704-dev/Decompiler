...
# static fields
.field public static final DEAULT_ENCODING_TABLE:[B

.field public static final DEFAULT_PADDING:B = 0x3dt
...
.method public decode([BIILjava/io/OutputStream;)I
    ...
    invoke-direct {v10, v5}, Lorg/bouncycastle/util/encoders/Base32Encoder;->ignore(C)Z
    ...
    invoke-direct {v10, v7}, Lorg/bouncycastle/util/encoders/Base32Encoder;->ignore(C)Z
    ...
    :cond_4
    invoke-direct {v10, v0, v1, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    iget-object v7, v10, Lorg/bouncycastle/util/encoders/Base32Encoder;->decodingTable:[B
    ...
    invoke-direct {v10, v0, v8, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I

    move-result v7

    iget-object v8, v10, Lorg/bouncycastle/util/encoders/Base32Encoder;->decodingTable:[B
    ...
    invoke-direct {v10, v0, v9, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v12, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v13, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v14, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v15, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v4, v6}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v6, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v1, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I

    move-result v1

    add-int/lit8 v3, v1, 0x1

    invoke-direct {v10, v0, v3, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I

    move-result v3

    add-int/lit8 v5, v3, 0x1

    invoke-direct {v10, v0, v5, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
    ...
    invoke-direct {v10, v0, v7, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I

    move-result v7

    add-int/lit8 v8, v7, 0x1

    invoke-direct {v10, v0, v8, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I

    move-result v8

    add-int/lit8 v9, v8, 0x1

    invoke-direct {v10, v0, v9, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I

    move-result v9

    add-int/lit8 v12, v9, 0x1

    invoke-direct {v10, v0, v12, v4}, Lorg/bouncycastle/util/encoders/Base32Encoder;->nextI([BII)I
