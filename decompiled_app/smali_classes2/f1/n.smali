...
.method public static j(Landroid/os/CancellationSignal;[Landroidx/core/provider/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
...
.method public a(Landroid/content/Context;Le1/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Le1/e$d;->d()Ljava/lang/String;
    ...
    invoke-virtual {p0, p2, p4}, Lf1/n;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/k$b;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p3, p1}, Lf1/n;->j(Landroid/os/CancellationSignal;[Landroidx/core/provider/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-virtual {p0, p1, p4}, Lf1/n;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, v0, p1}, Lf1/n;->j(Landroid/os/CancellationSignal;[Landroidx/core/provider/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [Landroidx/core/provider/k$b;

    invoke-static {p2, v4, p1}, Lf1/n;->j(Landroid/os/CancellationSignal;[Landroidx/core/provider/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-virtual {p0, v0, p4}, Lf1/n;->i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final i(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    .locals 5
    ...
    invoke-static {v0, v1}, Lf1/n;->k(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lf1/n;->k(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
