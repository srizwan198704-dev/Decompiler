...
.method public constructor <init>(Landroidx/media3/datasource/a;)V
    ...
    iput-object p1, p0, Lj2/n;->a:Landroidx/media3/datasource/a;

    sget-object p1, Landroid/net/Uri;->EMPTY:Landroid/net/Uri;

    iput-object p1, p0, Lj2/n;->c:Landroid/net/Uri;

    invoke-static {}, Ljava/util/Collections;->emptyMap()Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lj2/n;->d:Ljava/util/Map;
...
.method public a(Lj2/h;)J
    ...
    iput-object v0, p0, Lj2/n;->c:Landroid/net/Uri;

    invoke-static {}, Ljava/util/Collections;->emptyMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lj2/n;->d:Ljava/util/Map;

    :try_start_0
    iget-object v0, p0, Lj2/n;->a:Landroidx/media3/datasource/a;
    ...
    invoke-virtual {p0}, Lj2/n;->getUri()Landroid/net/Uri;
    ...
    :cond_0
    invoke-virtual {p0}, Lj2/n;->getResponseHeaders()Ljava/util/Map;
...
.method public e()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lj2/n;->c:Landroid/net/Uri;
...
.method public f()Ljava/util/Map;
    ...
    iget-object v0, p0, Lj2/n;->d:Ljava/util/Map;
...
.method public read([BII)I
    ...
    iget-wide p2, p0, Lj2/n;->b:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lj2/n;->b:J
