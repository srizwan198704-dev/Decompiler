...
.method public c(Landroidx/media3/common/audio/AudioProcessor$a;)Landroidx/media3/common/audio/AudioProcessor$a;
    ...
    iput-boolean v0, p0, Lm2/w0;->k:Z

    iget v0, p0, Lm2/w0;->i:I

    if-nez v0, :cond_3

    iget v0, p0, Lm2/w0;->j:I
...
.method public d()V
    ...
    iget-boolean v0, p0, Lm2/w0;->k:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iput-boolean v1, p0, Lm2/w0;->k:Z
    ...
    iput v0, p0, Lm2/w0;->l:I

    :cond_0
    iput v1, p0, Lm2/w0;->n:I
...
.method public e()V
    ...
    iget v0, p0, Lm2/w0;->n:I

    if-lez v0, :cond_0

    iget-wide v1, p0, Lm2/w0;->o:J
    ...
    iput-wide v1, p0, Lm2/w0;->o:J

    :cond_0
    const/4 v0, 0x0

    iput v0, p0, Lm2/w0;->n:I
...
.method public getOutput()Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Lm2/w0;->m:[B

    iget v2, p0, Lm2/w0;->n:I
...
.method public j(II)V
    ...
    iput p1, p0, Lm2/w0;->i:I

    iput p2, p0, Lm2/w0;->j:I
...
.method public queueInput(Ljava/nio/ByteBuffer;)V
    ...
    :cond_0
    iget v3, p0, Lm2/w0;->l:I

    invoke-static {v2, v3}, Ljava/lang/Math;->min(II)I

    move-result v3

    iget-wide v4, p0, Lm2/w0;->o:J
    ...
    iput-wide v4, p0, Lm2/w0;->o:J

    iget v4, p0, Lm2/w0;->l:I

    sub-int/2addr v4, v3

    iput v4, p0, Lm2/w0;->l:I

    add-int/2addr v0, v3

    invoke-virtual {p1, v0}, Ljava/nio/ByteBuffer;->position(I)Ljava/nio/Buffer;

    iget v0, p0, Lm2/w0;->l:I
    ...
    iget v4, p0, Lm2/w0;->n:I

    const/4 v5, 0x0

    invoke-static {v0, v5, v4}, Lg2/z0;->p(III)I

    move-result v4

    iget-object v6, p0, Lm2/w0;->m:[B

    invoke-virtual {v3, v6, v5, v4}, Ljava/nio/ByteBuffer;->put([BII)Ljava/nio/ByteBuffer;

    sub-int/2addr v0, v4

    invoke-static {v0, v5, v2}, Lg2/z0;->p(III)I
    ...
    iget-object v0, p0, Lm2/w0;->m:[B

    iget v1, p0, Lm2/w0;->n:I

    invoke-virtual {p1, v0, v1, v2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget p1, p0, Lm2/w0;->n:I

    add-int/2addr p1, v2

    iput p1, p0, Lm2/w0;->n:I
