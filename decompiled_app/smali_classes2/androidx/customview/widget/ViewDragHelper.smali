...
.field private final mCallback:Landroidx/customview/widget/ViewDragHelper$b;
...
.method private constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroidx/customview/widget/ViewDragHelper$b;)V
    .locals 1
    ...
    iput-object p3, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;
...
.method private checkNewEdgeDrag(FFII)Z
    ...
    iget-object p2, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {p2, p4}, Landroidx/customview/widget/ViewDragHelper$b;->onEdgeLock(I)Z
...
.method private checkTouchSlop(Landroid/view/View;FF)Z
    ...
    :cond_0
    iget-object v1, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v1, p1}, Landroidx/customview/widget/ViewDragHelper$b;->getViewHorizontalDragRange(Landroid/view/View;)I
    ...
    :goto_0
    iget-object v3, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v3, p1}, Landroidx/customview/widget/ViewDragHelper$b;->getViewVerticalDragRange(Landroid/view/View;)I
...
.method private computeSettleDuration(Landroid/view/View;IIII)I
    ...
    :goto_3
    iget-object v2, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v2, p1}, Landroidx/customview/widget/ViewDragHelper$b;->getViewHorizontalDragRange(Landroid/view/View;)I
    ...
    iget-object p4, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {p4, p1}, Landroidx/customview/widget/ViewDragHelper$b;->getViewVerticalDragRange(Landroid/view/View;)I
...
.method public static create(Landroid/view/ViewGroup;FLandroidx/customview/widget/ViewDragHelper$b;)Landroidx/customview/widget/ViewDragHelper;
    .locals 1
    ...
    invoke-static {p0, p2}, Landroidx/customview/widget/ViewDragHelper;->create(Landroid/view/ViewGroup;Landroidx/customview/widget/ViewDragHelper$b;)Landroidx/customview/widget/ViewDragHelper;
...
.method public static create(Landroid/view/ViewGroup;Landroidx/customview/widget/ViewDragHelper$b;)Landroidx/customview/widget/ViewDragHelper;
    .locals 2
    .param p0    # Landroid/view/ViewGroup;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method private dispatchViewReleased(FF)V
    ...
    invoke-virtual {v1, v2, p1, p2}, Landroidx/customview/widget/ViewDragHelper$b;->onViewReleased(Landroid/view/View;FF)V
...
.method private dragTo(IIII)V
    ...
    invoke-virtual {v2, v3, p1, p3}, Landroidx/customview/widget/ViewDragHelper$b;->clampViewPositionHorizontal(Landroid/view/View;II)I
    ...
    iget-object p1, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    iget-object v2, p0, Landroidx/customview/widget/ViewDragHelper;->mCapturedView:Landroid/view/View;

    invoke-virtual {p1, v2, p2, p4}, Landroidx/customview/widget/ViewDragHelper$b;->clampViewPositionVertical(Landroid/view/View;II)I
    ...
    iget-object v4, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    iget-object v5, p0, Landroidx/customview/widget/ViewDragHelper;->mCapturedView:Landroid/view/View;

    invoke-virtual/range {v4 .. v9}, Landroidx/customview/widget/ViewDragHelper$b;->onViewPositionChanged(Landroid/view/View;IIII)V
...
.method private reportNewEdgeDrags(FFI)V
    ...
    invoke-virtual {p1, v0, p3}, Landroidx/customview/widget/ViewDragHelper$b;->onEdgeDragStarted(II)V
...
.method public abort()V
    ...
    invoke-virtual/range {v3 .. v8}, Landroidx/customview/widget/ViewDragHelper$b;->onViewPositionChanged(Landroid/view/View;IIII)V
...
.method public captureChildView(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v0, p1, p2}, Landroidx/customview/widget/ViewDragHelper$b;->onViewCaptured(Landroid/view/View;I)V
...
.method public findTopChildUnder(II)Landroid/view/View;
    ...
    invoke-virtual {v2, v0}, Landroidx/customview/widget/ViewDragHelper$b;->getOrderedChildIndex(I)I
...
.method public processTouchEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v2, p1, v0}, Landroidx/customview/widget/ViewDragHelper$b;->onEdgeTouched(II)V
    ...
    invoke-virtual {v2, v0, p1}, Landroidx/customview/widget/ViewDragHelper$b;->onEdgeTouched(II)V
...
.method public setDragState(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/customview/widget/ViewDragHelper$b;->onViewDragStateChanged(I)V
...
.method public shouldInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, v0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    and-int/2addr v1, v3

    invoke-virtual {v4, v1, v2}, Landroidx/customview/widget/ViewDragHelper$b;->onEdgeTouched(II)V
    ...
    iget-object v14, v0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v14, v7, v13, v12}, Landroidx/customview/widget/ViewDragHelper$b;->clampViewPositionHorizontal(Landroid/view/View;II)I
    ...
    iget-object v5, v0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v5, v7, v15, v14}, Landroidx/customview/widget/ViewDragHelper$b;->clampViewPositionVertical(Landroid/view/View;II)I

    move-result v5

    iget-object v14, v0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v14, v7}, Landroidx/customview/widget/ViewDragHelper$b;->getViewHorizontalDragRange(Landroid/view/View;)I

    move-result v14

    iget-object v15, v0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Landroidx/customview/widget/ViewDragHelper$b;

    invoke-virtual {v15, v7}, Landroidx/customview/widget/ViewDragHelper$b;->getViewVerticalDragRange(Landroid/view/View;)I
    ...
    invoke-virtual {v4, v2, v1}, Landroidx/customview/widget/ViewDragHelper$b;->onEdgeTouched(II)V
...
.method public tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/customview/widget/ViewDragHelper$b;->tryCaptureView(Landroid/view/View;I)Z
