...
.field public j:Landroidx/media3/ui/z0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroidx/media3/ui/TrackSelectionView;->j:Landroidx/media3/ui/z0;
...
.method public static synthetic a(Ljava/util/Comparator;Landroidx/media3/ui/TrackSelectionView$c;Landroidx/media3/ui/TrackSelectionView$c;)I
    ...
    invoke-static {p0, p1, p2}, Landroidx/media3/ui/TrackSelectionView;->c(Ljava/util/Comparator;Landroidx/media3/ui/TrackSelectionView$c;Landroidx/media3/ui/TrackSelectionView$c;)I
...
.method public static synthetic b(Landroidx/media3/ui/TrackSelectionView;Landroid/view/View;)V
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/media3/ui/TrackSelectionView;->d(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic c(Ljava/util/Comparator;Landroidx/media3/ui/TrackSelectionView$c;Landroidx/media3/ui/TrackSelectionView$c;)I
    .locals 0

    invoke-virtual {p1}, Landroidx/media3/ui/TrackSelectionView$c;->a()Landroidx/media3/common/r;

    move-result-object p1

    invoke-virtual {p2}, Landroidx/media3/ui/TrackSelectionView$c;->a()Landroidx/media3/common/r;
...
.method public static filterOverrides(Ljava/util/Map;Ljava/util/List;Z)Ljava/util/Map;
    ...
    check-cast v2, Landroidx/media3/common/j0$a;

    invoke-virtual {v2}, Landroidx/media3/common/j0$a;->a()Landroidx/media3/common/g0;
    ...
    :cond_0
    iget-object v3, v2, Landroidx/media3/common/h0;->a:Landroidx/media3/common/g0;
...
.method public final d(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/TrackSelectionView;->f()V
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroidx/media3/ui/TrackSelectionView;->g(Landroid/view/View;)V
...
.method public final g(Landroid/view/View;)V
    ...
    iget-object v2, v1, Landroidx/media3/ui/TrackSelectionView$c;->a:Landroidx/media3/common/j0$a;
    ...
    check-cast v4, Landroidx/media3/common/h0;
    ...
    invoke-direct {v0, v2, v1}, Landroidx/media3/common/h0;-><init>(Landroidx/media3/common/g0;Ljava/util/List;)V
    ...
    iget-object v4, v4, Landroidx/media3/common/h0;->b:Lcom/google/common/collect/ImmutableList;
    ...
    iget-object v1, v1, Landroidx/media3/ui/TrackSelectionView$c;->a:Landroidx/media3/common/j0$a;

    invoke-virtual {p0, v1}, Landroidx/media3/ui/TrackSelectionView;->h(Landroidx/media3/common/j0$a;)Z

    move-result v1

    if-nez v1, :cond_2

    invoke-virtual {p0}, Landroidx/media3/ui/TrackSelectionView;->i()Z
    ...
    invoke-direct {v0, v2, v5}, Landroidx/media3/common/h0;-><init>(Landroidx/media3/common/g0;Ljava/util/List;)V
...
.method public final h(Landroidx/media3/common/j0$a;)Z
    .locals 1
    ...
    invoke-virtual {p1}, Landroidx/media3/common/j0$a;->e()Z
...
.method public init(Ljava/util/List;ZLjava/util/Map;Ljava/util/Comparator;Landroidx/media3/ui/TrackSelectionView$d;)V
    .locals 0
    ...
    iput-boolean p2, p0, Landroidx/media3/ui/TrackSelectionView;->l:Z
    ...
    :cond_0
    new-instance p2, Landroidx/media3/ui/a1;

    invoke-direct {p2, p4}, Landroidx/media3/ui/a1;-><init>(Ljava/util/Comparator;)V

    :goto_0
    iput-object p2, p0, Landroidx/media3/ui/TrackSelectionView;->m:Ljava/util/Comparator;

    iget-object p2, p0, Landroidx/media3/ui/TrackSelectionView;->f:Ljava/util/List;
    ...
    iget-object p2, p0, Landroidx/media3/ui/TrackSelectionView;->g:Ljava/util/Map;

    invoke-interface {p2}, Ljava/util/Map;->clear()V

    iget-object p2, p0, Landroidx/media3/ui/TrackSelectionView;->g:Ljava/util/Map;

    iget-boolean p4, p0, Landroidx/media3/ui/TrackSelectionView;->i:Z
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/TrackSelectionView;->k()V
...
.method public final j()V
    ...
    invoke-virtual {v3}, Landroidx/media3/common/j0$a;->a()Landroidx/media3/common/g0;
    ...
    iget-object v6, v1, Landroidx/media3/common/h0;->b:Lcom/google/common/collect/ImmutableList;
...
.method public final k()V
    ...
    invoke-virtual {p0, v4}, Landroidx/media3/ui/TrackSelectionView;->h(Landroidx/media3/common/j0$a;)Z

    move-result v5

    iget-object v6, p0, Landroidx/media3/ui/TrackSelectionView;->k:[[Landroid/widget/CheckedTextView;

    iget v7, v4, Landroidx/media3/common/j0$a;->a:I
    ...
    :goto_2
    iget v9, v4, Landroidx/media3/common/j0$a;->a:I

    if-ge v8, v9, :cond_2

    new-instance v9, Landroidx/media3/ui/TrackSelectionView$c;

    invoke-direct {v9, v4, v8}, Landroidx/media3/ui/TrackSelectionView$c;-><init>(Landroidx/media3/common/j0$a;I)V
    ...
    iget-object v10, p0, Landroidx/media3/ui/TrackSelectionView;->j:Landroidx/media3/ui/z0;

    aget-object v11, v6, v8

    invoke-virtual {v11}, Landroidx/media3/ui/TrackSelectionView$c;->a()Landroidx/media3/common/r;

    move-result-object v11

    invoke-interface {v10, v11}, Landroidx/media3/ui/z0;->a(Landroidx/media3/common/r;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v8}, Landroidx/media3/common/j0$a;->i(I)Z
...
.method public setTrackNameProvider(Landroidx/media3/ui/z0;)V
    .locals 0
    ...
    check-cast p1, Landroidx/media3/ui/z0;

    iput-object p1, p0, Landroidx/media3/ui/TrackSelectionView;->j:Landroidx/media3/ui/z0;
