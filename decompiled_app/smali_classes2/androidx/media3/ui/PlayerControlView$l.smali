...
.method public static synthetic g(Landroidx/media3/ui/PlayerControlView$l;Landroidx/media3/common/a0;Landroidx/media3/common/g0;Landroidx/media3/ui/PlayerControlView$k;Landroid/view/View;)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/media3/ui/PlayerControlView$l;->i(Landroidx/media3/common/a0;Landroidx/media3/common/g0;Landroidx/media3/ui/PlayerControlView$k;Landroid/view/View;)V
...
.method public final synthetic i(Landroidx/media3/common/a0;Landroidx/media3/common/g0;Landroidx/media3/ui/PlayerControlView$k;Landroid/view/View;)V
    .locals 2
    ...
    :cond_0
    invoke-interface {p1}, Landroidx/media3/common/a0;->m()Landroidx/media3/common/i0;

    move-result-object p4

    invoke-virtual {p4}, Landroidx/media3/common/i0;->a()Landroidx/media3/common/i0$c;
    ...
    invoke-direct {v0, p2, v1}, Landroidx/media3/common/h0;-><init>(Landroidx/media3/common/g0;Ljava/util/List;)V

    invoke-virtual {p4, v0}, Landroidx/media3/common/i0$c;->L(Landroidx/media3/common/h0;)Landroidx/media3/common/i0$c;

    move-result-object p2

    iget-object p4, p3, Landroidx/media3/ui/PlayerControlView$k;->a:Landroidx/media3/common/j0$a;

    invoke-virtual {p4}, Landroidx/media3/common/j0$a;->d()I

    move-result p4

    const/4 v0, 0x0

    invoke-virtual {p2, p4, v0}, Landroidx/media3/common/i0$c;->P(IZ)Landroidx/media3/common/i0$c;

    move-result-object p2

    invoke-virtual {p2}, Landroidx/media3/common/i0$c;->F()Landroidx/media3/common/i0;

    move-result-object p2

    invoke-interface {p1, p2}, Landroidx/media3/common/a0;->V(Landroidx/media3/common/i0;)V
...
.method public j(Landroidx/media3/ui/PlayerControlView$i;I)V
    ...
    iget-object v1, p2, Landroidx/media3/ui/PlayerControlView$k;->a:Landroidx/media3/common/j0$a;

    invoke-virtual {v1}, Landroidx/media3/common/j0$a;->a()Landroidx/media3/common/g0;

    move-result-object v1

    invoke-interface {v0}, Landroidx/media3/common/a0;->m()Landroidx/media3/common/i0;

    move-result-object v3

    iget-object v3, v3, Landroidx/media3/common/i0;->D:Lcom/google/common/collect/ImmutableMap;
    ...
    invoke-direct {v2, p0, v0, v1, p2}, Landroidx/media3/ui/q;-><init>(Landroidx/media3/ui/PlayerControlView$l;Landroidx/media3/common/a0;Landroidx/media3/common/g0;Landroidx/media3/ui/PlayerControlView$k;)V
...
.method public abstract k(Landroidx/media3/ui/PlayerControlView$i;)V
.end method
