...
.field public final E:Landroidx/media3/ui/y0;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field public final H:Landroidx/media3/common/f0$b;

.field public final I:Landroidx/media3/common/f0$c;
...
.field public final j:Landroidx/media3/ui/z0;

.field public j0:Landroidx/media3/common/a0;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field public k0:Landroidx/media3/ui/PlayerControlView$d;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ILandroid/util/AttributeSet;)V
    ...
    iput-object v2, v5, Landroidx/media3/ui/PlayerControlView;->H:Landroidx/media3/common/f0$b;

    new-instance v2, Landroidx/media3/common/f0$c;

    invoke-direct {v2}, Landroidx/media3/common/f0$c;-><init>()V

    iput-object v2, v5, Landroidx/media3/ui/PlayerControlView;->I:Landroidx/media3/common/f0$c;
    ...
    invoke-static {v7, v4, v3}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v3, v2, Landroidx/media3/ui/PlayerControlView;->n:Landroid/widget/ImageView;

    if-eqz v3, :cond_a

    invoke-static {v7, v4, v12}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v7, v12}, Le1/h;->g(Landroid/content/Context;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v7, v4, v10}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v7, v4, v13}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v7, v4, v0}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v0, v10}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V
    ...
    invoke-static {v7, v4, v8}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, v2, Landroidx/media3/ui/PlayerControlView;->b0:Landroid/graphics/drawable/Drawable;

    invoke-static {v7, v4, v9}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v7, v4, v14}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, v2, Landroidx/media3/ui/PlayerControlView;->K:Landroid/graphics/drawable/Drawable;

    invoke-static {v7, v4, v15}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v7, v4, v1}, Lg2/z0;->a0(Landroid/content/Context;Landroid/content/res/Resources;I)Landroid/graphics/drawable/Drawable;
...
.method public static synthetic F(Landroidx/media3/ui/PlayerControlView;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->n0()V
...
.method public static synthetic G(Landroidx/media3/ui/PlayerControlView;I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/ui/PlayerControlView;->c0(I)V
...
.method public static synthetic O(Landroidx/media3/ui/PlayerControlView;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->s0()V
...
.method public static synthetic P(Landroidx/media3/ui/PlayerControlView;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->k0()V
...
.method public static synthetic R(Landroidx/media3/ui/PlayerControlView;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->m0()V

    return-void
.end method

.method public static S(Landroidx/media3/common/a0;Landroidx/media3/common/f0$c;)Z
    .locals 8
    ...
    invoke-virtual {p0}, Landroidx/media3/common/f0;->p()I
    ...
    invoke-virtual {p0, v3, p1}, Landroidx/media3/common/f0;->n(ILandroidx/media3/common/f0$c;)Landroidx/media3/common/f0$c;

    move-result-object v4

    iget-wide v4, v4, Landroidx/media3/common/f0$c;->m:J
...
.method public static synthetic a(Landroidx/media3/ui/PlayerControlView;Landroid/view/View;IIIIIIII)V
    ...
    invoke-virtual/range {p0 .. p9}, Landroidx/media3/ui/PlayerControlView;->b0(Landroid/view/View;IIIIIIII)V
...
.method public static synthetic c(Landroidx/media3/ui/PlayerControlView;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/ui/PlayerControlView;->a0(Landroid/view/View;)V
...
.method public static synthetic i(Landroidx/media3/ui/PlayerControlView;)Landroidx/media3/ui/e0;
    .locals 0
...
.method public static synthetic j(Landroidx/media3/ui/PlayerControlView;)Landroidx/media3/common/a0;
    .locals 0
...
.method public static synthetic k(Landroidx/media3/ui/PlayerControlView;Landroidx/media3/common/a0;J)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/ui/PlayerControlView;->e0(Landroidx/media3/common/a0;J)V
...
.method public static synthetic x(Landroidx/media3/ui/PlayerControlView;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->l0()V
...
.method public static synthetic y(Landroidx/media3/ui/PlayerControlView;Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/media3/ui/PlayerControlView;->T(Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroid/view/View;)V
...
# virtual methods
.method public final T(Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroid/view/View;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->r0()V
...
.method public final U(Landroidx/media3/common/j0;I)Lcom/google/common/collect/ImmutableList;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v4, Landroidx/media3/common/j0$a;

    invoke-virtual {v4}, Landroidx/media3/common/j0$a;->d()I
    ...
    :goto_1
    iget v6, v4, Landroidx/media3/common/j0$a;->a:I

    if-ge v5, v6, :cond_3

    invoke-virtual {v4, v5}, Landroidx/media3/common/j0$a;->i(I)Z
    ...
    :cond_1
    invoke-virtual {v4, v5}, Landroidx/media3/common/j0$a;->b(I)Landroidx/media3/common/r;
    ...
    invoke-direct {v7, p1, v3, v5, v6}, Landroidx/media3/ui/PlayerControlView$k;-><init>(Landroidx/media3/common/j0;IILjava/lang/String;)V
...
.method public final W()V
    ...
    invoke-interface {v0}, Landroidx/media3/common/a0;->getCurrentTracks()Landroidx/media3/common/j0;
    ...
    invoke-virtual {p0, v0, v2}, Landroidx/media3/ui/PlayerControlView;->U(Landroidx/media3/common/j0;I)Lcom/google/common/collect/ImmutableList;
...
.method public Z()V
    ...
    invoke-interface {v1, v2}, Landroidx/media3/ui/PlayerControlView$m;->f(I)V
...
.method public final b0(Landroid/view/View;IIIIIIII)V
    .locals 0
...
.method public final c0(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/media3/ui/PlayerControlView;->T(Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroid/view/View;)V
...
.method public dispatchMediaKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    :cond_3
    invoke-static {v1}, Lg2/z0;->v0(Landroidx/media3/common/a0;)Z

    goto :goto_0

    :cond_4
    invoke-static {v1}, Lg2/z0;->w0(Landroidx/media3/common/a0;)Z
    ...
    invoke-static {v1, p1}, Lg2/z0;->x0(Landroidx/media3/common/a0;Z)Z
...
.method public final e0(Landroidx/media3/common/a0;J)V
    .locals 6
    ...
    invoke-interface {p1}, Landroidx/media3/common/a0;->getCurrentTimeline()Landroidx/media3/common/f0;
    ...
    :goto_0
    iget-object v3, p0, Landroidx/media3/ui/PlayerControlView;->I:Landroidx/media3/common/f0$c;

    invoke-virtual {v0, v2, v3}, Landroidx/media3/common/f0;->n(ILandroidx/media3/common/f0$c;)Landroidx/media3/common/f0$c;

    move-result-object v3

    invoke-virtual {v3}, Landroidx/media3/common/f0$c;->d()J
...
.method public final g0(ZLandroid/view/View;)V
    .locals 0
...
.method public final i0(Landroid/widget/ImageView;Z)V
    .locals 0
...
.method public final k0()V
    ...
    iget-object v1, p0, Landroidx/media3/ui/PlayerControlView;->I:Landroidx/media3/common/f0$c;

    invoke-static {v0, v1}, Landroidx/media3/ui/PlayerControlView;->S(Landroidx/media3/common/a0;Landroidx/media3/common/f0$c;)Z
    ...
    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->p0()V

    :cond_3
    if-eqz v4, :cond_4

    invoke-virtual {p0}, Landroidx/media3/ui/PlayerControlView;->h0()V

    :cond_4
    iget-object v5, p0, Landroidx/media3/ui/PlayerControlView;->m:Landroid/widget/ImageView;

    invoke-virtual {p0, v2, v5}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V

    iget-object v2, p0, Landroidx/media3/ui/PlayerControlView;->q:Landroid/view/View;

    invoke-virtual {p0, v3, v2}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V

    iget-object v2, p0, Landroidx/media3/ui/PlayerControlView;->p:Landroid/view/View;

    invoke-virtual {p0, v4, v2}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V

    iget-object v2, p0, Landroidx/media3/ui/PlayerControlView;->n:Landroid/widget/ImageView;

    invoke-virtual {p0, v0, v2}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V
...
.method public final l0()V
    ...
    invoke-static {v0, v1}, Lg2/z0;->m1(Landroidx/media3/common/a0;Z)Z
    ...
    invoke-static {v0}, Lg2/z0;->l1(Landroidx/media3/common/a0;)Z

    move-result v0

    iget-object v1, p0, Landroidx/media3/ui/PlayerControlView;->o:Landroid/widget/ImageView;

    invoke-virtual {p0, v0, v1}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V
...
.method public final n0()V
    ...
    invoke-static {v6, v7, v1, v2}, Lg2/z0;->o0(Ljava/lang/StringBuilder;Ljava/util/Formatter;J)Ljava/lang/String;
    ...
    invoke-static/range {v7 .. v12}, Lg2/z0;->q(JJJ)J
...
.method public final o0()V
    ...
    invoke-virtual {p0, v2, v0}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V
    ...
    invoke-virtual {p0, v2, v1}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V
...
.method public setTimeBarMinUpdateInterval(I)V
    ...
    invoke-static {p1, v0, v1}, Lg2/z0;->p(III)I
...
.method public setVrButtonListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/media3/ui/PlayerControlView;->g0(ZLandroid/view/View;)V
...
.method public final t0()V
    ...
    iget-object v2, v0, Landroidx/media3/ui/PlayerControlView;->I:Landroidx/media3/common/f0$c;

    invoke-static {v1, v2}, Landroidx/media3/ui/PlayerControlView;->S(Landroidx/media3/common/a0;Landroidx/media3/common/f0$c;)Z
    ...
    :cond_2
    sget-object v2, Landroidx/media3/common/f0;->a:Landroidx/media3/common/f0;
    ...
    invoke-static {v11, v12}, Lg2/z0;->z1(J)J
    ...
    :cond_5
    iget-object v14, v0, Landroidx/media3/ui/PlayerControlView;->I:Landroidx/media3/common/f0$c;

    invoke-virtual {v2, v10, v14}, Landroidx/media3/common/f0;->n(ILandroidx/media3/common/f0$c;)Landroidx/media3/common/f0$c;

    iget-object v14, v0, Landroidx/media3/ui/PlayerControlView;->I:Landroidx/media3/common/f0$c;

    iget-wide v5, v14, Landroidx/media3/common/f0$c;->m:J
    ...
    :cond_6
    iget v5, v14, Landroidx/media3/common/f0$c;->n:I

    :goto_5
    iget-object v6, v0, Landroidx/media3/ui/PlayerControlView;->I:Landroidx/media3/common/f0$c;

    iget v14, v6, Landroidx/media3/common/f0$c;->o:I

    if-gt v5, v14, :cond_d

    iget-object v6, v0, Landroidx/media3/ui/PlayerControlView;->H:Landroidx/media3/common/f0$b;

    invoke-virtual {v2, v5, v6}, Landroidx/media3/common/f0;->f(ILandroidx/media3/common/f0$b;)Landroidx/media3/common/f0$b;

    iget-object v6, v0, Landroidx/media3/ui/PlayerControlView;->H:Landroidx/media3/common/f0$b;

    invoke-virtual {v6}, Landroidx/media3/common/f0$b;->p()I

    move-result v6

    iget-object v14, v0, Landroidx/media3/ui/PlayerControlView;->H:Landroidx/media3/common/f0$b;

    invoke-virtual {v14}, Landroidx/media3/common/f0$b;->c()I
    ...
    iget-object v4, v0, Landroidx/media3/ui/PlayerControlView;->H:Landroidx/media3/common/f0$b;

    invoke-virtual {v4, v6}, Landroidx/media3/common/f0$b;->f(I)J
    ...
    iget-wide v3, v4, Landroidx/media3/common/f0$b;->d:J
    ...
    :cond_8
    iget-object v3, v0, Landroidx/media3/ui/PlayerControlView;->H:Landroidx/media3/common/f0$b;

    invoke-virtual {v3}, Landroidx/media3/common/f0$b;->o()J
    ...
    invoke-static/range {v17 .. v18}, Lg2/z0;->z1(J)J
    ...
    invoke-virtual {v4, v6}, Landroidx/media3/common/f0$b;->q(I)Z
    ...
    :cond_d
    iget-wide v3, v6, Landroidx/media3/common/f0$c;->m:J
    ...
    invoke-static {v4, v5, v1, v2}, Lg2/z0;->o0(Ljava/lang/StringBuilder;Ljava/util/Formatter;J)Ljava/lang/String;
    ...
    :cond_13
    invoke-virtual/range {p0 .. p0}, Landroidx/media3/ui/PlayerControlView;->n0()V
...
.method public updateIsFullscreen(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/media3/ui/PlayerControlView;->i0(Landroid/widget/ImageView;Z)V
