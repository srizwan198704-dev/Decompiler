...
.field public final synthetic b:Landroidx/media3/datasource/cronet/CronetDataSource;
...
.method public declared-synchronized onFailed(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;Lorg/chromium/net/CronetException;)V
    ...
    invoke-static {p1}, Landroidx/media3/datasource/cronet/CronetDataSource;->n(Landroidx/media3/datasource/cronet/CronetDataSource;)Lg2/l;
...
.method public declared-synchronized onRedirectReceived(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Landroidx/media3/datasource/cronet/CronetDataSource;->i(Landroidx/media3/datasource/cronet/CronetDataSource;)Lj2/h;
    ...
    sget-object v7, Lg2/z0;->f:[B

    const/4 v4, 0x0

    move-object v1, p3

    invoke-direct/range {v1 .. v7}, Landroidx/media3/datasource/HttpDataSource$InvalidResponseCodeException;-><init>(ILjava/lang/String;Ljava/io/IOException;Ljava/util/Map;Lj2/h;[B)V
    ...
    :try_start_4
    iget p1, v6, Lj2/h;->c:I

    if-ne p1, v1, :cond_7

    invoke-virtual {v6}, Lj2/h;->a()Lj2/h$b;

    move-result-object p1

    invoke-virtual {p1, p3}, Lj2/h$b;->j(Ljava/lang/String;)Lj2/h$b;

    move-result-object p1

    invoke-virtual {p1, v3}, Lj2/h$b;->d(I)Lj2/h$b;

    move-result-object p1

    const/4 p3, 0x0

    invoke-virtual {p1, p3}, Lj2/h$b;->c([B)Lj2/h$b;
    ...
    invoke-virtual {v6, p1}, Lj2/h;->g(Landroid/net/Uri;)Lj2/h;
    ...
    iget-object v0, v6, Lj2/h;->e:Ljava/util/Map;
    ...
    invoke-virtual {p1, p3}, Lj2/h$b;->e(Ljava/util/Map;)Lj2/h$b;
    ...
    invoke-static {p2, p1}, Landroidx/media3/datasource/cronet/CronetDataSource;->j(Landroidx/media3/datasource/cronet/CronetDataSource;Lj2/h;)V
    :try_end_5
