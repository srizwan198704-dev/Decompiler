...
.field public final m:Landroidx/media3/datasource/HttpDataSource$b;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field public final o:Lg2/l;

.field public final p:Lg2/i;

.field public final q:I

.field public final r:Lcom/google/common/base/n;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.field public w:Landroidx/media3/datasource/cronet/CronetDataSource$c;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lorg/chromium/net/CronetEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$b;Lcom/google/common/base/n;ZI)V
    .locals 1
    ...
    invoke-direct {p0, v0}, Lj2/a;-><init>(Z)V
    ...
    iput-object p1, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->p:Lg2/i;
    ...
    iput-object p1, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->o:Lg2/l;

    return-void
.end method

.method public static A(Lorg/chromium/net/UrlRequest;)I
    .locals 3
    ...
    invoke-direct {v2, v1, v0}, Landroidx/media3/datasource/cronet/CronetDataSource$a;-><init>([ILg2/l;)V

    invoke-virtual {p0, v2}, Lorg/chromium/net/UrlRequest;->getStatus(Lorg/chromium/net/UrlRequest$StatusListener;)V

    invoke-virtual {v0}, Lg2/l;->a()V
...
.method public static B(Lorg/chromium/net/UrlResponseInfo;)Z
    .locals 3
...
.method private G(JLj2/h;)V
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/media3/datasource/cronet/CronetDataSource;->z()Ljava/nio/ByteBuffer;
    ...
    :try_start_0
    iget-object v4, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->o:Lg2/l;

    invoke-virtual {v4}, Lg2/l;->d()Z

    invoke-virtual {v2}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    invoke-virtual {p0, v2, p3}, Landroidx/media3/datasource/cronet/CronetDataSource;->D(Ljava/nio/ByteBuffer;Lj2/h;)V
    ...
    invoke-direct {p1, p3, p2, v3}, Landroidx/media3/datasource/cronet/CronetDataSource$OpenException;-><init>(Lj2/h;II)V
    ...
    :goto_2
    invoke-direct {p2, p1, p3, v0, v3}, Landroidx/media3/datasource/cronet/CronetDataSource$OpenException;-><init>(Ljava/io/IOException;Lj2/h;II)V
...
.method public static synthetic i(Landroidx/media3/datasource/cronet/CronetDataSource;)Lj2/h;
    .locals 0

    iget-object p0, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->x:Lj2/h;

    return-object p0
.end method

.method public static synthetic j(Landroidx/media3/datasource/cronet/CronetDataSource;Lj2/h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cronet/CronetDataSource;->x(Lj2/h;)V
...
.method public static synthetic m(Landroidx/media3/datasource/cronet/CronetDataSource;Ljava/io/IOException;)Ljava/io/IOException;
    .locals 0
...
.method public static synthetic n(Landroidx/media3/datasource/cronet/CronetDataSource;)Lg2/l;
    .locals 0

    iget-object p0, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->o:Lg2/l;

    return-object p0
.end method

.method public static synthetic o(Landroidx/media3/datasource/cronet/CronetDataSource;)Z
    .locals 0
...
.method public static synthetic p(Landroidx/media3/datasource/cronet/CronetDataSource;)V
    .locals 0

    invoke-virtual {p0}, Landroidx/media3/datasource/cronet/CronetDataSource;->F()V

    return-void
.end method

.method public static synthetic q(Landroidx/media3/datasource/cronet/CronetDataSource;)Z
    .locals 0
...
.method public static synthetic s(Ljava/util/List;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic t(Landroidx/media3/datasource/cronet/CronetDataSource;)V
    .locals 0

    invoke-virtual {p0}, Landroidx/media3/datasource/cronet/CronetDataSource;->w()V

    return-void
.end method

.method public static y(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
# virtual methods
.method public final D(Ljava/nio/ByteBuffer;Lj2/h;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/media3/datasource/HttpDataSource$HttpDataSourceException;
    ...
    :try_start_0
    iget-object v2, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->o:Lg2/l;

    iget v3, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->i:I

    int-to-long v3, v3

    invoke-virtual {v2, v3, v4}, Lg2/l;->b(J)Z
    ...
    invoke-direct {p1, v2, p2, v1, v0}, Landroidx/media3/datasource/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;Lj2/h;II)V
    ...
    :cond_3
    invoke-static {p1, p2, v0}, Landroidx/media3/datasource/HttpDataSource$HttpDataSourceException;->createForIOException(Ljava/io/IOException;Lj2/h;I)Landroidx/media3/datasource/HttpDataSource$HttpDataSourceException;
...
.method public final E()[B
    ...
    iget-object v2, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->x:Lj2/h;
    ...
    invoke-virtual {p0, v1, v2}, Landroidx/media3/datasource/cronet/CronetDataSource;->D(Ljava/nio/ByteBuffer;Lj2/h;)V
...
.method public final F()V
    ...
    iget-object v0, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->p:Lg2/i;
...
.method public a(Lj2/h;)J
    ...
    iget-object v0, v1, Landroidx/media3/datasource/cronet/CronetDataSource;->o:Lg2/l;

    invoke-virtual {v0}, Lg2/l;->d()Z

    invoke-virtual/range {p0 .. p0}, Landroidx/media3/datasource/cronet/CronetDataSource;->F()V

    iput-object v7, v1, Landroidx/media3/datasource/cronet/CronetDataSource;->x:Lj2/h;

    :try_start_0
    invoke-virtual/range {p0 .. p1}, Landroidx/media3/datasource/cronet/CronetDataSource;->x(Lj2/h;)V
    ...
    invoke-virtual/range {p0 .. p1}, Lj2/a;->f(Lj2/h;)V

    :try_start_1
    invoke-virtual/range {p0 .. p0}, Landroidx/media3/datasource/cronet/CronetDataSource;->u()Z
    ...
    invoke-direct {v0, v4, v7}, Landroidx/media3/datasource/HttpDataSource$CleartextNotPermittedException;-><init>(Ljava/io/IOException;Lj2/h;)V
    ...
    invoke-direct {v2, v4, v7, v3, v0}, Landroidx/media3/datasource/cronet/CronetDataSource$OpenException;-><init>(Ljava/io/IOException;Lj2/h;II)V
    ...
    invoke-direct {v0, v13, v7}, Landroidx/media3/datasource/HttpDataSource$InvalidContentTypeException;-><init>(Ljava/lang/String;Lj2/h;)V
    ...
    invoke-static {v0, v3}, Lj2/k;->b(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-virtual/range {p0 .. p1}, Lj2/a;->g(Lj2/h;)V

    invoke-direct {v1, v8, v9, v7}, Landroidx/media3/datasource/cronet/CronetDataSource;->G(JLj2/h;)V
    ...
    invoke-static {v4}, Lj2/k;->c(Ljava/lang/String;)J

    move-result-wide v12

    iget-wide v14, v7, Lj2/h;->g:J
    ...
    :cond_b
    :try_start_2
    invoke-virtual/range {p0 .. p0}, Landroidx/media3/datasource/cronet/CronetDataSource;->E()[B
    ...
    invoke-direct/range {v2 .. v8}, Landroidx/media3/datasource/HttpDataSource$InvalidResponseCodeException;-><init>(ILjava/lang/String;Ljava/io/IOException;Ljava/util/Map;Lj2/h;[B)V
    ...
    invoke-direct {v2, v3, v7, v4, v0}, Landroidx/media3/datasource/cronet/CronetDataSource$OpenException;-><init>(Ljava/io/IOException;Lj2/h;II)V
    ...
    invoke-direct {v0, v2, v7, v3, v4}, Landroidx/media3/datasource/cronet/CronetDataSource$OpenException;-><init>(Ljava/io/IOException;Lj2/h;II)V
    ...
    invoke-direct {v2, v0, v7, v3, v4}, Landroidx/media3/datasource/cronet/CronetDataSource$OpenException;-><init>(Ljava/io/IOException;Lj2/h;II)V
...
.method public declared-synchronized close()V
    ...
    iput-object v0, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->x:Lj2/h;
...
.method public getUri()Landroid/net/Uri;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->x:Lj2/h;

    if-eqz v0, :cond_1

    iget-object v0, v0, Lj2/h;->a:Landroid/net/Uri;
...
.method public read([BII)I
    ...
    iget-object v5, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->o:Lg2/l;

    invoke-virtual {v5}, Lg2/l;->d()Z

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    iget-object v5, p0, Landroidx/media3/datasource/cronet/CronetDataSource;->x:Lj2/h;
    ...
    invoke-virtual {p0, v1, v5}, Landroidx/media3/datasource/cronet/CronetDataSource;->D(Ljava/nio/ByteBuffer;Lj2/h;)V
    ...
    :cond_5
    invoke-virtual {p0, p3}, Lj2/a;->d(I)V
...
.method public v(Lj2/h;)Lorg/chromium/net/UrlRequest$Builder;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v2, p1, Lj2/h;->e:Ljava/util/Map;
    ...
    invoke-direct {v0, v3, p1, v1, v2}, Landroidx/media3/datasource/cronet/CronetDataSource$OpenException;-><init>(Ljava/lang/String;Lj2/h;II)V

    throw v0

    :cond_3
    :goto_1
    iget-wide v1, p1, Lj2/h;->g:J

    iget-wide v3, p1, Lj2/h;->h:J

    invoke-static {v1, v2, v3, v4}, Lj2/k;->a(JJ)Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {p1}, Lj2/h;->b()Ljava/lang/String;
...
.method public final x(Lj2/h;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cronet/CronetDataSource;->v(Lj2/h;)Lorg/chromium/net/UrlRequest$Builder;
