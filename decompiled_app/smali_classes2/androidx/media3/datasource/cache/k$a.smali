.class public final Landroidx/media3/datasource/cache/k$a;
...
.method public constructor <init>(Li2/a;)V
    ...
    iput-object p1, p0, Landroidx/media3/datasource/cache/k$a;->a:Li2/a;
...
.method public static j(Li2/a;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-interface {p0}, Li2/a;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_1
    invoke-static {p0, v1, p1}, Li2/c;->c(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;)V
...
.method public a()Z
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/media3/datasource/cache/k$a;->a:Li2/a;

    invoke-interface {v0}, Li2/a;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0, v2, v1}, Li2/c;->b(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;)I
...
.method public b(Ljava/util/HashMap;)V
    ...
    :cond_0
    :try_start_0
    iget-object p1, p0, Landroidx/media3/datasource/cache/k$a;->a:Li2/a;

    invoke-interface {p1}, Li2/a;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/media3/datasource/cache/k$a;->k(Landroid/database/sqlite/SQLiteDatabase;I)V
    ...
    :cond_1
    invoke-virtual {p0, p1, v1}, Landroidx/media3/datasource/cache/k$a;->i(Landroid/database/sqlite/SQLiteDatabase;Landroidx/media3/datasource/cache/j;)V
...
.method public d(Ljava/util/HashMap;)V
    ...
    invoke-interface {v0}, Li2/a;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_1
    invoke-virtual {p0, v0}, Landroidx/media3/datasource/cache/k$a;->o(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media3/datasource/cache/k$a;->i(Landroid/database/sqlite/SQLiteDatabase;Landroidx/media3/datasource/cache/j;)V
...
.method public e(Ljava/util/HashMap;Landroid/util/SparseArray;)V
    ...
    invoke-static {v0, v2, v3}, Li2/c;->b(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;)I
    ...
    :cond_1
    :goto_1
    invoke-virtual {p0}, Landroidx/media3/datasource/cache/k$a;->m()Landroid/database/Cursor;
...
.method public f()V
    ...
    invoke-static {v0, v1}, Landroidx/media3/datasource/cache/k$a;->j(Li2/a;Ljava/lang/String;)V
...
.method public final i(Landroid/database/sqlite/SQLiteDatabase;Landroidx/media3/datasource/cache/j;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final o(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1, v1, v0, v1}, Li2/c;->d(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;I)V
