...
.method public constructor <init>(Ljava/io/File;Landroidx/media3/datasource/cache/b;Li2/a;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/media3/datasource/cache/SimpleCache;-><init>(Ljava/io/File;Landroidx/media3/datasource/cache/b;Li2/a;[BZZ)V

    return-void
.end method

.method public constructor <init>(Ljava/io/File;Landroidx/media3/datasource/cache/b;Li2/a;[BZZ)V
    .locals 7
    .param p3    # Li2/a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/media3/datasource/cache/k;-><init>(Li2/a;Ljava/io/File;[BZZ)V
    ...
    invoke-direct {p4, p3}, Landroidx/media3/datasource/cache/d;-><init>(Li2/a;)V
...
.method public static synthetic i(Landroidx/media3/datasource/cache/SimpleCache;)V
    .locals 0

    invoke-virtual {p0}, Landroidx/media3/datasource/cache/SimpleCache;->q()V

    return-void
.end method

.method public static synthetic j(Landroidx/media3/datasource/cache/SimpleCache;)Landroidx/media3/datasource/cache/b;
    .locals 0
...
.method public static m(Ljava/io/File;)V
    ...
    invoke-static {v0, p0}, Lg2/t;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static s([Ljava/io/File;)J
    ...
    invoke-static {v4, v3}, Lg2/t;->c(Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public final A(Ljava/lang/String;Landroidx/media3/datasource/cache/s;)Landroidx/media3/datasource/cache/s;
    .locals 9
    ...
    invoke-virtual {p0, p2, p1}, Landroidx/media3/datasource/cache/SimpleCache;->w(Landroidx/media3/datasource/cache/s;Landroidx/media3/datasource/cache/h;)V
...
.method public declared-synchronized b(Ljava/lang/String;JJ)Landroidx/media3/datasource/cache/h;
    ...
    invoke-virtual/range {p0 .. p5}, Landroidx/media3/datasource/cache/SimpleCache;->p(Ljava/lang/String;JJ)Landroidx/media3/datasource/cache/s;
    ...
    invoke-virtual {p0, p1, p4}, Landroidx/media3/datasource/cache/SimpleCache;->A(Ljava/lang/String;Landroidx/media3/datasource/cache/s;)Landroidx/media3/datasource/cache/s;
...
.method public declared-synchronized d(Ljava/io/File;J)V
    ...
    invoke-static {p1, p2, p3, v0}, Landroidx/media3/datasource/cache/s;->h(Ljava/io/File;JLandroidx/media3/datasource/cache/k;)Landroidx/media3/datasource/cache/s;
    ...
    :cond_4
    :goto_0
    invoke-virtual {p0, p2}, Landroidx/media3/datasource/cache/SimpleCache;->k(Landroidx/media3/datasource/cache/s;)V
    :try_end_4
...
.method public declared-synchronized e(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/media3/datasource/cache/SimpleCache;->y(Landroidx/media3/datasource/cache/h;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized f(Landroidx/media3/datasource/cache/h;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cache/SimpleCache;->y(Landroidx/media3/datasource/cache/h;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final k(Landroidx/media3/datasource/cache/s;)V
    .locals 4
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cache/SimpleCache;->u(Landroidx/media3/datasource/cache/s;)V
...
.method public final p(Ljava/lang/String;JJ)Landroidx/media3/datasource/cache/s;
    .locals 5
    ...
    invoke-static {p1, p2, p3, p4, p5}, Landroidx/media3/datasource/cache/s;->i(Ljava/lang/String;JJ)Landroidx/media3/datasource/cache/s;
    ...
    invoke-virtual {p0}, Landroidx/media3/datasource/cache/SimpleCache;->z()V
...
.method public final q()V
    ...
    invoke-virtual {p0, v4, v3, v0, v2}, Landroidx/media3/datasource/cache/SimpleCache;->r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v2, v3, v0, v4}, Landroidx/media3/datasource/cache/SimpleCache;->r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
    :try_end_2
...
.method public final r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v8, v0, v2, p4}, Landroidx/media3/datasource/cache/SimpleCache;->r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
    ...
    invoke-static/range {v2 .. v7}, Landroidx/media3/datasource/cache/s;->g(Ljava/io/File;JJLandroidx/media3/datasource/cache/k;)Landroidx/media3/datasource/cache/s;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {p0, v2}, Landroidx/media3/datasource/cache/SimpleCache;->k(Landroidx/media3/datasource/cache/s;)V
...
.method public declared-synchronized startFile(Ljava/lang/String;JJ)Ljava/io/File;
    ...
    invoke-static/range {v2 .. v7}, Landroidx/media3/datasource/cache/s;->k(Ljava/io/File;IJJ)Ljava/io/File;
...
.method public final u(Landroidx/media3/datasource/cache/s;)V
    .locals 3
...
.method public final v(Landroidx/media3/datasource/cache/h;)V
    .locals 3
...
.method public final w(Landroidx/media3/datasource/cache/s;Landroidx/media3/datasource/cache/h;)V
    .locals 3
...
.method public final y(Landroidx/media3/datasource/cache/h;)V
    .locals 5
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cache/SimpleCache;->v(Landroidx/media3/datasource/cache/h;)V
...
.method public final z()V
    ...
    invoke-virtual {p0, v2}, Landroidx/media3/datasource/cache/SimpleCache;->y(Landroidx/media3/datasource/cache/h;)V
