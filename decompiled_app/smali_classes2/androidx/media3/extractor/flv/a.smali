...
.method public constructor <init>(Lb3/s0;)V
    ...
    invoke-direct {p0, p1}, Landroidx/media3/extractor/flv/TagPayloadReader;-><init>(Lb3/s0;)V
...
.method public b(Lg2/i0;)Z
    ...
    invoke-virtual {v0, v2}, Landroidx/media3/common/r$b;->U(Ljava/lang/String;)Landroidx/media3/common/r$b;
    ...
    iget-object v0, p0, Landroidx/media3/extractor/flv/TagPayloadReader;->a:Lb3/s0;
    ...
    invoke-virtual {v0, p1}, Landroidx/media3/common/r$b;->u0(Ljava/lang/String;)Landroidx/media3/common/r$b;

    move-result-object p1

    invoke-virtual {p1, v1}, Landroidx/media3/common/r$b;->R(I)Landroidx/media3/common/r$b;

    move-result-object p1

    const/16 v0, 0x1f40

    invoke-virtual {p1, v0}, Landroidx/media3/common/r$b;->v0(I)Landroidx/media3/common/r$b;
...
.method public c(Lg2/i0;J)Z
    ...
    invoke-interface {v0, p1, v7}, Lb3/s0;->g(Lg2/i0;I)V

    iget-object v3, p0, Landroidx/media3/extractor/flv/TagPayloadReader;->a:Lb3/s0;
    ...
    invoke-virtual {p1, p3, v1, p2}, Lg2/i0;->l([BII)V

    invoke-static {p3}, Lb3/a;->e([B)Lb3/a$b;
    ...
    iget-object v0, p1, Lb3/a$b;->c:Ljava/lang/String;

    invoke-virtual {p2, v0}, Landroidx/media3/common/r$b;->S(Ljava/lang/String;)Landroidx/media3/common/r$b;

    move-result-object p2

    iget v0, p1, Lb3/a$b;->b:I

    invoke-virtual {p2, v0}, Landroidx/media3/common/r$b;->R(I)Landroidx/media3/common/r$b;

    move-result-object p2

    iget p1, p1, Lb3/a$b;->a:I

    invoke-virtual {p2, p1}, Landroidx/media3/common/r$b;->v0(I)Landroidx/media3/common/r$b;
    ...
    iget-object p2, p0, Landroidx/media3/extractor/flv/TagPayloadReader;->a:Lb3/s0;
    ...
    invoke-interface {v0, p1, v9}, Lb3/s0;->g(Lg2/i0;I)V

    iget-object v5, p0, Landroidx/media3/extractor/flv/TagPayloadReader;->a:Lb3/s0;
