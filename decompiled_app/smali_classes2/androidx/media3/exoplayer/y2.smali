...
.field public final k:[Landroidx/media3/exoplayer/y3;

.field public final l:Lz2/e0;

.field public final m:Landroidx/media3/exoplayer/q3;
...
.field public o:Lw2/n0;

.field public p:Lz2/f0;
...
.method public constructor <init>([Landroidx/media3/exoplayer/y3;JLz2/e0;Landroidx/media3/exoplayer/upstream/b;Landroidx/media3/exoplayer/q3;Landroidx/media3/exoplayer/z2;Lz2/f0;J)V
    .locals 10
    ...
    iput-object v3, v0, Landroidx/media3/exoplayer/y2;->l:Lz2/e0;
    ...
    iget-object v5, v4, Landroidx/media3/exoplayer/source/l$b;->a:Ljava/lang/Object;
    ...
    sget-object v5, Lw2/n0;->d:Lw2/n0;

    iput-object v5, v0, Landroidx/media3/exoplayer/y2;->o:Lw2/n0;

    move-object/from16 v5, p8

    iput-object v5, v0, Landroidx/media3/exoplayer/y2;->p:Lz2/f0;

    array-length v5, v1

    new-array v5, v5, [Lw2/g0;

    iput-object v5, v0, Landroidx/media3/exoplayer/y2;->c:[Lw2/g0;
    ...
    invoke-static/range {v1 .. v8}, Landroidx/media3/exoplayer/y2;->f(Landroidx/media3/exoplayer/source/l$b;Landroidx/media3/exoplayer/q3;Landroidx/media3/exoplayer/upstream/b;JJZ)Landroidx/media3/exoplayer/source/k;

    move-result-object v1

    iput-object v1, v0, Landroidx/media3/exoplayer/y2;->a:Landroidx/media3/exoplayer/source/k;

    return-void
.end method

.method public static f(Landroidx/media3/exoplayer/source/l$b;Landroidx/media3/exoplayer/q3;Landroidx/media3/exoplayer/upstream/b;JJZ)Landroidx/media3/exoplayer/source/k;
    .locals 7

    invoke-virtual {p1, p0, p2, p3, p4}, Landroidx/media3/exoplayer/q3;->h(Landroidx/media3/exoplayer/source/l$b;Landroidx/media3/exoplayer/upstream/b;J)Landroidx/media3/exoplayer/source/k;
...
.method public static y(Landroidx/media3/exoplayer/q3;Landroidx/media3/exoplayer/source/k;)V
    .locals 1
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/exoplayer/q3;->A(Landroidx/media3/exoplayer/source/k;)V
    ...
    invoke-static {p1, v0, p0}, Lg2/t;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public A(Landroidx/media3/exoplayer/y2;)V
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/media3/exoplayer/y2;->g()V

    iput-object p1, p0, Landroidx/media3/exoplayer/y2;->n:Landroidx/media3/exoplayer/y2;

    invoke-virtual {p0}, Landroidx/media3/exoplayer/y2;->i()V
...
.method public E()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/y2;->a:Landroidx/media3/exoplayer/source/k;
...
.method public a(Lz2/f0;JZ)J
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/media3/exoplayer/y2;->b(Lz2/f0;JZ[Z)J
...
.method public b(Lz2/f0;JZ[Z)J
    ...
    iget-object v6, v0, Landroidx/media3/exoplayer/y2;->p:Lz2/f0;

    invoke-virtual {p1, v6, v3}, Lz2/f0;->b(Lz2/f0;I)Z
    ...
    :cond_1
    iget-object v3, v0, Landroidx/media3/exoplayer/y2;->c:[Lw2/g0;

    invoke-virtual {p0, v3}, Landroidx/media3/exoplayer/y2;->h([Lw2/g0;)V

    invoke-virtual {p0}, Landroidx/media3/exoplayer/y2;->g()V

    iput-object v1, v0, Landroidx/media3/exoplayer/y2;->p:Lz2/f0;

    invoke-virtual {p0}, Landroidx/media3/exoplayer/y2;->i()V

    iget-object v6, v0, Landroidx/media3/exoplayer/y2;->a:Landroidx/media3/exoplayer/source/k;

    iget-object v7, v1, Lz2/f0;->c:[Lz2/z;

    iget-object v8, v0, Landroidx/media3/exoplayer/y2;->j:[Z

    iget-object v9, v0, Landroidx/media3/exoplayer/y2;->c:[Lw2/g0;
    ...
    iget-object v6, v0, Landroidx/media3/exoplayer/y2;->c:[Lw2/g0;

    invoke-virtual {p0, v6}, Landroidx/media3/exoplayer/y2;->c([Lw2/g0;)V
    ...
    :goto_2
    iget-object v7, v0, Landroidx/media3/exoplayer/y2;->c:[Lw2/g0;
    ...
    invoke-virtual {p1, v6}, Lz2/f0;->c(I)Z
...
.method public final c([Lw2/g0;)V
    .locals 3
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/y2;->p:Lz2/f0;

    invoke-virtual {v1, v0}, Lz2/f0;->c(I)Z
...
.method public e(Landroidx/media3/exoplayer/v2;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/y2;->u()Z
...
.method public final g()V
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/y2;->p:Lz2/f0;

    iget-object v2, v2, Lz2/f0;->c:[Lz2/z;
    ...
    invoke-interface {v2}, Lz2/z;->disable()V
...
.method public final h([Lw2/g0;)V
    .locals 3
...
.method public final i()V
    ...
    invoke-interface {v2}, Lz2/z;->enable()V
...
.method public o()Lw2/n0;
    .locals 1

    iget-object v0, p0, Landroidx/media3/exoplayer/y2;->o:Lw2/n0;

    return-object v0
.end method

.method public p()Lz2/f0;
    .locals 1

    iget-object v0, p0, Landroidx/media3/exoplayer/y2;->p:Lz2/f0;

    return-object v0
.end method

.method public q(FLandroidx/media3/common/f0;Z)V
    .locals 4
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/y2;->o:Lw2/n0;

    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/exoplayer/y2;->z(FLandroidx/media3/common/f0;Z)Lz2/f0;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Landroidx/media3/exoplayer/y2;->a(Lz2/f0;JZ)J
...
.method public r()Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/exoplayer/y2;->c:[Lw2/g0;
    ...
    invoke-interface {v4}, Lw2/g0;->maybeThrowError()V
    :try_end_0
...
.method public v(Landroidx/media3/exoplayer/source/k$a;J)V
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/media3/exoplayer/source/k;->e(Landroidx/media3/exoplayer/source/k$a;J)V
...
.method public x()V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/y2;->a:Landroidx/media3/exoplayer/source/k;

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/y2;->y(Landroidx/media3/exoplayer/q3;Landroidx/media3/exoplayer/source/k;)V

    return-void
.end method

.method public z(FLandroidx/media3/common/f0;Z)Lz2/f0;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/media3/exoplayer/ExoPlaybackException;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/y2;->l:Lz2/e0;

    iget-object v1, p0, Landroidx/media3/exoplayer/y2;->k:[Landroidx/media3/exoplayer/y3;

    invoke-virtual {p0}, Landroidx/media3/exoplayer/y2;->o()Lw2/n0;
    ...
    invoke-virtual {v0, v1, v2, v3, p2}, Lz2/e0;->k([Landroidx/media3/exoplayer/y3;Lw2/n0;Landroidx/media3/exoplayer/source/l$b;Landroidx/media3/common/f0;)Lz2/f0;
    ...
    iget-object v2, p2, Lz2/f0;->c:[Lz2/z;
    ...
    :cond_4
    iget-object v1, p2, Lz2/f0;->c:[Lz2/z;
    ...
    invoke-interface {v3, p1}, Lz2/z;->onPlaybackSpeed(F)V

    invoke-interface {v3, p3}, Lz2/z;->b(Z)V
