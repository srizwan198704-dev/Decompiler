...
.method public constructor <init>(Ljava/util/UUID;)V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/drm/h;->w()Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-static {v0}, Landroidx/media3/exoplayer/drm/h;->q(Landroid/media/MediaDrm;)V

    :cond_0
    return-void
.end method

.method public static synthetic g(Ljava/util/UUID;)Landroidx/media3/exoplayer/drm/g;
    .locals 0

    invoke-static {p0}, Landroidx/media3/exoplayer/drm/h;->v(Ljava/util/UUID;)Landroidx/media3/exoplayer/drm/g;
...
.method public static synthetic h(Landroidx/media3/exoplayer/drm/h;Landroidx/media3/exoplayer/drm/g$b;Landroid/media/MediaDrm;[BII[B)V
    .locals 0

    invoke-virtual/range {p0 .. p6}, Landroidx/media3/exoplayer/drm/h;->u(Landroidx/media3/exoplayer/drm/g$b;Landroid/media/MediaDrm;[BII[B)V
...
.method public static i([B)[B
    ...
    invoke-virtual {v0, v5, v6}, Lg2/i0;->F(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-static {v4, v0}, Lg2/t;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static l(Ljava/util/UUID;[B)[B
    ...
    invoke-static {p1, p0}, Lv3/p;->e([BLjava/util/UUID;)[B
    ...
    invoke-static {v0, p1}, Lv3/p;->a(Ljava/util/UUID;[B)[B

    move-result-object p1

    :cond_1
    invoke-static {p0}, Landroidx/media3/exoplayer/drm/h;->o(Ljava/util/UUID;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-static {p1}, Lv3/p;->d([B)Lv3/p$a;
    ...
    iget-object v2, v1, Lv3/p$a;->d:[Ljava/util/UUID;

    iget-object v1, v1, Lv3/p$a;->c:[B

    invoke-static {p1, v2, v1}, Lv3/p;->b(Ljava/util/UUID;[Ljava/util/UUID;[B)[B
...
.method public static o(Ljava/util/UUID;)Z
    .locals 2
...
.method public static q(Landroid/media/MediaDrm;)V
    .locals 2
...
.method public static s(Ljava/util/UUID;Ljava/util/List;)Landroidx/media3/common/DrmInitData$SchemeData;
    .locals 8
...
.method public static synthetic v(Ljava/util/UUID;)Landroidx/media3/exoplayer/drm/g;
    .locals 2

    :try_start_0
    invoke-static {p0}, Landroidx/media3/exoplayer/drm/h;->x(Ljava/util/UUID;)Landroidx/media3/exoplayer/drm/h;
...
.method public static x(Ljava/util/UUID;)Landroidx/media3/exoplayer/drm/h;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public bridge synthetic b([B)Landroidx/media3/decoder/b;
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/exoplayer/drm/h;->p([B)Lp2/v;
...
.method public c([BLjava/lang/String;)Z
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/drm/h;->t()Z
    ...
    invoke-static {v0, p1}, Lp2/w;->a(Landroid/media/MediaDrm;[B)I
...
.method public d([BLjava/util/List;ILjava/util/HashMap;)Landroidx/media3/exoplayer/drm/g$a;
    ...
    invoke-static {v0, p2}, Landroidx/media3/exoplayer/drm/h;->s(Ljava/util/UUID;Ljava/util/List;)Landroidx/media3/common/DrmInitData$SchemeData;
    ...
    invoke-virtual {p0, p4}, Landroidx/media3/exoplayer/drm/h;->j(Ljava/lang/String;)Ljava/lang/String;
...
.method public e([BLl2/f4;)V
    ...
    invoke-static {v0, p1, p2}, Landroidx/media3/exoplayer/drm/h$a;->b(Landroid/media/MediaDrm;[BLl2/f4;)V
    :try_end_0
...
.method public f(Landroidx/media3/exoplayer/drm/g$b;)V
    ...
    invoke-direct {v1, p0, p1}, Lp2/y;-><init>(Landroidx/media3/exoplayer/drm/h;Landroidx/media3/exoplayer/drm/g$b;)V
...
.method public final j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Landroidx/media3/exoplayer/drm/h;->r(Ljava/lang/String;)Ljava/lang/String;
...
.method public p([B)Lp2/v;
    ...
    invoke-static {v1}, Landroidx/media3/exoplayer/drm/h;->n(Ljava/util/UUID;)Ljava/util/UUID;

    move-result-object v1

    invoke-direct {v0, v1, p1}, Lp2/v;-><init>(Ljava/util/UUID;[B)V
...
.method public final synthetic u(Landroidx/media3/exoplayer/drm/g$b;Landroid/media/MediaDrm;[BII[B)V
    .locals 6
