...
.field public final b:Landroidx/media3/exoplayer/s2;
...
.method public constructor <init>(Landroidx/media3/exoplayer/dash/d;Landroidx/media3/exoplayer/upstream/b;)V
    ...
    invoke-static {p2}, Landroidx/media3/exoplayer/source/s;->m(Landroidx/media3/exoplayer/upstream/b;)Landroidx/media3/exoplayer/source/s;
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/dash/d$c;->b:Landroidx/media3/exoplayer/s2;

    new-instance p1, Lk3/b;

    invoke-direct {p1}, Lk3/b;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/dash/d$c;->c:Lk3/b;
...
.method public a(JIIILb3/s0$a;)V
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/media3/exoplayer/source/s;->a(JIIILb3/s0$a;)V
...
.method public b(Landroidx/media3/common/r;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/media3/exoplayer/source/s;->b(Landroidx/media3/common/r;)V
...
.method public e(Landroidx/media3/common/j;IZI)I
    ...
    invoke-virtual {p4, p1, p2, p3}, Landroidx/media3/exoplayer/source/s;->c(Landroidx/media3/common/j;IZ)I
...
.method public f(Lg2/i0;II)V
    ...
    invoke-virtual {p3, p1, p2}, Landroidx/media3/exoplayer/source/s;->g(Lg2/i0;I)V
...
.method public final h()Lk3/b;
    .locals 4
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object v0, p0, Landroidx/media3/exoplayer/dash/d$c;->c:Lk3/b;

    invoke-virtual {v0}, Landroidx/media3/decoder/DecoderInputBuffer;->clear()V

    iget-object v0, p0, Landroidx/media3/exoplayer/dash/d$c;->a:Landroidx/media3/exoplayer/source/s;

    iget-object v1, p0, Landroidx/media3/exoplayer/dash/d$c;->b:Landroidx/media3/exoplayer/s2;

    iget-object v2, p0, Landroidx/media3/exoplayer/dash/d$c;->c:Lk3/b;

    const/4 v3, 0x0

    invoke-virtual {v0, v1, v2, v3, v3}, Landroidx/media3/exoplayer/source/s;->V(Landroidx/media3/exoplayer/s2;Landroidx/media3/decoder/DecoderInputBuffer;IZ)I
...
.method public j(Lx2/e;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/media3/exoplayer/dash/d;->m(Lx2/e;)V

    return-void
.end method

.method public k(Lx2/e;)Z
    .locals 4
...
.method public final m()V
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/dash/d$c;->h()Lk3/b;
    ...
    invoke-static {v4}, Landroidx/media3/exoplayer/dash/d;->a(Landroidx/media3/exoplayer/dash/d;)Lm3/b;

    move-result-object v4

    invoke-virtual {v4, v0}, Lk3/c;->a(Lk3/b;)Landroidx/media3/common/x;
    ...
    iget-object v1, v0, Lm3/a;->a:Ljava/lang/String;

    iget-object v4, v0, Lm3/a;->b:Ljava/lang/String;
    ...
    invoke-virtual {p0, v2, v3, v0}, Landroidx/media3/exoplayer/dash/d$c;->n(JLm3/a;)V
    ...
    invoke-virtual {v0}, Landroidx/media3/exoplayer/source/s;->t()V

    return-void
.end method

.method public final n(JLm3/a;)V
    .locals 4

    invoke-static {p3}, Landroidx/media3/exoplayer/dash/d;->c(Lm3/a;)J
