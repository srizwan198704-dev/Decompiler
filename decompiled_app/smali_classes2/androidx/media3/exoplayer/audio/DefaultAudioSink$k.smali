...
.method public constructor <init>(Landroid/media/AudioTrack;Landroidx/media3/exoplayer/audio/a;)V
    ...
    iput-object p2, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$k;->b:Landroidx/media3/exoplayer/audio/a;

    new-instance p2, Lm2/n0;

    invoke-direct {p2, p0}, Lm2/n0;-><init>(Landroidx/media3/exoplayer/audio/DefaultAudioSink$k;)V
    ...
    invoke-static {p1, v0, p2}, Lm2/j0;->a(Landroid/media/AudioTrack;Landroid/media/AudioRouting$OnRoutingChangedListener;Landroid/os/Handler;)V
...
.method public final b(Landroid/media/AudioRouting;)V
    ...
    :cond_0
    invoke-static {p1}, Lm2/m0;->a(Landroid/media/AudioRouting;)Landroid/media/AudioDeviceInfo;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object v0, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$k;->b:Landroidx/media3/exoplayer/audio/a;
...
.method public c()V
    ...
    invoke-static {v1}, Lm2/k0;->a(Ljava/lang/Object;)Landroid/media/AudioRouting$OnRoutingChangedListener;

    move-result-object v1

    invoke-static {v0, v1}, Lm2/l0;->a(Landroid/media/AudioTrack;Landroid/media/AudioRouting$OnRoutingChangedListener;)V
