...
.method public constructor <init>(Landroidx/media3/common/f0;JJZ)V
    .locals 8
    ...
    invoke-virtual {p1, v2, v1}, Landroidx/media3/common/f0;->n(ILandroidx/media3/common/f0$c;)Landroidx/media3/common/f0$c;
    ...
    iget-boolean p6, p1, Landroidx/media3/common/f0$c;->k:Z
    ...
    iget-boolean p6, p1, Landroidx/media3/common/f0$c;->h:Z
    ...
    iget-wide p4, p1, Landroidx/media3/common/f0$c;->m:J
    ...
    :goto_2
    iget-wide v0, p1, Landroidx/media3/common/f0$c;->m:J
    ...
    iget-boolean p1, p1, Landroidx/media3/common/f0$c;->i:Z
...
.method public g(ILandroidx/media3/common/f0$b;Z)Landroidx/media3/common/f0$b;
    ...
    iget-object p1, p0, Lw2/n;->e:Landroidx/media3/common/f0;

    const/4 v0, 0x0

    invoke-virtual {p1, v0, p2, p3}, Landroidx/media3/common/f0;->g(ILandroidx/media3/common/f0$b;Z)Landroidx/media3/common/f0$b;

    invoke-virtual {p2}, Landroidx/media3/common/f0$b;->o()J
    ...
    :goto_0
    iget-object v5, p2, Landroidx/media3/common/f0$b;->a:Ljava/lang/Object;

    iget-object v6, p2, Landroidx/media3/common/f0$b;->b:Ljava/lang/Object;

    const/4 v7, 0x0

    move-object v4, p2

    invoke-virtual/range {v4 .. v11}, Landroidx/media3/common/f0$b;->t(Ljava/lang/Object;Ljava/lang/Object;IJJ)Landroidx/media3/common/f0$b;
...
.method public o(ILandroidx/media3/common/f0$c;J)Landroidx/media3/common/f0$c;
    ...
    invoke-virtual {p1, p3, p2, v0, v1}, Landroidx/media3/common/f0;->o(ILandroidx/media3/common/f0$c;J)Landroidx/media3/common/f0$c;

    iget-wide p3, p2, Landroidx/media3/common/f0$c;->p:J

    iget-wide v0, p0, Landroidx/media3/exoplayer/source/ClippingMediaSource$c;->f:J

    add-long/2addr p3, v0

    iput-wide p3, p2, Landroidx/media3/common/f0$c;->p:J

    iget-wide p3, p0, Landroidx/media3/exoplayer/source/ClippingMediaSource$c;->h:J

    iput-wide p3, p2, Landroidx/media3/common/f0$c;->m:J

    iget-boolean p1, p0, Landroidx/media3/exoplayer/source/ClippingMediaSource$c;->i:Z

    iput-boolean p1, p2, Landroidx/media3/common/f0$c;->i:Z
    ...
    invoke-static {p3, p4}, Lg2/z0;->z1(J)J

    move-result-wide p3

    iget-wide v0, p2, Landroidx/media3/common/f0$c;->e:J
    ...
    iput-wide v0, p2, Landroidx/media3/common/f0$c;->e:J

    :cond_2
    iget-wide v0, p2, Landroidx/media3/common/f0$c;->f:J
    ...
    iput-wide v0, p2, Landroidx/media3/common/f0$c;->f:J
