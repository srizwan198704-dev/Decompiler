...
.method public constructor <init>(Lj2/h;Landroidx/media3/datasource/a$a;Lj2/p;Landroidx/media3/common/r;JLandroidx/media3/exoplayer/upstream/m;Landroidx/media3/exoplayer/source/m$a;ZLandroidx/media3/exoplayer/util/c;)V
    .locals 0
    .param p3    # Lj2/p;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .param p10    # Landroidx/media3/exoplayer/util/c;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/u;->a:Lj2/h;

    iput-object p2, p0, Landroidx/media3/exoplayer/source/u;->b:Landroidx/media3/datasource/a$a;

    iput-object p3, p0, Landroidx/media3/exoplayer/source/u;->c:Lj2/p;

    iput-object p4, p0, Landroidx/media3/exoplayer/source/u;->j:Landroidx/media3/common/r;
    ...
    invoke-direct {p2, p5}, Landroidx/media3/common/g0;-><init>([Landroidx/media3/common/r;)V

    new-array p3, p3, [Landroidx/media3/common/g0;

    aput-object p2, p3, p6

    invoke-direct {p1, p3}, Lw2/n0;-><init>([Landroidx/media3/common/g0;)V

    iput-object p1, p0, Landroidx/media3/exoplayer/source/u;->f:Lw2/n0;
...
.method public a(Landroidx/media3/exoplayer/v2;)Z
    ...
    iget-boolean p1, p0, Landroidx/media3/exoplayer/source/u;->l:Z

    if-nez p1, :cond_2

    iget-object p1, p0, Landroidx/media3/exoplayer/source/u;->i:Landroidx/media3/exoplayer/upstream/Loader;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/media3/exoplayer/source/u;->b:Landroidx/media3/datasource/a$a;

    invoke-interface {p1}, Landroidx/media3/datasource/a$a;->createDataSource()Landroidx/media3/datasource/a;

    move-result-object p1

    iget-object v0, p0, Landroidx/media3/exoplayer/source/u;->c:Lj2/p;

    if-eqz v0, :cond_1

    invoke-interface {p1, v0}, Landroidx/media3/datasource/a;->c(Lj2/p;)V

    :cond_1
    new-instance v0, Landroidx/media3/exoplayer/source/u$c;

    iget-object v1, p0, Landroidx/media3/exoplayer/source/u;->a:Lj2/h;

    invoke-direct {v0, v1, p1}, Landroidx/media3/exoplayer/source/u$c;-><init>(Lj2/h;Landroidx/media3/datasource/a;)V

    iget-object p1, p0, Landroidx/media3/exoplayer/source/u;->i:Landroidx/media3/exoplayer/upstream/Loader;

    iget-object v1, p0, Landroidx/media3/exoplayer/source/u;->d:Landroidx/media3/exoplayer/upstream/m;
...
.method public d(Landroidx/media3/exoplayer/source/u$c;JJZ)V
    ...
    invoke-static/range {p1 .. p1}, Landroidx/media3/exoplayer/source/u$c;->a(Landroidx/media3/exoplayer/source/u$c;)Lj2/n;
    ...
    iget-object v6, v1, Landroidx/media3/exoplayer/source/u$c;->b:Lj2/h;

    invoke-virtual {v2}, Lj2/n;->e()Landroid/net/Uri;

    move-result-object v7

    invoke-virtual {v2}, Lj2/n;->f()Ljava/util/Map;

    move-result-object v8

    invoke-virtual {v2}, Lj2/n;->d()J
...
.method public f(Landroidx/media3/exoplayer/source/u$c;JJ)V
    ...
    iput v2, v0, Landroidx/media3/exoplayer/source/u;->n:I
    ...
    iget-object v7, v0, Landroidx/media3/exoplayer/source/u;->j:Landroidx/media3/common/r;
...
.method public g(Landroidx/media3/exoplayer/source/u$c;JJLjava/io/IOException;I)Landroidx/media3/exoplayer/upstream/Loader$c;
    .locals 36
    ...
    iget-object v7, v1, Landroidx/media3/exoplayer/source/u$c;->b:Lj2/h;

    invoke-virtual {v3}, Lj2/n;->e()Landroid/net/Uri;

    move-result-object v18

    invoke-virtual {v3}, Lj2/n;->f()Ljava/util/Map;

    move-result-object v19

    invoke-virtual {v3}, Lj2/n;->d()J
    ...
    iget-object v5, v0, Landroidx/media3/exoplayer/source/u;->j:Landroidx/media3/common/r;
    ...
    invoke-direct/range {v26 .. v35}, Lw2/p;-><init>(IILandroidx/media3/common/r;ILjava/lang/Object;JJ)V
    ...
    invoke-direct {v6, v4, v3, v13, v2}, Landroidx/media3/exoplayer/upstream/m$c;-><init>(Lw2/o;Lw2/p;Ljava/io/IOException;I)V
    ...
    iget-object v9, v0, Landroidx/media3/exoplayer/source/u;->d:Landroidx/media3/exoplayer/upstream/m;
    ...
    :goto_1
    iget-boolean v9, v0, Landroidx/media3/exoplayer/source/u;->k:Z
    ...
    invoke-static {v2, v3, v13}, Lg2/t;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v6, v0, Landroidx/media3/exoplayer/source/u;->j:Landroidx/media3/common/r;
...
.method public getTrackGroups()Lw2/n0;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/source/u;->f:Lw2/n0;
...
.method public i(Landroidx/media3/exoplayer/source/u$c;JJI)V
    .locals 19
    ...
    invoke-direct/range {v3 .. v8}, Lw2/o;-><init>(JLj2/h;J)V
    ...
    iget-wide v8, v1, Landroidx/media3/exoplayer/source/u$c;->a:J

    iget-object v10, v1, Landroidx/media3/exoplayer/source/u$c;->b:Lj2/h;
    ...
    invoke-virtual/range {v3 .. v14}, Landroidx/media3/exoplayer/source/m$a;->C(Lw2/o;IILandroidx/media3/common/r;ILjava/lang/Object;JJI)V
...
.method public bridge synthetic k(Landroidx/media3/exoplayer/upstream/Loader$d;JJLjava/io/IOException;I)Landroidx/media3/exoplayer/upstream/Loader$c;
    ...
    invoke-virtual/range {p0 .. p7}, Landroidx/media3/exoplayer/source/u;->g(Landroidx/media3/exoplayer/source/u$c;JJLjava/io/IOException;I)Landroidx/media3/exoplayer/upstream/Loader$c;
...
.method public bridge synthetic o(Landroidx/media3/exoplayer/upstream/Loader$d;JJI)V
    ...
    invoke-virtual/range {p0 .. p6}, Landroidx/media3/exoplayer/source/u;->i(Landroidx/media3/exoplayer/source/u$c;JJI)V
