...
.method public static b(Landroid/content/Context;Lf5/m;)Landroid/content/Intent;
    .locals 2
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p1}, Landroidx/work/impl/background/systemalarm/b;->q(Landroid/content/Intent;Lf5/m;)Landroid/content/Intent;
...
.method public static c(Landroid/content/Context;Lf5/m;Z)Landroid/content/Intent;
    .locals 2
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static e(Landroid/content/Context;Lf5/m;)Landroid/content/Intent;
    .locals 2
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static f(Landroid/content/Context;Lf5/m;)Landroid/content/Intent;
    .locals 2
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static p(Landroid/content/Intent;)Lf5/m;
    .locals 4
...
.method public static q(Landroid/content/Intent;Lf5/m;)Landroid/content/Intent;
    .locals 2
    .param p0    # Landroid/content/Intent;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public d(Lf5/m;Z)V
    ...
    invoke-virtual {v2, p1}, Landroidx/work/impl/v;->b(Lf5/m;)Landroidx/work/impl/u;
...
.method public final h(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/work/impl/background/systemalarm/b;->p(Landroid/content/Intent;)Lf5/m;
    ...
    invoke-virtual {v3, p1}, Landroidx/work/impl/v;->d(Lf5/m;)Landroidx/work/impl/u;
...
.method public final i(Landroid/content/Intent;I)V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/work/impl/background/systemalarm/b;->d(Lf5/m;Z)V
...
.method public final k(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-interface {v2, v3}, Lf5/v;->i(Ljava/lang/String;)Lf5/u;
    ...
    :cond_0
    :try_start_2
    iget-object v4, v2, Lf5/u;->b:Landroidx/work/WorkInfo$State;
    ...
    :cond_1
    :try_start_3
    invoke-virtual {v2}, Lf5/u;->c()J

    move-result-wide v3

    invoke-virtual {v2}, Lf5/u;->h()Z
    ...
    invoke-static {p2, v0, p1, v3, v4}, Landroidx/work/impl/background/systemalarm/a;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lf5/m;J)V
    ...
    invoke-static {v1, v0, p1, v3, v4}, Landroidx/work/impl/background/systemalarm/a;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lf5/m;J)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->f()Lg5/c;

    move-result-object v1

    invoke-interface {v1}, Lg5/c;->a()Ljava/util/concurrent/Executor;
...
.method public final l(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-direct {v3, v0, p1}, Lf5/m;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v2, v3}, Landroidx/work/impl/v;->b(Lf5/m;)Landroidx/work/impl/u;
    ...
    invoke-virtual {v1}, Landroidx/work/impl/u;->a()Lf5/m;

    move-result-object v4

    invoke-static {v2, v3, v4}, Landroidx/work/impl/background/systemalarm/a;->a(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lf5/m;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->d(Lf5/m;Z)V
...
.method public o(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->g(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->k(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;->h(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {p0, p1, p3}, Landroidx/work/impl/background/systemalarm/b;->l(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
