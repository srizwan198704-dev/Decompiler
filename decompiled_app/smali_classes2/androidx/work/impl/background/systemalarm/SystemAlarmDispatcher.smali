...
.field private final e:Landroidx/work/impl/d0;
...
.field private i:Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;

.field private j:Landroidx/work/impl/v;
...
.method constructor <init>(Landroid/content/Context;Landroidx/work/impl/Processor;Landroidx/work/impl/d0;)V
    .locals 3
    ...
    iput-object v1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->j:Landroidx/work/impl/v;

    .line 5
    new-instance v1, Landroidx/work/impl/background/systemalarm/b;

    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->j:Landroidx/work/impl/v;
    ...
    iput-object v1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->f:Landroidx/work/impl/background/systemalarm/b;
    ...
    :goto_0
    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->e:Landroidx/work/impl/d0;

    .line 7
    new-instance p1, Landroidx/work/impl/utils/WorkTimer;

    invoke-virtual {p3}, Landroidx/work/impl/d0;->m()Landroidx/work/a;
    ...
    .line 8
    :cond_1
    invoke-virtual {p3}, Landroidx/work/impl/d0;->q()Landroidx/work/impl/Processor;
    ...
    .line 9
    invoke-virtual {p3}, Landroidx/work/impl/d0;->u()Lk4/c;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->b:Lk4/c;
    ...
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->g:Ljava/util/List;
...
.method private i(Ljava/lang/String;)Z
    ...
    .line 3
    .line 4
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->g:Ljava/util/List;
    ...
    .line 7
    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->g:Ljava/util/List;
...
.method private k()V
    ...
    .line 14
    .line 15
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->e:Landroidx/work/impl/d0;

    .line 16
    .line 17
    invoke-virtual {v1}, Landroidx/work/impl/d0;->u()Lk4/c;
    ...
    .line 25
    .line 26
    invoke-interface {v1, v2}, Lk4/c;->c(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public a(Landroid/content/Intent;I)Z
    ...
    .line 85
    .line 86
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->g:Ljava/util/List;
    ...
    .line 96
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->g:Ljava/util/List;
...
.method c()V
    ...
    .line 18
    :try_start_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->h:Landroid/content/Intent;
    ...
    .line 35
    .line 36
    iget-object v4, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->h:Landroid/content/Intent;
    ...
    .line 56
    .line 57
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->h:Landroid/content/Intent;
    ...
    .line 66
    iput-object v2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->h:Landroid/content/Intent;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->b:Lk4/c;

    .line 80
    .line 81
    invoke-interface {v2}, Lk4/c;->b()Lk4/a;
    ...
    .line 85
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->f:Landroidx/work/impl/background/systemalarm/b;
    ...
    .line 92
    .line 93
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->g:Ljava/util/List;
    ...
    .line 115
    .line 116
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->i:Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;
...
.method public d(Lj4/m;Z)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->b:Lk4/c;
    ...
    .line 10
    .line 11
    invoke-static {v2, p1, p2}, Landroidx/work/impl/background/systemalarm/b;->c(Landroid/content/Context;Lj4/m;Z)Landroid/content/Intent;
...
.method g()Landroidx/work/impl/d0;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->e:Landroidx/work/impl/d0;
...
.method j()V
    ...
    .line 18
    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->i:Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;
...
.method l(Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;)V
    .locals 2

    .line 1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->i:Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;
    ...
    .line 17
    :cond_0
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->i:Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;
