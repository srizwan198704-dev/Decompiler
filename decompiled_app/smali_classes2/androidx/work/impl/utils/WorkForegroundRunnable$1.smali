...
.method public run()V
    ...
    iget-object v4, v4, Landroidx/work/impl/utils/WorkForegroundRunnable;->mWorkSpec:Lf5/u;
    ...
    invoke-interface {v3, v4, v1, v0}, Landroidx/work/f;->a(Landroid/content/Context;Ljava/util/UUID;Landroidx/work/e;)Lcom/google/common/util/concurrent/t;

    move-result-object v0

    invoke-virtual {v2, v0}, Landroidx/work/impl/utils/futures/a;->v(Lcom/google/common/util/concurrent/t;)Z
    ...
    iget-object v1, v1, Landroidx/work/impl/utils/WorkForegroundRunnable;->mWorkSpec:Lf5/u;

    iget-object v1, v1, Lf5/u;->c:Ljava/lang/String;
