...
.method public run()V
    ...
    invoke-virtual {v0, v1}, Landroidx/work/impl/Processor;->h(Ljava/lang/String;)Lf5/u;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lf5/u;->h()Z
    ...
    iget-object v2, v0, Landroidx/work/impl/foreground/SystemForegroundDispatcher;->i:Lc5/d;

    iget-object v0, v0, Landroidx/work/impl/foreground/SystemForegroundDispatcher;->h:Ljava/util/Set;

    invoke-interface {v2, v0}, Lc5/d;->a(Ljava/lang/Iterable;)V
