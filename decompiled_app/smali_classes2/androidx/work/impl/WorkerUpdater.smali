...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "f",
        "(Landroidx/work/impl/Processor;Landroidx/work/impl/WorkDatabase;Landroidx/work/a;Ljava/util/List;Lf5/u;Ljava/util/Set;)Landroidx/work/WorkManager$UpdateResult;",
        ...
        "Landroidx/work/l;",
        "c",
        "(Landroidx/work/impl/d0;Ljava/lang/String;Landroidx/work/r;)Landroidx/work/l;",
...
.method public static synthetic b(Landroidx/work/impl/WorkDatabase;Lf5/u;Lf5/u;Ljava/util/List;Ljava/lang/String;Ljava/util/Set;Z)V
    .locals 0

    invoke-static/range {p0 .. p6}, Landroidx/work/impl/WorkerUpdater;->g(Landroidx/work/impl/WorkDatabase;Lf5/u;Lf5/u;Ljava/util/List;Ljava/lang/String;Ljava/util/Set;Z)V
...
.method public static final c(Landroidx/work/impl/d0;Ljava/lang/String;Landroidx/work/r;)Landroidx/work/l;
    ...
    invoke-virtual {p0}, Landroidx/work/impl/d0;->u()Lg5/c;

    move-result-object v1

    invoke-interface {v1}, Lg5/c;->b()Lg5/a;
...
.method public static final d(Landroidx/work/impl/d0;Ljava/lang/String;Landroidx/work/impl/o;Lkotlin/jvm/functions/Function0;Landroidx/work/r;)V
    ...
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->n0()Lf5/v;

    move-result-object v2

    invoke-interface {v2, v0}, Lf5/v;->q(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_1
    iget-object v7, v6, Lf5/u$b;->a:Ljava/lang/String;

    invoke-interface {v2, v7}, Lf5/v;->i(Ljava/lang/String;)Lf5/u;
    ...
    iget-object v5, v6, Lf5/u$b;->a:Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, v6, Lf5/u$b;->b:Landroidx/work/WorkInfo$State;

    sget-object v7, Landroidx/work/WorkInfo$State;->CANCELLED:Landroidx/work/WorkInfo$State;

    if-ne v0, v7, :cond_4

    iget-object v0, v6, Lf5/u$b;->a:Ljava/lang/String;

    invoke-interface {v2, v0}, Lf5/v;->a(Ljava/lang/String;)V
    ...
    :cond_4
    invoke-virtual/range {p4 .. p4}, Landroidx/work/r;->d()Lf5/u;

    move-result-object v7

    iget-object v8, v6, Lf5/u$b;->a:Ljava/lang/String;
    ...
    invoke-static/range {v7 .. v36}, Lf5/u;->e(Lf5/u;Ljava/lang/String;Landroidx/work/WorkInfo$State;Ljava/lang/String;Ljava/lang/String;Landroidx/work/d;Landroidx/work/d;JJJLandroidx/work/b;ILandroidx/work/BackoffPolicy;JJJJZLandroidx/work/OutOfQuotaPolicy;IIILjava/lang/Object;)Lf5/u;
    ...
    invoke-static/range {v37 .. v42}, Landroidx/work/impl/WorkerUpdater;->f(Landroidx/work/impl/Processor;Landroidx/work/impl/WorkDatabase;Landroidx/work/a;Ljava/util/List;Lf5/u;Ljava/util/Set;)Landroidx/work/WorkManager$UpdateResult;
...
.method public static final f(Landroidx/work/impl/Processor;Landroidx/work/impl/WorkDatabase;Landroidx/work/a;Ljava/util/List;Lf5/u;Ljava/util/Set;)Landroidx/work/WorkManager$UpdateResult;
    .locals 9
    ...
    iget-object v5, p4, Lf5/u;->a:Ljava/lang/String;

    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->n0()Lf5/v;

    move-result-object v0

    invoke-interface {v0, v5}, Lf5/v;->i(Ljava/lang/String;)Lf5/u;

    move-result-object v3

    if-eqz v3, :cond_5

    iget-object v0, v3, Lf5/u;->b:Landroidx/work/WorkInfo$State;
    ...
    :cond_0
    invoke-virtual {v3}, Lf5/u;->j()Z

    move-result v0

    invoke-virtual {p4}, Lf5/u;->j()Z
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/work/impl/h0;-><init>(Landroidx/work/impl/WorkDatabase;Lf5/u;Lf5/u;Ljava/util/List;Ljava/lang/String;Ljava/util/Set;Z)V
...
.method public static final g(Landroidx/work/impl/WorkDatabase;Lf5/u;Lf5/u;Ljava/util/List;Ljava/lang/String;Ljava/util/Set;Z)V
    .locals 35
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/work/impl/WorkDatabase;->n0()Lf5/v;

    move-result-object v13

    invoke-virtual/range {p0 .. p0}, Landroidx/work/impl/WorkDatabase;->o0()Lf5/z;

    move-result-object v14

    iget-object v6, v0, Lf5/u;->b:Landroidx/work/WorkInfo$State;

    iget v5, v0, Lf5/u;->k:I

    move/from16 v18, v5

    iget-wide v7, v0, Lf5/u;->n:J

    move-wide/from16 v22, v7

    invoke-virtual/range {p2 .. p2}, Lf5/u;->f()I
    ...
    invoke-static/range {v4 .. v33}, Lf5/u;->e(Lf5/u;Ljava/lang/String;Landroidx/work/WorkInfo$State;Ljava/lang/String;Ljava/lang/String;Landroidx/work/d;Landroidx/work/d;JJJLandroidx/work/b;ILandroidx/work/BackoffPolicy;JJJJZLandroidx/work/OutOfQuotaPolicy;IIILjava/lang/Object;)Lf5/u;

    move-result-object v4

    invoke-static {v1, v4}, Landroidx/work/impl/utils/b;->b(Ljava/util/List;Lf5/u;)Lf5/u;

    move-result-object v1

    invoke-interface {v0, v1}, Lf5/v;->y(Lf5/u;)V

    move-object/from16 v1, v34

    invoke-interface {v1, v2}, Lf5/z;->c(Ljava/lang/String;)V

    invoke-interface {v1, v2, v3}, Lf5/z;->d(Ljava/lang/String;Ljava/util/Set;)V

    if-nez p6, :cond_0

    const-wide/16 v3, -0x1

    invoke-interface {v0, v2, v3, v4}, Lf5/v;->p(Ljava/lang/String;J)I

    invoke-virtual/range {p0 .. p0}, Landroidx/work/impl/WorkDatabase;->m0()Lf5/r;

    move-result-object v0

    invoke-interface {v0, v2}, Lf5/r;->a(Ljava/lang/String;)V
