...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/work/impl/d0;-><init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;Z)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;Landroidx/work/impl/WorkDatabase;)V
    .locals 9
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v1, v0, p3}, Le5/n;-><init>(Landroid/content/Context;Lg5/c;)V

    iput-object v1, p0, Landroidx/work/impl/d0;->j:Le5/n;

    invoke-virtual {p0, v0, p2, v1}, Landroidx/work/impl/d0;->j(Landroid/content/Context;Landroidx/work/a;Le5/n;)Ljava/util/List;
    ...
    invoke-direct/range {v2 .. v7}, Landroidx/work/impl/Processor;-><init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V

    move-object v2, p0

    invoke-virtual/range {v2 .. v8}, Landroidx/work/impl/d0;->v(Landroid/content/Context;Landroidx/work/a;Lg5/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/Processor;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;Z)V
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-interface {p3}, Lg5/c;->b()Lg5/a;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/work/impl/d0;-><init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;Landroidx/work/impl/WorkDatabase;)V
...
.method public static h(Landroid/content/Context;Landroidx/work/a;)V
    ...
    invoke-direct {v2, v3}, Lg5/d;-><init>(Ljava/util/concurrent/Executor;)V

    invoke-direct {v1, p0, p1, v2}, Landroidx/work/impl/d0;-><init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;)V
...
.method public A(Landroidx/work/impl/u;Landroidx/work/WorkerParameters$a;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/d0;->d:Lg5/c;
...
.method public B(Lf5/m;)V
    ...
    invoke-direct {v2, p1}, Landroidx/work/impl/u;-><init>(Lf5/m;)V
...
.method public g(Ljava/util/UUID;)Landroidx/lifecycle/LiveData;
    ...
    invoke-interface {v0, p1}, Lf5/v;->B(Ljava/util/List;)Landroidx/lifecycle/LiveData;
    ...
    iget-object v1, p0, Landroidx/work/impl/d0;->d:Lg5/c;

    invoke-static {p1, v0, v1}, Landroidx/work/impl/utils/LiveDataUtils;->a(Landroidx/lifecycle/LiveData;Ln/a;Lg5/c;)Landroidx/lifecycle/LiveData;
...
.method public i(Ljava/util/UUID;)Landroidx/work/l;
    ...
    invoke-interface {v0, p1}, Lg5/c;->c(Ljava/lang/Runnable;)V
...
.method public j(Landroid/content/Context;Landroidx/work/a;Le5/n;)Ljava/util/List;
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v1, p1, p2, p3, p0}, Landroidx/work/impl/background/greedy/a;-><init>(Landroid/content/Context;Landroidx/work/a;Le5/n;Landroidx/work/impl/d0;)V
...
.method public s()Le5/n;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    iget-object v0, p0, Landroidx/work/impl/d0;->j:Le5/n;
...
.method public final v(Landroid/content/Context;Landroidx/work/a;Lg5/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/Processor;)V
    .locals 0
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iput-object p3, p0, Landroidx/work/impl/d0;->d:Lg5/c;
    ...
    :cond_1
    :goto_0
    iget-object p2, p0, Landroidx/work/impl/d0;->d:Lg5/c;
    ...
    invoke-interface {p2, p3}, Lg5/c;->c(Ljava/lang/Runnable;)V
...
.method public x()V
    ...
    invoke-static {v0}, Lb5/k;->a(Landroid/content/Context;)V
