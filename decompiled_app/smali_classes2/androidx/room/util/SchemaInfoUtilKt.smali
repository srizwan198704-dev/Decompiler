...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "d",
        "(Lr4/b;Ljava/lang/String;)Ljava/util/Set;",
        "Lr4/e;",
        "stmt",
        "",
        "Landroidx/room/util/e;",
        "c",
        "(Lr4/e;)Ljava/util/List;",
        "",
        "Landroidx/room/util/n$a;",
        "b",
        "(Lr4/b;Ljava/lang/String;)Ljava/util/Map;",
        ...
        "unique",
        "e",
        "(Lr4/b;Ljava/lang/String;Z)Landroidx/room/util/n$d;",
        "",
        "[Ljava/lang/String;",
        "FTS_OPTIONS",
...
.method public static final a(Ljava/lang/String;)I
    ...
    invoke-static {p0, v1, v2, v3, v4}, Lkotlin/text/StringsKt__StringsKt;->c0(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
    ...
    invoke-static {p0, v0, v2, v3, v4}, Lkotlin/text/StringsKt__StringsKt;->c0(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
...
.method public static final b(Lr4/b;Ljava/lang/String;)Ljava/util/Map;
    .locals 17
    ...
    invoke-static {v1, v0}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v0

    const-string v3, "type"

    invoke-static {v1, v3}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v3

    const-string v4, "notnull"

    invoke-static {v1, v4}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v4

    const-string v5, "pk"

    invoke-static {v1, v5}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v5

    const-string v6, "dflt_value"

    invoke-static {v1, v6}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I
    ...
    :goto_3
    new-instance v14, Landroidx/room/util/n$a;
    ...
    invoke-static {v7}, Lkotlin/collections/u;->b(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final c(Lr4/e;)Ljava/util/List;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v0}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v0

    const-string v1, "seq"

    invoke-static {p0, v1}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v1

    const-string v2, "from"

    invoke-static {p0, v2}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v2

    const-string v3, "to"

    invoke-static {p0, v3}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I
    ...
    invoke-interface {p0, v3}, Lr4/e;->o0(I)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v4}, Lkotlin/collections/i;->a(Ljava/util/List;)Ljava/util/List;
...
.method public static final d(Lr4/b;Ljava/lang/String;)Ljava/util/Set;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, p1}, Lr4/b;->F0(Ljava/lang/String;)Lr4/e;
    ...
    invoke-static {p0, p1}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I
    ...
    invoke-static {p0}, Landroidx/room/util/SchemaInfoUtilKt;->c(Lr4/e;)Ljava/util/List;

    move-result-object v4

    invoke-interface {p0}, Lr4/e;->reset()V
    ...
    :cond_0
    invoke-interface {p0, p1}, Lr4/e;->getLong(I)J
    ...
    invoke-direct/range {v7 .. v12}, Landroidx/room/util/n$c;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_4
    invoke-static {v5}, Lkotlin/collections/y;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method public static final e(Lr4/b;Ljava/lang/String;Z)Landroidx/room/util/n$d;
    .locals 13
    ...
    invoke-static {v1, v3}, Lkotlin/collections/CollectionsKt___CollectionsKt;->I0(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    new-instance v2, Landroidx/room/util/n$d;

    invoke-direct {v2, p1, p2, v0, v1}, Landroidx/room/util/n$d;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static final f(Lr4/b;Ljava/lang/String;)Ljava/util/Set;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v0

    const-string v1, "origin"

    invoke-static {p1, v1}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I

    move-result v1

    const-string v2, "unique"

    invoke-static {p1, v2}, Landroidx/room/util/j;->a(Lr4/e;Ljava/lang/String;)I
    ...
    :goto_1
    invoke-static {p0, v5, v6}, Landroidx/room/util/SchemaInfoUtilKt;->e(Lr4/b;Ljava/lang/String;Z)Landroidx/room/util/n$d;
    ...
    :cond_4
    invoke-static {v3}, Lkotlin/collections/y;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method public static final g(Lr4/b;Ljava/lang/String;)Landroidx/room/util/n;
    .locals 3
    ...
    invoke-static {p0, p1}, Landroidx/room/util/SchemaInfoUtilKt;->b(Lr4/b;Ljava/lang/String;)Ljava/util/Map;

    move-result-object v0

    invoke-static {p0, p1}, Landroidx/room/util/SchemaInfoUtilKt;->d(Lr4/b;Ljava/lang/String;)Ljava/util/Set;

    move-result-object v1

    invoke-static {p0, p1}, Landroidx/room/util/SchemaInfoUtilKt;->f(Lr4/b;Ljava/lang/String;)Ljava/util/Set;

    move-result-object p0

    new-instance v2, Landroidx/room/util/n;

    invoke-direct {v2, p1, v0, v1, p0}, Landroidx/room/util/n;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
