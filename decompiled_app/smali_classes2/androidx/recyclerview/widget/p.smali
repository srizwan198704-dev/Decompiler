...
# static fields
.field private static final MAX_SCROLL_ON_FLING_DURATION:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/recyclerview/widget/p;->MAX_SCROLL_ON_FLING_DURATION:I
...
.method private distanceToCenter(Landroid/view/View;Landroidx/recyclerview/widget/o;)I
    .locals 1
...
.method private findCenterView(Landroidx/recyclerview/widget/RecyclerView$m;Landroidx/recyclerview/widget/o;)Landroid/view/View;
    .locals 8
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method private getHorizontalHelper(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
    .locals 1
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/o;->a:Landroidx/recyclerview/widget/RecyclerView$m;

    if-eq v0, p1, :cond_1

    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/o;->a(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
...
.method private getOrientationHelper(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/p;->getVerticalHelper(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/p;->getHorizontalHelper(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
...
.method private getVerticalHelper(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
    .locals 1
    .param p1    # Landroidx/recyclerview/widget/RecyclerView$m;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_0
    invoke-static {p1}, Landroidx/recyclerview/widget/o;->c(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
...
.method public calculateDistanceToFinalSnap(Landroidx/recyclerview/widget/RecyclerView$m;Landroid/view/View;)[I
    ...
    invoke-direct {p0, p2, v1}, Landroidx/recyclerview/widget/p;->distanceToCenter(Landroid/view/View;Landroidx/recyclerview/widget/o;)I
    ...
    invoke-direct {p0, p2, p1}, Landroidx/recyclerview/widget/p;->distanceToCenter(Landroid/view/View;Landroidx/recyclerview/widget/o;)I
...
.method public createScroller(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/RecyclerView$w;
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/t;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;
...
.method public findSnapView(Landroidx/recyclerview/widget/RecyclerView$m;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/p;->findCenterView(Landroidx/recyclerview/widget/RecyclerView$m;Landroidx/recyclerview/widget/o;)Landroid/view/View;
...
.method public findTargetSnapPosition(Landroidx/recyclerview/widget/RecyclerView$m;II)I
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/p;->getOrientationHelper(Landroidx/recyclerview/widget/RecyclerView$m;)Landroidx/recyclerview/widget/o;
    ...
    :cond_2
    invoke-direct {p0, v9, v2}, Landroidx/recyclerview/widget/p;->distanceToCenter(Landroid/view/View;Landroidx/recyclerview/widget/o;)I
    ...
    :cond_5
    invoke-direct {p0, p1, p2, p3}, Landroidx/recyclerview/widget/p;->isForwardFling(Landroidx/recyclerview/widget/RecyclerView$m;II)Z
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/p;->isReverseLayout(Landroidx/recyclerview/widget/RecyclerView$m;)Z
