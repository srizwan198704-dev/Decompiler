...
.method public constructor <init>(Landroidx/core/view/WindowInsetsAnimationCompat$Callback;)V
    ...
    iput-object v0, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->d:Ljava/util/HashMap;

    iput-object p1, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->a:Landroidx/core/view/WindowInsetsAnimationCompat$Callback;
...
.method public final a(Landroid/view/WindowInsetsAnimation;)Landroidx/core/view/WindowInsetsAnimationCompat;
    ...
    iget-object v0, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->d:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->d:Ljava/util/HashMap;
...
.method public onEnd(Landroid/view/WindowInsetsAnimation;)V
    ...
    iget-object v0, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->a:Landroidx/core/view/WindowInsetsAnimationCompat$Callback;

    invoke-virtual {p0, p1}, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->a(Landroid/view/WindowInsetsAnimation;)Landroidx/core/view/WindowInsetsAnimationCompat;
...
.method public onProgress(Landroid/view/WindowInsets;Ljava/util/List;)Landroid/view/WindowInsets;
    ...
    iget-object v0, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->c:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->b:Ljava/util/List;
    ...
    invoke-static {v1}, Landroidx/core/view/e1;->a(Ljava/lang/Object;)Landroid/view/WindowInsetsAnimation;

    move-result-object v1

    invoke-virtual {p0, v1}, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->a(Landroid/view/WindowInsetsAnimation;)Landroidx/core/view/WindowInsetsAnimationCompat;

    move-result-object v2

    invoke-static {v1}, Landroidx/core/view/z0;->a(Landroid/view/WindowInsetsAnimation;)F

    move-result v1

    invoke-virtual {v2, v1}, Landroidx/core/view/WindowInsetsAnimationCompat;->setFraction(F)V

    iget-object v1, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->c:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p2, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->a:Landroidx/core/view/WindowInsetsAnimationCompat$Callback;

    invoke-static {p1}, Landroidx/core/view/WindowInsetsCompat;->toWindowInsetsCompat(Landroid/view/WindowInsets;)Landroidx/core/view/WindowInsetsCompat;

    move-result-object p1

    iget-object v0, p0, Landroidx/core/view/WindowInsetsAnimationCompat$a$a;->b:Ljava/util/List;
