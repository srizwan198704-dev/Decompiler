...
.method public constructor <init>(ILandroid/view/animation/Interpolator;J)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/core/view/WindowInsetsAnimationCompat$b;-><init>(ILandroid/view/animation/Interpolator;J)V

    return-void
.end method

.method public static i(Landroidx/core/view/WindowInsetsCompat;Landroidx/core/view/WindowInsetsCompat;[I[I)V
    .locals 9
    ...
    invoke-virtual {p0, v1}, Landroidx/core/view/WindowInsetsCompat;->getInsets(I)Lf1/c;
    ...
    iget v4, v2, Lf1/c;->a:I

    iget v5, v3, Lf1/c;->a:I

    const/4 v6, 0x0

    if-gt v4, v5, :cond_1

    iget v7, v2, Lf1/c;->b:I

    iget v8, v3, Lf1/c;->b:I

    if-gt v7, v8, :cond_1

    iget v7, v2, Lf1/c;->c:I

    iget v8, v3, Lf1/c;->c:I

    if-gt v7, v8, :cond_1

    iget v7, v2, Lf1/c;->d:I

    iget v8, v3, Lf1/c;->d:I
    ...
    iget v4, v2, Lf1/c;->b:I

    iget v5, v3, Lf1/c;->b:I

    if-lt v4, v5, :cond_3

    iget v4, v2, Lf1/c;->c:I

    iget v5, v3, Lf1/c;->c:I

    if-lt v4, v5, :cond_3

    iget v2, v2, Lf1/c;->d:I

    iget v3, v3, Lf1/c;->d:I
...
.method public static j(Landroidx/core/view/WindowInsetsCompat;Landroidx/core/view/WindowInsetsCompat;I)Landroidx/core/view/WindowInsetsAnimationCompat$BoundsCompat;
    .locals 4

    invoke-virtual {p0, p2}, Landroidx/core/view/WindowInsetsCompat;->getInsets(I)Lf1/c;

    move-result-object p0

    invoke-virtual {p1, p2}, Landroidx/core/view/WindowInsetsCompat;->getInsets(I)Lf1/c;
    ...
    invoke-static {p2, v0, v1, v2}, Lf1/c;->c(IIII)Lf1/c;
    ...
    invoke-static {v0, v1, v2, p0}, Lf1/c;->c(IIII)Lf1/c;

    move-result-object p0

    new-instance p1, Landroidx/core/view/WindowInsetsAnimationCompat$BoundsCompat;

    invoke-direct {p1, p2, p0}, Landroidx/core/view/WindowInsetsAnimationCompat$BoundsCompat;-><init>(Lf1/c;Lf1/c;)V

    return-object p1
.end method

.method public static k(II)Landroid/view/animation/Interpolator;
    .locals 1
...
.method public static m(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat;)V
    ...
    invoke-static {p0}, Landroidx/core/view/WindowInsetsAnimationCompat$Impl21;->r(Landroid/view/View;)Landroidx/core/view/WindowInsetsAnimationCompat$Callback;
    ...
    invoke-static {v1, p1}, Landroidx/core/view/WindowInsetsAnimationCompat$Impl21;->m(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat;)V
...
.method public static n(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat;Landroidx/core/view/WindowInsetsCompat;Z)V
    .locals 2
    ...
    invoke-static {v0, p1, p2, p3}, Landroidx/core/view/WindowInsetsAnimationCompat$Impl21;->n(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat;Landroidx/core/view/WindowInsetsCompat;Z)V
...
.method public static o(Landroid/view/View;Landroidx/core/view/WindowInsetsCompat;Ljava/util/List;)V
    ...
    invoke-static {v1, p1, p2}, Landroidx/core/view/WindowInsetsAnimationCompat$Impl21;->o(Landroid/view/View;Landroidx/core/view/WindowInsetsCompat;Ljava/util/List;)V
...
.method public static p(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat;Landroidx/core/view/WindowInsetsAnimationCompat$BoundsCompat;)V
    .locals 2
    ...
    invoke-static {v1, p1, p2}, Landroidx/core/view/WindowInsetsAnimationCompat$Impl21;->p(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat;Landroidx/core/view/WindowInsetsAnimationCompat$BoundsCompat;)V
...
.method public static s(Landroidx/core/view/WindowInsetsCompat;Landroidx/core/view/WindowInsetsCompat;FI)Landroidx/core/view/WindowInsetsCompat;
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/core/view/WindowInsetsCompat$Builder;->setInsets(ILf1/c;)Landroidx/core/view/WindowInsetsCompat$Builder;
    ...
    iget v6, v2, Lf1/c;->b:I

    iget v7, v3, Lf1/c;->b:I
    ...
    invoke-static {v2, v4, v6, v7, v3}, Landroidx/core/view/WindowInsetsCompat;->insetInsets(Lf1/c;IIII)Lf1/c;
...
.method public static t(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat$Callback;)V
    ...
    invoke-static {p0, p1}, Landroidx/core/view/WindowInsetsAnimationCompat$Impl21;->l(Landroid/view/View;Landroidx/core/view/WindowInsetsAnimationCompat$Callback;)Landroid/view/View$OnApplyWindowInsetsListener;
