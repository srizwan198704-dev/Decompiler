...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "",
        "invoke",
        "(Landroidx/compose/runtime/saveable/e;Landroidx/compose/ui/text/y;)Ljava/lang/Object;",
        "<anonymous>"
    }
    k = 0x3
    mv = {
...
.method public final invoke(Landroidx/compose/runtime/saveable/e;Landroidx/compose/ui/text/y;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->g()J
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->k()J

    move-result-wide v3

    invoke-static {v3, v4}, Lt0/w;->b(J)Lt0/w;

    move-result-object v3

    sget-object v4, Lt0/w;->b:Lt0/w$a;

    invoke-static {v4}, Landroidx/compose/ui/text/SaversKt;->u(Lt0/w$a;)Landroidx/compose/runtime/saveable/d;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->n()Landroidx/compose/ui/text/font/u;

    move-result-object v5

    sget-object v6, Landroidx/compose/ui/text/font/u;->b:Landroidx/compose/ui/text/font/u$a;

    invoke-static {v6}, Landroidx/compose/ui/text/SaversKt;->m(Landroidx/compose/ui/text/font/u$a;)Landroidx/compose/runtime/saveable/d;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->l()Landroidx/compose/ui/text/font/q;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->m()Landroidx/compose/ui/text/font/r;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->j()Ljava/lang/String;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->o()J

    move-result-wide v10

    invoke-static {v10, v11}, Lt0/w;->b(J)Lt0/w;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->e()Landroidx/compose/ui/text/style/a;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->u()Landroidx/compose/ui/text/style/m;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->p()Ls0/i;

    move-result-object v12

    sget-object v13, Ls0/i;->c:Ls0/i$a;

    invoke-static {v13}, Landroidx/compose/ui/text/SaversKt;->t(Ls0/i$a;)Landroidx/compose/runtime/saveable/d;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->d()J

    move-result-wide v13

    invoke-static {v13, v14}, Landroidx/compose/ui/graphics/w1;->g(J)Landroidx/compose/ui/graphics/w1;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->s()Landroidx/compose/ui/text/style/i;
    ...
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/ui/text/y;->r()Landroidx/compose/ui/graphics/b5;

    move-result-object v14

    sget-object v15, Landroidx/compose/ui/graphics/b5;->d:Landroidx/compose/ui/graphics/b5$a;

    invoke-static {v15}, Landroidx/compose/ui/text/SaversKt;->k(Landroidx/compose/ui/graphics/b5$a;)Landroidx/compose/runtime/saveable/d;
