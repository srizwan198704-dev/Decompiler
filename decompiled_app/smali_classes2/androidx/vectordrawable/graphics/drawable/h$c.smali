...
.method public constructor <init>(Landroidx/vectordrawable/graphics/drawable/h$c;)V
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Le1/d;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Le1/d;
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/h$c;->h:Le1/d;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->h:Le1/d;
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->h:Le1/d;
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Le1/d;
...
.method public b([I)Z
    ...
    invoke-virtual {v0, p1}, Le1/d;->j([I)Z

    move-result v0

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Le1/d;

    invoke-virtual {v1, p1}, Le1/d;->j([I)Z
...
.method public g(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p3, p2, v0}, Le1/k;->k(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
...
.method public final h(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p2, v0}, Le1/k;->j(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lf1/e;->d(Ljava/lang/String;)[Lf1/e$b;

    move-result-object v0

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h$f;->a:[Lf1/e$b;
    ...
    invoke-static/range {v1 .. v6}, Le1/k;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;II)Le1/d;
    ...
    invoke-static {p1, p2, v2, v0, v1}, Le1/k;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v0, v1, v2}, Le1/k;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I

    move-result v0

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->n:Landroid/graphics/Paint$Cap;

    invoke-virtual {p0, v0, v1}, Landroidx/vectordrawable/graphics/drawable/h$c;->e(ILandroid/graphics/Paint$Cap;)Landroid/graphics/Paint$Cap;
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/vectordrawable/graphics/drawable/h$c;->f(ILandroid/graphics/Paint$Join;)Landroid/graphics/Paint$Join;
    ...
    iput-object p3, p0, Landroidx/vectordrawable/graphics/drawable/h$c;->f:Le1/d;
    ...
    invoke-static {p1, p2, v1, p3, v0}, Le1/k;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v1, p3, v0}, Le1/k;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
...
.method public setFillColor(I)V
    ...
    invoke-virtual {v0, p1}, Le1/d;->k(I)V
