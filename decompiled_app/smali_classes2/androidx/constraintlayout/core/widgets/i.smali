...
.field public i1:Lz0/b$a;

.field public j1:Lz0/b$b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/constraintlayout/core/widgets/i;->j1:Lz0/b$b;
...
.method public H1(Landroidx/constraintlayout/core/widgets/ConstraintWidget;Landroidx/constraintlayout/core/widgets/ConstraintWidget$DimensionBehaviour;ILandroidx/constraintlayout/core/widgets/ConstraintWidget$DimensionBehaviour;I)V
    ...
    :goto_0
    iget-object v0, p0, Landroidx/constraintlayout/core/widgets/i;->j1:Lz0/b$b;
    ...
    invoke-virtual {v0}, Landroidx/constraintlayout/core/widgets/d;->N1()Lz0/b$b;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;
    ...
    iget-object p2, p0, Landroidx/constraintlayout/core/widgets/i;->j1:Lz0/b$b;

    invoke-interface {p2, p1, v0}, Lz0/b$b;->b(Landroidx/constraintlayout/core/widgets/ConstraintWidget;Lz0/b$a;)V

    iget-object p2, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;
...
.method public I1()Z
    ...
    :goto_1
    iget v3, p0, Ly0/b;->W0:I

    const/4 v4, 0x1

    if-ge v2, v3, :cond_7

    iget-object v3, p0, Ly0/b;->V0:[Landroidx/constraintlayout/core/widgets/ConstraintWidget;
    ...
    :cond_6
    iget-object v4, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;

    iput-object v5, v4, Lz0/b$a;->a:Landroidx/constraintlayout/core/widgets/ConstraintWidget$DimensionBehaviour;

    iput-object v6, v4, Lz0/b$a;->b:Landroidx/constraintlayout/core/widgets/ConstraintWidget$DimensionBehaviour;

    invoke-virtual {v3}, Landroidx/constraintlayout/core/widgets/ConstraintWidget;->Y()I

    move-result v5

    iput v5, v4, Lz0/b$a;->c:I
    ...
    iput v5, v4, Lz0/b$a;->d:I

    iget-object v4, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;

    invoke-interface {v0, v3, v4}, Lz0/b$b;->b(Landroidx/constraintlayout/core/widgets/ConstraintWidget;Lz0/b$a;)V

    iget-object v4, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;

    iget v4, v4, Lz0/b$a;->e:I

    invoke-virtual {v3, v4}, Landroidx/constraintlayout/core/widgets/ConstraintWidget;->o1(I)V

    iget-object v4, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;

    iget v4, v4, Lz0/b$a;->f:I

    invoke-virtual {v3, v4}, Landroidx/constraintlayout/core/widgets/ConstraintWidget;->P0(I)V

    iget-object v4, p0, Landroidx/constraintlayout/core/widgets/i;->i1:Lz0/b$a;

    iget v4, v4, Lz0/b$a;->g:I
...
.method public y1()V
    ...
    :goto_0
    iget v1, p0, Ly0/b;->W0:I

    if-ge v0, v1, :cond_1

    iget-object v1, p0, Ly0/b;->V0:[Landroidx/constraintlayout/core/widgets/ConstraintWidget;
...
.method public z1(Ljava/util/HashSet;)Z
    ...
    :goto_0
    iget v2, p0, Ly0/b;->W0:I

    if-ge v1, v2, :cond_1

    iget-object v2, p0, Ly0/b;->V0:[Landroidx/constraintlayout/core/widgets/ConstraintWidget;
