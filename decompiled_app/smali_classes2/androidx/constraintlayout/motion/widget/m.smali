...
.method public F(La1/e;Landroid/view/View;III)V
    .locals 4
    ...
    :cond_0
    iget p4, p1, La1/e;->b:I

    iget v1, p1, La1/e;->d:I

    add-int/2addr p4, v1

    iget v1, p1, La1/e;->c:I

    iget v3, p1, La1/e;->e:I
...
.method public I(IIFJ)V
    ...
    :cond_c
    invoke-static {v11, v12}, La1/d;->f(Ljava/lang/String;Landroid/util/SparseArray;)La1/d;
    ...
    :cond_d
    invoke-static {v11}, La1/d;->g(Ljava/lang/String;)La1/d;
    ...
    :cond_19
    invoke-static {v6, v7}, La1/f;->g(Ljava/lang/String;Landroid/util/SparseArray;)La1/f;
    ...
    invoke-static {v6, v11, v12}, La1/f;->h(Ljava/lang/String;J)La1/f;
    ...
    invoke-static {v3}, La1/c;->i(Ljava/lang/String;)La1/c;
...
.method public x(Landroid/view/View;FJLandroidx/constraintlayout/core/motion/utils/d;)Z
    ...
    invoke-virtual {v3, v11, v14}, La1/d;->h(Landroid/view/View;F)V
    ...
    instance-of v2, v1, La1/f$d;

    if-eqz v2, :cond_5

    move-object v8, v1

    check-cast v8, La1/f$d;
    ...
    invoke-virtual/range {v1 .. v6}, La1/f;->i(Landroid/view/View;FJLandroidx/constraintlayout/core/motion/utils/d;)Z
    ...
    invoke-virtual/range {v1 .. v7}, La1/d$d;->i(Landroid/view/View;FDD)V
    ...
    invoke-virtual/range {v1 .. v10}, La1/f$d;->j(Landroid/view/View;Landroidx/constraintlayout/core/motion/utils/d;FJDD)Z
    ...
    invoke-static {v1, v11, v2}, La1/a;->b(Landroidx/constraintlayout/widget/ConstraintAttribute;Landroid/view/View;[F)V
    ...
    instance-of v2, v1, La1/c$d;

    if-eqz v2, :cond_17

    check-cast v1, La1/c$d;
    ...
    invoke-virtual/range {v1 .. v7}, La1/c$d;->k(Landroid/view/View;FDD)V

    goto :goto_a

    :cond_17
    invoke-virtual {v1, v11, v14}, La1/c;->j(Landroid/view/View;F)V
