...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lb5/k;->e:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/d0;)V
    ...
    invoke-direct {v1, p1}, Lb5/j;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, p1, p2, v0, v1}, Lb5/k;-><init>(Landroid/content/Context;Landroidx/work/impl/d0;Landroid/app/job/JobScheduler;Lb5/j;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/d0;Landroid/app/job/JobScheduler;Lb5/j;)V
    .locals 0
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iput-object p2, p0, Lb5/k;->c:Landroidx/work/impl/d0;

    iput-object p3, p0, Lb5/k;->b:Landroid/app/job/JobScheduler;

    iput-object p4, p0, Lb5/k;->d:Lb5/j;
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lb5/k;->g(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, Lb5/k;->d(Landroid/app/job/JobScheduler;I)V
...
.method public static d(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lb5/k;->e:Ljava/lang/String;
...
.method public static f(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, p1}, Lb5/k;->g(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    invoke-static {v0}, Lb5/k;->h(Landroid/app/job/JobInfo;)Lf5/m;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lf5/m;->b()Ljava/lang/String;
...
.method public static g(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    sget-object v2, Lb5/k;->e:Ljava/lang/String;
...
.method public static h(Landroid/app/job/JobInfo;)Lf5/m;
    .locals 3
...
.method public static i(Landroid/content/Context;Landroidx/work/impl/d0;)Z
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->k0()Lf5/j;

    move-result-object v1

    invoke-interface {v1}, Lf5/j;->d()Ljava/util/List;
    ...
    invoke-static {v3}, Lb5/k;->h(Landroid/app/job/JobInfo;)Lf5/m;

    move-result-object v5

    if-eqz v5, :cond_1

    invoke-virtual {v5}, Lf5/m;->b()Ljava/lang/String;
    ...
    invoke-static {v0, v3}, Lb5/k;->d(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v0, Lb5/k;->e:Ljava/lang/String;
    ...
    :try_start_0
    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->n0()Lf5/v;
    ...
    invoke-interface {p1, v1, v3, v4}, Lf5/v;->p(Ljava/lang/String;J)I
...
.method public b(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lb5/k;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1, p1}, Lb5/k;->f(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v2, p0, Lb5/k;->b:Landroid/app/job/JobScheduler;

    invoke-static {v2, v1}, Lb5/k;->d(Landroid/app/job/JobScheduler;I)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lb5/k;->c:Landroidx/work/impl/d0;

    invoke-virtual {v0}, Landroidx/work/impl/d0;->t()Landroidx/work/impl/WorkDatabase;

    move-result-object v0

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->k0()Lf5/j;

    move-result-object v0

    invoke-interface {v0, p1}, Lf5/j;->f(Ljava/lang/String;)V

    :cond_1
    return-void
.end method

.method public varargs c([Lf5/u;)V
    .locals 10
    .param p1    # [Lf5/u;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v7, v5, Lf5/u;->a:Ljava/lang/String;

    invoke-interface {v6, v7}, Lf5/v;->i(Ljava/lang/String;)Lf5/u;
    ...
    sget-object v8, Lb5/k;->e:Ljava/lang/String;
    ...
    iget-object v5, v5, Lf5/u;->a:Ljava/lang/String;
    ...
    :cond_0
    :try_start_2
    iget-object v6, v6, Lf5/u;->b:Landroidx/work/WorkInfo$State;
    ...
    :cond_1
    invoke-static {v5}, Lf5/x;->a(Lf5/u;)Lf5/m;
    ...
    invoke-interface {v7, v6}, Lf5/j;->g(Lf5/m;)Lf5/i;

    move-result-object v7

    if-eqz v7, :cond_2

    iget v8, v7, Lf5/i;->c:I

    goto :goto_2

    :cond_2
    iget-object v8, p0, Lb5/k;->c:Landroidx/work/impl/d0;
    ...
    iget-object v9, p0, Lb5/k;->c:Landroidx/work/impl/d0;
    ...
    invoke-static {v6, v8}, Lf5/l;->a(Lf5/m;I)Lf5/i;

    move-result-object v6

    iget-object v7, p0, Lb5/k;->c:Landroidx/work/impl/d0;

    invoke-virtual {v7}, Landroidx/work/impl/d0;->t()Landroidx/work/impl/WorkDatabase;

    move-result-object v7

    invoke-virtual {v7}, Landroidx/work/impl/WorkDatabase;->k0()Lf5/j;

    move-result-object v7

    invoke-interface {v7, v6}, Lf5/j;->a(Lf5/i;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lb5/k;->j(Lf5/u;I)V
    ...
    iget-object v6, p0, Lb5/k;->a:Landroid/content/Context;

    iget-object v7, p0, Lb5/k;->b:Landroid/app/job/JobScheduler;

    iget-object v9, v5, Lf5/u;->a:Ljava/lang/String;

    invoke-static {v6, v7, v9}, Lb5/k;->f(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_5
    iget-object v6, p0, Lb5/k;->c:Landroidx/work/impl/d0;
    ...
    :goto_3
    invoke-virtual {p0, v5, v6}, Lb5/k;->j(Lf5/u;I)V
...
.method public j(Lf5/u;I)V
    ...
    iget-object v2, p0, Lb5/k;->d:Lb5/j;

    invoke-virtual {v2, p1, p2}, Lb5/j;->a(Lf5/u;I)Landroid/app/job/JobInfo;
    ...
    sget-object v4, Lb5/k;->e:Ljava/lang/String;
    ...
    iget-object v6, p1, Lf5/u;->a:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v3, p0, Lb5/k;->b:Landroid/app/job/JobScheduler;
    ...
    iget-object v5, p1, Lf5/u;->a:Ljava/lang/String;
    ...
    iget-boolean v2, p1, Lf5/u;->q:Z

    if-eqz v2, :cond_1

    iget-object v2, p1, Lf5/u;->r:Landroidx/work/OutOfQuotaPolicy;

    sget-object v3, Landroidx/work/OutOfQuotaPolicy;->RUN_AS_NON_EXPEDITED_WORK_REQUEST:Landroidx/work/OutOfQuotaPolicy;

    if-ne v2, v3, :cond_1

    iput-boolean v1, p1, Lf5/u;->q:Z
    ...
    invoke-virtual {p0, p1, p2}, Lb5/k;->j(Lf5/u;I)V
    :try_end_0
    ...
    :goto_1
    iget-object p2, p0, Lb5/k;->a:Landroid/content/Context;

    iget-object v2, p0, Lb5/k;->b:Landroid/app/job/JobScheduler;

    invoke-static {p2, v2}, Lb5/k;->g(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    iget-object v3, p0, Lb5/k;->c:Landroidx/work/impl/d0;
    ...
    invoke-interface {v3}, Lf5/v;->e()Ljava/util/List;
    ...
    iget-object v4, p0, Lb5/k;->c:Landroidx/work/impl/d0;
    ...
    iget-object p1, p0, Lb5/k;->c:Landroidx/work/impl/d0;
