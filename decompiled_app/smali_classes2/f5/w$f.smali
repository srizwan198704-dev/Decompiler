...
.method public constructor <init>(Lf5/w;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lf5/w$f;->d:Lf5/w;
...
.method public bridge synthetic j(Ls4/h;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lf5/w$f;->n(Ls4/h;Lf5/u;)V

    return-void
.end method

.method public n(Ls4/h;Lf5/u;)V
    .locals 10
    ...
    iget-object p2, p2, Lf5/u;->j:Landroidx/work/b;
    ...
    invoke-static {v8}, Lf5/b0;->g(Landroidx/work/NetworkType;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, Ls4/f;->c(IJ)V
    ...
    invoke-interface {p1, v5, v8, v9}, Ls4/f;->c(IJ)V
    ...
    invoke-static {p2}, Lf5/b0;->i(Ljava/util/Set;)[B
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, Ls4/f;->h0(I[B)V
