...
.method public static b(Lgg/b;II)Lmf/b;
    .locals 10
    ...
    invoke-direct {v6, p1, p2}, Lmf/b;-><init>(II)V
    ...
    invoke-direct {v6, v0, v1}, Lmf/b;-><init>(II)V
    ...
    invoke-virtual {p0, p2, p1}, Lgg/b;->b(II)B
    ...
    invoke-virtual {v6, v7, v3, v4, v4}, Lmf/b;->u(IIII)V
...
.method public static c(Lsf/e;Lsf/k;II)Lmf/b;
    .locals 12

    invoke-virtual {p1}, Lsf/k;->h()I

    move-result v0

    invoke-virtual {p1}, Lsf/k;->g()I

    move-result v1

    new-instance v2, Lgg/b;

    invoke-virtual {p1}, Lsf/k;->j()I

    move-result v3

    invoke-virtual {p1}, Lsf/k;->i()I

    move-result v4

    invoke-direct {v2, v3, v4}, Lgg/b;-><init>(II)V
    ...
    :goto_2
    invoke-virtual {v2, v8, v5, v9}, Lgg/b;->g(IIZ)V
    ...
    iget v9, p1, Lsf/k;->d:I

    rem-int v9, v6, v9

    if-nez v9, :cond_3

    invoke-virtual {v2, v8, v5, v7}, Lgg/b;->g(IIZ)V

    add-int/lit8 v8, v8, 0x1

    :cond_3
    invoke-virtual {p0, v6, v4}, Lsf/e;->e(II)Z
    ...
    :goto_4
    invoke-virtual {v2, v9, v5, v10}, Lgg/b;->g(IIZ)V
    ...
    invoke-virtual {v2, v9, v6, v7}, Lgg/b;->g(IIZ)V
    ...
    :cond_9
    invoke-static {v2, p2, p3}, Lpf/b;->b(Lgg/b;II)Lmf/b;
...
.method public a(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;IILjava/util/Map;)Lmf/b;
    ...
    :cond_8
    invoke-static {p1, p2, v1, v2, v3}, Lsf/j;->b(Ljava/lang/String;Lcom/google/zxing/datamatrix/encoder/SymbolShapeHint;Lcom/google/zxing/c;Lcom/google/zxing/c;Z)Ljava/lang/String;
    ...
    invoke-static {p5, p2, v1, v2, v4}, Lsf/k;->l(ILcom/google/zxing/datamatrix/encoder/SymbolShapeHint;Lcom/google/zxing/c;Lcom/google/zxing/c;Z)Lsf/k;

    move-result-object p2

    invoke-static {p1, p2}, Lsf/i;->b(Ljava/lang/String;Lsf/k;)Ljava/lang/String;

    move-result-object p1

    new-instance p5, Lsf/e;

    invoke-virtual {p2}, Lsf/k;->h()I

    move-result v0

    invoke-virtual {p2}, Lsf/k;->g()I

    move-result v1

    invoke-direct {p5, p1, v0, v1}, Lsf/e;-><init>(Ljava/lang/CharSequence;II)V

    invoke-virtual {p5}, Lsf/e;->h()V

    invoke-static {p5, p2, p3, p4}, Lpf/b;->c(Lsf/e;Lsf/k;II)Lmf/b;
