...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Lpc/a;-><init>(Landroid/view/View;)V
...
.method public static synthetic f(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;Landroid/animation/ValueAnimator;)V
    ...
    invoke-static {p0, p1}, Lpc/h;->q(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;Landroid/animation/ValueAnimator;)V
...
.method public g(Landroid/view/View;)V
    ...
    invoke-super {p0}, Lpc/a;->b()Landroidx/activity/b;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lpc/h;->i(Landroid/view/View;)Landroid/animation/AnimatorSet;

    move-result-object p1

    iget-object v0, p0, Lpc/a;->b:Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lpc/h;->h(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;)Landroid/animation/ValueAnimator;
...
.method public final h(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p1}, Lpc/g;-><init>(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;)V
...
.method public final i(Landroid/view/View;)Landroid/animation/AnimatorSet;
    ...
    iget-object v1, p0, Lpc/a;->b:Landroid/view/View;
    ...
    iget-object v2, p0, Lpc/a;->b:Landroid/view/View;
    ...
    iget-object v3, p0, Lpc/a;->b:Landroid/view/View;
    ...
    iget-object v5, p0, Lpc/a;->b:Landroid/view/View;
    ...
    new-instance v1, Lpc/h$a;

    invoke-direct {v1, p0, p1}, Lpc/h$a;-><init>(Lpc/h;Landroid/view/View;)V
...
.method public j(JLandroid/view/View;)V
    ...
    invoke-virtual {p0, p3}, Lpc/h;->i(Landroid/view/View;)Landroid/animation/AnimatorSet;
...
.method public k()I
    ...
    iget-object v0, p0, Lpc/h;->l:Ljava/lang/Integer;

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lpc/h;->p()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lpc/h;->n()I
    ...
    iput-object v0, p0, Lpc/h;->l:Ljava/lang/Integer;
...
.method public l()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lpc/h;->k:Landroid/graphics/Rect;
...
.method public m()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lpc/h;->j:Landroid/graphics/Rect;
...
.method public final n()I
    ...
    invoke-virtual {p0, v0, v2}, Lpc/h;->o(Landroid/view/WindowInsets;I)I
    ...
    invoke-virtual {p0, v0, v3}, Lpc/h;->o(Landroid/view/WindowInsets;I)I
...
.method public final r()V
    ...
    iput v0, p0, Lpc/h;->i:F

    const/4 v0, 0x0

    iput-object v0, p0, Lpc/h;->j:Landroid/graphics/Rect;

    iput-object v0, p0, Lpc/h;->k:Landroid/graphics/Rect;
...
.method public s(FLandroid/view/View;)V
    ...
    iput-object p2, p0, Lpc/h;->k:Landroid/graphics/Rect;

    :cond_0
    iput p1, p0, Lpc/h;->i:F
...
.method public t(Landroidx/activity/b;Landroid/view/View;)V
    ...
    invoke-super {p0, p1}, Lpc/a;->d(Landroidx/activity/b;)V

    invoke-virtual {p1}, Landroidx/activity/b;->c()F

    move-result p1

    invoke-virtual {p0, p1, p2}, Lpc/h;->s(FLandroid/view/View;)V
...
.method public u(FZFF)V
    ...
    invoke-virtual {p0, p1}, Lpc/a;->a(F)F
    ...
    invoke-static {v3, v4, p1}, Lec/b;->a(FFF)F
    ...
    invoke-static {v2, v0, p1}, Lec/b;->a(FFF)F
    ...
    iget v4, p0, Lpc/h;->h:F

    invoke-static {p2, v4}, Ljava/lang/Math;->min(FF)F

    move-result p2

    iget v4, p0, Lpc/h;->i:F
    ...
    invoke-static {v2, p2, v4}, Lec/b;->a(FFF)F

    move-result p2

    mul-float/2addr p2, p3

    iget-object p3, p0, Lpc/a;->b:Landroid/view/View;
    ...
    iget-object p2, p0, Lpc/a;->b:Landroid/view/View;
...
.method public v(Landroidx/activity/b;Landroid/view/View;F)V
    ...
    invoke-super {p0, p1}, Lpc/a;->e(Landroidx/activity/b;)Landroidx/activity/b;
    ...
    invoke-virtual {p0, v0, p2, p1, p3}, Lpc/h;->u(FZFF)V
