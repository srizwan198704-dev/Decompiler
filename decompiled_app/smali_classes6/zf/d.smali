...
.method public static b([[BI)Lmf/b;
    .locals 8
    ...
    invoke-direct {v0, v2, v4}, Lmf/b;-><init>(II)V

    invoke-virtual {v0}, Lmf/b;->c()V
    ...
    invoke-virtual {v0, v7, v2}, Lmf/b;->t(II)V
...
.method public static c(Ldg/d;Ljava/lang/String;IIIIZ)Lmf/b;
    .locals 3
    ...
    invoke-virtual {p0, p1, p2, p6}, Ldg/d;->e(Ljava/lang/String;IZ)V

    invoke-virtual {p0}, Ldg/d;->f()Ldg/a;
    ...
    invoke-virtual {p1, p2, p6}, Ldg/a;->b(II)[[B
    ...
    invoke-virtual {p0, p3, p1}, Ldg/a;->b(II)[[B

    move-result-object p0

    if-eqz v0, :cond_3

    invoke-static {p0}, Lzf/d;->d([[B)[[B

    move-result-object p0

    :cond_3
    invoke-static {p0, p5}, Lzf/d;->b([[BI)Lmf/b;
    ...
    :cond_4
    invoke-static {p1, p5}, Lzf/d;->b([[BI)Lmf/b;
...
.method public a(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;IILjava/util/Map;)Lmf/b;
    ...
    invoke-virtual {v1, v3}, Ldg/d;->h(Z)V
    ...
    invoke-virtual {v1, v3}, Ldg/d;->i(Lcom/google/zxing/pdf417/encoder/Compaction;)V
    ...
    invoke-virtual {v3}, Ldg/c;->a()I

    move-result v4

    invoke-virtual {v3}, Ldg/c;->c()I

    move-result v5

    invoke-virtual {v3}, Ldg/c;->b()I

    move-result v6

    invoke-virtual {v3}, Ldg/c;->d()I

    move-result v3

    invoke-virtual {v1, v4, v5, v6, v3}, Ldg/d;->j(IIII)V
    ...
    invoke-virtual {v1, v3}, Ldg/d;->k(Ljava/nio/charset/Charset;)V
    ...
    invoke-static/range {v1 .. v7}, Lzf/d;->c(Ldg/d;Ljava/lang/String;IIIIZ)Lmf/b;
