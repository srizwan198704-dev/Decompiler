...
.method public constructor <init>(Lcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;Lkg/i;)V
    .locals 2
    ...
    iput-object v0, p0, Lkg/p;->a:Ljava/lang/String;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lkg/p;->g:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object v0, p0, Lkg/p;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x1

    iput v0, p0, Lkg/p;->j:I

    iput-object p1, p0, Lkg/p;->b:Lcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;

    iput-object p2, p0, Lkg/p;->c:Lkg/i;
    ...
    :goto_0
    iput-object v1, p0, Lkg/p;->d:Ljava/lang/String;
    ...
    iput-object v1, p0, Lkg/p;->f:Lkg/q;
    ...
    iput-object v0, p0, Lkg/p;->i:Lcom/hisavana/mediation/handler/DispatcherHandler;

    return-void
.end method

.method public static synthetic b(Lkg/p;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 0

    iget-object p0, p0, Lkg/p;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    return-object p0
.end method

.method public static synthetic f(Lkg/p;Landroid/content/Context;Ljava/util/List;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lkg/p;->e(Landroid/content/Context;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic h(Lkg/p;)Ljava/util/concurrent/CopyOnWriteArrayList;
    .locals 0

    iget-object p0, p0, Lkg/p;->g:Ljava/util/concurrent/CopyOnWriteArrayList;

    return-object p0
.end method

.method public static synthetic l(Lkg/p;)Lcom/hisavana/mediation/handler/DispatcherHandler;
    .locals 0

    iget-object p0, p0, Lkg/p;->i:Lcom/hisavana/mediation/handler/DispatcherHandler;

    return-object p0
.end method

.method public static synthetic n(Lkg/p;)Z
    .locals 0

    invoke-virtual {p0}, Lkg/p;->j()Z
...
.method public static synthetic o(Lkg/p;)V
    .locals 0

    invoke-virtual {p0}, Lkg/p;->m()V
...
.method public a(Lcom/hisavana/common/interfacz/Iad;)Lcom/hisavana/common/bean/TInnerAdRequestBody;
    ...
    new-instance v1, Lkg/p$b;

    invoke-direct {v1, p0, p1}, Lkg/p$b;-><init>(Lkg/p;Lcom/hisavana/common/interfacz/Iad;)V
...
.method public c()V
    ...
    iget-object v0, p0, Lkg/p;->g:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_2
    iget-object v0, p0, Lkg/p;->f:Lkg/q;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Lkg/q;->n()V
...
.method public d(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lkg/p;->b:Lcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;

    invoke-virtual {p0, v0}, Lkg/p;->g(Lcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;)Z
    ...
    :cond_0
    iget-object v0, p0, Lkg/p;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0}, Lkg/q;->l()V

    invoke-virtual {p0, p1}, Lkg/p;->i(Landroid/content/Context;)V
...
.method public final e(Landroid/content/Context;Ljava/util/List;)V
    ...
    iget-object v0, p0, Lkg/p;->i:Lcom/hisavana/mediation/handler/DispatcherHandler;

    iget-object v1, p0, Lkg/p;->f:Lkg/q;
    ...
    iput-object p1, p0, Lkg/p;->g:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final g(Lcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;)Z
    ...
    iget-object v1, p0, Lkg/p;->d:Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, Lkg/p;->i:Lcom/hisavana/mediation/handler/DispatcherHandler;
    ...
    iget-object v0, p0, Lkg/p;->c:Lkg/i;
...
.method public final i(Landroid/content/Context;)V
    ...
    new-instance v1, Lkg/p$a;

    invoke-direct {v1, p0, p1}, Lkg/p$a;-><init>(Lkg/p;Landroid/content/Context;)V
...
.method public final k(Lcom/hisavana/common/interfacz/Iad;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lkg/p;->a(Lcom/hisavana/common/interfacz/Iad;)Lcom/hisavana/common/bean/TInnerAdRequestBody;
    ...
    invoke-virtual {v1, p1, v7}, Lkg/q;->f(Lcom/hisavana/common/bean/Network;Z)V
    ...
    iget-object v4, p0, Lkg/p;->d:Ljava/lang/String;
    ...
    iget-object p1, p0, Lkg/p;->h:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final m()V
    ...
    :cond_1
    invoke-static {v2}, Lkg/o;->e(Lcom/hisavana/common/interfacz/Iad;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {p0, v2}, Lkg/p;->k(Lcom/hisavana/common/interfacz/Iad;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Lkg/p;->c:Lkg/i;

    invoke-virtual {v2}, Lkg/i;->E()I

    move-result v3

    add-int/lit8 v3, v3, 0x1

    invoke-virtual {v2, v3}, Lkg/i;->y(I)V
