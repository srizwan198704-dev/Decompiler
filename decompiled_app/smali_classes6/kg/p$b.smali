...
.method public constructor <init>(Lkg/p;Lcom/hisavana/common/interfacz/Iad;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)V"
    ...
    iput-object p1, p0, Lkg/p$b;->b:Lkg/p;

    invoke-direct {p0}, Lcom/hisavana/common/interfacz/WrapTAdAllianceListener;-><init>()V

    iput-object p2, p0, Lkg/p$b;->a:Lcom/hisavana/common/interfacz/Iad;
...
.method public final a()V
    ...
    iget-object v0, p0, Lkg/p$b;->b:Lkg/p;

    invoke-static {v0}, Lkg/p;->b(Lkg/p;)Ljava/util/concurrent/atomic/AtomicInteger;

    move-result-object v0

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    iget-object v0, p0, Lkg/p$b;->a:Lcom/hisavana/common/interfacz/Iad;
    ...
    iget-object v3, p0, Lkg/p$b;->a:Lcom/hisavana/common/interfacz/Iad;
    ...
    iget-object v3, p0, Lkg/p$b;->b:Lkg/p;

    invoke-static {v3}, Lkg/p;->b(Lkg/p;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {v0}, Lkg/o;->e(Lcom/hisavana/common/interfacz/Iad;)Z
    ...
    iget-object v1, p0, Lkg/p$b;->a:Lcom/hisavana/common/interfacz/Iad;
    ...
    invoke-static {v0}, Lkg/p;->l(Lkg/p;)Lcom/hisavana/mediation/handler/DispatcherHandler;

    move-result-object v0

    iget-object v1, p0, Lkg/p$b;->b:Lkg/p;

    invoke-static {v1}, Lkg/p;->h(Lkg/p;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-static {v0}, Lkg/p;->n(Lkg/p;)Z
    ...
    invoke-static {v0}, Lkg/p;->o(Lkg/p;)V
...
.method public onError(Lcom/hisavana/common/bean/TAdErrorCode;)V
    ...
    iget-object p1, p0, Lkg/p$b;->a:Lcom/hisavana/common/interfacz/Iad;
    ...
    iget-object p1, p0, Lkg/p$b;->b:Lkg/p;

    invoke-static {p1}, Lkg/p;->b(Lkg/p;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {p1}, Lkg/p;->n(Lkg/p;)Z
    ...
    invoke-static {p1}, Lkg/p;->l(Lkg/p;)Lcom/hisavana/mediation/handler/DispatcherHandler;

    move-result-object p1

    iget-object v0, p0, Lkg/p$b;->b:Lkg/p;

    invoke-static {v0}, Lkg/p;->h(Lkg/p;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-static {p1}, Lkg/p;->o(Lkg/p;)V
