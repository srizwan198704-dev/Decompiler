...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lkg/c;->x(Landroid/content/Context;)V
.end annotation
...
.method public constructor <init>(Lkg/c;Landroid/content/Context;)V
    .locals 0
    ...
    iput-object p1, p0, Lkg/c$c;->b:Lkg/c;

    iput-object p2, p0, Lkg/c$c;->a:Landroid/content/Context;
...
.method public final a(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lkg/c$c;->b:Lkg/c;

    invoke-static {v0}, Lkg/c;->B(Lkg/c;)Z
    ...
    iget-object v3, p0, Lkg/c$c;->b:Lkg/c;

    invoke-static {v3}, Lkg/c;->T(Lkg/c;)Lcom/hisavana/mediation/handler/DispatcherHandler;

    move-result-object v3

    iget-object v4, p0, Lkg/c$c;->a:Landroid/content/Context;

    iget-object v5, p0, Lkg/c$c;->b:Lkg/c;

    iget-object v5, v5, Lkg/c;->o:Lcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;
    ...
    iget-object v4, p0, Lkg/c$c;->b:Lkg/c;

    invoke-static {v4}, Lkg/c;->Q(Lkg/c;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v2, p0, Lkg/c$c;->b:Lkg/c;

    const/4 v4, 0x1

    invoke-static {v2, v3, v4}, Lkg/c;->t(Lkg/c;Lcom/hisavana/common/interfacz/Iad;I)Z

    goto :goto_1

    :cond_3
    iget-object p1, p0, Lkg/c$c;->b:Lkg/c;

    invoke-static {p1}, Lkg/c;->T(Lkg/c;)Lcom/hisavana/mediation/handler/DispatcherHandler;
...
.method public onQueryPriceFailed()V
    ...
    invoke-virtual {p0, v0}, Lkg/c$c;->a(Ljava/util/List;)V
...
.method public onQueryPriceSuccess(Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1}, Lkg/c$c;->a(Ljava/util/List;)V
