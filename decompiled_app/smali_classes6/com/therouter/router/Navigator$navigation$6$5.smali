...
.method public constructor <init>(Lcom/therouter/router/RouteItem;Lvh/c;Lcom/therouter/router/Navigator;)V
    .locals 0

    iput-object p1, p0, Lcom/therouter/router/Navigator$navigation$6$5;->$routeItem:Lcom/therouter/router/RouteItem;

    iput-object p2, p0, Lcom/therouter/router/Navigator$navigation$6$5;->$callback:Lvh/c;
...
.method public final invoke(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Lcom/therouter/router/Navigator$navigation$6$5;->$callback:Lvh/c;

    iget-object v1, p0, Lcom/therouter/router/Navigator$navigation$6$5;->this$0:Lcom/therouter/router/Navigator;

    invoke-virtual {v0, v1, p1}, Lvh/c;->a(Lcom/therouter/router/Navigator;Landroid/app/Activity;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/therouter/router/Navigator;->E(Ljava/lang/String;Ljava/lang/Object;)Lcom/therouter/router/Navigator;

    move-result-object v0

    const-string v1, "therouter_object_current_activity"

    invoke-virtual {v0, v1, p1}, Lcom/therouter/router/Navigator;->E(Ljava/lang/String;Ljava/lang/Object;)Lcom/therouter/router/Navigator;
