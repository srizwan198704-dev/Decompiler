...
.method public static final b(Lcom/therouter/router/Navigator;Landroid/content/Context;)V
    .locals 5
    ...
    invoke-virtual {v3, v1}, Lth/a;->d(Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, v4}, Lrh/a;-><init>(Ljava/lang/String;)V
    ...
    :goto_2
    invoke-virtual {v3, v1, p0}, Lth/a;->b(Landroid/content/Context;Lcom/therouter/router/Navigator;)Z

    move-result v1

    invoke-virtual {v3}, Lth/a;->a()Landroid/os/Bundle;
    ...
    invoke-virtual {p1, v1}, Lth/a;->d(Landroid/os/Bundle;)V

    invoke-virtual {p1}, Lth/a;->c()V
...
.method public final c(Lcom/therouter/router/Navigator;Landroid/content/Context;)V
    ...
    invoke-virtual {p1}, Lcom/therouter/router/Navigator;->n()Ljava/lang/String;
    ...
    invoke-direct {v0, p1, p2}, Lsh/a;-><init>(Lcom/therouter/router/Navigator;Landroid/content/Context;)V
