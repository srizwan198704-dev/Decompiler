...
# virtual methods
.method public a(Lnh/a;)V
    .locals 1

    iget-object p1, p1, Lnh/a;->j:Ljava/util/List;
...
.method public b()V
    ...
    iget-object v2, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;
...
.method public declared-synchronized c()Lnh/a;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final e(Ljava/io/IOException;)V
    ...
    iget-object v1, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;

    iget v2, v1, Lnh/a;->g:I

    if-nez v2, :cond_0

    invoke-virtual {v1}, Lnh/a;->getRoute()Lcom/squareup/okhttp/Route;
...
.method public final f(ZZZ)V
    ...
    :cond_1
    iget-object p2, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;

    if-eqz p2, :cond_6

    if-eqz p1, :cond_2

    iput-boolean p3, p2, Lnh/a;->k:Z
    ...
    iget-boolean p1, p2, Lnh/a;->k:Z

    if-eqz p1, :cond_6

    :cond_3
    invoke-virtual {p0, p2}, Lcom/squareup/okhttp/internal/http/n;->p(Lnh/a;)V

    iget-object p1, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;

    iget p2, p1, Lnh/a;->g:I
    ...
    iget-object p3, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;

    invoke-virtual {p1, p2, p3}, Lcom/squareup/okhttp/internal/c;->connectionBecameIdle(Lcom/squareup/okhttp/ConnectionPool;Lnh/a;)Z
    ...
    :goto_1
    iput-object v1, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;
    ...
    invoke-virtual {v1}, Lnh/a;->getSocket()Ljava/net/Socket;
...
.method public final g(IIIZ)Lnh/a;
    .locals 8
    ...
    invoke-virtual {v1, v2, v3, p0}, Lcom/squareup/okhttp/internal/c;->get(Lcom/squareup/okhttp/ConnectionPool;Lcom/squareup/okhttp/Address;Lcom/squareup/okhttp/internal/http/n;)Lnh/a;
    ...
    invoke-direct {v7, v0}, Lnh/a;-><init>(Lcom/squareup/okhttp/Route;)V

    invoke-virtual {p0, v7}, Lcom/squareup/okhttp/internal/http/n;->a(Lnh/a;)V
    ...
    invoke-virtual {v0, v2, v7}, Lcom/squareup/okhttp/internal/c;->put(Lcom/squareup/okhttp/ConnectionPool;Lnh/a;)V

    iput-object v7, p0, Lcom/squareup/okhttp/internal/http/n;->d:Lnh/a;
    ...
    invoke-virtual/range {v1 .. v6}, Lnh/a;->c(IIILjava/util/List;Z)V

    invoke-virtual {p0}, Lcom/squareup/okhttp/internal/http/n;->q()Lcom/squareup/okhttp/internal/f;

    move-result-object p1

    invoke-virtual {v7}, Lnh/a;->getRoute()Lcom/squareup/okhttp/Route;
...
.method public final h(IIIZZ)Lnh/a;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/squareup/okhttp/internal/http/n;->g(IIIZ)Lnh/a;
    ...
    invoke-virtual {v0, p5}, Lnh/a;->h(Z)Z
...
.method public k(IIIZZ)Lcom/squareup/okhttp/internal/http/HttpStream;
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p5}, Lcom/squareup/okhttp/internal/http/n;->h(IIIZZ)Lnh/a;

    move-result-object p1

    iget-object p4, p1, Lnh/a;->f:Lcom/squareup/okhttp/internal/framed/FramedConnection;

    if-eqz p4, :cond_0

    new-instance p2, Lcom/squareup/okhttp/internal/http/e;

    iget-object p3, p1, Lnh/a;->f:Lcom/squareup/okhttp/internal/framed/FramedConnection;
    ...
    :cond_0
    invoke-virtual {p1}, Lnh/a;->getSocket()Ljava/net/Socket;

    move-result-object p4

    invoke-virtual {p4, p2}, Ljava/net/Socket;->setSoTimeout(I)V

    iget-object p4, p1, Lnh/a;->h:Lokio/BufferedSource;
    ...
    iget-object p4, p1, Lnh/a;->i:Lokio/BufferedSink;
    ...
    iget-object p3, p1, Lnh/a;->h:Lokio/BufferedSource;
    ...
    :try_start_1
    iget p4, p1, Lnh/a;->g:I

    add-int/lit8 p4, p4, 0x1

    iput p4, p1, Lnh/a;->g:I
...
.method public final p(Lnh/a;)V
    .locals 3

    iget-object v0, p1, Lnh/a;->j:Ljava/util/List;
    ...
    iget-object v2, p1, Lnh/a;->j:Ljava/util/List;
