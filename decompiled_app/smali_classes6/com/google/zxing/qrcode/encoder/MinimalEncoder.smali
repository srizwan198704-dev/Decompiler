...
.method public constructor <init>(Ljava/lang/String;Ljava/nio/charset/Charset;ZLcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;)V
    ...
    invoke-direct {p3, p1, p2, v0}, Lmf/g;-><init>(Ljava/lang/String;Ljava/nio/charset/Charset;I)V

    iput-object p3, p0, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;
...
.method public static synthetic c(Lcom/google/zxing/qrcode/encoder/MinimalEncoder;)Lmf/g;
    .locals 0

    iget-object p0, p0, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;
...
.method public static i(Ljava/lang/String;Lfg/f;Ljava/nio/charset/Charset;ZLcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->h(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;
...
.method public static l(Lcom/google/zxing/qrcode/encoder/MinimalEncoder$VersionSize;)Lfg/f;
    .locals 1
...
.method public static m(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$VersionSize;
    .locals 2

    invoke-virtual {p0}, Lfg/f;->j()I
...
.method public f(Lfg/f;[[[Lcom/google/zxing/qrcode/encoder/MinimalEncoder$b;ILcom/google/zxing/qrcode/encoder/MinimalEncoder$b;)V
    .locals 16
    ...
    iget-object v0, v9, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;

    invoke-virtual {v0}, Lmf/g;->g()I

    move-result v0

    iget-object v1, v9, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;

    invoke-virtual {v1}, Lmf/g;->f()I

    move-result v1

    if-ltz v1, :cond_0

    iget-object v2, v9, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;
    ...
    invoke-virtual {v2, v3, v1}, Lmf/g;->a(CI)Z
    ...
    invoke-virtual {v0, v1, v13}, Lmf/g;->a(CI)Z
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder$b;-><init>(Lcom/google/zxing/qrcode/encoder/MinimalEncoder;Lcom/google/zxing/qrcode/decoder/Mode;IIILcom/google/zxing/qrcode/encoder/MinimalEncoder$b;Lfg/f;Lcom/google/zxing/qrcode/encoder/MinimalEncoder$a;)V
...
.method public h(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/WriterException;
    ...
    invoke-static {p1}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->l(Lcom/google/zxing/qrcode/encoder/MinimalEncoder$VersionSize;)Lfg/f;
    ...
    invoke-static {v4}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->l(Lcom/google/zxing/qrcode/encoder/MinimalEncoder$VersionSize;)Lfg/f;
    ...
    invoke-static {v5}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->l(Lcom/google/zxing/qrcode/encoder/MinimalEncoder$VersionSize;)Lfg/f;

    move-result-object v5

    new-array v6, v2, [Lfg/f;
    ...
    invoke-virtual {p0, p1}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->j(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;

    move-result-object p1

    aget-object v4, v6, v3

    invoke-virtual {p0, v4}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->j(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;

    move-result-object v4

    aget-object v5, v6, v0

    invoke-virtual {p0, v5}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->j(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;
    ...
    invoke-static {v4, v5, v8}, Lcom/google/zxing/qrcode/encoder/a;->v(ILfg/f;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;)Z
    ...
    invoke-virtual {v0}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;->e()Lfg/f;

    move-result-object v2

    invoke-static {v2}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->m(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$VersionSize;

    move-result-object v2

    invoke-static {v2}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->l(Lcom/google/zxing/qrcode/encoder/MinimalEncoder$VersionSize;)Lfg/f;
    ...
    invoke-static {v1, v2, v3}, Lcom/google/zxing/qrcode/encoder/a;->v(ILfg/f;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;)Z
...
.method public j(Lfg/f;)Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/WriterException;
    ...
    iget-object v2, p0, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;

    invoke-virtual {v2}, Lmf/g;->g()I
    ...
    invoke-virtual {p0, p1, v1, v2, v3}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->f(Lfg/f;[[[Lcom/google/zxing/qrcode/encoder/MinimalEncoder$b;ILcom/google/zxing/qrcode/encoder/MinimalEncoder$b;)V
    ...
    :goto_1
    iget-object v6, p0, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;

    invoke-virtual {v6}, Lmf/g;->g()I
    ...
    invoke-virtual {p0, p1, v1, v4, v7}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->f(Lfg/f;[[[Lcom/google/zxing/qrcode/encoder/MinimalEncoder$b;ILcom/google/zxing/qrcode/encoder/MinimalEncoder$b;)V
    ...
    :goto_3
    iget-object v8, p0, Lcom/google/zxing/qrcode/encoder/MinimalEncoder;->c:Lmf/g;

    invoke-virtual {v8}, Lmf/g;->g()I
    ...
    invoke-direct {v2, p0, p1, v0}, Lcom/google/zxing/qrcode/encoder/MinimalEncoder$c;-><init>(Lcom/google/zxing/qrcode/encoder/MinimalEncoder;Lfg/f;Lcom/google/zxing/qrcode/encoder/MinimalEncoder$b;)V
