...
.method public constructor <init>(Lcom/google/zxing/datamatrix/encoder/MinimalEncoder$c;Lcom/google/zxing/datamatrix/encoder/MinimalEncoder$Mode;IILcom/google/zxing/datamatrix/encoder/MinimalEncoder$b;)V
    ...
    invoke-virtual {p1, p3}, Lmf/m;->a(I)Z

    move-result p4

    if-nez p4, :cond_e

    invoke-virtual {p1, p3}, Lmf/m;->charAt(I)C

    move-result p3

    invoke-virtual {p1}, Lmf/m;->f()I
...
.method public k(ZI)[B
    ...
    invoke-virtual {v3, v4}, Lmf/m;->charAt(I)C

    move-result v3

    if-eqz p1, :cond_0

    invoke-static {v3}, Lsf/j;->h(C)Z
...
.method public m()[B
    ...
    invoke-virtual {v0, v1}, Lmf/m;->charAt(I)C
    ...
    invoke-virtual {v0, v1}, Lmf/m;->a(I)Z
    ...
    invoke-virtual {v0, v1}, Lmf/m;->b(I)I
    ...
    invoke-virtual {v1, v3}, Lmf/m;->charAt(I)C
    ...
    invoke-virtual {v0, v1}, Lmf/m;->h(I)Z
...
.method public n()[B
    ...
    invoke-virtual {v5}, Lmf/m;->length()I
    ...
    invoke-virtual {v10, v2}, Lmf/m;->charAt(I)C
...
.method public o()Lcom/google/zxing/datamatrix/encoder/MinimalEncoder$Mode;
    ...
    invoke-virtual {v1}, Lmf/m;->length()I
...
.method public p()I
    ...
    invoke-virtual {v0}, Lmf/m;->length()I
    ...
    invoke-virtual {v2, v1}, Lmf/m;->charAt(I)C

    move-result v1

    iget-object v2, p0, Lcom/google/zxing/datamatrix/encoder/MinimalEncoder$b;->a:Lcom/google/zxing/datamatrix/encoder/MinimalEncoder$c;

    invoke-virtual {v2}, Lmf/m;->f()I
    ...
    invoke-virtual {v2, v5}, Lmf/m;->charAt(I)C
    ...
    invoke-virtual {v1, v5}, Lmf/m;->charAt(I)C
    ...
    invoke-virtual {v0, v2}, Lmf/m;->charAt(I)C
...
.method public x()[B
    ...
    invoke-virtual {v4, v6}, Lmf/m;->charAt(I)C
    ...
    invoke-virtual {v6, v7}, Lmf/m;->charAt(I)C
