...
.method public static a([B)Lmf/d;
    .locals 13
    ...
    invoke-direct {v0, p0}, Lmf/c;-><init>([B)V

    new-instance v1, Lmf/i;

    const/16 v2, 0x64

    invoke-direct {v1, v2}, Lmf/i;-><init>(I)V
    ...
    invoke-static {v0, v1, v2, v9}, Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser;->c(Lmf/c;Lmf/i;Ljava/lang/StringBuilder;Ljava/util/Set;)Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser$Mode;
    ...
    :pswitch_0
    invoke-static {v0, v1}, Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser;->f(Lmf/c;Lmf/i;)V
    ...
    :pswitch_1
    invoke-static {v0, v1, v5}, Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser;->d(Lmf/c;Lmf/i;Ljava/util/Collection;)V

    goto :goto_0

    :pswitch_2
    invoke-static {v0, v1}, Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser;->g(Lmf/c;Lmf/i;)V

    goto :goto_0

    :pswitch_3
    invoke-static {v0, v1}, Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser;->b(Lmf/c;Lmf/i;)V

    goto :goto_0

    :pswitch_4
    invoke-static {v0, v1, v9}, Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser;->h(Lmf/c;Lmf/i;Ljava/util/Set;)V

    goto :goto_0

    :pswitch_5
    invoke-static {v0, v1, v9}, Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser;->e(Lmf/c;Lmf/i;Ljava/util/Set;)V
    ...
    invoke-virtual {v1, v2}, Lmf/i;->e(Ljava/lang/StringBuilder;)V
    ...
    invoke-direct/range {v7 .. v12}, Lmf/d;-><init>([BLjava/lang/String;Ljava/util/List;Ljava/lang/String;I)V
...
.method public static b(Lmf/c;Lmf/i;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/FormatException;
    ...
    :cond_1
    invoke-virtual {p0, v3}, Lmf/c;->d(I)I
    ...
    invoke-virtual {p1, v3}, Lmf/i;->b(C)V
...
.method public static c(Lmf/c;Lmf/i;Ljava/lang/StringBuilder;Ljava/util/Set;)Lcom/google/zxing/datamatrix/decoder/DecodedBitStreamParser$Mode;
    .locals 5
    ...
    invoke-virtual {p0, v2}, Lmf/c;->d(I)I
    ...
    invoke-virtual {p1, p0}, Lmf/i;->b(C)V
    ...
    :cond_4
    invoke-virtual {p1, v2}, Lmf/i;->c(I)V
    ...
    invoke-virtual {p1, v2}, Lmf/i;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v2}, Lmf/i;->b(C)V
...
.method public static d(Lmf/c;Lmf/i;Ljava/util/Collection;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, p0}, Lmf/i;->d(Ljava/lang/String;)V
...
.method public static e(Lmf/c;Lmf/i;Ljava/util/Set;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    invoke-virtual {p0, v6}, Lmf/c;->d(I)I
    ...
    invoke-virtual {p1, v4}, Lmf/i;->b(C)V
    ...
    :cond_e
    invoke-virtual {p1, v6}, Lmf/i;->b(C)V
...
.method public static f(Lmf/c;Lmf/i;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/FormatException;
    ...
    invoke-virtual {p0, v1}, Lmf/c;->d(I)I
    ...
    invoke-virtual {p1, p0}, Lmf/i;->f(I)V
...
.method public static g(Lmf/c;Lmf/i;)V
    .locals 3
    ...
    invoke-virtual {p0, p1}, Lmf/c;->d(I)I
    ...
    invoke-virtual {p1, v1}, Lmf/i;->b(C)V
...
.method public static h(Lmf/c;Lmf/i;Ljava/util/Set;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
