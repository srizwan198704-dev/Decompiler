...
.method public static a(Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    invoke-static {p2, p1, p3}, Lcom/google/firebase/messaging/d;->f(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/d;->q(Lcom/google/firebase/messaging/k0;)Z
...
.method public static b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;)Landroid/app/PendingIntent;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    invoke-static {p2}, Lcom/google/firebase/messaging/d;->q(Lcom/google/firebase/messaging/k0;)Z
...
.method public static d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/d$a;
    .locals 5
    ...
    invoke-virtual {v3, p3}, Landroidx/core/app/NotificationCompat$m;->L(Landroidx/core/app/NotificationCompat$p;)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v3, p3}, Landroidx/core/app/NotificationCompat$m;->J(I)Landroidx/core/app/NotificationCompat$m;

    invoke-static {v0, p2, v1}, Lcom/google/firebase/messaging/d;->n(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/res/Resources;)Landroid/net/Uri;

    move-result-object p3

    if-eqz p3, :cond_2

    invoke-virtual {v3, p3}, Landroidx/core/app/NotificationCompat$m;->K(Landroid/net/Uri;)Landroidx/core/app/NotificationCompat$m;

    :cond_2
    invoke-static {p0, p2, v0, v2}, Lcom/google/firebase/messaging/d;->a(Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    invoke-static {p0, p1, p2}, Lcom/google/firebase/messaging/d;->b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v3, p0}, Landroidx/core/app/NotificationCompat$m;->C(Z)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v3, p0}, Landroidx/core/app/NotificationCompat$m;->M(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v3, p0}, Landroidx/core/app/NotificationCompat$m;->G(I)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v3, p0}, Landroidx/core/app/NotificationCompat$m;->D(I)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v3, p1}, Landroidx/core/app/NotificationCompat$m;->I(Z)Landroidx/core/app/NotificationCompat$m;

    invoke-virtual {p0}, Ljava/lang/Long;->longValue()J

    move-result-wide p3

    invoke-virtual {v3, p3, p4}, Landroidx/core/app/NotificationCompat$m;->P(J)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v3, p0}, Landroidx/core/app/NotificationCompat$m;->N([J)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v3, p4, p1, p0}, Landroidx/core/app/NotificationCompat$m;->B(III)Landroidx/core/app/NotificationCompat$m;

    :cond_b
    invoke-static {p2}, Lcom/google/firebase/messaging/d;->i(Lcom/google/firebase/messaging/k0;)I
    ...
    invoke-static {p2}, Lcom/google/firebase/messaging/d;->o(Lcom/google/firebase/messaging/k0;)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;Lcom/google/firebase/messaging/k0;)Lcom/google/firebase/messaging/d$a;
    .locals 2
    ...
    invoke-static {p0, p0, p1, v1, v0}, Lcom/google/firebase/messaging/d;->d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/d$a;
...
.method public static f(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    .locals 2
...
.method public static h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    :try_start_1
    invoke-static {p0, p1}, Lc1/b;->getColor(Landroid/content/Context;I)I
...
.method public static i(Lcom/google/firebase/messaging/k0;)I
    .locals 2
...
.method public static k(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Lo/b;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {p1, p0, p2}, Lo/g;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object p0

    invoke-static {v0, p0}, Lo/d;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
...
.method public static n(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/res/Resources;)Landroid/net/Uri;
    .locals 1
...
.method public static o(Lcom/google/firebase/messaging/k0;)Ljava/lang/String;
    .locals 2
...
.method public static q(Lcom/google/firebase/messaging/k0;)Z
    .locals 1
