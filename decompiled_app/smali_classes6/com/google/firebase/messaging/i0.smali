...
.method public static A(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :cond_4
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->r(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_6
    :goto_0
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->t(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_7
    :goto_1
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->n(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v2}, Lcd/f;->j(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, p0, v1}, Lgd/a;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static B(Landroid/os/Bundle;)V
    ...
    const-class v3, Lgd/a;

    invoke-virtual {v0, v3}, Lcd/f;->j(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v2, v1, p0}, Lgd/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v2, p0, v1}, Lgd/a;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static C(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->u(Landroid/content/Intent;)Z
...
.method public static D(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->E(Landroid/os/Bundle;)Z
...
.method public static a()Z
    ...
    invoke-virtual {v2}, Lcd/f;->k()Landroid/content/Context;
...
.method public static b(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->s(Landroid/os/Bundle;)I
    ...
    invoke-static {}, Lcom/google/firebase/messaging/i0;->o()Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->m(Landroid/os/Bundle;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->k(Landroid/os/Bundle;)I
    ...
    :cond_6
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->q(Landroid/os/Bundle;)J
...
.method public static f(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/firebase/installations/a;->q(Lcd/f;)Lcom/google/firebase/installations/a;
...
.method public static k(Landroid/os/Bundle;)I
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->p(Landroid/os/Bundle;)I
...
.method public static p(Landroid/os/Bundle;)I
    ...
    :cond_1
    invoke-static {v0}, Lcom/google/firebase/messaging/i0;->j(Ljava/lang/String;)I
...
.method public static q(Landroid/os/Bundle;)J
    ...
    invoke-virtual {v0}, Lcd/m;->d()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcd/m;->c()Ljava/lang/String;
...
.method public static v(Landroid/content/Intent;)V
    ...
    invoke-static {v0, p0}, Lcom/google/firebase/messaging/i0;->A(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static x(Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->B(Landroid/os/Bundle;)V
...
.method public static y(Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->D(Landroid/content/Intent;)Z
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/messaging/i0;->A(Ljava/lang/String;Landroid/os/Bundle;)V

    :cond_0
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->C(Landroid/content/Intent;)Z
    ...
    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->u()Ly9/i;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/i0;->z(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Ly9/i;)V

    :cond_1
    return-void
.end method

.method public static z(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Ly9/i;)V
    .locals 5
    .param p2    # Ly9/i;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-static {p1}, Ly9/f;->b(Ljava/lang/Integer;)Ly9/f;
    ...
    invoke-interface {p2, v1, v2, v3, v4}, Ly9/i;->b(Ljava/lang/String;Ljava/lang/Class;Ly9/c;Ly9/g;)Ly9/h;

    move-result-object p2

    invoke-static {}, Lne/a;->b()Lne/a$a;

    move-result-object v1

    invoke-virtual {v1, p0}, Lne/a$a;->b(Lcom/google/firebase/messaging/reporting/MessagingClientEvent;)Lne/a$a;

    move-result-object p0

    invoke-virtual {p0}, Lne/a$a;->a()Lne/a;

    move-result-object p0

    invoke-static {p0, p1}, Ly9/d;->g(Ljava/lang/Object;Ly9/f;)Ly9/d;

    move-result-object p0

    invoke-interface {p2, p0}, Ly9/h;->a(Ly9/d;)V
    :try_end_0
