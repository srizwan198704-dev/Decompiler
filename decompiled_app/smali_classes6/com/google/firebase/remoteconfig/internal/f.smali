...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/remoteconfig/internal/f;->h:Ljava/util/Date;
...
.method public constructor <init>(Lorg/json/JSONObject;Ljava/util/Date;Lorg/json/JSONArray;Lorg/json/JSONObject;JLorg/json/JSONArray;)V
    ...
    iput-wide p5, p0, Lcom/google/firebase/remoteconfig/internal/f;->f:J

    iput-object p7, p0, Lcom/google/firebase/remoteconfig/internal/f;->g:Lorg/json/JSONArray;
...
.method public synthetic constructor <init>(Lorg/json/JSONObject;Ljava/util/Date;Lorg/json/JSONArray;Lorg/json/JSONObject;JLorg/json/JSONArray;Lcom/google/firebase/remoteconfig/internal/f$a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    invoke-direct/range {p0 .. p7}, Lcom/google/firebase/remoteconfig/internal/f;-><init>(Lorg/json/JSONObject;Ljava/util/Date;Lorg/json/JSONArray;Lorg/json/JSONObject;JLorg/json/JSONArray;)V
...
.method public static synthetic a()Ljava/util/Date;
    ...
    sget-object v0, Lcom/google/firebase/remoteconfig/internal/f;->h:Ljava/util/Date;
...
.method public static b(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/f;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/google/firebase/remoteconfig/internal/f;-><init>(Lorg/json/JSONObject;Ljava/util/Date;Lorg/json/JSONArray;Lorg/json/JSONObject;JLorg/json/JSONArray;)V

    return-object v0
.end method

.method public static d(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/f;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    invoke-static {v0}, Lcom/google/firebase/remoteconfig/internal/f;->b(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/f;
...
.method public static l()Lcom/google/firebase/remoteconfig/internal/f$b;
    .locals 2
...
.method public final c()Ljava/util/Map;
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/f;->j()Lorg/json/JSONArray;
...
.method public f(Lcom/google/firebase/remoteconfig/internal/f;)Ljava/util/Set;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Lcom/google/firebase/remoteconfig/internal/f;->d(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/f;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/f;->g()Lorg/json/JSONObject;

    move-result-object v0

    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/f;->c()Ljava/util/Map;

    move-result-object v1

    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/internal/f;->c()Ljava/util/Map;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/f;->i()Lorg/json/JSONObject;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/internal/f;->i()Lorg/json/JSONObject;
...
.method public j()Lorg/json/JSONArray;
    ...
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/f;->g:Lorg/json/JSONArray;
...
.method public k()J
    ...
    iget-wide v0, p0, Lcom/google/firebase/remoteconfig/internal/f;->f:J
