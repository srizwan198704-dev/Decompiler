...
.method public constructor <init>(Lokhttp3/RequestBody;Lcom/google/net/cronet/okhttptransport/UploadBodyDataBroker;Ljava/util/concurrent/ExecutorService;J)V
    ...
    iput-object p3, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->c:Lcom/google/common/util/concurrent/v;
    ...
    iput-object p1, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->c:Lcom/google/common/util/concurrent/v;
...
.method public static synthetic b(Lcom/google/net/cronet/okhttptransport/a$c$a;)Ljava/lang/Void;
    .locals 0

    invoke-direct {p0}, Lcom/google/net/cronet/okhttptransport/a$c$a;->k()Ljava/lang/Void;
...
.method public static synthetic d(Lcom/google/net/cronet/okhttptransport/a$c$a;)Lcom/google/net/cronet/okhttptransport/UploadBodyDataBroker;
    .locals 0
...
.method private h()V
    ...
    iget-object v0, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->e:Lcom/google/common/util/concurrent/t;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->c:Lcom/google/common/util/concurrent/v;

    new-instance v1, Lhf/f;

    invoke-direct {v1, p0}, Lhf/f;-><init>(Lcom/google/net/cronet/okhttptransport/a$c$a;)V
    ...
    iput-object v0, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->e:Lcom/google/common/util/concurrent/t;
...
.method private j(Lorg/chromium/net/UploadDataSink;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p2}, Lcom/google/net/cronet/okhttptransport/a$c$a;->m(Ljava/nio/ByteBuffer;)Lcom/google/net/cronet/okhttptransport/UploadBodyDataBroker$ReadResult;
    ...
    iget-wide v0, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->f:J

    invoke-static {p1, p2, v0, v1}, Lcom/google/net/cronet/okhttptransport/a$c$a;->l(JJ)Ljava/io/IOException;
...
.method private n(Lorg/chromium/net/UploadDataSink;Ljava/nio/ByteBuffer;)V
    ...
    iget-wide v2, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->f:J
    ...
    :cond_2
    invoke-direct {p0, p1, p2}, Lcom/google/net/cronet/okhttptransport/a$c$a;->j(Lorg/chromium/net/UploadDataSink;Ljava/nio/ByteBuffer;)V
    ...
    iget-wide v3, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->f:J

    invoke-static {v1, v2, v3, v4}, Lcom/google/net/cronet/okhttptransport/a$c$a;->l(JJ)Ljava/io/IOException;
    ...
    :goto_1
    iget-object v1, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->e:Lcom/google/common/util/concurrent/t;
...
.method public final m(Ljava/nio/ByteBuffer;)Lcom/google/net/cronet/okhttptransport/UploadBodyDataBroker$ReadResult;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/util/concurrent/TimeoutException;,
    ...
    iput-wide v2, p0, Lcom/google/net/cronet/okhttptransport/a$c$a;->f:J
...
.method public read(Lorg/chromium/net/UploadDataSink;Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {p0}, Lcom/google/net/cronet/okhttptransport/a$c$a;->h()V
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/net/cronet/okhttptransport/a$c$a;->o(Lorg/chromium/net/UploadDataSink;Ljava/nio/ByteBuffer;)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/google/net/cronet/okhttptransport/a$c$a;->n(Lorg/chromium/net/UploadDataSink;Ljava/nio/ByteBuffer;)V
