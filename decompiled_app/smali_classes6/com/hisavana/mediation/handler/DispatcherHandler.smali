...
.method public constructor <init>(Lcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;Lkg/i;)V
    ...
    iput-object p2, p0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    return-void
.end method

.method public static a(Lkg/i;Lcom/hisavana/common/bean/Network;ILcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;)Landroid/os/Bundle;
    .locals 10
    ...
    invoke-virtual {p0}, Lkg/i;->v()Landroid/os/Bundle;
...
.method public static synthetic o(Lcom/hisavana/mediation/handler/DispatcherHandler;)Lkg/i;
    .locals 0

    iget-object p0, p0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;
...
.method public final c(Landroid/content/Context;Lcom/hisavana/common/bean/Network;II)Lcom/hisavana/common/interfacz/Iad;
    ...
    invoke-virtual {v1, v2}, Lkg/o;->f(I)Lcom/hisavana/common/interfacz/IBaseAdSummary;
    ...
    iget-object p2, p0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    invoke-virtual {p2}, Lkg/i;->J()Z
    ...
    invoke-virtual {p2}, Lkg/i;->z()Ljava/lang/String;

    move-result-object p2

    iget-object p3, p0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    invoke-virtual {p3}, Lkg/i;->B()Ljava/lang/String;

    move-result-object p3

    iget-object p4, p0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    invoke-virtual {p4}, Lkg/i;->x()Ljava/util/Map;
    ...
    invoke-virtual {p3}, Lkg/i;->r()I

    move-result p3

    iget-object v0, p0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    invoke-virtual {v0}, Lkg/i;->t()I
    ...
    invoke-virtual {p2}, Lkg/i;->G()Lcom/cloud/hisavana/sdk/common/bean/SSPWebPageReqInfo;
...
.method public f(Landroid/content/Context;Ljava/util/List;Ljava/util/List;Ljava/util/List;Z)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v8, v0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    invoke-virtual {v8}, Lkg/i;->J()Z
    ...
    iget-object v7, v0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    invoke-virtual {v7}, Lkg/i;->J()Z
...
.method public final i(Lcom/hisavana/common/interfacz/Iad;II)Z
    ...
    invoke-static {v0, v1, p2, v3}, Lcom/hisavana/mediation/handler/DispatcherHandler;->a(Lkg/i;Lcom/hisavana/common/bean/Network;ILcom/hisavana/mediation/bean/CloudControlConfig$CodeSeat;)Landroid/os/Bundle;
...
.method public k(Lcom/hisavana/common/interfacz/Iad;IILcom/hisavana/common/bean/TInnerAdRequestBody;Z)Z
    ...
    iget-object v4, p0, Lcom/hisavana/mediation/handler/DispatcherHandler;->e:Lkg/i;

    invoke-virtual {v4}, Lkg/i;->J()Z
