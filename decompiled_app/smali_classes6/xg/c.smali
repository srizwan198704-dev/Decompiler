...
.method public static b(IIII)Lorg/json/JSONObject;
    ...
    invoke-static {p1, p0}, Lxg/d;->b(Ljava/lang/String;Ljava/lang/Exception;)V

    :goto_0
    return-object v0
.end method

.method public static c(Lorg/json/JSONObject;)Lxg/c$b;
    .locals 2

    sget-object p0, Lxg/c;->a:Landroid/view/WindowManager;
    ...
    sget-object v0, Lxg/c;->a:Landroid/view/WindowManager;
    ...
    :goto_0
    new-instance v1, Lxg/c$b;

    invoke-direct {v1, v0, p0}, Lxg/c$b;-><init>(FF)V
...
.method public static d(Landroid/content/Context;)V
    ...
    sput-object p0, Lxg/c;->a:Landroid/view/WindowManager;
...
.method public static e(Lorg/json/JSONObject;Lcom/iab/omid/library/mmadbridge/adsession/OutputDeviceStatus;)V
    ...
    invoke-static {p1}, Lxg/c;->k(Lcom/iab/omid/library/mmadbridge/adsession/OutputDeviceStatus;)Z
...
.method public static m(Lorg/json/JSONObject;)V
    ...
    invoke-static {p0}, Lxg/c;->c(Lorg/json/JSONObject;)Lxg/c$b;
...
.method public static p(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_0
    invoke-static {p0, p1}, Lxg/c;->l(Lorg/json/JSONArray;Lorg/json/JSONArray;)Z
    ...
    invoke-static {v3, v4}, Lxg/c;->v(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
...
.method public static v(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_1
    invoke-static {p0, p1}, Lxg/c;->t(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lxg/c;->u(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lxg/c;->s(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lxg/c;->r(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lxg/c;->q(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lxg/c;->p(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
