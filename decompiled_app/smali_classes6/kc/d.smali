...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, v0, v0}, Lkc/d;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, Lkc/d;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static {p0, p1}, Lkc/d;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
...
.method public static c(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0}, Lkc/d;->e(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
...
.method public static e(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, Lg1/a;->r(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p2}, Lg1/a;->p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static g(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0}, Lkc/a;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Lkc/b;->a(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;

    move-result-object p0

    invoke-static {p0}, Lkc/c;->a(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static l(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    invoke-static {p0, p1}, Lkc/d$b;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Lkc/d$a;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    :try_end_0
...
.method public static n(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p0, p1}, Lg1/a;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
