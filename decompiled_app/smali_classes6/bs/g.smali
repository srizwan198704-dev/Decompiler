...
.method public constructor <init>(Landroidx/constraintlayout/widget/ConstraintLayout;Landroidx/constraintlayout/widget/Group;Landroid/view/View;Landroidx/appcompat/widget/AppCompatImageButton;Landroid/widget/RelativeLayout;Landroid/widget/ProgressBar;Landroid/widget/TextView;Landroid/widget/ImageView;Landroid/widget/FrameLayout;Landroid/widget/LinearLayout;Landroid/widget/ImageView;Landroidx/constraintlayout/widget/ConstraintLayout;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;Lcom/transsion/publish/view/MatchParentVideoView;)V
    ...
    .param p16    # Landroid/widget/TextView;
        ...
        .end annotation
    .end param
    .param p17    # Lcom/transsion/publish/view/MatchParentVideoView;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    iput-object v1, v0, Lbs/g;->a:Landroidx/constraintlayout/widget/ConstraintLayout;

    move-object v1, p2

    iput-object v1, v0, Lbs/g;->b:Landroidx/constraintlayout/widget/Group;

    move-object v1, p3

    iput-object v1, v0, Lbs/g;->c:Landroid/view/View;

    move-object v1, p4

    iput-object v1, v0, Lbs/g;->d:Landroidx/appcompat/widget/AppCompatImageButton;

    move-object v1, p5

    iput-object v1, v0, Lbs/g;->e:Landroid/widget/RelativeLayout;

    move-object v1, p6

    iput-object v1, v0, Lbs/g;->f:Landroid/widget/ProgressBar;

    move-object v1, p7

    iput-object v1, v0, Lbs/g;->g:Landroid/widget/TextView;

    move-object v1, p8

    iput-object v1, v0, Lbs/g;->h:Landroid/widget/ImageView;

    move-object v1, p9

    iput-object v1, v0, Lbs/g;->i:Landroid/widget/FrameLayout;

    move-object v1, p10

    iput-object v1, v0, Lbs/g;->j:Landroid/widget/LinearLayout;

    move-object v1, p11

    iput-object v1, v0, Lbs/g;->k:Landroid/widget/ImageView;

    move-object v1, p12

    iput-object v1, v0, Lbs/g;->l:Landroidx/constraintlayout/widget/ConstraintLayout;

    move-object v1, p13

    iput-object v1, v0, Lbs/g;->m:Landroid/widget/TextView;

    move-object/from16 v1, p14

    iput-object v1, v0, Lbs/g;->n:Landroid/widget/TextView;

    move-object/from16 v1, p15

    iput-object v1, v0, Lbs/g;->o:Landroid/widget/TextView;

    move-object/from16 v1, p16

    iput-object v1, v0, Lbs/g;->p:Landroid/widget/TextView;

    move-object/from16 v1, p17

    iput-object v1, v0, Lbs/g;->q:Lcom/transsion/publish/view/MatchParentVideoView;

    return-void
.end method

.method public static a(Landroid/view/View;)Lbs/g;
    .locals 21
...
.method public static c(Landroid/view/LayoutInflater;)Lbs/g;
    .locals 2
    ...
    invoke-static {p0, v0, v1}, Lbs/g;->d(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lbs/g;
...
.method public static d(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lbs/g;
    .locals 2
    .param p0    # Landroid/view/LayoutInflater;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_0
    invoke-static {p0}, Lbs/g;->a(Landroid/view/View;)Lbs/g;
...
.method public b()Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    iget-object v0, p0, Lbs/g;->a:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public bridge synthetic getRoot()Landroid/view/View;
    ...
    invoke-virtual {p0}, Lbs/g;->b()Landroidx/constraintlayout/widget/ConstraintLayout;
