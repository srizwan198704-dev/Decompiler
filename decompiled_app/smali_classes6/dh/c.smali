...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldh/c;->b:[Ljava/lang/String;
...
.method public static b(Lorg/json/JSONObject;)Ldh/c$b;
    .locals 2

    sget-object p0, Ldh/c;->a:Landroid/view/WindowManager;
    ...
    sget-object v0, Ldh/c;->a:Landroid/view/WindowManager;
    ...
    invoke-static {v0}, Ldh/c;->a(I)F

    move-result v0

    iget p0, p0, Landroid/graphics/Point;->y:I

    invoke-static {p0}, Ldh/c;->a(I)F
    ...
    invoke-direct {v1, v0, p0}, Ldh/c$b;-><init>(FF)V
...
.method public static c(IIII)Lorg/json/JSONObject;
    ...
    invoke-static {p1, p0}, Ldh/d;->b(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static d(Landroid/content/Context;)V
    ...
    sput-object p0, Ldh/c;->a:Landroid/view/WindowManager;
...
.method public static e(Lorg/json/JSONObject;Lcom/iab/omid/library/vungle/adsession/OutputDeviceStatus;)V
    ...
    invoke-static {p1}, Ldh/c;->k(Lcom/iab/omid/library/vungle/adsession/OutputDeviceStatus;)Z
...
.method public static k(Lcom/iab/omid/library/vungle/adsession/OutputDeviceStatus;)Z
    .locals 1

    sget-object v0, Ldh/c$a;->a:[I
...
.method public static m(Lorg/json/JSONObject;)V
    ...
    invoke-static {p0}, Ldh/c;->b(Lorg/json/JSONObject;)Ldh/c$b;
...
.method public static p(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_0
    invoke-static {p0, p1}, Ldh/c;->l(Lorg/json/JSONArray;Lorg/json/JSONArray;)Z
    ...
    invoke-static {v3, v4}, Ldh/c;->v(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
...
.method public static t(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    sget-object v0, Ldh/c;->b:[Ljava/lang/String;
...
.method public static v(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_1
    invoke-static {p0, p1}, Ldh/c;->t(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Ldh/c;->u(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Ldh/c;->s(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Ldh/c;->r(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Ldh/c;->q(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Ldh/c;->p(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
