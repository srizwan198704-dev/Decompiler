...
# interfaces
.implements Lcom/cloud/hisavana/sdk/p3;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cloud/hisavana/sdk/w2$b;
    }
.end annotation


# instance fields
.field public i:Lcom/cloud/hisavana/sdk/p5;

.field public j:Lcom/cloud/hisavana/sdk/w2$b;
...
.method public constructor <init>(Lcom/cloud/hisavana/sdk/o3;)V
    ...
    iput-object p1, p0, Lcom/cloud/hisavana/sdk/w2;->k:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public static synthetic H(Lcom/cloud/hisavana/sdk/w2;)Lcom/cloud/hisavana/sdk/p5;
    .locals 0

    iget-object p0, p0, Lcom/cloud/hisavana/sdk/w2;->i:Lcom/cloud/hisavana/sdk/p5;
...
.method private I(I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/cloud/hisavana/sdk/w2;->k:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static synthetic M(Lcom/cloud/hisavana/sdk/w2;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/cloud/hisavana/sdk/w2;->U(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V

    return-void
.end method

.method public static synthetic R(Lcom/cloud/hisavana/sdk/w2;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/cloud/hisavana/sdk/w2;->X(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
...
.method private Y()V
    ...
    iget-object v0, p0, Lcom/cloud/hisavana/sdk/w2;->i:Lcom/cloud/hisavana/sdk/p5;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/cloud/hisavana/sdk/p5;->j()Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lcom/cloud/hisavana/sdk/w2;->U(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
...
.method private a0()V
    ...
    invoke-direct {v0, p0}, Lcom/cloud/hisavana/sdk/p5;-><init>(Lcom/cloud/hisavana/sdk/w2;)V

    iput-object v0, p0, Lcom/cloud/hisavana/sdk/w2;->i:Lcom/cloud/hisavana/sdk/p5;

    new-instance v0, Lcom/cloud/hisavana/sdk/w2$b;

    invoke-direct {v0, p0}, Lcom/cloud/hisavana/sdk/w2$b;-><init>(Lcom/cloud/hisavana/sdk/w2;)V

    iput-object v0, p0, Lcom/cloud/hisavana/sdk/w2;->j:Lcom/cloud/hisavana/sdk/w2$b;
...
.method public F(Landroid/content/Context;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)Lcom/cloud/hisavana/sdk/api/view/AdChoicesView;
    ...
    invoke-static {p2}, Lcom/cloud/hisavana/sdk/J0;->f(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;

    move-result-object p2

    const/4 v0, 0x0

    invoke-static {p1, p2, v0}, Lcom/cloud/hisavana/sdk/J0;->e(Landroid/content/Context;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Lcom/cloud/hisavana/sdk/api/listener/e;)Lcom/cloud/hisavana/sdk/api/view/AdChoicesView;
...
.method public final K(Landroid/view/View;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    .locals 3
    ...
    iget-object v1, p0, Lcom/cloud/hisavana/sdk/w2;->j:Lcom/cloud/hisavana/sdk/w2$b;
...
.method public final L(Landroid/view/ViewGroup;Ljava/util/List;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    .locals 5
    ...
    invoke-static {p3}, Lcom/cloud/hisavana/sdk/J0;->f(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;
    ...
    invoke-virtual {p0, p1, p3}, Lcom/cloud/hisavana/sdk/w2;->K(Landroid/view/View;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    ...
    iget-object v1, p0, Lcom/cloud/hisavana/sdk/w2;->i:Lcom/cloud/hisavana/sdk/p5;

    invoke-virtual {v1, p1, p2, p3, v0}, Lcom/cloud/hisavana/sdk/p5;->e(Landroid/view/View;Ljava/util/List;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V
...
.method public final N(Ljava/util/List;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/cloud/hisavana/sdk/F;->b:Lcom/cloud/hisavana/sdk/o3;

    invoke-virtual {v1}, Lcom/cloud/hisavana/sdk/o3;->i()Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/cloud/hisavana/sdk/F;->b:Lcom/cloud/hisavana/sdk/o3;
...
.method public final O(Ljava/util/List;Landroid/os/Bundle;Ljava/util/List;)V
    .locals 3
    ...
    invoke-virtual {p0, p2}, Lcom/cloud/hisavana/sdk/w2;->J(Landroid/os/Bundle;)V

    return-void

    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/cloud/hisavana/sdk/w2;->N(Ljava/util/List;Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lcom/cloud/hisavana/sdk/J0;->F(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v2, p0}, Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;->setNativeBridge(Lcom/cloud/hisavana/sdk/p3;)V
    ...
    invoke-direct {p0, v0}, Lcom/cloud/hisavana/sdk/w2;->I(I)V
...
.method public final P(Ljava/util/List;Landroid/os/Bundle;Ljava/util/List;Lcom/cloud/hisavana/sdk/data/bean/request/AdxImpBean;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Lcom/cloud/hisavana/sdk/w2;->T(Ljava/util/List;Landroid/os/Bundle;)V

    return-void

    :cond_1
    invoke-virtual {p4}, Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;->getSource()I
    ...
    invoke-virtual {v3}, Lcom/cloud/hisavana/sdk/data/bean/response/ccofig/CommonConfigDTO;->getShowWebLetterAdPrice()Ljava/lang/Integer;
    ...
    const-string v2, "high price ,not use recommend -> firstPrice:"
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Lcom/cloud/hisavana/sdk/w2;->O(Ljava/util/List;Landroid/os/Bundle;Ljava/util/List;)V
...
.method public Q(Landroid/view/ViewGroup;Ljava/util/List;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    ...
    invoke-direct {p0}, Lcom/cloud/hisavana/sdk/w2;->a0()V
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/cloud/hisavana/sdk/w2;->L(Landroid/view/ViewGroup;Ljava/util/List;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V

    return-void
.end method

.method public S(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    .locals 3
...
.method public final T(Ljava/util/List;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, p0}, Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;->setNativeBridge(Lcom/cloud/hisavana/sdk/p3;)V
...
.method public final U(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    .locals 1
...
.method public V(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)I
    ...
    invoke-static {p1}, Lcom/cloud/hisavana/sdk/J0;->f(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;
    ...
    invoke-static {p1}, Lcom/cloud/hisavana/sdk/v2;->c(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Ljava/lang/String;
...
.method public W(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/cloud/hisavana/sdk/w2;->Z()Lcom/cloud/hisavana/sdk/api/listener/AdCallback;
...
.method public final X(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/cloud/hisavana/sdk/p5;->k(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
...
.method public a(Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
    ...
    new-instance v0, Lcom/cloud/hisavana/sdk/w2$a;

    invoke-direct {v0, p0, p1}, Lcom/cloud/hisavana/sdk/w2$a;-><init>(Lcom/cloud/hisavana/sdk/w2;Lcom/cloud/hisavana/sdk/common/bean/TaNativeInfo;)V
...
.method public c(Ljava/util/List;Ljava/util/List;Landroid/os/Bundle;Lcom/cloud/hisavana/sdk/data/bean/request/AdxImpBean;)V
    ...
    invoke-virtual {p0, p1, p3, p2, p4}, Lcom/cloud/hisavana/sdk/w2;->P(Ljava/util/List;Landroid/os/Bundle;Ljava/util/List;Lcom/cloud/hisavana/sdk/data/bean/request/AdxImpBean;)V
...
.method public d(Ljava/util/List;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2, v0, v0}, Lcom/cloud/hisavana/sdk/w2;->P(Ljava/util/List;Landroid/os/Bundle;Ljava/util/List;Lcom/cloud/hisavana/sdk/data/bean/request/AdxImpBean;)V
...
.method public m()V
    ...
    invoke-direct {p0}, Lcom/cloud/hisavana/sdk/w2;->Y()V

    iget-object v0, p0, Lcom/cloud/hisavana/sdk/w2;->i:Lcom/cloud/hisavana/sdk/p5;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/cloud/hisavana/sdk/p5;->d()V
