.class public final Lcom/cloud/hisavana/sdk/o2;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cloud/hisavana/sdk/o2$a;
    }
.end annotation


# instance fields
.field public i:Lcom/cloud/hisavana/sdk/v;

.field public volatile j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;

.field public k:Lcom/cloud/hisavana/sdk/o2$a;
...
.method public constructor <init>(Lcom/cloud/hisavana/sdk/o3;)V
    ...
    iput-object p1, p0, Lcom/cloud/hisavana/sdk/o2;->j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->m:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Lcom/cloud/hisavana/sdk/o2;->o:Ljava/lang/ref/WeakReference;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/cloud/hisavana/sdk/o2;->p:J
    ...
    iput-object p1, p0, Lcom/cloud/hisavana/sdk/o2;->q:Ljava/lang/Integer;
...
.method private F()V
    ...
    invoke-virtual {p0}, Lcom/cloud/hisavana/sdk/o2;->R()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/cloud/hisavana/sdk/F;->b:Lcom/cloud/hisavana/sdk/o3;
    ...
    iput-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->q:Ljava/lang/Integer;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :catchall_0
    iget-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->k:Lcom/cloud/hisavana/sdk/o2$a;

    if-nez v0, :cond_0

    new-instance v0, Lcom/cloud/hisavana/sdk/o2$a;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    iget-object v2, p0, Lcom/cloud/hisavana/sdk/o2;->q:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v2

    invoke-direct {v0, p0, v1, v2}, Lcom/cloud/hisavana/sdk/o2$a;-><init>(Lcom/cloud/hisavana/sdk/o2;Landroid/os/Looper;I)V

    iput-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->k:Lcom/cloud/hisavana/sdk/o2$a;
    ...
    iget-object v2, p0, Lcom/cloud/hisavana/sdk/o2;->k:Lcom/cloud/hisavana/sdk/o2$a;
...
.method public static synthetic I(Lcom/cloud/hisavana/sdk/o2;)V
    .locals 0

    invoke-direct {p0}, Lcom/cloud/hisavana/sdk/o2;->S()V
...
.method private P()V
    ...
    iget-object v1, p0, Lcom/cloud/hisavana/sdk/o2;->l:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Lcom/cloud/hisavana/sdk/o2;->j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;
...
.method private Q()V
    ...
    iget-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->i:Lcom/cloud/hisavana/sdk/v;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/cloud/hisavana/sdk/o2;->l:Landroid/view/ViewGroup;

    iget-object v2, p0, Lcom/cloud/hisavana/sdk/F;->b:Lcom/cloud/hisavana/sdk/o3;

    invoke-virtual {v2}, Lcom/cloud/hisavana/sdk/o3;->w()Z

    move-result v2

    iget-object v3, p0, Lcom/cloud/hisavana/sdk/F;->b:Lcom/cloud/hisavana/sdk/o3;

    invoke-virtual {v3}, Lcom/cloud/hisavana/sdk/o3;->t()Z

    move-result v3

    iget-object v4, p0, Lcom/cloud/hisavana/sdk/o2;->j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;
    ...
    invoke-virtual {p0, v0}, Lcom/cloud/hisavana/sdk/o2;->K(Lcom/cloud/hisavana/sdk/common/constant/TaErrorCode;)V
    ...
    iget-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->l:Landroid/view/ViewGroup;
...
.method private S()V
    ...
    invoke-virtual {v0}, Lcom/cloud/hisavana/sdk/o2$a;->a()V
    ...
    invoke-virtual {v0, v1}, Lcom/cloud/hisavana/sdk/o3;->d(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->o:Ljava/lang/ref/WeakReference;
...
.method public E()V
    ...
    invoke-virtual {p0, v0}, Lcom/cloud/hisavana/sdk/o2;->N(Z)V
...
.method public final G()V
    ...
    invoke-direct {v0, p0}, Lcom/cloud/hisavana/sdk/v;-><init>(Lcom/cloud/hisavana/sdk/o2;)V

    iput-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->i:Lcom/cloud/hisavana/sdk/v;
...
.method public H(I)V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/cloud/hisavana/sdk/o2;->P()V

    return-void
.end method

.method public J(Lcom/cloud/hisavana/sdk/api/adx/TBannerView;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/cloud/hisavana/sdk/o2;->o:Ljava/lang/ref/WeakReference;
...
.method public M(Lcom/cloud/hisavana/sdk/api/adx/TBannerView;)V
    ...
    iput-object p1, p0, Lcom/cloud/hisavana/sdk/o2;->l:Landroid/view/ViewGroup;

    invoke-virtual {p0}, Lcom/cloud/hisavana/sdk/o2;->G()V

    iget-object p1, p0, Lcom/cloud/hisavana/sdk/o2;->l:Landroid/view/ViewGroup;

    const-string v0, "TranBanner"

    if-eqz p1, :cond_2

    iget-object p1, p0, Lcom/cloud/hisavana/sdk/o2;->j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;
    ...
    invoke-direct {p0}, Lcom/cloud/hisavana/sdk/o2;->Q()V
    ...
    invoke-virtual {p0, p1}, Lcom/cloud/hisavana/sdk/o2;->K(Lcom/cloud/hisavana/sdk/common/constant/TaErrorCode;)V
...
.method public N(Z)V
    ...
    iput-boolean p1, p0, Lcom/cloud/hisavana/sdk/o2;->n:Z

    iget-object p1, p0, Lcom/cloud/hisavana/sdk/F;->a:Lcom/cloud/hisavana/sdk/e;

    invoke-virtual {p1}, Lcom/cloud/hisavana/sdk/e;->n()V
...
.method public T()V
    ...
    iget-object v1, p0, Lcom/cloud/hisavana/sdk/o2;->j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;
...
.method public U()V
    ...
    invoke-direct {p0}, Lcom/cloud/hisavana/sdk/o2;->F()V
...
.method public b(Lcom/cloud/hisavana/sdk/common/constant/TaErrorCode;Landroid/os/Bundle;)V
    ...
    iget-boolean v0, p0, Lcom/cloud/hisavana/sdk/o2;->n:Z

    if-eqz v0, :cond_0

    iget-object p1, p0, Lcom/cloud/hisavana/sdk/o2;->o:Ljava/lang/ref/WeakReference;
...
.method public d(Ljava/util/List;Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-object v1, p0, Lcom/cloud/hisavana/sdk/o2;->j:Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;

    iget-boolean v1, p0, Lcom/cloud/hisavana/sdk/o2;->n:Z
    ...
    invoke-virtual {p0, p1}, Lcom/cloud/hisavana/sdk/o2;->M(Lcom/cloud/hisavana/sdk/api/adx/TBannerView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/cloud/hisavana/sdk/o2;->b(Lcom/cloud/hisavana/sdk/common/constant/TaErrorCode;Landroid/os/Bundle;)V
