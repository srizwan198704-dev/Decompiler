...
.method public final zze(Landroid/os/Bundle;)Z
    ...
    invoke-static {v7, v8}, Lo/b;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {v8, v9, v10}, Lo/g;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object v9

    invoke-static {v7, v9}, Lo/d;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
    ...
    :cond_13
    :goto_7
    new-instance v8, Landroidx/core/app/NotificationCompat$m;

    iget-object v9, p0, Lcom/google/android/gms/gcm/zzd;->zzl:Landroid/content/Context;

    invoke-direct {v8, v9}, Landroidx/core/app/NotificationCompat$m;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Landroidx/core/app/NotificationCompat$m;->l(Z)Landroidx/core/app/NotificationCompat$m;

    move-result-object v8

    invoke-virtual {v8, v5}, Landroidx/core/app/NotificationCompat$m;->J(I)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v5, v0}, Landroidx/core/app/NotificationCompat$m;->r(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v5, v1}, Landroidx/core/app/NotificationCompat$m;->q(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$m;

    new-instance v0, Landroidx/core/app/NotificationCompat$k;

    invoke-direct {v0}, Landroidx/core/app/NotificationCompat$k;-><init>()V

    invoke-virtual {v0, v1}, Landroidx/core/app/NotificationCompat$k;->q(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$k;

    move-result-object v0

    invoke-virtual {v5, v0}, Landroidx/core/app/NotificationCompat$m;->L(Landroidx/core/app/NotificationCompat$p;)Landroidx/core/app/NotificationCompat$m;
    ...
    invoke-virtual {v5, v0}, Landroidx/core/app/NotificationCompat$m;->o(I)Landroidx/core/app/NotificationCompat$m;

    :cond_16
    if-eqz v3, :cond_17

    invoke-virtual {v5, v3}, Landroidx/core/app/NotificationCompat$m;->K(Landroid/net/Uri;)Landroidx/core/app/NotificationCompat$m;

    :cond_17
    if-eqz v6, :cond_18

    invoke-virtual {v5, v6}, Landroidx/core/app/NotificationCompat$m;->p(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$m;

    :cond_18
    if-eqz v7, :cond_19

    invoke-virtual {v5, v7}, Landroidx/core/app/NotificationCompat$m;->n(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$m;

    :cond_19
    invoke-virtual {v5}, Landroidx/core/app/NotificationCompat$m;->c()Landroid/app/Notification;
