...
.method public constructor <init>(Lpa/e0;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/flv/TagPayloadReader;-><init>(Lpa/e0;)V
...
.method public b(Lcom/google/android/exoplayer2/util/d0;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/p1$b;->f0(I)Lcom/google/android/exoplayer2/p1$b;
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/flv/TagPayloadReader;->a:Lpa/e0;
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/p1$b;->e0(Ljava/lang/String;)Lcom/google/android/exoplayer2/p1$b;

    move-result-object p1

    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/p1$b;->H(I)Lcom/google/android/exoplayer2/p1$b;

    move-result-object p1

    const/16 v0, 0x1f40

    invoke-virtual {p1, v0}, Lcom/google/android/exoplayer2/p1$b;->f0(I)Lcom/google/android/exoplayer2/p1$b;
...
.method public c(Lcom/google/android/exoplayer2/util/d0;J)Z
    ...
    invoke-interface {v0, p1, v7}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget-object v3, p0, Lcom/google/android/exoplayer2/extractor/flv/TagPayloadReader;->a:Lpa/e0;
    ...
    invoke-virtual {p1, p3, v1, p2}, Lcom/google/android/exoplayer2/util/d0;->j([BII)V
    ...
    invoke-virtual {p2, v0}, Lcom/google/android/exoplayer2/p1$b;->I(Ljava/lang/String;)Lcom/google/android/exoplayer2/p1$b;

    move-result-object p2

    iget v0, p1, Lcom/google/android/exoplayer2/audio/a$b;->b:I

    invoke-virtual {p2, v0}, Lcom/google/android/exoplayer2/p1$b;->H(I)Lcom/google/android/exoplayer2/p1$b;

    move-result-object p2

    iget p1, p1, Lcom/google/android/exoplayer2/audio/a$b;->a:I

    invoke-virtual {p2, p1}, Lcom/google/android/exoplayer2/p1$b;->f0(I)Lcom/google/android/exoplayer2/p1$b;
    ...
    invoke-virtual {p1, p2}, Lcom/google/android/exoplayer2/p1$b;->T(Ljava/util/List;)Lcom/google/android/exoplayer2/p1$b;
    ...
    iget-object p2, p0, Lcom/google/android/exoplayer2/extractor/flv/TagPayloadReader;->a:Lpa/e0;
    ...
    invoke-interface {v0, p1, v9}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget-object v5, p0, Lcom/google/android/exoplayer2/extractor/flv/TagPayloadReader;->a:Lpa/e0;
    ...
    invoke-interface/range {v5 .. v11}, Lpa/e0;->f(JIIILpa/e0$a;)V
