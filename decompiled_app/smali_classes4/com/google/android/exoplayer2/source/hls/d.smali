...
.method public static e(Lcom/google/android/exoplayer2/util/l0;Lcom/google/android/exoplayer2/p1;Ljava/util/List;)Lxa/g;
    .locals 2
    ...
    invoke-direct {v0, p1, p0, v1, p2}, Lxa/g;-><init>(ILcom/google/android/exoplayer2/util/l0;Lxa/o;Ljava/util/List;)V

    return-object v0
.end method

.method public static f(IZLcom/google/android/exoplayer2/p1;Ljava/util/List;Lcom/google/android/exoplayer2/util/l0;)Lza/h0;
    .locals 1
    ...
    :cond_3
    new-instance p0, Lza/h0;

    new-instance p1, Lza/j;

    invoke-direct {p1, v0, p3}, Lza/j;-><init>(ILjava/util/List;)V

    const/4 p2, 0x2

    invoke-direct {p0, p2, p4, p1}, Lza/h0;-><init>(ILcom/google/android/exoplayer2/util/l0;Lza/i0$c;)V

    return-object p0
.end method

.method public static g(Lcom/google/android/exoplayer2/p1;)Z
    .locals 4
...
.method public static h(Lpa/l;Lpa/m;)Z
    .locals 0
    ...
    :try_start_0
    invoke-interface {p0, p1}, Lpa/l;->d(Lpa/m;)Z
...
# virtual methods
.method public bridge synthetic a(Landroid/net/Uri;Lcom/google/android/exoplayer2/p1;Ljava/util/List;Lcom/google/android/exoplayer2/util/l0;Ljava/util/Map;Lpa/m;Lma/u1;)Lcom/google/android/exoplayer2/source/hls/j;
    .locals 0
    .param p3    # Ljava/util/List;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/google/android/exoplayer2/source/hls/d;->c(Landroid/net/Uri;Lcom/google/android/exoplayer2/p1;Ljava/util/List;Lcom/google/android/exoplayer2/util/l0;Ljava/util/Map;Lpa/m;Lma/u1;)Lcom/google/android/exoplayer2/source/hls/b;
...
.method public c(Landroid/net/Uri;Lcom/google/android/exoplayer2/p1;Ljava/util/List;Lcom/google/android/exoplayer2/util/l0;Ljava/util/Map;Lpa/m;Lma/u1;)Lcom/google/android/exoplayer2/source/hls/b;
    .locals 6
    .param p3    # Ljava/util/List;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :cond_0
    invoke-interface {p6}, Lpa/m;->resetPeekPosition()V
    ...
    invoke-virtual {p0, v2, p2, p3, p4}, Lcom/google/android/exoplayer2/source/hls/d;->d(ILcom/google/android/exoplayer2/p1;Ljava/util/List;Lcom/google/android/exoplayer2/util/l0;)Lpa/l;
    ...
    invoke-static {v4, p6}, Lcom/google/android/exoplayer2/source/hls/d;->h(Lpa/l;Lpa/m;)Z
    ...
    invoke-direct {p1, v4, p2, p4}, Lcom/google/android/exoplayer2/source/hls/b;-><init>(Lpa/l;Lcom/google/android/exoplayer2/p1;Lcom/google/android/exoplayer2/util/l0;)V
    ...
    invoke-direct {p1, p3, p2, p4}, Lcom/google/android/exoplayer2/source/hls/b;-><init>(Lpa/l;Lcom/google/android/exoplayer2/p1;Lcom/google/android/exoplayer2/util/l0;)V

    return-object p1
.end method

.method public final d(ILcom/google/android/exoplayer2/p1;Ljava/util/List;Lcom/google/android/exoplayer2/util/l0;)Lpa/l;
    .locals 1
    .param p3    # Ljava/util/List;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-static {p1, v0, p2, p3, p4}, Lcom/google/android/exoplayer2/source/hls/d;->f(IZLcom/google/android/exoplayer2/p1;Ljava/util/List;Lcom/google/android/exoplayer2/util/l0;)Lza/h0;
    ...
    :cond_2
    invoke-static {p4, p2, p3}, Lcom/google/android/exoplayer2/source/hls/d;->e(Lcom/google/android/exoplayer2/util/l0;Lcom/google/android/exoplayer2/p1;Ljava/util/List;)Lxa/g;
    ...
    invoke-direct {p1, p2, p3, p4}, Lwa/f;-><init>(IJ)V
