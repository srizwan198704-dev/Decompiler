...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lx5/h;->B(Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lx5/h;->t:[Ljava/lang/String;
    ...
    sput-object v0, Lx5/h;->u:[Ljava/lang/String;
    ...
    :cond_0
    sput-object v0, Lx5/h;->v:[Ljava/lang/String;
    ...
    sput-object v0, Lx5/h;->y:[J

    new-instance v0, Lx5/h;

    invoke-direct {v0}, Lx5/h;-><init>()V

    sput-object v0, Lx5/h;->z:Lx5/h;

    sput-boolean v1, Lx5/h;->A:Z

    sput-boolean v1, Lx5/h;->B:Z

    sput-boolean v1, Lx5/h;->C:Z

    sput-boolean v1, Lx5/h;->D:Z

    new-instance v0, Lx5/h$b;

    invoke-direct {v0}, Lx5/h$b;-><init>()V

    sput-object v0, Lx5/h;->E:Lcom/alibaba/fastjson/util/e;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lx5/h;-><init>(Z)V

    return-void
.end method

.method public constructor <init>(Ly5/a;Ljava/lang/ClassLoader;Z)V
    .locals 6
    ...
    iput-object v0, p0, Lx5/h;->a:Lcom/alibaba/fastjson/util/g;
    ...
    iput-object v0, p0, Lx5/h;->b:Lcom/alibaba/fastjson/util/g;
    ...
    iput-object v0, p0, Lx5/h;->c:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-direct {v0, v1}, Lx5/i;-><init>(I)V

    iput-object v0, p0, Lx5/h;->e:Lx5/i;

    sget-boolean v0, Lx5/h;->w:Z

    iput-boolean v0, p0, Lx5/h;->i:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Lx5/h;->n:Z

    sget-boolean v1, Lcom/alibaba/fastjson/util/TypeUtils;->b:Z

    iput-boolean v1, p0, Lx5/h;->o:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lx5/h;->p:Ljava/util/List;

    sget-boolean v1, Lx5/h;->x:Z

    iput-boolean v1, p0, Lx5/h;->r:Z
    ...
    iput-object v1, p0, Lx5/h;->k:[J

    sget-object v1, Lx5/h;->v:[Ljava/lang/String;
    ...
    :goto_0
    sget-object v4, Lx5/h;->v:[Ljava/lang/String;
    ...
    iput-object v1, p0, Lx5/h;->l:[J

    new-instance v1, Lx5/h$a;

    invoke-direct {v1, p0}, Lx5/h$a;-><init>(Lx5/h;)V

    iput-object v1, p0, Lx5/h;->s:Ljava/util/concurrent/Callable;

    iput-boolean p3, p0, Lx5/h;->m:Z
    ...
    invoke-direct {p2, p3}, Ly5/a;-><init>(Ljava/lang/ClassLoader;)V
    ...
    invoke-direct {p3, p2}, Ly5/a;-><init>(Ljava/lang/ClassLoader;)V
    :try_end_0
    ...
    :cond_2
    :goto_1
    iput-object p1, p0, Lx5/h;->h:Ly5/a;
    ...
    :cond_3
    invoke-virtual {p0}, Lx5/h;->u()V

    sget-object p1, Lx5/h;->u:[Ljava/lang/String;

    invoke-virtual {p0, p1}, Lx5/h;->f([Ljava/lang/String;)V

    sget-object p1, Lx5/h;->t:[Ljava/lang/String;

    invoke-virtual {p0, p1}, Lx5/h;->g([Ljava/lang/String;)V

    sget-object p1, Lx5/h;->v:[Ljava/lang/String;

    invoke-virtual {p0, p1}, Lx5/h;->e([Ljava/lang/String;)V
...
.method public constructor <init>(Z)V
    ...
    invoke-direct {p0, v0, v0, p1}, Lx5/h;-><init>(Ly5/a;Ljava/lang/ClassLoader;Z)V
...
.method public static synthetic a(Lx5/h;)Lcom/alibaba/fastjson/util/g;
    .locals 0

    iget-object p0, p0, Lx5/h;->a:Lcom/alibaba/fastjson/util/g;
...
.method public static w(Ljava/lang/Class;)Z
    ...
    sget-object v0, Lx5/h;->E:Lcom/alibaba/fastjson/util/e;
...
.method public static y(Ljava/lang/Class;Ljava/util/Map;)V
    ...
    invoke-static {p0, p1}, Lx5/h;->y(Ljava/lang/Class;Ljava/util/Map;)V
...
.method public final e([Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lx5/h;->b(Ljava/lang/String;)V
...
.method public final f([Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lx5/h;->c(Ljava/lang/String;)V
...
.method public final g([Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lx5/h;->d(Ljava/lang/String;)V
...
.method public h(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    invoke-virtual {p0, p1}, Lx5/h;->m(Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lx5/h;->j(Ljava/lang/String;Ljava/lang/Class;I)Ljava/lang/Class;
...
.method public i(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Class;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lx5/h;->j(Ljava/lang/String;Ljava/lang/Class;I)Ljava/lang/Class;
...
.method public j(Ljava/lang/String;Ljava/lang/Class;I)Ljava/lang/Class;
    ...
    :cond_0
    iget-object v5, v1, Lx5/h;->q:Ljava/util/List;
    ...
    check-cast v6, Lx5/h$c;

    invoke-interface {v6, v0, v2, v3}, Lx5/h$c;->a(Ljava/lang/String;Ljava/lang/Class;I)Ljava/lang/Class;
    ...
    iget-object v14, v1, Lx5/h;->g:Ljava/lang/ClassLoader;
    ...
    iget-object v7, v1, Lx5/h;->a:Lcom/alibaba/fastjson/util/g;
    ...
    iget-object v7, v1, Lx5/h;->c:Ljava/util/concurrent/ConcurrentMap;
    ...
    iget-object v6, v1, Lx5/h;->g:Ljava/lang/ClassLoader;
    ...
    iget-object v3, v1, Lx5/h;->g:Ljava/lang/ClassLoader;
    ...
    iget-object v5, v1, Lx5/h;->g:Ljava/lang/ClassLoader;
    :try_end_0
    ...
    invoke-direct {v5, v4, v10}, Lw5/b;-><init>(Ljava/io/InputStream;Z)V
    ...
    invoke-virtual {v5, v13}, Lw5/b;->a(Lcom/alibaba/fastjson/asm/TypeCollector;)V
    ...
    :goto_12
    iget-object v4, v1, Lx5/h;->g:Ljava/lang/ClassLoader;
    ...
    :cond_29
    iget-object v2, v1, Lx5/h;->f:Lcom/alibaba/fastjson/PropertyNamingStrategy;
...
.method public k(Lx5/h;Lcom/alibaba/fastjson/util/h;Lcom/alibaba/fastjson/util/d;)Ly5/l;
    .locals 4
    ...
    invoke-virtual {p3}, Lcom/alibaba/fastjson/util/d;->e()Lv5/b;
    ...
    invoke-interface {v1}, Lv5/b;->deserializeUsing()Ljava/lang/Class;
    ...
    invoke-direct {v0, p1, p2, p3}, Ly5/c;-><init>(Lx5/h;Ljava/lang/Class;Lcom/alibaba/fastjson/util/d;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Ly5/f;-><init>(Lx5/h;Ljava/lang/Class;Lcom/alibaba/fastjson/util/d;)V

    return-object v0
.end method

.method public l(Ljava/lang/Class;Ljava/lang/reflect/Type;)Ly5/b2;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-boolean v0, p0, Lx5/h;->d:Z

    iget-boolean v1, p0, Lx5/h;->m:Z
    ...
    invoke-interface {v4}, Lv5/d;->deserializer()Ljava/lang/Class;
    ...
    instance-of v5, v0, Ly5/b2;

    if-eqz v5, :cond_0

    check-cast v0, Ly5/b2;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :catchall_0
    :cond_0
    invoke-interface {v4}, Lv5/d;->asm()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-interface {v4}, Lv5/d;->parseFeatures()[Lcom/alibaba/fastjson/parser/Feature;
    ...
    invoke-static {p1, v4}, Lcom/alibaba/fastjson/util/h;->f(Ljava/lang/Class;Lv5/d;)Ljava/lang/Class;
    ...
    iget-object v4, p0, Lx5/h;->h:Ly5/a;

    if-eqz v4, :cond_7

    iget-object v4, v4, Ly5/a;->a:Lcom/alibaba/fastjson/util/a;
    ...
    :cond_9
    iget-object v6, p0, Lx5/h;->f:Lcom/alibaba/fastjson/PropertyNamingStrategy;

    sget-boolean v8, Lcom/alibaba/fastjson/util/TypeUtils;->b:Z

    iget-boolean v9, p0, Lx5/h;->n:Z
    ...
    :cond_10
    invoke-virtual {v7}, Lcom/alibaba/fastjson/util/d;->e()Lv5/b;

    move-result-object v9

    if-eqz v9, :cond_11

    invoke-interface {v9}, Lv5/b;->name()Ljava/lang/String;
    ...
    invoke-interface {v9}, Lv5/b;->format()Ljava/lang/String;
    ...
    invoke-interface {v9}, Lv5/b;->deserializeUsing()Ljava/lang/Class;

    move-result-object v10

    if-ne v10, v1, :cond_c

    invoke-interface {v9}, Lv5/b;->parseFeatures()[Lcom/alibaba/fastjson/parser/Feature;
    ...
    invoke-interface {v9}, Lv5/b;->unwrapped()Z
    ...
    invoke-virtual {p0, v8}, Lx5/h;->p(Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    invoke-direct {v0, p0, p1, p2}, Ly5/o;-><init>(Lx5/h;Ljava/lang/Class;Ljava/lang/reflect/Type;)V

    return-object v0

    :cond_17
    iget-object v0, p0, Lx5/h;->f:Lcom/alibaba/fastjson/PropertyNamingStrategy;
    ...
    :try_start_1
    iget-object v1, p0, Lx5/h;->h:Ly5/a;

    invoke-virtual {v1, p0, v0}, Ly5/a;->v(Lx5/h;Lcom/alibaba/fastjson/util/h;)Ly5/b2;
    ...
    invoke-direct {p1, p0, v0}, Ly5/o;-><init>(Lx5/h;Lcom/alibaba/fastjson/util/h;)V
...
.method public m(Ljava/lang/reflect/Type;)Ly5/b2;
    .locals 2
    ...
    iget-object v0, p0, Lx5/h;->a:Lcom/alibaba/fastjson/util/g;
    ...
    :cond_0
    iget-object v1, p0, Lx5/h;->b:Lcom/alibaba/fastjson/util/g;
...
.method public n()Ljava/lang/ClassLoader;
    ...
    iget-object v0, p0, Lx5/h;->g:Ljava/lang/ClassLoader;

    return-object v0
.end method

.method public o(Ljava/lang/Class;Ljava/lang/reflect/Type;)Ly5/b2;
    .locals 23
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v2}, Lx5/h;->m(Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    invoke-virtual {v0, v4}, Lx5/h;->m(Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    invoke-interface {v6}, Lv5/d;->mappingTo()Ljava/lang/Class;
    ...
    invoke-virtual {v0, v6, v6}, Lx5/h;->o(Ljava/lang/Class;Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    :cond_5
    invoke-virtual/range {p0 .. p1}, Lx5/h;->m(Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    :cond_7
    iget-object v6, v0, Lx5/h;->p:Ljava/util/List;
    ...
    invoke-interface {v4, v0, v1}, La6/a;->b(Lx5/h;Ljava/lang/Class;)Ly5/b2;

    move-result-object v4

    if-eqz v4, :cond_8

    invoke-virtual {v0, v2, v4}, Lx5/h;->z(Ljava/lang/reflect/Type;Ly5/b2;)V
    ...
    invoke-static/range {p1 .. p1}, Lz5/o;->k(Ljava/lang/Class;)Z

    move-result v7

    if-eqz v7, :cond_c

    sget-boolean v7, Lx5/h;->A:Z
    ...
    sget-object v7, Lz5/o;->a:Lz5/o;

    invoke-virtual {v0, v4, v7}, Lx5/h;->z(Ljava/lang/reflect/Type;Ly5/b2;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :catchall_0
    sput-boolean v10, Lx5/h;->A:Z

    :cond_b
    sget-object v4, Lz5/o;->a:Lz5/o;

    :cond_c
    sget-boolean v7, Lx5/h;->B:Z
    ...
    sget-object v4, Ly5/y1;->a:Ly5/y1;

    invoke-virtual {v0, v3, v4}, Lx5/h;->z(Ljava/lang/reflect/Type;Ly5/b2;)V
    ...
    sget-object v4, Ly5/d3;->a:Ly5/d3;
    ...
    :catchall_1
    sput-boolean v10, Lx5/h;->B:Z

    :cond_10
    sget-boolean v3, Lx5/h;->C:Z
    ...
    :catchall_2
    sput-boolean v10, Lx5/h;->C:Z

    :cond_12
    sget-boolean v3, Lx5/h;->D:Z
    ...
    sget-object v4, Lz5/u;->a:Lz5/u;

    invoke-virtual {v0, v1, v4}, Lx5/h;->z(Ljava/lang/reflect/Type;Ly5/b2;)V
    ...
    sget-object v4, Lz5/w0;->b:Lz5/w0;
    ...
    invoke-interface {v6}, Ly5/d;->a()Ljava/util/Set;
    ...
    invoke-virtual {v0, v8, v6}, Lx5/h;->z(Ljava/lang/reflect/Type;Ly5/b2;)V
    :try_end_4
    ...
    invoke-virtual {v0, v1, v2}, Lx5/h;->l(Ljava/lang/Class;Ljava/lang/reflect/Type;)Ly5/b2;

    move-result-object v1

    invoke-virtual {v0, v2, v1}, Lx5/h;->z(Ljava/lang/reflect/Type;Ly5/b2;)V
    ...
    invoke-static {v3, v1}, Lx5/h;->q(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    :cond_22
    invoke-static {v1, v1}, Lx5/h;->q(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {v2, v3}, Ly5/g;-><init>(Ljava/lang/reflect/Method;)V

    invoke-virtual {v0, v1, v2}, Lx5/h;->z(Ljava/lang/reflect/Type;Ly5/b2;)V

    return-object v2

    :cond_23
    invoke-virtual/range {p0 .. p1}, Lx5/h;->r(Ljava/lang/Class;)Ly5/b2;
    ...
    new-instance v3, Ly5/k3;

    invoke-direct {v3, v0, v1}, Ly5/k3;-><init>(Lx5/h;Ljava/lang/Class;)V
    ...
    new-instance v3, Ly5/g3;

    invoke-direct {v3, v1}, Ly5/g3;-><init>(Ljava/lang/Class;)V
    ...
    sget-object v1, Lz5/w0;->b:Lz5/w0;
...
.method public p(Ljava/lang/reflect/Type;)Ly5/b2;
    .locals 2
    ...
    invoke-virtual {p0, v0, p1}, Lx5/h;->o(Ljava/lang/Class;Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lx5/h;->p(Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    invoke-virtual {p0, p1}, Lx5/h;->p(Ljava/lang/reflect/Type;)Ly5/b2;
    ...
    :cond_4
    sget-object p1, Ly5/p;->a:Ly5/p;

    return-object p1
.end method

.method public r(Ljava/lang/Class;)Ly5/b2;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Ly5/h;-><init>(Ljava/lang/Class;)V
...
.method public final u()V
    ...
    sget-object v3, Ly5/z1;->a:Ly5/z1;
    ...
    sget-object v4, Ly5/z1;->a:Ly5/z1;
    ...
    sget-object v4, Lz5/k1;->a:Lz5/k1;
    ...
    sget-object v4, Ly5/a2;->a:Ly5/a2;
    ...
    sget-object v5, Lz5/j0;->a:Lz5/j0;
    ...
    sget-object v5, Lz5/u0;->a:Lz5/u0;
    ...
    sget-object v5, Lz5/h0;->b:Lz5/h0;
    ...
    sget-object v3, Lz5/d1;->a:Lz5/d1;
    ...
    sget-object v3, Ly5/j3;->a:Ly5/j3;
    ...
    invoke-direct {v1}, Ly5/n;-><init>()V

    const-class v2, Lcom/alibaba/fastjson/c;

    invoke-virtual {v0, v2, v1}, Lcom/alibaba/fastjson/util/g;->c(Ljava/lang/Object;Ljava/lang/Object;)Z

    iget-object v0, p0, Lx5/h;->s:Ljava/util/concurrent/Callable;
...
.method public x()Z
    ...
    iget-boolean v0, p0, Lx5/h;->r:Z

    return v0
.end method

.method public z(Ljava/lang/reflect/Type;Ly5/b2;)V
    .locals 3
    ...
    iget-object v2, p0, Lx5/h;->b:Lcom/alibaba/fastjson/util/g;
