...
.method public constructor <init>(ILjb/j0;ILbc/m$d;IIZ)V
    .locals 4

    invoke-direct {p0, p1, p2, p3}, Lbc/m$h;-><init>(ILjb/j0;I)V

    iput-object p4, p0, Lbc/m$i;->f:Lbc/m$d;

    iget-boolean p1, p4, Lbc/m$d;->F:Z
    ...
    :goto_0
    iget-boolean p2, p4, Lbc/m$d;->E:Z
    ...
    :goto_1
    iput-boolean p2, p0, Lbc/m$i;->n:Z
    ...
    :goto_2
    iput-boolean v1, p0, Lbc/m$i;->e:Z
    ...
    :goto_5
    iput-boolean p2, p0, Lbc/m$i;->m:Z

    move p2, p3

    :goto_6
    iget-object p6, p4, Lbc/z;->l:Lcom/google/common/collect/ImmutableList;
    ...
    iget-object p6, p0, Lbc/m$h;->d:Lcom/google/android/exoplayer2/p1;

    iget-object p6, p6, Lcom/google/android/exoplayer2/p1;->l:Ljava/lang/String;

    if-eqz p6, :cond_e

    iget-object p7, p4, Lbc/z;->l:Lcom/google/common/collect/ImmutableList;
    ...
    :goto_8
    iput-boolean p2, p0, Lbc/m$i;->p:Z
    ...
    :cond_11
    iput-boolean p3, p0, Lbc/m$i;->q:Z

    iget-object p2, p0, Lbc/m$h;->d:Lcom/google/android/exoplayer2/p1;

    iget-object p2, p2, Lcom/google/android/exoplayer2/p1;->l:Ljava/lang/String;

    invoke-static {p2}, Lbc/m;->w(Ljava/lang/String;)I

    move-result p2

    iput p2, p0, Lbc/m$i;->r:I

    invoke-virtual {p0, p5, p1}, Lbc/m$i;->k(II)I

    move-result p1

    iput p1, p0, Lbc/m$i;->o:I

    return-void
.end method

.method public static synthetic d(Lbc/m$i;Lbc/m$i;)I
    .locals 0

    invoke-static {p0, p1}, Lbc/m$i;->h(Lbc/m$i;Lbc/m$i;)I
...
.method public static synthetic e(Lbc/m$i;Lbc/m$i;)I
    .locals 0

    invoke-static {p0, p1}, Lbc/m$i;->g(Lbc/m$i;Lbc/m$i;)I
...
.method public static g(Lbc/m$i;Lbc/m$i;)I
    .locals 4
    ...
    iget-boolean v1, p0, Lbc/m$i;->h:Z

    iget-boolean v2, p1, Lbc/m$i;->h:Z

    invoke-virtual {v0, v1, v2}, Lcom/google/common/collect/h2;->h(ZZ)Lcom/google/common/collect/h2;

    move-result-object v0

    iget v1, p0, Lbc/m$i;->l:I

    iget v2, p1, Lbc/m$i;->l:I

    invoke-virtual {v0, v1, v2}, Lcom/google/common/collect/h2;->d(II)Lcom/google/common/collect/h2;

    move-result-object v0

    iget-boolean v1, p0, Lbc/m$i;->m:Z

    iget-boolean v2, p1, Lbc/m$i;->m:Z

    invoke-virtual {v0, v1, v2}, Lcom/google/common/collect/h2;->h(ZZ)Lcom/google/common/collect/h2;

    move-result-object v0

    iget-boolean v1, p0, Lbc/m$i;->e:Z

    iget-boolean v2, p1, Lbc/m$i;->e:Z

    invoke-virtual {v0, v1, v2}, Lcom/google/common/collect/h2;->h(ZZ)Lcom/google/common/collect/h2;

    move-result-object v0

    iget-boolean v1, p0, Lbc/m$i;->g:Z

    iget-boolean v2, p1, Lbc/m$i;->g:Z

    invoke-virtual {v0, v1, v2}, Lcom/google/common/collect/h2;->h(ZZ)Lcom/google/common/collect/h2;

    move-result-object v0

    iget v1, p0, Lbc/m$i;->k:I

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    iget v2, p1, Lbc/m$i;->k:I
    ...
    iget-boolean v1, p0, Lbc/m$i;->p:Z

    iget-boolean v2, p1, Lbc/m$i;->p:Z

    invoke-virtual {v0, v1, v2}, Lcom/google/common/collect/h2;->h(ZZ)Lcom/google/common/collect/h2;

    move-result-object v0

    iget-boolean v1, p0, Lbc/m$i;->q:Z

    iget-boolean v2, p1, Lbc/m$i;->q:Z
    ...
    iget p0, p0, Lbc/m$i;->r:I

    iget p1, p1, Lbc/m$i;->r:I
...
.method public static h(Lbc/m$i;Lbc/m$i;)I
    .locals 5

    iget-boolean v0, p0, Lbc/m$i;->e:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lbc/m$i;->h:Z
    ...
    iget v2, p0, Lbc/m$i;->i:I

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget v3, p1, Lbc/m$i;->i:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget-object v4, p0, Lbc/m$i;->f:Lbc/m$d;
    ...
    iget v2, p0, Lbc/m$i;->j:I

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget v3, p1, Lbc/m$i;->j:I
    ...
    iget p0, p0, Lbc/m$i;->i:I

    invoke-static {p0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p0

    iget p1, p1, Lbc/m$i;->i:I
...
.method public static i(Ljava/util/List;Ljava/util/List;)I
    ...
    invoke-direct {v1}, Lbc/q;-><init>()V

    invoke-static {p0, v1}, Ljava/util/Collections;->max(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lbc/m$i;
...
.method public static j(ILjb/j0;Lbc/m$d;[II)Lcom/google/common/collect/ImmutableList;
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iget v0, v9, Lbc/z;->i:I

    iget v1, v9, Lbc/z;->j:I

    iget-boolean v2, v9, Lbc/z;->k:Z

    invoke-static {v8, v0, v1, v2}, Lbc/m;->u(Ljb/j0;IIZ)I
    ...
    :goto_0
    iget v0, v8, Ljb/j0;->a:I

    if-ge v13, v0, :cond_2

    invoke-virtual {v8, v13}, Ljb/j0;->c(I)Lcom/google/android/exoplayer2/p1;
    ...
    invoke-direct/range {v0 .. v7}, Lbc/m$i;-><init>(ILjb/j0;ILbc/m$d;IIZ)V
...
.method public bridge synthetic b(Lbc/m$h;)Z
    ...
    invoke-virtual {p0, p1}, Lbc/m$i;->l(Lbc/m$i;)Z
...
.method public final k(II)I
    ...
    :cond_0
    iget-object v0, p0, Lbc/m$i;->f:Lbc/m$d;
    ...
    iget-boolean v0, v0, Lbc/m$d;->D:Z
    ...
    iget-boolean v0, p0, Lbc/m$i;->g:Z
    ...
    iget-boolean v1, v0, Lbc/z;->x:Z

    if-nez v1, :cond_3

    iget-boolean v0, v0, Lbc/z;->w:Z
...
.method public l(Lbc/m$i;)Z
    .locals 2

    iget-boolean v0, p0, Lbc/m$i;->n:Z
    ...
    iget-boolean v0, v0, Lbc/m$d;->G:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lbc/m$i;->p:Z

    iget-boolean v1, p1, Lbc/m$i;->p:Z

    if-ne v0, v1, :cond_1

    iget-boolean v0, p0, Lbc/m$i;->q:Z

    iget-boolean p1, p1, Lbc/m$i;->q:Z
