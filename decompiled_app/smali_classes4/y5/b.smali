...
.method public f(Lx5/a;Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lx5/b;->l()J

    move-result-wide v4

    invoke-interface {v1, v3}, Lx5/b;->b0(I)V
    ...
    iget-object v5, p1, Lx5/a;->f:Lx5/b;

    invoke-interface {v5}, Lx5/b;->D0()Ljava/util/Locale;
    ...
    iget-object v8, p1, Lx5/a;->f:Lx5/b;

    invoke-interface {v8}, Lx5/b;->D0()Ljava/util/Locale;
    ...
    invoke-interface {v5}, Lx5/b;->n0()Ljava/util/TimeZone;
    ...
    invoke-interface {v0}, Lx5/b;->D0()Ljava/util/Locale;
    ...
    :cond_5
    :goto_2
    iget-object p5, p1, Lx5/a;->f:Lx5/b;

    invoke-interface {p5}, Lx5/b;->n0()Ljava/util/TimeZone;
    ...
    invoke-interface {v1, p4}, Lx5/b;->n(Lcom/alibaba/fastjson/parser/Feature;)Z
    ...
    invoke-direct {p4, v2}, Lx5/e;-><init>(Ljava/lang/String;)V

    invoke-virtual {p4}, Lx5/e;->w1()Z

    move-result p5

    if-eqz p5, :cond_9

    invoke-virtual {p4}, Lx5/c;->J0()Ljava/util/Calendar;
    ...
    :cond_9
    invoke-virtual {p4}, Lx5/c;->close()V
    ...
    invoke-virtual {p1, v2}, Lx5/a;->b(I)V
    ...
    invoke-interface {v1}, Lx5/b;->r()I

    move-result v2

    invoke-virtual {p5, p4, v6, v2}, Lx5/h;->j(Ljava/lang/String;Ljava/lang/Class;I)Ljava/lang/Class;
    ...
    :cond_e
    invoke-virtual {p1, v5}, Lx5/a;->b(I)V

    invoke-virtual {p1, v3}, Lx5/a;->b(I)V

    :cond_f
    invoke-interface {v1, v4}, Lx5/b;->q(I)V
    ...
    invoke-virtual {p1, v0}, Lx5/a;->b(I)V
    ...
    invoke-virtual {p1, p4}, Lx5/a;->H0(I)V
    ...
    :goto_5
    invoke-virtual {p0, p1, p2, p3, p4}, Ly5/b;->g(Lx5/a;Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public abstract g(Lx5/a;Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
