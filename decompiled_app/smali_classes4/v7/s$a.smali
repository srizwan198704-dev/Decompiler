...
.method public static a(Lv7/y;Lv7/z;)V
    .locals 14
    ...
    invoke-virtual {p1}, Lv7/z;->getLayerId()J
    ...
    invoke-static {v0, v2, v1, v4}, Landroidx/room/util/b;->g(Landroidx/room/RoomDatabase;Ls4/g;ZLandroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    :goto_1
    new-instance v4, Lv7/z;

    move-object v8, v4

    invoke-direct/range {v8 .. v13}, Lv7/z;-><init>(JJLjava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {p1}, Lv7/z;->getRequestTime()J
    ...
    iget-object p1, p0, Lv7/y;->e:Lv7/x;

    invoke-virtual {p1}, Landroidx/room/l0;->b()Ls4/h;
    ...
    iget-object p0, p0, Lv7/y;->e:Lv7/x;

    invoke-virtual {p0, p1}, Landroidx/room/l0;->h(Ls4/h;)V
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lv7/y;->a(Lv7/z;)J
...
.method public static b(Lv7/y;Lv7/z;)J
    .locals 5
    ...
    :try_start_0
    iget-object v0, p0, Lv7/y;->b:Lv7/t;
    ...
    invoke-static {p1, v2}, Landroidx/room/i0;->b(Ljava/lang/String;I)Landroidx/room/i0;

    move-result-object p1

    iget-object v3, p0, Lv7/y;->a:Lcom/cloud/hisavana/abtestkit/db/ABRoomDatabase_Impl;
    ...
    invoke-static {v3, p1, v2, v4}, Landroidx/room/util/b;->g(Landroidx/room/RoomDatabase;Ls4/g;ZLandroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    iget-object p1, p0, Lv7/y;->c:Lv7/v;
    ...
    invoke-interface {p1, v4, v2, v3}, Ls4/f;->c(IJ)V
    ...
    iget-object p0, p0, Lv7/y;->c:Lv7/v;
    ...
    iget-object p0, p0, Lv7/y;->a:Lcom/cloud/hisavana/abtestkit/db/ABRoomDatabase_Impl;
