...
.method public static b(J)V
    ...
    sget-object v2, Lv7/l;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_0
    invoke-virtual {v2, v0, v1}, Lv7/z;->setRequestTime(J)V
    ...
    invoke-virtual {v2, p0, p1}, Lv7/z;->setLayerId(J)V

    invoke-virtual {v2, v0, v1}, Lv7/z;->setRequestTime(J)V

    sget-object v3, Lv7/l;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v4, Lv7/l;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v3, p0, p1, v0, v1}, Lv7/d;-><init>(JJ)V
...
.method public static final c(JJ)V
    ...
    invoke-direct/range {v1 .. v8}, Lv7/z;-><init>(JJLjava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-virtual {v9, p0, p1}, Lv7/z;->setLayerId(J)V

    invoke-virtual {v9, p2, p3}, Lv7/z;->setRequestTime(J)V
...
.method public static d(Lcom/cloud/hisavana/abtestkit/OnInitCompleteListener;)V
    ...
    invoke-virtual {v9, v10, v11}, Lv7/z;->setLayerId(J)V
    ...
    :goto_2
    invoke-virtual {v9, v10, v11}, Lv7/z;->setRequestTime(J)V
    ...
    invoke-virtual {v9, v10}, Lv7/z;->setInfo(Ljava/lang/String;)V
    ...
    :cond_8
    :goto_6
    sget-object v0, Lv7/l;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v2, Lv7/l;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v2, v4}, Ll8/a;->f(Ljava/lang/String;)I
    ...
    :cond_d
    :goto_a
    sget-object v0, Lv7/l;->b:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_e
    sput-object v3, Lv7/l;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static e(Lcom/cloud/hisavana/abtestkit/bean/OnlineABLayerDTO;)V
    ...
    invoke-virtual {p0}, Lv7/z;->getLayerId()J
    ...
    invoke-direct {v1, p0}, Lv7/c;-><init>(Lcom/cloud/hisavana/abtestkit/bean/OnlineABLayerDTO;)V
...
.method public static g(Lcom/cloud/hisavana/abtestkit/OnInitCompleteListener;)V
    ...
    invoke-direct {v1, p0}, Lv7/b;-><init>(Lcom/cloud/hisavana/abtestkit/OnInitCompleteListener;)V
    ...
    :cond_1
    invoke-static {p0}, Lv7/e;->d(Lcom/cloud/hisavana/abtestkit/OnInitCompleteListener;)V
...
.method public static final h(Lcom/cloud/hisavana/abtestkit/bean/OnlineABLayerDTO;)V
    ...
    invoke-direct/range {v2 .. v9}, Lv7/z;-><init>(JJLjava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-virtual {v10, v0, v1}, Lv7/z;->setLayerId(J)V

    invoke-virtual {p0}, Lv7/z;->getRequestTime()J

    move-result-wide v0

    invoke-virtual {v10, v0, v1}, Lv7/z;->setRequestTime(J)V

    invoke-virtual {p0}, Lv7/z;->getInfo()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v10, p0}, Lv7/z;->setInfo(Ljava/lang/String;)V
