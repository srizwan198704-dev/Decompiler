...
.method public static synthetic a(Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;Ljava/lang/String;Landroid/webkit/ValueCallback;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->m(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
...
.method public static synthetic b(Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->l(Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic c(Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;Ljava/lang/String;II)Ljava/lang/String;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->d(Ljava/lang/String;II)Ljava/lang/String;
...
.method public static synthetic e(Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;Ljava/lang/String;Landroid/webkit/ValueCallback;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->g(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
...
.method public final f(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Ljava/lang/String;Z)V
    .locals 1
...
.method public final g(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Ld8/d;-><init>(Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;Ljava/lang/String;Landroid/webkit/ValueCallback;)V
...
.method public getAppVersionCode()Ljava/lang/String;
    ...
    :cond_0
    invoke-static {}, Lk8/c;->p()Ljava/lang/String;
...
.method public getAppVersionName()Ljava/lang/String;
    ...
    :cond_0
    invoke-static {}, Lk8/c;->q()Ljava/lang/String;
...
.method public getPsVersion()J
    ...
    invoke-static {v0}, Le8/f0;->c(Landroid/content/Context;)Landroid/content/pm/PackageInfo;
...
.method public final h(Landroid/content/Context;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Z
    .locals 8
    ...
    invoke-static {p2}, Lcom/cloud/hisavana/sdk/J0;->R(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Z
    ...
    invoke-static {p1, v5, v7}, Lcom/cloud/hisavana/sdk/J0;->x(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-static {p1, p2, v4, v0}, Lcom/cloud/hisavana/sdk/J0;->u(Landroid/content/Context;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, p2, v4, v6}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->f(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Ljava/lang/String;Z)V

    invoke-virtual {p0, p2}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->k(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V
    ...
    invoke-static {p1, p2, v4}, Lcom/cloud/hisavana/sdk/J0;->s(Landroid/content/Context;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Ljava/lang/String;)Z
    ...
    :cond_7
    invoke-virtual {p0, v4}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->j(Ljava/lang/String;)Z
    ...
    invoke-static {p1, v4, v5}, Lcom/cloud/hisavana/sdk/J0;->H(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_8
    invoke-static {p1, v4, v2}, Lcom/cloud/hisavana/sdk/J0;->H(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_9
    invoke-virtual {p0, p2, v2, v0}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->f(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Ljava/lang/String;Z)V
...
.method public handleAdClick(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, p1}, Ld8/e;-><init>(Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;Ljava/lang/String;)V
...
.method public final i(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Z
    .locals 5
    ...
    invoke-static {v0, p1, v2, v3}, Lcom/cloud/hisavana/sdk/J0;->t(Landroid/content/Context;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, v3, v4}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->f(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Ljava/lang/String;Z)V
    ...
    invoke-static {v0, v2}, Lcom/cloud/hisavana/sdk/J0;->T(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :cond_6
    invoke-virtual {p0, v0, p1}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->h(Landroid/content/Context;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Z
...
.method public final synthetic l(Ljava/lang/String;)V
    ...
    invoke-static {v1, p1, v9, v2}, Lcom/cloud/hisavana/sdk/J0;->b(Landroid/content/Context;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Lcom/cloud/hisavana/sdk/common/tracking/DownUpPointBean;Z)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final synthetic m(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
    .locals 2
...
.method public openPsDetail(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p2}, Lcom/cloud/hisavana/sdk/J0;->E(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Lcom/cloud/hisavana/sdk/common/bean/PslinkInfo;
    ...
    invoke-virtual {p0, p2}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->i(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Z
...
.method public shouldInterceptRequest(Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    ...
    invoke-static {v2}, Ld8/b;->a(Ljava/io/File;)Ljava/nio/file/Path;

    move-result-object v2

    new-array v4, v6, [Ljava/nio/file/OpenOption;

    invoke-static {v2, v4}, Ld8/c;->a(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/InputStream;
...
.method public showAdmAdFromJs(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p4, v1, p1}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->d(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1, v3}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->g(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
    ...
    invoke-virtual {p5, v2, v0}, Lcom/cloud/sdk/commonutil/util/c;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p5}, Lcom/cloud/hisavana/sdk/J0;->E(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)Lcom/cloud/hisavana/sdk/common/bean/PslinkInfo;
    ...
    new-instance p3, Lcom/cloud/hisavana/sdk/o3$b;

    invoke-direct {p3}, Lcom/cloud/hisavana/sdk/o3$b;-><init>()V

    invoke-virtual {p5}, Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;->getCodeSeatId()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p3, v0}, Lcom/cloud/hisavana/sdk/o3$b;->e(Ljava/lang/String;)Lcom/cloud/hisavana/sdk/o3$b;

    move-result-object p3

    invoke-virtual {p3}, Lcom/cloud/hisavana/sdk/o3$b;->g()Lcom/cloud/hisavana/sdk/o3;

    move-result-object p3

    new-instance v0, Lcom/cloud/hisavana/sdk/u2;

    invoke-direct {v0, p3}, Lcom/cloud/hisavana/sdk/u2;-><init>(Lcom/cloud/hisavana/sdk/o3;)V

    new-instance p3, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge$a;

    invoke-direct {p3, v0, p0, p5}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge$a;-><init>(Lcom/cloud/hisavana/sdk/u2;Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V

    invoke-virtual {v0, p3}, Lcom/cloud/hisavana/sdk/F;->g(Lcom/cloud/hisavana/sdk/api/listener/AdCallback;)V

    invoke-virtual {p0, p4, p1, p2}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->d(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1, v3}, Lcom/cloud/hisavana/sdk/bridge/HisavanaAdJsBridge;->g(Ljava/lang/String;Landroid/webkit/ValueCallback;)V

    invoke-virtual {v0, p5}, Lcom/cloud/hisavana/sdk/u2;->H(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V
...
.method public trackAdShow(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/cloud/hisavana/sdk/p2;->a(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V
    ...
    invoke-static {v3, p1, v2}, Lcom/cloud/hisavana/sdk/Y0;->o(Ljava/util/List;Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;Lcom/cloud/hisavana/sdk/common/tracking/DownUpPointBean;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/cloud/hisavana/sdk/Y;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lcom/cloud/hisavana/sdk/r;->q(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V

    goto :goto_0

    :cond_3
    sget-object v1, Lcom/cloud/hisavana/sdk/l0;->a:Lcom/cloud/hisavana/sdk/l0;

    invoke-virtual {v1, p1}, Lcom/cloud/hisavana/sdk/l0;->a(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V
    ...
    invoke-static {p1}, Lcom/cloud/hisavana/sdk/p2;->b(Lcom/cloud/hisavana/sdk/data/bean/response/AdsDTO;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
