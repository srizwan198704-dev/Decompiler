...
.method public final containsValue(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, p1}, Ll/᩹۠ۧ;->ۖ(F)Z
...
.method public final entrySet()Ljava/util/Set;
    ...
    invoke-virtual {v0}, Ll/᩹۠ۧ;->᩺᩷()Ll/ܶ᩶ۧ;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Ll/᩹۠ۧ;

    .line 601
    iget v3, v2, Ll/᩹۠ۧ;->۟᩷:I
    ...
    .line 388
    :cond_2
    invoke-virtual {v2}, Ll/᩹۠ۧ;->᩺᩷()Ll/ܶ᩶ۧ;
...
.method public final forEach(Ljava/util/function/BiConsumer;)V
    ...
    invoke-direct {v1, p1}, Ll/ۨۨۧ;-><init>(Ljava/util/function/BiConsumer;)V

    if-eqz v0, :cond_0

    .line 263
    check-cast v0, Ll/֨ۨۧ;

    invoke-interface {v0, v1}, Ll/֨ۨۧ;->᩷(Ljava/util/function/Consumer;)V
...
.method public putAll(Ljava/util/Map;)V
    ...
    .line 350
    instance-of v0, p1, Ll/ۢۨۧ;

    if-eqz v0, :cond_1

    .line 351
    check-cast p1, Ll/ۢۨۧ;

    .line 49
    invoke-interface {p1}, Ll/ۢۨۧ;->᩺᩷()Ll/ܶ᩶ۧ;

    move-result-object p1

    .line 50
    instance-of v0, p1, Ll/֨ۨۧ;

    if-eqz v0, :cond_0

    check-cast p1, Ll/֨ۨۧ;

    invoke-interface {p1}, Ll/֨ۨۧ;->᩷()Ll/ۚܽۧ;
    ...
    check-cast v0, Ll/۠ۨۧ;

    .line 354
    invoke-interface {v0}, Ll/۠ۨۧ;->᩷()I

    move-result v1

    invoke-interface {v0}, Ll/۠ۨۧ;->֡()F

    move-result v0

    invoke-virtual {p0, v0, v1}, Ll/ۛ᩸ۧ;->᩷(FI)F
    ...
    .line 164
    invoke-static {p0, v2, v0}, Ll/ۗۨۧ;->᩷(Ll/ۛ᩸ۧ;Ljava/lang/Integer;Ljava/lang/Float;)Ljava/lang/Float;
...
.method public final toString()Ljava/lang/String;
    ...
    check-cast v2, Ll/֨ۨۧ;

    invoke-interface {v2}, Ll/֨ۨۧ;->᩷()Ll/ۚܽۧ;
    ...
    :cond_0
    check-cast v2, Ll/ᩴۨۧ;

    invoke-virtual {v2}, Ll/ᩴۨۧ;->iterator()Ll/ۚܽۧ;
    ...
    check-cast v1, Ll/۠ۨۧ;

    .line 403
    invoke-interface {v1}, Ll/۠ۨۧ;->᩷()I
    ...
    .line 405
    invoke-interface {v1}, Ll/۠ۨۧ;->֡()F
