.class public final synthetic Ll/᩶᩹ۡ;
...
.method public static $default$replaceAll(Ljava/util/concurrent/ConcurrentMap;Ljava/util/function/BiFunction;)V
    ...
    .line 0
    instance-of p1, p0, Ll/ۤ᩹ۡ;

    if-eqz p1, :cond_0

    check-cast p0, Ll/ۤ᩹ۡ;

    invoke-interface {p0, v0}, Ll/ۤ᩹ۡ;->forEach(Ljava/util/function/BiConsumer;)V

    return-void

    :cond_0
    invoke-static {p0, v0}, Ll/᩶᩹ۡ;->$default$forEach(Ljava/util/concurrent/ConcurrentMap;Ljava/util/function/BiConsumer;)V
