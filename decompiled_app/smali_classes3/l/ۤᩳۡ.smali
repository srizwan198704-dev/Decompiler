.class public final synthetic Ll/ۤᩳۡ;
...
# instance fields
.field public final synthetic a:Ll/۟ۗۡ;


# direct methods
.method public synthetic constructor <init>(Ll/۟ۗۡ;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll/ۤᩳۡ;->a:Ll/۟ۗۡ;

    return-void
.end method

.method public static synthetic b(Ll/۟ۗۡ;)Ljava/util/stream/LongStream;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/֫ᩳۡ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/֫ᩳۡ;

    iget-object p0, p0, Ll/֫ᩳۡ;->a:Ljava/util/stream/LongStream;

    return-object p0

    :cond_1
    new-instance v0, Ll/ۤᩳۡ;

    invoke-direct {v0, p0}, Ll/ۤᩳۡ;-><init>(Ll/۟ۗۡ;)V
...
.method public final synthetic allMatch(Ljava/util/function/LongPredicate;)Z
    ...
    iget-object v0, p0, Ll/ۤᩳۡ;->a:Ll/۟ۗۡ;

    invoke-interface {v0, p1}, Ll/۟ۗۡ;->allMatch(Ljava/util/function/LongPredicate;)Z
...
.method public final synthetic anyMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->anyMatch(Ljava/util/function/LongPredicate;)Z
...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->asDoubleStream()Ll/᩺ۘۡ;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->average()Ll/֫ܶۡ;
...
.method public final synthetic boxed()Ljava/util/stream/Stream;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->boxed()Ll/ۙۧۡ;
...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/ObjLongConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Ll/۟ۗۡ;->collect(Ljava/util/function/Supplier;Ljava/util/function/ObjLongConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic count()J
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->count()J
...
.method public final synthetic distinct()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->distinct()Ll/۟ۗۡ;
...
.method public final synthetic dropWhile(Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->dropWhile(Ljava/util/function/LongPredicate;)Ll/۟ۗۡ;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/ۤᩳۡ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۤᩳۡ;

    iget-object p1, p1, Ll/ۤᩳۡ;->a:Ll/۟ۗۡ;
...
.method public final synthetic filter(Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->filter(Ljava/util/function/LongPredicate;)Ll/۟ۗۡ;
...
.method public final synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->findAny()Ll/ܿܶۡ;

    move-result-object v0

    invoke-static {v0}, Ll/ۚ᩶ۧ;->D(Ll/ܿܶۡ;)Ljava/util/OptionalLong;
...
.method public final synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->findFirst()Ll/ܿܶۡ;
...
.method public final flatMap(Ljava/util/function/LongFunction;)Ljava/util/stream/LongStream;
    ...
    .line 0
    invoke-interface {v0, v1}, Ll/۟ۗۡ;->a(Ll/ܺ۫ۧ;)Ll/۟ۗۡ;
...
.method public final synthetic forEach(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->forEach(Ljava/util/function/LongConsumer;)V
...
.method public final synthetic forEachOrdered(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->forEachOrdered(Ljava/util/function/LongConsumer;)V
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->iterator()Ll/ۙ᩹ۡ;
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Ll/ܶ۟ۡ;

    if-eqz v1, :cond_1

    check-cast v0, Ll/ܶ۟ۡ;

    iget-object v0, v0, Ll/ܶ۟ۡ;->a:Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-direct {v1, v0}, Ll/ۨ۟ۡ;-><init>(Ll/ۙ᩹ۡ;)V
...
.method public final synthetic limit(J)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1, p2}, Ll/۟ۗۡ;->limit(J)Ll/۟ۗۡ;
...
.method public final synthetic map(Ljava/util/function/LongUnaryOperator;)Ljava/util/stream/LongStream;
    ...
    iget-object p1, p0, Ll/ۤᩳۡ;->a:Ll/۟ۗۡ;

    invoke-interface {p1}, Ll/۟ۗۡ;->l()Ll/۟ۗۡ;
...
.method public final synthetic mapToDouble(Ljava/util/function/LongToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Ll/۟ۗۡ;->c()Ll/᩺ۘۡ;
...
.method public final synthetic mapToInt(Ljava/util/function/LongToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {p1}, Ll/۟ۗۡ;->p()Ll/۠ۜۡ;
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->mapToObj(Ljava/util/function/LongFunction;)Ll/ۙۧۡ;
...
.method public final synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->max()Ll/ܿܶۡ;
...
.method public final synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->min()Ll/ܿܶۡ;
...
.method public final synthetic noneMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->noneMatch(Ljava/util/function/LongPredicate;)Z
...
.method public final synthetic parallel()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->parallel()Ll/۟ۗۡ;
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->peek(Ljava/util/function/LongConsumer;)Ll/۟ۗۡ;
...
.method public final synthetic reduce(JLjava/util/function/LongBinaryOperator;)J
    ...
    invoke-interface {v0, p1, p2, p3}, Ll/۟ۗۡ;->reduce(JLjava/util/function/LongBinaryOperator;)J
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->reduce(Ljava/util/function/LongBinaryOperator;)Ll/ܿܶۡ;

    move-result-object p1

    invoke-static {p1}, Ll/ۚ᩶ۧ;->D(Ll/ܿܶۡ;)Ljava/util/OptionalLong;
...
.method public final synthetic sequential()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->sequential()Ll/۟ۗۡ;
...
.method public final synthetic skip(J)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1, p2}, Ll/۟ۗۡ;->skip(J)Ll/۟ۗۡ;
...
.method public final synthetic sorted()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->sorted()Ll/۟ۗۡ;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfLong;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->spliterator()Ll/ۧ᩹ۡ;
...
.method public final synthetic sum()J
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->sum()J
...
.method public final summaryStatistics()Ljava/util/LongSummaryStatistics;
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->summaryStatistics()Ll/ܰܶۡ;
...
.method public final synthetic takeWhile(Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Ll/۟ۗۡ;->takeWhile(Ljava/util/function/LongPredicate;)Ll/۟ۗۡ;
...
.method public final synthetic toArray()[J
    ...
    invoke-interface {v0}, Ll/۟ۗۡ;->toArray()[J
