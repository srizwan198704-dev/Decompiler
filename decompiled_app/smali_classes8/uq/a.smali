...
.method public static b(Landroid/content/Context;Lcom/transsion/player/exo/ORExoDecoderType;)Landroidx/media3/exoplayer/b4;
    ...
    invoke-direct {v0, p0, p1}, Luq/g;-><init>(Landroid/content/Context;Lcom/transsion/player/exo/ORExoDecoderType;)V
...
.method public static declared-synchronized c(Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v1, Luq/a;->f:Landroidx/media3/exoplayer/offline/DownloadManager;
    ...
    invoke-static {p0}, Luq/a;->f(Landroid/content/Context;)Landroidx/media3/datasource/cache/Cache;
    ...
    invoke-static {p0}, Luq/a;->j(Landroid/content/Context;)Landroidx/media3/datasource/a$a;
    ...
    invoke-static {p0}, Luq/a;->e(Landroid/content/Context;)Li2/a;

    move-result-object v4

    invoke-direct {v3, v4}, Landroidx/media3/exoplayer/offline/a;-><init>(Li2/a;)V
    ...
    sput-object v2, Luq/a;->f:Landroidx/media3/exoplayer/offline/DownloadManager;
...
.method public static declared-synchronized d(Landroid/content/Context;)Landroidx/media3/datasource/a$a;
    ...
    :try_start_0
    sget-object v1, Luq/a;->a:Landroidx/media3/datasource/a$a;
    ...
    invoke-static {v1, p0}, Luq/a;->a(Landroidx/media3/datasource/a$a;Landroidx/media3/datasource/cache/Cache;)Landroidx/media3/datasource/cache/a$c;

    move-result-object p0

    sput-object p0, Luq/a;->a:Landroidx/media3/datasource/a$a;
    ...
    :cond_0
    :goto_0
    sget-object p0, Luq/a;->a:Landroidx/media3/datasource/a$a;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized e(Landroid/content/Context;)Li2/a;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Luq/a;->c:Li2/a;

    if-nez v1, :cond_0

    new-instance v1, Li2/b;

    invoke-direct {v1, p0}, Li2/b;-><init>(Landroid/content/Context;)V

    sput-object v1, Luq/a;->c:Li2/a;
...
.method public static declared-synchronized f(Landroid/content/Context;)Landroidx/media3/datasource/cache/Cache;
    ...
    :try_start_0
    sget-object v1, Luq/a;->e:Landroidx/media3/datasource/cache/Cache;

    if-nez v1, :cond_0

    new-instance v1, Ljava/io/File;

    invoke-static {p0}, Luq/a;->g(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-direct {v2, v1, v3, p0}, Landroidx/media3/datasource/cache/SimpleCache;-><init>(Ljava/io/File;Landroidx/media3/datasource/cache/b;Li2/a;)V

    sput-object v2, Luq/a;->e:Landroidx/media3/datasource/cache/Cache;
    ...
    :cond_0
    :goto_0
    sget-object p0, Luq/a;->e:Landroidx/media3/datasource/cache/Cache;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized g(Landroid/content/Context;)Ljava/io/File;
    ...
    :try_start_0
    sget-object v1, Luq/a;->d:Ljava/io/File;
    ...
    sput-object v1, Luq/a;->d:Ljava/io/File;
    ...
    sput-object p0, Luq/a;->d:Ljava/io/File;
    ...
    :cond_0
    :goto_0
    sget-object p0, Luq/a;->d:Ljava/io/File;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized h(Landroid/content/Context;)Landroidx/media3/exoplayer/offline/DownloadManager;
    ...
    :try_start_0
    invoke-static {p0}, Luq/a;->c(Landroid/content/Context;)V

    sget-object p0, Luq/a;->f:Landroidx/media3/exoplayer/offline/DownloadManager;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized i(Landroid/content/Context;)Landroidx/media3/exoplayer/offline/k;
    ...
    :try_start_0
    sget-object v1, Luq/a;->g:Landroidx/media3/exoplayer/offline/k;
    ...
    sput-object v1, Luq/a;->g:Landroidx/media3/exoplayer/offline/k;
    ...
    :cond_0
    :goto_0
    sget-object p0, Luq/a;->g:Landroidx/media3/exoplayer/offline/k;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized j(Landroid/content/Context;)Landroidx/media3/datasource/a$a;
    ...
    :try_start_0
    sget-object v1, Luq/a;->b:Landroidx/media3/datasource/a$a;
    ...
    sput-object v1, Luq/a;->b:Landroidx/media3/datasource/a$a;
    ...
    :cond_0
    :goto_0
    sget-object p0, Luq/a;->b:Landroidx/media3/datasource/a$a;
    ...
    sput-object p0, Luq/a;->b:Landroidx/media3/datasource/a$a;
