.class public Lil/j$c;
.super Landroidx/room/e;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lil/j;-><init>(Landroidx/room/RoomDatabase;)V
.end annotation
...
.method public constructor <init>(Lil/j;)V
    ...
    iput-object p1, p0, Lil/j$c;->a:Lil/j;
...
.method public bridge synthetic a(Lr4/e;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lil/j$c;->d(Lr4/e;Lcom/transsion/baselib/db/audio/AudioBean;)V
...
.method public b()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `audio` SET `audioId` = ?,`cover` = ?,`duration` = ?,`size` = ?,`url` = ?,`title` = ?,`desc` = ?,`bitrate` = ?,`updateTimeStamp` = ?,`readProcess` = ?,`localPath` = ?,`ops` = ?,`resourceId` = ?,`postId` = ?,`subjectId` = ?,`groupId` = ?,`status` = ?,`subjectTitle` = ?,`se` = ?,`ep` = ? WHERE `audioId` = ?"

    return-object v0
.end method

.method public d(Lr4/e;Lcom/transsion/baselib/db/audio/AudioBean;)V
    .locals 4
    .param p1    # Lr4/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Lcom/transsion/baselib/db/audio/AudioBean;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
