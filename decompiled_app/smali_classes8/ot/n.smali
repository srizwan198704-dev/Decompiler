...
.method public constructor <init>(Landroidx/core/widget/NestedScrollView;Lcom/transsion/search_pugc/ad/SearchHotAdContainerView;Landroidx/constraintlayout/widget/ConstraintLayout;Landroidx/recyclerview/widget/RecyclerView;Landroidx/appcompat/widget/AppCompatImageView;Landroidx/constraintlayout/widget/ConstraintLayout;Landroidx/cardview/widget/CardView;Landroid/widget/ProgressBar;Landroidx/constraintlayout/widget/ConstraintLayout;Landroidx/recyclerview/widget/RecyclerView;Landroidx/constraintlayout/widget/ConstraintLayout;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/view/View;Lnet/lucode/hackware/magicindicator/MagicIndicator;Landroid/widget/ImageView;Landroid/widget/RelativeLayout;Landroidx/viewpager2/widget/ViewPager2;Landroidx/core/widget/NestedScrollView;Landroid/widget/TextView;Landroid/widget/TextView;)V
    ...
    .param p14    # Landroid/view/View;
        ...
        .end annotation
    .end param
    .param p15    # Lnet/lucode/hackware/magicindicator/MagicIndicator;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .param p17    # Landroid/widget/RelativeLayout;
        ...
        .end annotation
    .end param
    .param p18    # Landroidx/viewpager2/widget/ViewPager2;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    iput-object v1, v0, Lot/n;->a:Landroidx/core/widget/NestedScrollView;

    move-object v1, p2

    iput-object v1, v0, Lot/n;->b:Lcom/transsion/search_pugc/ad/SearchHotAdContainerView;

    move-object v1, p3

    iput-object v1, v0, Lot/n;->c:Landroidx/constraintlayout/widget/ConstraintLayout;

    move-object v1, p4

    iput-object v1, v0, Lot/n;->d:Landroidx/recyclerview/widget/RecyclerView;

    move-object v1, p5

    iput-object v1, v0, Lot/n;->e:Landroidx/appcompat/widget/AppCompatImageView;

    move-object v1, p6

    iput-object v1, v0, Lot/n;->f:Landroidx/constraintlayout/widget/ConstraintLayout;

    move-object v1, p7

    iput-object v1, v0, Lot/n;->g:Landroidx/cardview/widget/CardView;

    move-object v1, p8

    iput-object v1, v0, Lot/n;->h:Landroid/widget/ProgressBar;

    move-object v1, p9

    iput-object v1, v0, Lot/n;->i:Landroidx/constraintlayout/widget/ConstraintLayout;

    move-object v1, p10

    iput-object v1, v0, Lot/n;->j:Landroidx/recyclerview/widget/RecyclerView;

    move-object v1, p11

    iput-object v1, v0, Lot/n;->k:Landroidx/constraintlayout/widget/ConstraintLayout;

    move-object v1, p12

    iput-object v1, v0, Lot/n;->l:Landroid/widget/ImageView;

    move-object v1, p13

    iput-object v1, v0, Lot/n;->m:Landroid/widget/TextView;

    move-object/from16 v1, p14

    iput-object v1, v0, Lot/n;->n:Landroid/view/View;

    move-object/from16 v1, p15

    iput-object v1, v0, Lot/n;->o:Lnet/lucode/hackware/magicindicator/MagicIndicator;

    move-object/from16 v1, p16

    iput-object v1, v0, Lot/n;->p:Landroid/widget/ImageView;

    move-object/from16 v1, p17

    iput-object v1, v0, Lot/n;->q:Landroid/widget/RelativeLayout;

    move-object/from16 v1, p18

    iput-object v1, v0, Lot/n;->r:Landroidx/viewpager2/widget/ViewPager2;

    move-object/from16 v1, p19

    iput-object v1, v0, Lot/n;->s:Landroidx/core/widget/NestedScrollView;

    move-object/from16 v1, p20

    iput-object v1, v0, Lot/n;->t:Landroid/widget/TextView;

    move-object/from16 v1, p21

    iput-object v1, v0, Lot/n;->u:Landroid/widget/TextView;

    return-void
.end method

.method public static a(Landroid/view/View;)Lot/n;
    .locals 25
    ...
    invoke-direct/range {v3 .. v24}, Lot/n;-><init>(Landroidx/core/widget/NestedScrollView;Lcom/transsion/search_pugc/ad/SearchHotAdContainerView;Landroidx/constraintlayout/widget/ConstraintLayout;Landroidx/recyclerview/widget/RecyclerView;Landroidx/appcompat/widget/AppCompatImageView;Landroidx/constraintlayout/widget/ConstraintLayout;Landroidx/cardview/widget/CardView;Landroid/widget/ProgressBar;Landroidx/constraintlayout/widget/ConstraintLayout;Landroidx/recyclerview/widget/RecyclerView;Landroidx/constraintlayout/widget/ConstraintLayout;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/view/View;Lnet/lucode/hackware/magicindicator/MagicIndicator;Landroid/widget/ImageView;Landroid/widget/RelativeLayout;Landroidx/viewpager2/widget/ViewPager2;Landroidx/core/widget/NestedScrollView;Landroid/widget/TextView;Landroid/widget/TextView;)V
...
.method public static c(Landroid/view/LayoutInflater;)Lot/n;
    .locals 2
    ...
    invoke-static {p0, v0, v1}, Lot/n;->d(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lot/n;
...
.method public static d(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lot/n;
    .locals 2
    .param p0    # Landroid/view/LayoutInflater;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_0
    invoke-static {p0}, Lot/n;->a(Landroid/view/View;)Lot/n;
...
.method public b()Landroidx/core/widget/NestedScrollView;
    ...
    iget-object v0, p0, Lot/n;->a:Landroidx/core/widget/NestedScrollView;
...
.method public bridge synthetic getRoot()Landroid/view/View;
    ...
    invoke-virtual {p0}, Lot/n;->b()Landroidx/core/widget/NestedScrollView;
