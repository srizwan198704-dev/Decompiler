...
.field public f:Lcom/transsion/version/update/RemoteVersionInfo;
...
.method public static synthetic l0(Lcom/transsion/version/update/dialog/UpdateDialog;Landroid/content/DialogInterface;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/version/update/dialog/UpdateDialog;->o0(Lcom/transsion/version/update/dialog/UpdateDialog;Landroid/content/DialogInterface;)V

    return-void
.end method

.method public static synthetic m0(Lcom/transsion/version/update/dialog/UpdateDialog;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/version/update/dialog/UpdateDialog;->p0(Lcom/transsion/version/update/dialog/UpdateDialog;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic n0(ZLcom/transsion/version/update/dialog/UpdateDialog;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/transsion/version/update/dialog/UpdateDialog;->q0(ZLcom/transsion/version/update/dialog/UpdateDialog;Landroid/view/View;)V

    return-void
.end method

.method public static final o0(Lcom/transsion/version/update/dialog/UpdateDialog;Landroid/content/DialogInterface;)V
    .locals 6
...
.method public static final p0(Lcom/transsion/version/update/dialog/UpdateDialog;Landroid/view/View;)V
    .locals 0
...
.method public static final q0(ZLcom/transsion/version/update/dialog/UpdateDialog;Landroid/view/View;)V
    .locals 0
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    :cond_0
    sget-object v3, Lfm/a;->a:Lfm/a;

    invoke-virtual {v3, p1}, Lfm/a;->a(Landroid/content/Context;)I
    ...
    :cond_1
    new-instance p1, Lj00/c;

    invoke-direct {p1, p0}, Lj00/c;-><init>(Lcom/transsion/version/update/dialog/UpdateDialog;)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Li00/a;->a(Landroid/view/View;)Li00/a;

    move-result-object p1

    iput-object p1, p0, Lcom/transsion/version/update/dialog/UpdateDialog;->c:Li00/a;
    ...
    iget-object v4, p0, Lcom/transsion/version/update/dialog/UpdateDialog;->c:Li00/a;

    if-eqz v4, :cond_7

    iget-object v4, v4, Li00/a;->k:Landroid/widget/TextView;
    ...
    iget-object v6, p0, Lcom/transsion/version/update/dialog/UpdateDialog;->g:Ljava/lang/String;
    ...
    :cond_8
    iget-object v2, p0, Lcom/transsion/version/update/dialog/UpdateDialog;->c:Li00/a;

    if-eqz v2, :cond_9

    iget-object v2, v2, Li00/a;->j:Landroid/widget/TextView;
    ...
    :cond_a
    iget-object v1, p0, Lcom/transsion/version/update/dialog/UpdateDialog;->c:Li00/a;

    if-eqz v1, :cond_b

    iget-object v1, v1, Li00/a;->g:Landroid/widget/TextView;
    ...
    :cond_d
    iget-object v0, p0, Lcom/transsion/version/update/dialog/UpdateDialog;->c:Li00/a;

    if-eqz v0, :cond_f

    iget-object v0, v0, Li00/a;->b:Landroid/widget/TextView;
    ...
    :cond_f
    iget-object p2, p0, Lcom/transsion/version/update/dialog/UpdateDialog;->c:Li00/a;

    if-eqz p2, :cond_10

    iget-object p2, p2, Li00/a;->b:Landroid/widget/TextView;

    if-eqz p2, :cond_10

    new-instance v0, Lj00/a;

    invoke-direct {v0, p0}, Lj00/a;-><init>(Lcom/transsion/version/update/dialog/UpdateDialog;)V
    ...
    iget-object p2, p2, Li00/a;->c:Landroid/widget/TextView;

    if-eqz p2, :cond_11

    new-instance v0, Lj00/b;

    invoke-direct {v0, p1, p0}, Lj00/b;-><init>(ZLcom/transsion/version/update/dialog/UpdateDialog;)V
...
.method public final s0(Lcom/transsion/version/update/RemoteVersionInfo;Z)V
    .locals 0
