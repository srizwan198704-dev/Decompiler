...
.method public static G(Lcom/transsion/transfer/androidasync/AsyncServer;Lcom/transsion/transfer/androidasync/z;Ljava/util/PriorityQueue;)V
    ...
    invoke-virtual {p1}, Lcom/transsion/transfer/androidasync/z;->h()Ljava/util/Set;
...
.method public static I(Lcom/transsion/transfer/androidasync/AsyncServer;Lcom/transsion/transfer/androidasync/z;Ljava/util/PriorityQueue;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lcom/transsion/transfer/androidasync/z;->m()I
    ...
    :try_start_2
    invoke-virtual {p1}, Lcom/transsion/transfer/androidasync/z;->k()V
    ...
    :cond_2
    invoke-virtual {p1, v2, v3}, Lcom/transsion/transfer/androidasync/z;->l(J)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0

    :cond_3
    :goto_1
    invoke-virtual {p1}, Lcom/transsion/transfer/androidasync/z;->n()Ljava/util/Set;
    ...
    invoke-virtual {p1}, Lcom/transsion/transfer/androidasync/z;->d()Ljava/nio/channels/Selector;
    ...
    invoke-virtual {v6, p0, v5}, Lcom/transsion/transfer/androidasync/AsyncNetworkSocket;->w(Lcom/transsion/transfer/androidasync/AsyncServer;Ljava/nio/channels/SelectionKey;)V

    invoke-virtual {v5, v6}, Ljava/nio/channels/SelectionKey;->attach(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-interface {v3, v6}, Lwx/f;->w(Lcom/transsion/transfer/androidasync/k;)V
    :try_end_5
    ...
    invoke-static {v4}, Lcom/transsion/transfer/androidasync/util/e;->a([Ljava/io/Closeable;)V
    ...
    invoke-virtual {v3}, Lcom/transsion/transfer/androidasync/AsyncNetworkSocket;->n()I
    ...
    invoke-virtual {v3}, Lcom/transsion/transfer/androidasync/AsyncNetworkSocket;->m()V
    ...
    invoke-virtual {v7, p0, v3}, Lcom/transsion/transfer/androidasync/AsyncNetworkSocket;->w(Lcom/transsion/transfer/androidasync/AsyncServer;Ljava/nio/channels/SelectionKey;)V
    ...
    iget-object v3, v4, Lcom/transsion/transfer/androidasync/AsyncServer$b;->g:Lwx/b;

    invoke-interface {v3, v5, v7}, Lwx/b;->a(Ljava/lang/Exception;Lcom/transsion/transfer/androidasync/k;)V
    ...
    invoke-interface {v3, v7, v5}, Lwx/b;->a(Ljava/lang/Exception;Lcom/transsion/transfer/androidasync/k;)V
...
.method public static K(Lcom/transsion/transfer/androidasync/z;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/transsion/transfer/androidasync/z;->h()Ljava/util/Set;
...
.method public static N(Lcom/transsion/transfer/androidasync/z;)V
    ...
    invoke-direct {v1, p0}, Lcom/transsion/transfer/androidasync/e;-><init>(Lcom/transsion/transfer/androidasync/z;)V
...
.method public static synthetic w(Lcom/transsion/transfer/androidasync/z;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/transsion/transfer/androidasync/z;->p()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final F()V
    ...
    :catch_1
    :try_start_4
    invoke-virtual {v0}, Lcom/transsion/transfer/androidasync/z;->d()Ljava/nio/channels/Selector;
...
.method public M(Z)V
    ...
    invoke-direct {v4, v1}, Lcom/transsion/transfer/androidasync/f;-><init>(Lcom/transsion/transfer/androidasync/z;)V
...
.method public k(Ljava/net/InetSocketAddress;Lwx/b;Lwx/h;)Lcom/transsion/transfer/androidasync/AsyncServer$b;
    .locals 8
    ...
    invoke-direct/range {v0 .. v5}, Lcom/transsion/transfer/androidasync/AsyncServer$3;-><init>(Lcom/transsion/transfer/androidasync/AsyncServer;Lcom/transsion/transfer/androidasync/AsyncServer$b;Lwx/b;Lwx/h;Ljava/net/InetSocketAddress;)V
...
.method public l(Ljava/net/InetSocketAddress;Lwx/b;)Lcom/transsion/transfer/androidasync/future/a;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lcom/transsion/transfer/androidasync/AsyncServer;->k(Ljava/net/InetSocketAddress;Lwx/b;Lwx/h;)Lcom/transsion/transfer/androidasync/AsyncServer$b;
...
.method public m(Ljava/lang/String;ILwx/b;)Lcom/transsion/transfer/androidasync/future/a;
    .locals 0
    ...
    invoke-virtual {p0, p1, p3}, Lcom/transsion/transfer/androidasync/AsyncServer;->n(Ljava/net/InetSocketAddress;Lwx/b;)Lcom/transsion/transfer/androidasync/future/a;
...
.method public n(Ljava/net/InetSocketAddress;Lwx/b;)Lcom/transsion/transfer/androidasync/future/a;
    .locals 3
    ...
    invoke-virtual {p0, p1, p2}, Lcom/transsion/transfer/androidasync/AsyncServer;->l(Ljava/net/InetSocketAddress;Lwx/b;)Lcom/transsion/transfer/androidasync/future/a;
    ...
    invoke-direct {v2, p0, p2, v0, p1}, Lcom/transsion/transfer/androidasync/AsyncServer$a;-><init>(Lcom/transsion/transfer/androidasync/AsyncServer;Lwx/b;Lcom/transsion/transfer/androidasync/future/w;Ljava/net/InetSocketAddress;)V

    invoke-interface {v1, v2}, Lcom/transsion/transfer/androidasync/future/f;->g(Lcom/transsion/transfer/androidasync/future/g;)V
...
.method public final s(Lcom/transsion/transfer/androidasync/AsyncNetworkSocket;)V
    ...
    invoke-virtual {p1}, Lcom/transsion/transfer/androidasync/AsyncNetworkSocket;->j()Lcom/transsion/transfer/androidasync/p;

    move-result-object v0

    iget-object v1, p0, Lcom/transsion/transfer/androidasync/AsyncServer;->a:Lcom/transsion/transfer/androidasync/z;

    invoke-virtual {v1}, Lcom/transsion/transfer/androidasync/z;->d()Ljava/nio/channels/Selector;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/transsion/transfer/androidasync/p;->j(Ljava/nio/channels/Selector;)Ljava/nio/channels/SelectionKey;

    move-result-object v0

    invoke-virtual {v0, p1}, Ljava/nio/channels/SelectionKey;->attach(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p1, p0, v0}, Lcom/transsion/transfer/androidasync/AsyncNetworkSocket;->w(Lcom/transsion/transfer/androidasync/AsyncServer;Ljava/nio/channels/SelectionKey;)V
...
.method public y(Ljava/net/InetAddress;ILwx/f;)Lcom/transsion/transfer/androidasync/j;
    .locals 8
    ...
    invoke-direct {v6, v0}, Lcom/transsion/transfer/androidasync/AsyncServer$d;-><init>(Lcom/transsion/transfer/androidasync/i;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/transsion/transfer/androidasync/AsyncServer$2;-><init>(Lcom/transsion/transfer/androidasync/AsyncServer;Ljava/net/InetAddress;ILwx/f;Lcom/transsion/transfer/androidasync/AsyncServer$d;)V
    ...
    check-cast p1, Lcom/transsion/transfer/androidasync/j;
