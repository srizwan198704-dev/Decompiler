...
.method public static synthetic a(Lcom/transsnet/downloader/widget/DownloadInfoExtendView;)V
    .locals 0
...
.method public static synthetic c(Lcom/transsnet/downloader/widget/DownloadInfoExtendView;Landroid/view/View;)V
    .locals 0
...
.method private final e()V
    ...
    iget-object v0, p0, Lcom/transsnet/downloader/widget/DownloadInfoExtendView;->b:Lu10/d1;

    if-eqz v0, :cond_1

    iget-object v0, v0, Lu10/d1;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v0, v0, Lu10/d1;->c:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final g()V
    ...
    invoke-static {v0}, Lu10/d1;->a(Landroid/view/View;)Lu10/d1;

    move-result-object v0

    iput-object v0, p0, Lcom/transsnet/downloader/widget/DownloadInfoExtendView;->b:Lu10/d1;
    ...
    invoke-direct {v1, p0}, Lb20/g;-><init>(Lcom/transsnet/downloader/widget/DownloadInfoExtendView;)V
...
.method private final getNewTextByConfig()Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, Lcom/transsnet/downloader/widget/DownloadInfoExtendView;->b:Lu10/d1;

    if-eqz v1, :cond_4

    iget-object v9, v1, Lu10/d1;->c:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {p0}, Lcom/transsnet/downloader/widget/DownloadInfoExtendView;->f()Z
    ...
    iget-object v1, v1, Lu10/d1;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    :cond_2
    iget-object v2, p0, Lcom/transsnet/downloader/widget/DownloadInfoExtendView;->b:Lu10/d1;

    if-eqz v2, :cond_3

    iget-object v2, v2, Lu10/d1;->b:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public static final h(Lcom/transsnet/downloader/widget/DownloadInfoExtendView;Landroid/view/View;)V
    ...
    invoke-direct {p0}, Lcom/transsnet/downloader/widget/DownloadInfoExtendView;->i()V
...
.method public final showData(Lcom/transsion/moviedetailapi/bean/Subject;)V
    ...
    iget-object p1, p0, Lcom/transsnet/downloader/widget/DownloadInfoExtendView;->b:Lu10/d1;

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lu10/d1;->b()Landroidx/constraintlayout/widget/ConstraintLayout;

    move-result-object p1

    if-eqz p1, :cond_2

    new-instance v0, Lb20/h;

    invoke-direct {v0, p0}, Lb20/h;-><init>(Lcom/transsnet/downloader/widget/DownloadInfoExtendView;)V
...
.method public final showData(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Lb20/i;-><init>(Lcom/transsnet/downloader/widget/DownloadInfoExtendView;)V
