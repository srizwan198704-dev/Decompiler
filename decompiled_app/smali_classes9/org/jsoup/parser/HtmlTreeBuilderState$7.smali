...
.method public anyOtherEndTag(Lorg/jsoup/parser/Token;Lorg/jsoup/parser/b;)Z
    ...
    invoke-virtual {v3}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;
...
.method public process(Lorg/jsoup/parser/Token;Lorg/jsoup/parser/b;)Z
    ...
    invoke-static {v5, v15}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    :cond_6
    invoke-virtual {v7}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;
    ...
    invoke-virtual {v12}, Lorg/jsoup/nodes/Element;->N0()Lorg/jsoup/nodes/Element;

    move-result-object v4

    if-eqz v4, :cond_10

    invoke-virtual {v12}, Lorg/jsoup/nodes/g;->N()V

    :cond_10
    invoke-virtual {v15, v12}, Lorg/jsoup/nodes/Element;->i0(Lorg/jsoup/nodes/g;)Lorg/jsoup/nodes/Element;
    ...
    :cond_11
    :goto_7
    invoke-virtual {v13}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;

    move-result-object v4

    sget-object v8, Lorg/jsoup/parser/HtmlTreeBuilderState$b;->q:[Ljava/lang/String;

    invoke-static {v4, v8}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    :cond_14
    invoke-virtual {v13, v12}, Lorg/jsoup/nodes/Element;->i0(Lorg/jsoup/nodes/g;)Lorg/jsoup/nodes/Element;

    :goto_8
    new-instance v4, Lorg/jsoup/nodes/Element;

    invoke-virtual {v7}, Lorg/jsoup/nodes/Element;->V0()Lorg/jsoup/parser/f;
    ...
    invoke-virtual {v4}, Lorg/jsoup/nodes/Element;->k()Lorg/jsoup/nodes/b;

    move-result-object v8

    invoke-virtual {v7}, Lorg/jsoup/nodes/Element;->k()Lorg/jsoup/nodes/b;

    move-result-object v9

    invoke-virtual {v8, v9}, Lorg/jsoup/nodes/b;->f(Lorg/jsoup/nodes/b;)V

    invoke-virtual {v14}, Lorg/jsoup/nodes/g;->q()Ljava/util/List;

    move-result-object v8

    invoke-virtual {v14}, Lorg/jsoup/nodes/Element;->p()I
    ...
    invoke-virtual {v4, v12}, Lorg/jsoup/nodes/Element;->i0(Lorg/jsoup/nodes/g;)Lorg/jsoup/nodes/Element;
    ...
    :cond_15
    invoke-virtual {v14, v4}, Lorg/jsoup/nodes/Element;->i0(Lorg/jsoup/nodes/g;)Lorg/jsoup/nodes/Element;
    ...
    invoke-static {v5, v4}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;
    ...
    invoke-virtual/range {p2 .. p2}, Lorg/jsoup/parser/b;->x()Lg50/b;

    move-result-object v1

    invoke-virtual {v2, v10}, Lorg/jsoup/parser/b;->y0(Lg50/b;)V
    ...
    invoke-static {v5, v3}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v4, v10}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v5}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v4}, Lorg/jsoup/nodes/g;->y(Ljava/lang/String;)Z

    move-result v4

    if-nez v4, :cond_40

    invoke-virtual {v1}, Lorg/jsoup/nodes/Element;->k()Lorg/jsoup/nodes/b;

    move-result-object v4

    invoke-virtual {v4, v3}, Lorg/jsoup/nodes/b;->z(Lorg/jsoup/nodes/a;)Lorg/jsoup/nodes/b;
    ...
    invoke-virtual {v4}, Lorg/jsoup/nodes/Element;->D()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lorg/jsoup/nodes/g;->N()V
    ...
    invoke-static {v4, v1}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3, v1}, Lorg/jsoup/parser/b;->Q(Lorg/jsoup/parser/Token$h;Z)Lg50/b;
    ...
    invoke-static {v4, v5}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v6, v7}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v1, v6}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lorg/jsoup/nodes/Document;->j1()Lorg/jsoup/nodes/Document$QuirksMode;
    ...
    invoke-virtual {v4, v6, v8}, Lorg/jsoup/nodes/Element;->l0(Ljava/lang/String;Ljava/lang/String;)Lorg/jsoup/nodes/Element;
    ...
    invoke-static {v8, v9}, Le50/c;->c(Ljava/lang/String;[Ljava/lang/String;)Z

    move-result v8

    if-nez v8, :cond_6d

    invoke-virtual {v4, v6}, Lorg/jsoup/nodes/b;->z(Lorg/jsoup/nodes/a;)Lorg/jsoup/nodes/b;
    ...
    invoke-virtual {v4, v7, v3}, Lorg/jsoup/nodes/b;->y(Ljava/lang/String;Ljava/lang/String;)Lorg/jsoup/nodes/b;
