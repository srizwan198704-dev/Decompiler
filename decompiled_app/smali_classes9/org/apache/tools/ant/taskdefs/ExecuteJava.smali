...
.implements Lorg/apache/tools/ant/util/t;
...
.field private perm:Lorg/apache/tools/ant/types/p;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/apache/tools/ant/taskdefs/ExecuteJava;->perm:Lorg/apache/tools/ant/types/p;
...
.method public static setupCommandLineForVMS(Lorg/apache/tools/ant/taskdefs/g;[Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lorg/apache/tools/ant/util/h;->c([Ljava/lang/String;)Ljava/io/File;
...
.method public execute(Lorg/apache/tools/ant/Project;)V
    ...
    invoke-virtual {v2}, Lorg/apache/tools/ant/types/c;->m()Ljava/lang/String;
    ...
    :goto_0
    :try_start_1
    iget-object v4, p0, Lorg/apache/tools/ant/taskdefs/ExecuteJava;->classpath:Lorg/apache/tools/ant/types/n;
    ...
    :cond_1
    invoke-virtual {p1, v4}, Lorg/apache/tools/ant/Project;->g(Lorg/apache/tools/ant/types/n;)Lorg/apache/tools/ant/a;
    ...
    invoke-virtual {v0, p0}, Lorg/apache/tools/ant/util/Watchdog;->addTimeoutObserver(Lorg/apache/tools/ant/util/t;)V
...
.method public fork(Lorg/apache/tools/ant/v;)I
    ...
    invoke-virtual {v1}, Lorg/apache/tools/ant/types/c;->m()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lorg/apache/tools/ant/types/n;->l(Lorg/apache/tools/ant/types/n;)V
    ...
    invoke-virtual {v0, v1}, Lorg/apache/tools/ant/types/d;->c(Lorg/apache/tools/ant/types/d$a;)V
    ...
    invoke-static {p1}, Lw40/a;->a(Ljava/lang/String;)Z
...
.method public run()V
    ...
    :try_start_0
    iget-object v0, p0, Lorg/apache/tools/ant/taskdefs/ExecuteJava;->perm:Lorg/apache/tools/ant/types/p;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lorg/apache/tools/ant/types/p;->j()V
    ...
    invoke-virtual {v0}, Lorg/apache/tools/ant/types/p;->i()V
    ...
    :goto_4
    iget-object v1, p0, Lorg/apache/tools/ant/taskdefs/ExecuteJava;->perm:Lorg/apache/tools/ant/types/p;

    if-eqz v1, :cond_5

    invoke-virtual {v1}, Lorg/apache/tools/ant/types/p;->i()V
...
.method public setPermissions(Lorg/apache/tools/ant/types/p;)V
    .locals 0

    iput-object p1, p0, Lorg/apache/tools/ant/taskdefs/ExecuteJava;->perm:Lorg/apache/tools/ant/types/p;
