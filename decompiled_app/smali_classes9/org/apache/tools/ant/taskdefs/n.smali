...
.method public declared-synchronized f()V
    ...
    :cond_1
    new-instance v1, Lorg/apache/tools/ant/util/s;

    iget-object v2, p0, Lorg/apache/tools/ant/taskdefs/n;->n:Ljava/io/OutputStream;

    invoke-direct {v1, v0, v2}, Lorg/apache/tools/ant/util/s;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
    ...
    :cond_4
    new-instance v2, Lorg/apache/tools/ant/util/s;

    iget-object v3, p0, Lorg/apache/tools/ant/taskdefs/n;->o:Ljava/io/OutputStream;

    invoke-direct {v2, v0, v3}, Lorg/apache/tools/ant/util/s;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
    ...
    :cond_7
    :try_start_1
    new-instance v0, Lorg/apache/tools/ant/util/k;

    invoke-direct {v0}, Lorg/apache/tools/ant/util/k;-><init>()V

    iget-object v3, p0, Lorg/apache/tools/ant/taskdefs/n;->m:Lorg/apache/tools/ant/v;

    invoke-virtual {v0, v3}, Lorg/apache/tools/ant/util/k;->d(Lorg/apache/tools/ant/v;)V
    ...
    invoke-direct {v4}, Ls40/a;-><init>()V
    ...
    invoke-virtual {v4, v5}, Ls40/a;->e(Lorg/apache/tools/ant/Project;)V

    invoke-virtual {v4, v3}, Ls40/a;->d(Ljava/io/Reader;)V

    iget-object v3, p0, Lorg/apache/tools/ant/taskdefs/n;->s:Ljava/util/Vector;

    invoke-virtual {v4, v3}, Ls40/a;->c(Ljava/util/Vector;)V

    invoke-virtual {v4}, Ls40/a;->b()Ljava/io/Reader;
    ...
    :cond_8
    :goto_3
    new-instance v4, Lorg/apache/tools/ant/util/p;

    iget-object v5, p0, Lorg/apache/tools/ant/taskdefs/n;->v:Ljava/lang/String;

    invoke-direct {v4, v3, v5}, Lorg/apache/tools/ant/util/p;-><init>(Ljava/io/Reader;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lorg/apache/tools/ant/util/c;->l(Lorg/apache/tools/ant/v;)V
    ...
    invoke-virtual {v0, v1}, Ls40/a;->e(Lorg/apache/tools/ant/Project;)V
    :try_end_6
    ...
    invoke-virtual {v0, v1}, Ls40/a;->d(Ljava/io/Reader;)V
    :try_end_7
    ...
    invoke-virtual {v0, v1}, Ls40/a;->c(Ljava/util/Vector;)V

    new-instance v1, Lorg/apache/tools/ant/util/p;

    invoke-virtual {v0}, Ls40/a;->b()Ljava/io/Reader;

    move-result-object v0

    iget-object v2, p0, Lorg/apache/tools/ant/taskdefs/n;->x:Ljava/lang/String;

    invoke-direct {v1, v0, v2}, Lorg/apache/tools/ant/util/p;-><init>(Ljava/io/Reader;Ljava/lang/String;)V
...
.method public final g()V
    ...
    new-instance v2, Lorg/apache/tools/ant/util/o;

    const-wide/16 v3, 0x0

    invoke-direct {v2, v0, v3, v4}, Lorg/apache/tools/ant/util/o;-><init>(Ljava/io/OutputStream;J)V

    :try_start_0
    invoke-virtual {v2}, Lorg/apache/tools/ant/util/o;->g()Ljava/io/OutputStream;
    ...
    invoke-direct {v0, v1}, Lorg/apache/tools/ant/util/i;-><init>(Ljava/io/OutputStream;)V
    ...
    invoke-direct {v1, v2, v0}, Lorg/apache/tools/ant/util/s;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
...
.method public final h([Ljava/io/File;Ljava/lang/String;I)Ljava/io/OutputStream;
    ...
    new-instance v0, Lorg/apache/tools/ant/util/j;
    ...
    invoke-direct {v0, v2, v3, v4}, Lorg/apache/tools/ant/util/j;-><init>(Ljava/io/File;ZZ)V
    ...
    new-instance v4, Lorg/apache/tools/ant/util/j;
    ...
    invoke-direct {v4, v5, v6, v7}, Lorg/apache/tools/ant/util/j;-><init>(Ljava/io/File;ZZ)V

    invoke-direct {v2, v3, v4}, Lorg/apache/tools/ant/util/s;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
...
.method public final k(Ljava/io/ByteArrayOutputStream;Ljava/lang/String;)V
    ...
    sget-object v2, Lorg/apache/tools/ant/util/r;->a:Ljava/lang/String;
