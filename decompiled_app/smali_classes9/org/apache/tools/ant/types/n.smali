...
.field public static final e:Ljava/util/Iterator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/apache/tools/ant/types/n;->e:Ljava/util/Iterator;
...
.method public constructor <init>(Lorg/apache/tools/ant/Project;)V
    ...
    iput-object v0, p0, Lorg/apache/tools/ant/types/n;->b:Lx40/g;
...
.method public constructor <init>(Lorg/apache/tools/ant/Project;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lorg/apache/tools/ant/types/n;->r()Lorg/apache/tools/ant/types/n$a;
...
.method public static synthetic n(Ljava/lang/String;)Ljava/lang/Class;
    .locals 1
...
.method public static v(Lorg/apache/tools/ant/Project;Ljava/lang/String;)Ljava/io/File;
    .locals 1
    ...
    :goto_0
    invoke-virtual {v0, p0, p1}, Lorg/apache/tools/ant/util/f;->q(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
...
.method public static x(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lorg/apache/tools/ant/types/n;->y(Ljava/lang/StringBuffer;I)Z
...
.method public static y(Ljava/lang/StringBuffer;I)Z
    .locals 2
...
.method public static z(Lorg/apache/tools/ant/Project;Ljava/lang/String;)[Ljava/lang/String;
    .locals 6
    ...
    :try_start_0
    invoke-static {p0, v3}, Lorg/apache/tools/ant/types/n;->v(Lorg/apache/tools/ant/Project;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, v3}, Lorg/apache/tools/ant/types/n;->y(Ljava/lang/StringBuffer;I)Z
...
.method public declared-synchronized a()Z
    ...
    iget-object v0, p0, Lorg/apache/tools/ant/types/n;->b:Lx40/g;

    invoke-virtual {p0, v0}, Lorg/apache/tools/ant/types/n;->m(Lorg/apache/tools/ant/types/v;)Lorg/apache/tools/ant/types/v;
    :try_end_1
...
.method public clone()Ljava/lang/Object;
    ...
    iget-object v1, p0, Lorg/apache/tools/ant/types/n;->b:Lx40/g;
    ...
    :cond_0
    invoke-virtual {v1}, Lx40/a;->clone()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lx40/g;

    :goto_0
    iput-object v1, v0, Lorg/apache/tools/ant/types/n;->b:Lx40/g;
    :try_end_0
...
.method public e(Lorg/apache/tools/ant/types/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/tools/ant/BuildException;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lorg/apache/tools/ant/types/n;->g(Lorg/apache/tools/ant/types/v;)V
...
.method public g(Lorg/apache/tools/ant/types/v;)V
    .locals 3
    ...
    invoke-direct {v0}, Lx40/g;-><init>()V
    ...
    invoke-virtual {v0, v1}, Lx40/a;->m(Z)V

    :cond_1
    iget-object v0, p0, Lorg/apache/tools/ant/types/n;->b:Lx40/g;

    invoke-virtual {v0, p1}, Lx40/a;->e(Lorg/apache/tools/ant/types/v;)V
...
.method public i(Lorg/apache/tools/ant/types/n;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lorg/apache/tools/ant/types/n;->k(Lorg/apache/tools/ant/types/n;Z)V
...
.method public final declared-synchronized iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {p0}, Lorg/apache/tools/ant/types/n;->t()Z
    ...
    invoke-virtual {p0}, Lorg/apache/tools/ant/types/n;->u()[Ljava/lang/String;

    move-result-object v1

    const/4 v2, 0x0

    invoke-direct {v0, v2, v1}, Lx40/d;-><init>(Ljava/io/File;[Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sget-object v0, Lorg/apache/tools/ant/types/n;->e:Ljava/util/Iterator;
    ...
    invoke-interface {v0}, Lorg/apache/tools/ant/types/v;->iterator()Ljava/util/Iterator;
...
.method public k(Lorg/apache/tools/ant/types/n;Z)V
    .locals 5

    invoke-virtual {p1}, Lorg/apache/tools/ant/types/n;->u()[Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lorg/apache/tools/ant/types/n;->v(Lorg/apache/tools/ant/Project;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0, v2}, Lorg/apache/tools/ant/types/n;->w(Ljava/io/File;)V
...
.method public l(Lorg/apache/tools/ant/types/n;)V
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lorg/apache/tools/ant/types/n;->e(Lorg/apache/tools/ant/types/n;)V

    return-void
.end method

.method public m(Lorg/apache/tools/ant/types/v;)Lorg/apache/tools/ant/types/v;
    .locals 2

    if-eqz p1, :cond_1

    invoke-interface {p1}, Lorg/apache/tools/ant/types/v;->a()Z
...
.method public final o(Ljava/lang/String;Lorg/apache/tools/ant/types/n;)Lorg/apache/tools/ant/types/n;
    .locals 4
    ...
    invoke-virtual {v0, p2, v2}, Lorg/apache/tools/ant/types/n;->k(Lorg/apache/tools/ant/types/n;Z)V
    ...
    invoke-virtual {v0, p0}, Lorg/apache/tools/ant/types/n;->i(Lorg/apache/tools/ant/types/n;)V
...
.method public p(Ljava/lang/String;)Lorg/apache/tools/ant/types/n;
    ...
    invoke-virtual {p0, p1, v0}, Lorg/apache/tools/ant/types/n;->o(Ljava/lang/String;Lorg/apache/tools/ant/types/n;)Lorg/apache/tools/ant/types/n;
...
.method public q(Ljava/lang/String;)Lorg/apache/tools/ant/types/n;
    .locals 1
...
.method public r()Lorg/apache/tools/ant/types/n$a;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/tools/ant/BuildException;
    ...
    invoke-virtual {p0, v0}, Lorg/apache/tools/ant/types/n;->g(Lorg/apache/tools/ant/types/v;)V
...
.method public s()Z
    ...
    sget-object v1, Lorg/apache/tools/ant/types/n;->f:Ljava/lang/Class;

    const-string v2, "org.apache.tools.ant.types.Path"

    if-nez v1, :cond_0

    invoke-static {v2}, Lorg/apache/tools/ant/types/n;->n(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v1

    sput-object v1, Lorg/apache/tools/ant/types/n;->f:Ljava/lang/Class;
    ...
    sget-object v3, Lorg/apache/tools/ant/types/n;->f:Ljava/lang/Class;
    ...
    sput-object v3, Lorg/apache/tools/ant/types/n;->f:Ljava/lang/Class;
...
.method public declared-synchronized size()I
    ...
    invoke-interface {v0}, Lorg/apache/tools/ant/types/v;->size()I
...
.method public toString()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v0}, Lx40/a;->toString()Ljava/lang/String;
...
.method public u()[Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lorg/apache/tools/ant/types/n;->u()[Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lx40/g;->o()[Ljava/lang/String;
