...
.method public a([CIILt40/a;)V
    ...
    invoke-virtual {p4}, Lt40/a;->c()Lorg/apache/tools/ant/RuntimeConfigurable;
...
.method public c(Ljava/lang/String;Ljava/lang/String;Lt40/a;)V
    .locals 0

    invoke-virtual {p3}, Lt40/a;->o()V

    return-void
.end method

.method public d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xml/sax/Attributes;Lt40/a;)Lt40/b$a;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/xml/sax/SAXParseException;
    ...
    invoke-static {}, Lt40/b;->i()Lt40/b$a;
...
.method public e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xml/sax/Attributes;Lt40/a;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/xml/sax/SAXParseException;
    ...
    invoke-virtual {p5}, Lt40/a;->c()Lorg/apache/tools/ant/RuntimeConfigurable;
    ...
    invoke-virtual {p5}, Lt40/a;->m()Lorg/apache/tools/ant/Project;

    move-result-object v3

    invoke-virtual {v2, v3}, Lorg/apache/tools/ant/v;->setProject(Lorg/apache/tools/ant/Project;)V

    invoke-virtual {v2, p1}, Lorg/apache/tools/ant/c0;->K(Ljava/lang/String;)V

    invoke-virtual {v2, p3}, Lorg/apache/tools/ant/c0;->L(Ljava/lang/String;)V

    invoke-virtual {v2}, Lorg/apache/tools/ant/c0;->B()Ljava/lang/String;
    ...
    invoke-virtual {v2, p2}, Lorg/apache/tools/ant/z;->u(Ljava/lang/String;)V

    invoke-virtual {v2, p3}, Lorg/apache/tools/ant/z;->t(Ljava/lang/String;)V

    new-instance p2, Lorg/apache/tools/ant/Location;

    invoke-virtual {p5}, Lt40/a;->k()Lorg/xml/sax/Locator;
    ...
    invoke-virtual {p5}, Lt40/a;->h()Lorg/apache/tools/ant/y;

    move-result-object p2

    invoke-virtual {v2, p2}, Lorg/apache/tools/ant/z;->r(Lorg/apache/tools/ant/y;)V

    if-eqz v1, :cond_1

    check-cast v1, Lorg/apache/tools/ant/c0;

    invoke-virtual {v1, v2}, Lorg/apache/tools/ant/c0;->v(Lorg/apache/tools/ant/c0;)V
    ...
    invoke-virtual {p2, v2}, Lorg/apache/tools/ant/y;->d(Lorg/apache/tools/ant/z;)V

    :goto_1
    invoke-virtual {p5, v2, p4}, Lt40/a;->b(Ljava/lang/Object;Lorg/xml/sax/Attributes;)V

    new-instance p2, Lorg/apache/tools/ant/RuntimeConfigurable;

    invoke-virtual {v2}, Lorg/apache/tools/ant/c0;->k()Ljava/lang/String;
    ...
    sget-object v7, Lorg/apache/tools/ant/util/r;->a:Ljava/lang/String;
    ...
    invoke-virtual {p5, v3}, Lt40/a;->l(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {p5, p2}, Lt40/a;->p(Lorg/apache/tools/ant/RuntimeConfigurable;)V
