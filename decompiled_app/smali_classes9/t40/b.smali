...
# static fields
.field public static b:Lt40/b$a;

.field public static c:Lt40/b$a;

.field public static d:Lt40/b$a;

.field public static e:Lt40/b$a;

.field public static final f:Lorg/apache/tools/ant/util/f;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lt40/b$b;

    invoke-direct {v0}, Lt40/b$b;-><init>()V

    sput-object v0, Lt40/b;->b:Lt40/b$a;

    new-instance v0, Lt40/b$f;

    invoke-direct {v0}, Lt40/b$f;-><init>()V

    sput-object v0, Lt40/b;->c:Lt40/b$a;

    new-instance v0, Lt40/b$c;

    invoke-direct {v0}, Lt40/b$c;-><init>()V

    sput-object v0, Lt40/b;->d:Lt40/b$a;

    new-instance v0, Lt40/b$d;

    invoke-direct {v0}, Lt40/b$d;-><init>()V

    sput-object v0, Lt40/b;->e:Lt40/b$a;

    invoke-static {}, Lorg/apache/tools/ant/util/f;->k()Lorg/apache/tools/ant/util/f;

    move-result-object v0

    sput-object v0, Lt40/b;->f:Lorg/apache/tools/ant/util/f;
...
.method public static synthetic f()Lorg/apache/tools/ant/util/f;
    .locals 1

    sget-object v0, Lt40/b;->f:Lorg/apache/tools/ant/util/f;

    return-object v0
.end method

.method public static synthetic g()Lt40/b$a;
    .locals 1

    sget-object v0, Lt40/b;->e:Lt40/b$a;

    return-object v0
.end method

.method public static synthetic h()Lt40/b$a;
    .locals 1

    sget-object v0, Lt40/b;->c:Lt40/b$a;

    return-object v0
.end method

.method public static synthetic i()Lt40/b$a;
    .locals 1

    sget-object v0, Lt40/b;->b:Lt40/b$a;
...
# virtual methods
.method public j(Lorg/apache/tools/ant/Project;Ljava/lang/Object;Lt40/b$e;)V
    .locals 6
    ...
    invoke-static {p3}, Lt40/b$e;->a(Lt40/b$e;)Lt40/a;
    ...
    sget-object v1, Lt40/b;->f:Lorg/apache/tools/ant/util/f;

    invoke-virtual {p2}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {v1, p2}, Lorg/apache/tools/ant/util/f;->o(Ljava/lang/String;)Ljava/io/File;

    move-result-object p2

    invoke-virtual {v0, p2}, Lt40/a;->q(Ljava/io/File;)V
    ...
    :goto_0
    :try_start_0
    invoke-static {}, Lorg/apache/tools/ant/util/g;->c()Lorg/xml/sax/XMLReader;
    ...
    invoke-virtual {v0, v4}, Lorg/apache/tools/ant/util/f;->r(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lorg/apache/tools/ant/util/f;->b(Ljava/io/InputStream;)V
...
.method public k(Lorg/apache/tools/ant/Project;Ljava/net/URL;)Lorg/apache/tools/ant/c0;
    ...
    invoke-direct {v1, p1}, Lt40/a;-><init>(Lorg/apache/tools/ant/Project;)V

    invoke-virtual {v1, v0}, Lt40/a;->a(Lorg/apache/tools/ant/y;)V

    invoke-virtual {v1, v0}, Lt40/a;->t(Lorg/apache/tools/ant/y;)V

    invoke-virtual {v1}, Lt40/a;->m()Lorg/apache/tools/ant/Project;

    move-result-object p1

    new-instance v2, Lt40/b$e;

    sget-object v3, Lt40/b;->b:Lt40/b$a;

    invoke-direct {v2, v1, v3}, Lt40/b$e;-><init>(Lt40/a;Lt40/b$a;)V

    invoke-virtual {p0, p1, p2, v2}, Lt40/b;->j(Lorg/apache/tools/ant/Project;Ljava/lang/Object;Lt40/b$e;)V
