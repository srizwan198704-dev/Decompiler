...
# static fields
.field public static final Companion:Lr20/b$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lr20/b$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lr20/b;->Companion:Lr20/b$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lr20/b;->context:Landroid/content/Context;
    ...
    iput-object p1, p0, Lr20/b;->uiHandler:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lr20/b;->cachedOMSDKJS:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lr20/b;->cachedOMSessionJS:Ljava/util/concurrent/atomic/AtomicReference;

    return-void
.end method

.method public static synthetic a(Lr20/b;)V
    .locals 0

    invoke-static {p0}, Lr20/b;->init$lambda-2(Lr20/b;)V
...
.method private final getOMSessionJS()Ljava/lang/String;
    ...
    iget-object v0, p0, Lr20/b;->cachedOMSessionJS:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p0, v0}, Lr20/b;->loadJsFromRaw(I)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lr20/b;->cachedOMSessionJS:Ljava/util/concurrent/atomic/AtomicReference;
...
.method private static final init$lambda-2(Lr20/b;)V
    .locals 3
    ...
    invoke-static {}, Lah/a;->b()Z

    move-result v0

    if-nez v0, :cond_0

    iget-object p0, p0, Lr20/b;->context:Landroid/content/Context;

    invoke-static {p0}, Lah/a;->a(Landroid/content/Context;)V
...
.method private final loadJsFromRaw(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lr20/b;->context:Landroid/content/Context;
...
.method public final getContext()Landroid/content/Context;
    ...
    iget-object v0, p0, Lr20/b;->context:Landroid/content/Context;
...
.method public final getOMSDKJS$vungle_ads_release()Ljava/lang/String;
    ...
    iget-object v0, p0, Lr20/b;->cachedOMSDKJS:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Lr20/b;->cachedOMSDKJS:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final init()V
    ...
    iget-object v0, p0, Lr20/b;->uiHandler:Landroid/os/Handler;

    new-instance v1, Lr20/a;

    invoke-direct {v1, p0}, Lr20/a;-><init>(Lr20/b;)V
...
.method public final injectJsFiles$vungle_ads_release(Ljava/io/File;)Ljava/util/List;
    ...
    invoke-virtual {p0}, Lr20/b;->getOMSDKJS$vungle_ads_release()Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v2}, Lr20/b;->writeToFile(Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    :goto_0
    invoke-direct {p0}, Lr20/b;->getOMSessionJS()Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v1}, Lr20/b;->writeToFile(Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
