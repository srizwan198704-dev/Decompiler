...
.method public synthetic constructor <init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-direct {p0}, Lmy/a$a;-><init>()V
...
# virtual methods
.method public final a(Lmy/a;)Ljava/lang/String;
    .locals 3

    invoke-virtual {p1}, Lmy/a;->q()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p1}, Lmy/a;->a()Z
    ...
    invoke-virtual {p0}, Lmy/a$a;->b()Ljava/lang/String;
...
.method public final c(Z)Lmy/a;
    ...
    invoke-virtual {v1, v0}, Lmy/a;->y(Ljava/lang/String;)V

    sget-object v0, Landroid/os/Build;->DEVICE:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lmy/a;->u(Ljava/lang/String;)V

    sget-object v0, Landroid/os/Build;->BRAND:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lmy/a;->s(Ljava/lang/String;)V

    sget-object v0, Landroid/os/Build;->PRODUCT:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lmy/a;->w(Ljava/lang/String;)V

    sget-object v0, Landroid/os/Build$VERSION;->RELEASE:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lmy/a;->C(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lmy/a;->D(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lmy/a;->A(Ljava/lang/String;)V

    invoke-static {}, Lcom/blankj/utilcode/util/c;->f()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lmy/a;->B(Ljava/lang/String;)V

    invoke-static {}, Lcom/blankj/utilcode/util/c;->c()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lmy/a;->v(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lti/b$a;->e(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lmy/a;->t(Ljava/lang/String;)V

    const-string v0, "userId"

    invoke-virtual {v1, v0}, Lmy/a;->z(Ljava/lang/String;)V

    const-string v0, "avatarIndex"

    invoke-virtual {v1, v0}, Lmy/a;->r(Ljava/lang/String;)V

    if-eqz p1, :cond_0

    const-string v0, "5G"

    invoke-virtual {v1, v0}, Lmy/a;->E(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-virtual {v0, v1}, Lmy/a$a;->a(Lmy/a;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lmy/a;->H(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Lmy/a;->G(Ljava/lang/String;)V

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Lmy/a;->x(Z)V
