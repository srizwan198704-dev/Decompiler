...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lkotlin/collections/t;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs j([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    invoke-static {v0, p0}, Lkotlin/collections/v;->q(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static varargs k([Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/v;->u([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lkotlin/collections/u;->g(Ljava/util/Map;)Ljava/util/Map;
...
.method public static r(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/v;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_1
    invoke-static {p0}, Lkotlin/collections/u;->f(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/v;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/v;->m(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/v;->p(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static t(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/v;->v(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final u([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/v;->q(Ljava/util/Map;[Lkotlin/Pair;)V
