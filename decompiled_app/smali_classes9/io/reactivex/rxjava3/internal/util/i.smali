...
.method public static a(ZZLio/reactivex/rxjava3/core/o;ZLio/reactivex/rxjava3/operators/g;Lx20/b;Lio/reactivex/rxjava3/internal/util/e;)Z
    .locals 2
    ...
    invoke-interface {p5}, Lx20/b;->dispose()V
...
.method public static b(ZZLx50/c;ZLio/reactivex/rxjava3/operators/g;Lio/reactivex/rxjava3/internal/util/h;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p2, p0}, Lx50/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_1
    invoke-interface {p2}, Lx50/c;->onComplete()V
...
.method public static d(Lio/reactivex/rxjava3/operators/f;Lio/reactivex/rxjava3/core/o;ZLx20/b;Lio/reactivex/rxjava3/internal/util/e;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {v2 .. v8}, Lio/reactivex/rxjava3/internal/util/i;->a(ZZLio/reactivex/rxjava3/core/o;ZLio/reactivex/rxjava3/operators/g;Lx20/b;Lio/reactivex/rxjava3/internal/util/e;)Z
    ...
    invoke-static/range {v3 .. v9}, Lio/reactivex/rxjava3/internal/util/i;->a(ZZLio/reactivex/rxjava3/core/o;ZLio/reactivex/rxjava3/operators/g;Lx20/b;Lio/reactivex/rxjava3/internal/util/e;)Z
...
.method public static e(Lio/reactivex/rxjava3/operators/f;Lx50/c;ZLx20/b;Lio/reactivex/rxjava3/internal/util/h;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {v2 .. v7}, Lio/reactivex/rxjava3/internal/util/i;->b(ZZLx50/c;ZLio/reactivex/rxjava3/operators/g;Lio/reactivex/rxjava3/internal/util/h;)Z
    ...
    invoke-interface {p3}, Lx20/b;->dispose()V
    ...
    invoke-interface {p4, p1, v8}, Lio/reactivex/rxjava3/internal/util/h;->accept(Lx50/c;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, p0}, Lx50/c;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static f(Lx50/d;I)V
    .locals 2
    ...
    :goto_0
    invoke-interface {p0, v0, v1}, Lx50/d;->request(J)V
