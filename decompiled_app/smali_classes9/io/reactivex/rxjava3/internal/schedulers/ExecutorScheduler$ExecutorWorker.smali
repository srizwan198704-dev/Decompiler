...
.method public constructor <init>(Ljava/util/concurrent/Executor;ZZ)V
    ...
    iput-object v0, p0, Lio/reactivex/rxjava3/internal/schedulers/ExecutorScheduler$ExecutorWorker;->tasks:Lx20/a;
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/schedulers/ExecutorScheduler$ExecutorWorker;->tasks:Lx20/a;
...
.method public schedule(Ljava/lang/Runnable;)Lx20/b;
    ...
    :cond_0
    invoke-static {p1}, Le30/a;->t(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/schedulers/ExecutorScheduler$ExecutorWorker;->tasks:Lx20/a;

    invoke-direct {v0, p1, v1}, Lio/reactivex/rxjava3/internal/schedulers/ExecutorScheduler$ExecutorWorker$InterruptibleRunnable;-><init>(Ljava/lang/Runnable;Lx20/c;)V

    iget-object p1, p0, Lio/reactivex/rxjava3/internal/schedulers/ExecutorScheduler$ExecutorWorker;->tasks:Lx20/a;

    invoke-virtual {p1, v0}, Lx20/a;->a(Lx20/b;)Z
...
.method public schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lx20/b;
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/rxjava3/internal/schedulers/ExecutorScheduler$ExecutorWorker;->schedule(Ljava/lang/Runnable;)Lx20/b;
    ...
    invoke-direct {v1, v0}, Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;-><init>(Lx20/b;)V
    ...
    invoke-direct {v2, v3, p1}, Lio/reactivex/rxjava3/internal/schedulers/ScheduledRunnable;-><init>(Ljava/lang/Runnable;Lx20/c;)V

    iget-object p1, p0, Lio/reactivex/rxjava3/internal/schedulers/ExecutorScheduler$ExecutorWorker;->tasks:Lx20/a;

    invoke-virtual {p1, v2}, Lx20/a;->a(Lx20/b;)Z
    ...
    invoke-virtual {p1, v2, p2, p3, p4}, Lio/reactivex/rxjava3/core/Scheduler;->e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lx20/b;

    move-result-object p1

    new-instance p2, Lio/reactivex/rxjava3/internal/schedulers/b;

    invoke-direct {p2, p1}, Lio/reactivex/rxjava3/internal/schedulers/b;-><init>(Lx20/b;)V
