...
.method public constructor <init>(Lx50/c;JLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/core/Scheduler$Worker;ZLa30/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->downstream:Lx50/c;
    ...
    iput-object p7, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->onDropped:La30/f;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->upstream:Lx50/d;
...
.method public clear()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->onDropped:La30/f;
    ...
    :try_start_0
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->onDropped:La30/f;

    invoke-interface {v1, v0}, La30/f;->accept(Ljava/lang/Object;)V
    :try_end_0
...
.method public drain()V
    ...
    iget-object v4, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->downstream:Lx50/c;
    ...
    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->onDropped:La30/f;
    ...
    invoke-interface {v3, v2}, La30/f;->accept(Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    :goto_1
    invoke-interface {v4, v7}, Lx50/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v4, v0}, Lx50/c;->onNext(Ljava/lang/Object;)V

    invoke-interface {v4}, Lx50/c;->onComplete()V
    ...
    invoke-interface {v4, v0}, Lx50/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v4, v6}, Lx50/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, p0, v7, v8, v9}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lx20/b;
...
.method public onSubscribe(Lx50/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->upstream:Lx50/d;

    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->downstream:Lx50/c;
...
.method public tryDropAndSignalMBE(Ljava/lang/Object;)V
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableThrottleLatest$ThrottleLatestSubscriber;->downstream:Lx50/c;
