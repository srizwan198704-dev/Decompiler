...
.field final bufferSupplier:La30/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La30/k<",
            "TU;>;"
...
.method public constructor <init>(Lx50/c;La30/k;JLjava/util/concurrent/TimeUnit;IZLio/reactivex/rxjava3/core/Scheduler$Worker;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/rxjava3/internal/subscribers/b;-><init>(Lx50/c;Lio/reactivex/rxjava3/operators/f;)V

    iput-object p2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->bufferSupplier:La30/k;
...
# virtual methods
.method public bridge synthetic accept(Lx50/c;Ljava/lang/Object;)Z
    .locals 0

    check-cast p2, Ljava/util/Collection;

    invoke-virtual {p0, p1, p2}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->accept(Lx50/c;Ljava/util/Collection;)Z
...
.method public accept(Lx50/c;Ljava/util/Collection;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p2}, Lx50/c;->onNext(Ljava/lang/Object;)V
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->upstream:Lx50/d;
...
.method public onComplete()V
    ...
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/subscribers/b;->downstream:Lx50/c;

    const/4 v2, 0x0

    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/rxjava3/internal/util/i;->e(Lio/reactivex/rxjava3/operators/f;Lx50/c;ZLx20/b;Lio/reactivex/rxjava3/internal/util/h;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/subscribers/b;->downstream:Lx50/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->timer:Lx20/b;
    ...
    invoke-virtual {p0, v0, p1, p0}, Lio/reactivex/rxjava3/internal/subscribers/b;->fastPathOrderedEmitMax(Ljava/lang/Object;ZLx20/b;)V

    :try_start_1
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->bufferSupplier:La30/k;

    invoke-interface {p1}, La30/k;->get()Ljava/lang/Object;
    ...
    invoke-virtual/range {v0 .. v6}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedulePeriodically(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lx20/b;

    move-result-object p1

    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->timer:Lx20/b;
...
.method public onSubscribe(Lx50/d;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->upstream:Lx50/d;

    :try_start_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->bufferSupplier:La30/k;
    ...
    invoke-virtual/range {v1 .. v7}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedulePeriodically(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lx20/b;

    move-result-object v0

    iput-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->timer:Lx20/b;
    ...
    invoke-interface {p1}, Lx50/d;->cancel()V

    iget-object p1, p0, Lio/reactivex/rxjava3/internal/subscribers/b;->downstream:Lx50/c;

    invoke-static {v0, p1}, Lio/reactivex/rxjava3/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lx50/c;)V
...
.method public run()V
    ...
    invoke-virtual {p0, v1, v0, p0}, Lio/reactivex/rxjava3/internal/subscribers/b;->fastPathOrderedEmitMax(Ljava/lang/Object;ZLx20/b;)V
    ...
    invoke-interface {v1, v0}, Lx50/c;->onError(Ljava/lang/Throwable;)V
