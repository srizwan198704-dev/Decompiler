...
.method public constructor <init>(Lx50/c;JJI)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lx50/c;
    ...
    invoke-direct {p1, p6}, Lio/reactivex/rxjava3/operators/h;-><init>(I)V

    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/rxjava3/operators/h;
...
.method public checkTerminated(ZZLx50/c;Lio/reactivex/rxjava3/operators/h;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-virtual {p4}, Lio/reactivex/rxjava3/operators/h;->clear()V

    invoke-interface {p3, p1}, Lx50/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p3}, Lx50/c;->onComplete()V
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lx50/c;

    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/rxjava3/operators/h;
    ...
    :cond_4
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->checkTerminated(ZZLx50/c;Lio/reactivex/rxjava3/operators/h;)Z
    ...
    :cond_6
    new-instance v10, Lio/reactivex/rxjava3/internal/operators/flowable/g;

    invoke-direct {v10, v12}, Lio/reactivex/rxjava3/internal/operators/flowable/g;-><init>(Lio/reactivex/rxjava3/processors/a;)V

    invoke-interface {v0, v10}, Lx50/c;->onNext(Ljava/lang/Object;)V

    invoke-virtual {v10}, Lio/reactivex/rxjava3/internal/operators/flowable/g;->h()Z
    ...
    invoke-virtual {v1}, Lio/reactivex/rxjava3/operators/h;->isEmpty()Z

    move-result v11

    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->checkTerminated(ZZLx50/c;Lio/reactivex/rxjava3/operators/h;)Z
...
.method public onComplete()V
    ...
    invoke-interface {v1}, Lx50/c;->onComplete()V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, p1}, Lx50/c;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v4, p0}, Lio/reactivex/rxjava3/processors/UnicastProcessor;->i(ILjava/lang/Runnable;)Lio/reactivex/rxjava3/processors/UnicastProcessor;
    ...
    check-cast v8, Lx50/a;

    invoke-interface {v8, p1}, Lx50/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/rxjava3/operators/h;

    invoke-virtual {p1, v4}, Lio/reactivex/rxjava3/operators/h;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Lx50/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->upstream:Lx50/d;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->upstream:Lx50/d;

    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lx50/c;
