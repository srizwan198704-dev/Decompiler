...
.method public constructor <init>(Lio/reactivex/rxjava3/core/o;JLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/core/Scheduler;IJZ)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public createFirstWindow()V
    ...
    invoke-static {v2, p0}, Lio/reactivex/rxjava3/subjects/UnicastSubject;->G(ILjava/lang/Runnable;)Lio/reactivex/rxjava3/subjects/UnicastSubject;
    ...
    new-instance v3, Lio/reactivex/rxjava3/internal/operators/observable/q;

    invoke-direct {v3, v2}, Lio/reactivex/rxjava3/internal/operators/observable/q;-><init>(Lio/reactivex/rxjava3/subjects/a;)V
    ...
    invoke-virtual/range {v4 .. v10}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedulePeriodically(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lx20/b;
    ...
    invoke-virtual/range {v4 .. v10}, Lio/reactivex/rxjava3/core/Scheduler;->f(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lx20/b;
    ...
    :goto_0
    invoke-virtual {v3}, Lio/reactivex/rxjava3/internal/operators/observable/q;->G()Z
...
.method public createNewWindow(Lio/reactivex/rxjava3/subjects/UnicastSubject;)Lio/reactivex/rxjava3/subjects/UnicastSubject;
    ...
    invoke-static {p1, p0}, Lio/reactivex/rxjava3/subjects/UnicastSubject;->G(ILjava/lang/Runnable;)Lio/reactivex/rxjava3/subjects/UnicastSubject;
    ...
    new-instance v2, Lio/reactivex/rxjava3/internal/operators/observable/q;

    invoke-direct {v2, p1}, Lio/reactivex/rxjava3/internal/operators/observable/q;-><init>(Lio/reactivex/rxjava3/subjects/a;)V

    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableWindowTimed$AbstractWindowObserver;->downstream:Lio/reactivex/rxjava3/core/o;
    ...
    invoke-virtual {v3, v0}, Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;->update(Lx20/b;)Z

    :cond_2
    invoke-virtual {v2}, Lio/reactivex/rxjava3/internal/operators/observable/q;->G()Z
