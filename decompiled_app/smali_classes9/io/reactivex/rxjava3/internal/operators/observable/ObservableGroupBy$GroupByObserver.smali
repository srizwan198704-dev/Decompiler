...
.field final keySelector:La30/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La30/h<",
            "-TT;+TK;>;"
...
.field final valueSelector:La30/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La30/h<",
            "-TT;+TV;>;"
...
.method public constructor <init>(Lio/reactivex/rxjava3/core/o;La30/h;La30/h;IZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->downstream:Lio/reactivex/rxjava3/core/o;

    iput-object p2, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->keySelector:La30/h;

    iput-object p3, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->valueSelector:La30/h;
...
.method public cancel(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->upstream:Lx20/b;
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->upstream:Lx20/b;
...
.method public onComplete()V
    ...
    check-cast v1, Lio/reactivex/rxjava3/internal/operators/observable/h;

    invoke-virtual {v1}, Lio/reactivex/rxjava3/internal/operators/observable/h;->onComplete()V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->downstream:Lio/reactivex/rxjava3/core/o;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1, p1}, Lio/reactivex/rxjava3/internal/operators/observable/h;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->keySelector:La30/h;

    invoke-interface {v0, p1}, La30/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v2, Lio/reactivex/rxjava3/internal/operators/observable/h;
    ...
    invoke-static {v0, v2, p0, v3}, Lio/reactivex/rxjava3/internal/operators/observable/h;->G(Ljava/lang/Object;ILio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;Z)Lio/reactivex/rxjava3/internal/operators/observable/h;
    ...
    :goto_1
    :try_start_1
    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->valueSelector:La30/h;

    invoke-interface {v3, p1}, La30/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, p1}, Lio/reactivex/rxjava3/internal/operators/observable/h;->onNext(Ljava/lang/Object;)V

    if-eqz v1, :cond_3

    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->downstream:Lio/reactivex/rxjava3/core/o;

    invoke-interface {p1, v2}, Lio/reactivex/rxjava3/core/o;->onNext(Ljava/lang/Object;)V

    iget-object p1, v2, Lio/reactivex/rxjava3/internal/operators/observable/h;->b:Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$State;
    ...
    invoke-virtual {v2}, Lio/reactivex/rxjava3/internal/operators/observable/h;->onComplete()V
    ...
    invoke-interface {v0, v2}, Lio/reactivex/rxjava3/core/o;->onNext(Ljava/lang/Object;)V
...
.method public onSubscribe(Lx20/b;)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/observable/ObservableGroupBy$GroupByObserver;->upstream:Lx20/b;
