...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    check-cast p0, Lx50/d;

    if-eq p0, v1, :cond_1

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lx50/d;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, Lx50/d;->request(J)V
    ...
    invoke-static {p1, p2, p3}, Lio/reactivex/rxjava3/internal/util/a;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lx50/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lx50/d;)Z
    ...
    invoke-interface {p2, p0, p1}, Lx50/d;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lx50/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-static {p0, v0, p1}, Landroidx/compose/animation/core/j0;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lx50/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lx50/d;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lx50/d;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p2, p3}, Lx50/d;->request(J)V
...
.method public static validate(Lx50/d;Lx50/d;)Z
    .locals 1
    ...
    invoke-static {p0}, Le30/a;->r(Ljava/lang/Throwable;)V
