...
# instance fields
.field public final b:Lio/reactivex/rxjava3/operators/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public g(Lx50/c;)V
    ...
    invoke-interface {p1, v0}, Lx50/c;->onSubscribe(Lx50/d;)V
...
.method public h(ZZZLx50/c;Lio/reactivex/rxjava3/operators/h;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Lx50/c;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_2
    invoke-interface {p4}, Lx50/c;->onComplete()V
...
.method public l()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/rxjava3/processors/UnicastProcessor;->m(Lx50/c;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/rxjava3/processors/UnicastProcessor;->n(Lx50/c;)V
...
.method public m(Lx50/c;)V
    ...
    :cond_2
    invoke-interface {p1, v4}, Lx50/c;->onNext(Ljava/lang/Object;)V
...
.method public n(Lx50/c;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/rxjava3/processors/UnicastProcessor;->h(ZZZLx50/c;Lio/reactivex/rxjava3/operators/h;)Z
    ...
    invoke-interface {v5, v8}, Lx50/c;->onNext(Ljava/lang/Object;)V
