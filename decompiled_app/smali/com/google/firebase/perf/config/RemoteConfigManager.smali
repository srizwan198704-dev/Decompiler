...
.field private final cache:Lre/w;

.field private final executor:Ljava/util/concurrent/Executor;

.field private firebaseRemoteConfig:Lcf/i;
...
.field private firebaseRemoteConfigProvider:Lge/b;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lue/a;
...
.method private constructor <init>()V
    ...
    invoke-direct/range {v0 .. v7}, Lcom/google/firebase/perf/config/RemoteConfigManager;-><init>(Lre/w;Ljava/util/concurrent/Executor;Lcf/i;JJ)V

    return-void
.end method

.method public constructor <init>(Lre/w;Ljava/util/concurrent/Executor;Lcf/i;JJ)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->cache:Lre/w;

    iput-object p2, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->executor:Ljava/util/concurrent/Executor;

    iput-object p3, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lcf/i;
    ...
    invoke-virtual {p3}, Lcf/i;->i()Ljava/util/Map;
...
.method public static getInitialStartupMillis()J
    ...
    :catch_0
    sget-object v0, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lue/a;
...
.method private getRemoteConfigValue(Ljava/lang/String;)Lcf/l;
    .locals 5
    ...
    invoke-interface {v1}, Lcf/l;->a()I

    move-result v2

    if-ne v2, v0, :cond_0

    sget-object v2, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lue/a;

    invoke-interface {v1}, Lcf/l;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, p1, v0}, Lue/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private synthetic lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$0(Ljava/lang/Boolean;)V
    ...
    iget-object p1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lcf/i;

    invoke-virtual {p1}, Lcf/i;->i()Ljava/util/Map;
...
.method private synthetic lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$1(Ljava/lang/Exception;)V
    ...
    invoke-virtual {v0, v1, v2}, Lue/a;->k(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch()V
    ...
    iget-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lcf/i;

    invoke-virtual {v0}, Lcf/i;->h()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0}, Lre/x;-><init>(Lcom/google/firebase/perf/config/RemoteConfigManager;)V
    ...
    new-instance v2, Lre/y;

    invoke-direct {v2, p0}, Lre/y;-><init>(Lcom/google/firebase/perf/config/RemoteConfigManager;)V
...
.method private triggerRemoteConfigFetchIfNecessary()V
    ...
    iget-object v1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lcf/i;

    invoke-virtual {v1}, Lcf/i;->i()Ljava/util/Map;
...
.method public getBoolean(Ljava/lang/String;)Lcom/google/firebase/perf/util/e;
    ...
    sget-object p1, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lue/a;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/config/RemoteConfigManager;->getRemoteConfigValue(Ljava/lang/String;)Lcf/l;
    ...
    :catch_0
    invoke-interface {v0}, Lcf/l;->b()Ljava/lang/String;
    ...
    sget-object v1, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lue/a;
    ...
    invoke-virtual {v1, p1, v2}, Lue/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getRemoteConfigValueOrDefault(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v2}, Lcf/l;->b()Ljava/lang/String;
    ...
    :try_start_1
    sget-object v4, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lue/a;
    ...
    invoke-virtual {v4, v5, v6}, Lue/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    sget-object v3, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lue/a;
    ...
    invoke-virtual {v3, p1, v4}, Lue/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getString(Ljava/lang/String;)Lcom/google/firebase/perf/util/e;
    ...
    invoke-interface {p1}, Lcf/l;->b()Ljava/lang/String;
...
.method public isFirebaseRemoteConfigAvailable()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfigProvider:Lge/b;
    ...
    invoke-virtual {v0, v1}, Lcf/p;->e(Ljava/lang/String;)Lcf/i;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lcf/i;
...
.method public isLastFetchFailed()Z
    ...
    invoke-virtual {v0}, Lcf/i;->j()Lcf/j;

    move-result-object v0

    invoke-interface {v0}, Lcf/j;->a()I
...
.method public setFirebaseRemoteConfigProvider(Lge/b;)V
    .locals 0
    .param p1    # Lge/b;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfigProvider:Lge/b;
...
.method public syncConfigValues(Ljava/util/Map;)V
    ...
    invoke-virtual {p1}, Lre/d;->c()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->cache:Lre/w;

    invoke-virtual {p1}, Lre/d;->a()Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, v0}, Lre/w;->m(Ljava/lang/String;Z)Z
    :try_end_0
