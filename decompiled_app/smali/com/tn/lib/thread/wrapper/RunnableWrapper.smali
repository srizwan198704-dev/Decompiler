...
.field private dispatcher:Laj/i;
...
.method public constructor <init>(Lzi/d;)V
    ...
    invoke-virtual {p1}, Lzi/d;->e()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lzi/d;->d()Lyi/b;

    move-result-object v1

    invoke-virtual {p1}, Lzi/d;->c()Ljava/util/concurrent/Executor;

    move-result-object v2

    invoke-virtual {p1}, Lzi/d;->a()Lyi/a;

    move-result-object p1

    invoke-direct {v0, v1, v2, p1}, Laj/i;-><init>(Lyi/b;Ljava/util/concurrent/Executor;Lyi/a;)V

    iput-object v0, p0, Lcom/tn/lib/thread/wrapper/RunnableWrapper;->dispatcher:Laj/i;
...
.method public run()V
    ...
    sget-object v1, Lzi/f;->a:Lzi/f$a;

    invoke-static {v0}, Lkotlin/jvm/internal/Intrinsics;->e(Ljava/lang/Object;)V

    iget-object v2, p0, Lcom/tn/lib/thread/wrapper/RunnableWrapper;->threadName:Ljava/lang/String;

    iget-object v3, p0, Lcom/tn/lib/thread/wrapper/RunnableWrapper;->dispatcher:Laj/i;

    invoke-virtual {v1, v0, v2, v3}, Lzi/f$a;->b(Ljava/lang/Thread;Ljava/lang/String;Lyi/b;)V

    iget-object v0, p0, Lcom/tn/lib/thread/wrapper/RunnableWrapper;->dispatcher:Laj/i;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/tn/lib/thread/wrapper/RunnableWrapper;->threadName:Ljava/lang/String;

    invoke-virtual {v0, v1}, Laj/i;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Laj/i;->onSuccess()V
    :try_end_0
    ...
    :goto_1
    iget-object v1, p0, Lcom/tn/lib/thread/wrapper/RunnableWrapper;->dispatcher:Laj/i;

    if-eqz v1, :cond_3

    iget-object v2, p0, Lcom/tn/lib/thread/wrapper/RunnableWrapper;->threadName:Ljava/lang/String;

    invoke-virtual {v1, v2, v0}, Laj/i;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v1}, Laj/i;->onCompleted(Ljava/lang/String;)V
