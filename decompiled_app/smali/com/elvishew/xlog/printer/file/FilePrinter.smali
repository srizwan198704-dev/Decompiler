...
.method public constructor <init>(Lcom/elvishew/xlog/printer/file/FilePrinter$b;)V
    ...
    iget-object v0, p1, Lcom/elvishew/xlog/printer/file/FilePrinter$b;->b:Lm9/b;

    iput-object v0, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->b:Lm9/b;

    iget-object v0, p1, Lcom/elvishew/xlog/printer/file/FilePrinter$b;->c:Lk9/a;

    iput-object v0, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->c:Lk9/a;

    iget-object v0, p1, Lcom/elvishew/xlog/printer/file/FilePrinter$b;->d:Ll9/a;

    iput-object v0, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->d:Ll9/a;

    iget-object v0, p1, Lcom/elvishew/xlog/printer/file/FilePrinter$b;->e:Lw8/c;

    iput-object v0, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->e:Lw8/c;

    iget-object p1, p1, Lcom/elvishew/xlog/printer/file/FilePrinter$b;->f:Ln9/b;

    iput-object p1, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->f:Ln9/b;
...
.method public final d()V
    ...
    iget-object v4, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->d:Ll9/a;

    invoke-interface {v4, v3}, Ll9/a;->a(Ljava/io/File;)Z
...
.method public final e(JILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->f:Ln9/b;

    invoke-virtual {v0}, Ln9/b;->d()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->f:Ln9/b;

    invoke-virtual {v1}, Ln9/b;->e()Z
    ...
    iget-object v2, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->b:Lm9/b;

    invoke-interface {v2}, Lm9/b;->b()Z
    ...
    invoke-interface {v2, p3, v3, v4}, Lm9/b;->a(IJ)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Ln9/b;->f(Ljava/io/File;)Z
    ...
    invoke-virtual {v1}, Ln9/b;->c()Ljava/io/File;

    move-result-object v1

    iget-object v2, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->c:Lk9/a;

    invoke-interface {v2, v1}, Lk9/b;->b(Ljava/io/File;)Z

    move-result v2

    if-eqz v2, :cond_5

    iget-object v2, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->f:Ln9/b;

    invoke-virtual {v2}, Ln9/b;->b()Z

    iget-object v2, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->c:Lk9/a;

    invoke-static {v1, v2}, Lh9/b;->a(Ljava/io/File;Lk9/a;)V
    ...
    invoke-virtual {v1, v2}, Ln9/b;->f(Ljava/io/File;)Z
    ...
    :cond_5
    iget-object v1, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->e:Lw8/c;
    ...
    invoke-interface/range {v1 .. v6}, Lw8/c;->a(JILjava/lang/String;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    iget-object p2, p0, Lcom/elvishew/xlog/printer/file/FilePrinter;->f:Ln9/b;

    invoke-virtual {p2, p1}, Ln9/b;->a(Ljava/lang/String;)V
