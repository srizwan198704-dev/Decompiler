...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lxr/f;

    invoke-direct {v1}, Lxr/f;-><init>()V
...
.method private constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lxr/d;-><init>(Lcom/transsion/publish/PublishManager;)V
...
.method public static final synthetic access$uploadCallback(Lcom/transsion/publish/PublishManager;)Lez/a;
    .locals 0

    invoke-direct {p0}, Lcom/transsion/publish/PublishManager;->uploadCallback()Lez/a;
...
.method private final create(Lcom/transsion/publish/api/bean/RequestPostEntity;Z)V
    ...
    invoke-direct {p0}, Lcom/transsion/publish/PublishManager;->getPublishModel()Les/b;

    move-result-object v0

    invoke-virtual {v0, p1}, Les/b;->e(Lcom/transsion/publish/api/bean/RequestPostEntity;)Lio/reactivex/rxjava3/core/j;
    ...
    invoke-virtual {v0, p1}, Les/b;->f(Lcom/transsion/publish/api/bean/RequestPostEntity;)Lio/reactivex/rxjava3/core/j;
...
.method public static synthetic d()Les/b;
    .locals 1

    invoke-static {}, Lcom/transsion/publish/PublishManager;->publishModel_delegate$lambda$0()Les/b;
...
.method private final disposeAudio(Ljava/util/List;Z)V
    ...
    invoke-virtual {v0, p2, v1, v2, v3}, Lez/c;->f(Ljava/lang/String;Lcom/transsion/upload/bean/UploadFileType;ZLez/a;)V
...
.method private final disposeCover(Lcom/transsion/publish/api/bean/MediaCoverEntity;Z)V
    ...
    invoke-virtual {p2, p1, v0, v1, v2}, Lez/c;->f(Ljava/lang/String;Lcom/transsion/upload/bean/UploadFileType;ZLez/a;)V
...
.method private final disposeImage()V
    ...
    invoke-virtual {v1, v2, v4, v6, v5}, Lez/c;->f(Ljava/lang/String;Lcom/transsion/upload/bean/UploadFileType;ZLez/a;)V
...
.method private final disposeImage(Ljava/util/List;Z)V
    ...
    invoke-virtual {v0, v3}, Ltm/a;->a(Landroid/content/Context;)Lum/h$a;
    ...
    invoke-virtual {v0, v3}, Lum/h$a;->l(Ljava/lang/String;)Lum/h$a;

    move-result-object v0

    new-instance v3, Lxr/e;

    invoke-direct {v3}, Lxr/e;-><init>()V

    invoke-virtual {v0, v3}, Lum/h$a;->j(Lum/a;)Lum/h$a;
    ...
    invoke-virtual {v0, v3}, Lum/h$a;->m(Lum/e;)Lum/h$a;

    move-result-object v0

    invoke-virtual {v0}, Lum/h$a;->k()V
...
.method private static final disposeImage$lambda$9$lambda$8(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v3, v1, v0, v2}, Lkotlin/text/s;->G(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
...
.method private final disposePost(Landroid/content/Context;Lcom/transsion/publish/api/bean/RequestPostEntity;Z)V
    ...
    :cond_3
    sget-object v0, Lhs/h;->a:Lhs/h$a;
    ...
    invoke-virtual {v0, p1, v3, v2}, Lhs/h$a;->a(Landroid/content/Context;Ljava/lang/String;Lhs/h$b;)V
...
.method private final isCompleteAll()Z
    ...
    invoke-virtual {v2, v3}, Lgz/a;->a(Ljava/lang/String;)V
...
.method private final isExceptionData(Ljava/lang/String;)Z
    ...
    invoke-static {p1, v0, v1, v2, v3}, Lkotlin/text/StringsKt__StringsKt;->c0(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
...
.method private static final publishModel_delegate$lambda$0()Les/b;
    .locals 1
...
.method private final startPost(Landroid/content/Context;Z)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lxr/h;-><init>(Lcom/transsion/publish/PublishManager;Landroid/content/Context;Z)V
...
.method private final successCallback(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Ltm/a;->a(Landroid/content/Context;)Lum/h$a;

    move-result-object p1

    invoke-virtual {p1}, Lum/h$a;->i()V
...
.method private final syncPost(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, p0}, Lxr/g;-><init>(Ljava/lang/String;Lcom/transsion/publish/PublishManager;)V
...
.method private static final syncPost$lambda$26(Ljava/lang/String;Lcom/transsion/publish/PublishManager;)V
    ...
    invoke-virtual {v0, p0, v1, p1}, Lc20/b;->h(Ljava/lang/String;Ljava/lang/String;I)V

    return-void
.end method

.method private final uploadCallback()Lez/a;
    .locals 1
