...
.method public static synthetic Z(Lkotlinx/coroutines/scheduling/CoroutineScheduler;JILjava/lang/Object;)Z
    .locals 0
    ...
    invoke-static {}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->n()Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->Y(J)Z
...
.method public final U(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;Lkotlinx/coroutines/scheduling/Task;Z)Lkotlinx/coroutines/scheduling/Task;
    .locals 2
...
.method public final Y(J)Z
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h()I
...
.method public final a0()Z
    ...
    :cond_0
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->s()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
...
.method public final e(Lkotlinx/coroutines/scheduling/Task;)Z
    .locals 1
...
.method public final isTerminated()Z
    ...
    invoke-static {}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->p()Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public final k()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
    .locals 3
...
.method public final l(Ljava/lang/Runnable;ZZ)V
    ...
    :goto_0
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->k()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;

    move-result-object v2

    invoke-virtual {p0, v2, p1, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->U(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;Lkotlinx/coroutines/scheduling/Task;Z)Lkotlinx/coroutines/scheduling/Task;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e(Lkotlinx/coroutines/scheduling/Task;)Z
    ...
    invoke-virtual {p0, v0, v1, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->x(JZ)V
...
.method public final q(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
    .locals 1
...
.method public final s()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
    .locals 10
    ...
    invoke-virtual {p0, v7}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->q(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
...
.method public final u(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;II)V
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->q(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
