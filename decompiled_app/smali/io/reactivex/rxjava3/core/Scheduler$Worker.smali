...
.method public schedule(Ljava/lang/Runnable;)Lx20/b;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lx20/b;
...
.method public abstract schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lx20/b;
.end method

.method public schedulePeriodically(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lx20/b;
    .locals 17
    ...
    invoke-direct {v15, v14}, Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;-><init>(Lx20/b;)V

    invoke-static/range {p1 .. p1}, Le30/a;->t(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    invoke-virtual {v10, v14, v11, v12, v13}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lx20/b;
    ...
    invoke-virtual {v1, v0}, Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;->replace(Lx20/b;)Z
