...
.method public static synthetic R0(Landroidx/browser/customtabs/CustomTabsService$a;Landroidx/browser/customtabs/k;)V
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/browser/customtabs/CustomTabsService$a;->U0(Landroidx/browser/customtabs/k;)V
...
.method public I0(Lc/a;Landroid/os/IBinder;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public N0(Lc/a;Landroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p3}, Landroidx/browser/customtabs/CustomTabsService$a;->T0(Landroid/os/Bundle;)Landroid/net/Uri;
...
.method public P(Lc/a;Landroid/net/Uri;ILandroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public Q(Lc/a;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    .locals 3
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public S(Lc/a;Ljava/lang/String;Landroid/os/Bundle;)I
    .locals 3
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public final T0(Landroid/os/Bundle;)Landroid/net/Uri;
    .locals 3
    .param p1    # Landroid/os/Bundle;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public final synthetic U0(Landroidx/browser/customtabs/k;)V
    .locals 1
...
.method public final V0(Lc/a;Landroid/app/PendingIntent;)Z
    .locals 4
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public d(Lc/a;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/browser/customtabs/CustomTabsService$a;->V0(Lc/a;Landroid/app/PendingIntent;)Z
...
.method public h0(Lc/a;ILandroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public q(Lc/a;)Z
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/browser/customtabs/CustomTabsService$a;->V0(Lc/a;Landroid/app/PendingIntent;)Z
...
.method public s0(Lc/a;Landroid/net/Uri;)Z
    .locals 3
    .param p1    # Lc/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
