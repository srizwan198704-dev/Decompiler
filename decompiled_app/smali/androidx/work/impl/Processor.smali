...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/work/impl/Processor;->d:Lg5/c;
...
.method public static synthetic e(Landroidx/work/impl/Processor;Lf5/m;Z)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/Processor;->l(Lf5/m;Z)V

    return-void
.end method

.method public static synthetic f(Landroidx/work/impl/Processor;Ljava/util/ArrayList;Ljava/lang/String;)Lf5/u;
    .locals 0

    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/Processor;->m(Ljava/util/ArrayList;Ljava/lang/String;)Lf5/u;
...
.method public c(Ljava/lang/String;Landroidx/work/e;)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkerWrapper;->getWorkGenerationalId()Lf5/m;

    move-result-object v1

    invoke-static {p1, v1, p2}, Landroidx/work/impl/foreground/SystemForegroundDispatcher;->e(Landroid/content/Context;Lf5/m;Landroidx/work/e;)Landroid/content/Intent;

    move-result-object p1

    iget-object p2, p0, Landroidx/work/impl/Processor;->b:Landroid/content/Context;

    invoke-static {p2, p1}, Lc1/b;->startForegroundService(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public d(Lf5/m;Z)V
    ...
    invoke-virtual {p1, v1}, Lf5/m;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v2, p1, p2}, Landroidx/work/impl/e;->d(Lf5/m;Z)V
...
.method public h(Ljava/lang/String;)Lf5/u;
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkerWrapper;->getWorkSpec()Lf5/u;
...
.method public final synthetic l(Lf5/m;Z)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/Processor;->d(Lf5/m;Z)V

    return-void
.end method

.method public final synthetic m(Ljava/util/ArrayList;Ljava/lang/String;)Lf5/u;
    .locals 1
    ...
    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->o0()Lf5/z;

    move-result-object v0

    invoke-interface {v0, p2}, Lf5/z;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {p1, p2}, Lf5/v;->i(Ljava/lang/String;)Lf5/u;
...
.method public final o(Lf5/m;Z)V
    .locals 2
    .param p1    # Lf5/m;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v0, p0, Landroidx/work/impl/Processor;->d:Lg5/c;
    ...
    invoke-direct {v1, p0, p1, p2}, Landroidx/work/impl/q;-><init>(Landroidx/work/impl/Processor;Lf5/m;Z)V
...
.method public q(Landroidx/work/impl/u;Landroidx/work/WorkerParameters$a;)Z
    ...
    invoke-virtual {p1}, Landroidx/work/impl/u;->a()Lf5/m;

    move-result-object v0

    invoke-virtual {v0}, Lf5/m;->b()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v2}, Landroidx/work/impl/Processor;->o(Lf5/m;Z)V
    ...
    iget-object v5, p0, Landroidx/work/impl/Processor;->d:Lg5/c;
    ...
    invoke-direct/range {v2 .. v9}, Landroidx/work/impl/WorkerWrapper$a;-><init>(Landroid/content/Context;Landroidx/work/a;Lg5/c;Landroidx/work/impl/foreground/a;Landroidx/work/impl/WorkDatabase;Lf5/u;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Landroidx/work/impl/WorkerWrapper;->getFuture()Lcom/google/common/util/concurrent/t;
    ...
    invoke-direct {v3, p0, v4, v2}, Landroidx/work/impl/Processor$FutureListener;-><init>(Landroidx/work/impl/e;Lf5/m;Lcom/google/common/util/concurrent/t;)V

    iget-object v4, p0, Landroidx/work/impl/Processor;->d:Lg5/c;

    invoke-interface {v4}, Lg5/c;->a()Ljava/util/concurrent/Executor;
    ...
    iget-object p1, p0, Landroidx/work/impl/Processor;->d:Lg5/c;

    invoke-interface {p1}, Lg5/c;->b()Lg5/a;
