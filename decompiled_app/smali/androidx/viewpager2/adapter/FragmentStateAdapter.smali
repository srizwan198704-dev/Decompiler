...
.field final mFragments:Landroidx/collection/x;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final mItemIdToViewHolder:Landroidx/collection/x;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroidx/collection/x<",
            "Ljava/lang/Integer;",
...
.field private final mSavedStates:Landroidx/collection/x;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroidx/collection/x<",
...
.method public constructor <init>(Landroidx/fragment/app/FragmentManager;Landroidx/lifecycle/Lifecycle;)V
    ...
    iput-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;

    new-instance v0, Landroidx/collection/x;

    invoke-direct {v0}, Landroidx/collection/x;-><init>()V

    iput-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mSavedStates:Landroidx/collection/x;

    new-instance v0, Landroidx/collection/x;

    invoke-direct {v0}, Landroidx/collection/x;-><init>()V

    iput-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mItemIdToViewHolder:Landroidx/collection/x;
...
.method private ensureFragment(I)V
    ...
    iget-object v2, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;

    invoke-virtual {v2, v0, v1}, Landroidx/collection/x;->f(J)Z
    ...
    iget-object v2, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mSavedStates:Landroidx/collection/x;

    invoke-virtual {v2, v0, v1}, Landroidx/collection/x;->g(J)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0, v1, p1}, Landroidx/collection/x;->n(JLjava/lang/Object;)V
...
.method private isFragmentViewBound(J)Z
    ...
    iget-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mItemIdToViewHolder:Landroidx/collection/x;

    invoke-virtual {v0, p1, p2}, Landroidx/collection/x;->f(J)Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;
...
.method private itemForViewHolder(I)Ljava/lang/Long;
    ...
    :goto_0
    iget-object v2, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mItemIdToViewHolder:Landroidx/collection/x;

    invoke-virtual {v2}, Landroidx/collection/x;->q()I
    ...
    invoke-virtual {v2, v1}, Landroidx/collection/x;->r(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Landroidx/collection/x;->m(I)J
...
.method private removeFragment(J)V
    ...
    iget-object v1, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mSavedStates:Landroidx/collection/x;

    invoke-virtual {v1, p1, p2}, Landroidx/collection/x;->o(J)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/collection/x;->o(J)V
    ...
    invoke-virtual {v2, v0}, Landroidx/fragment/app/FragmentManager;->y1(Landroidx/fragment/app/Fragment;)Landroidx/fragment/app/Fragment$SavedState;
    ...
    invoke-virtual {v1, p1, p2, v2}, Landroidx/collection/x;->n(JLjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Landroidx/fragment/app/v;->s(Landroidx/fragment/app/Fragment;)Landroidx/fragment/app/v;
...
.method private scheduleViewAttach(Landroidx/fragment/app/Fragment;Landroid/widget/FrameLayout;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/fragment/app/FragmentManager;->m1(Landroidx/fragment/app/FragmentManager$j;Z)V
...
.method public gcFragments()V
    ...
    :goto_0
    iget-object v3, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;
    ...
    invoke-virtual {v3, v2}, Landroidx/collection/x;->m(I)J
    ...
    iget-object v5, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mItemIdToViewHolder:Landroidx/collection/x;

    invoke-virtual {v5, v3, v4}, Landroidx/collection/x;->o(J)V
    ...
    invoke-virtual {v2, v1}, Landroidx/collection/x;->m(I)J
...
.method public final onBindViewHolder(Landroidx/viewpager2/adapter/FragmentViewHolder;I)V
    ...
    iget-object v4, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mItemIdToViewHolder:Landroidx/collection/x;

    invoke-virtual {v3}, Ljava/lang/Long;->longValue()J

    move-result-wide v5

    invoke-virtual {v4, v5, v6}, Landroidx/collection/x;->o(J)V

    :cond_0
    iget-object v3, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mItemIdToViewHolder:Landroidx/collection/x;

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    invoke-virtual {v3, v0, v1, v2}, Landroidx/collection/x;->n(JLjava/lang/Object;)V
...
.method public final onViewRecycled(Landroidx/viewpager2/adapter/FragmentViewHolder;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/collection/x;->o(J)V
...
.method public placeFragmentInViewHolder(Landroidx/viewpager2/adapter/FragmentViewHolder;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/collection/x;->g(J)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v0, p1}, Landroidx/fragment/app/v;->e(Landroidx/fragment/app/Fragment;Ljava/lang/String;)Landroidx/fragment/app/v;

    move-result-object p1

    sget-object v3, Landroidx/lifecycle/Lifecycle$State;->STARTED:Landroidx/lifecycle/Lifecycle$State;

    invoke-virtual {p1, v0, v3}, Landroidx/fragment/app/v;->w(Landroidx/fragment/app/Fragment;Landroidx/lifecycle/Lifecycle$State;)Landroidx/fragment/app/v;
...
.method public final restoreState(Landroid/os/Parcelable;)V
    ...
    iget-object v0, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mSavedStates:Landroidx/collection/x;

    invoke-virtual {v0}, Landroidx/collection/x;->l()Z
    ...
    iget-object v4, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;

    invoke-virtual {v4, v2, v3, v1}, Landroidx/collection/x;->n(JLjava/lang/Object;)V
    ...
    iget-object v4, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mSavedStates:Landroidx/collection/x;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;

    invoke-virtual {p1}, Landroidx/collection/x;->l()Z
...
.method public final saveState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;

    invoke-virtual {v1}, Landroidx/collection/x;->q()I
    ...
    iget-object v5, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/x;

    invoke-virtual {v5, v3, v4}, Landroidx/collection/x;->g(J)Ljava/lang/Object;
    ...
    iget-object v5, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mSavedStates:Landroidx/collection/x;

    invoke-virtual {v5, v2, v3}, Landroidx/collection/x;->g(J)Ljava/lang/Object;
