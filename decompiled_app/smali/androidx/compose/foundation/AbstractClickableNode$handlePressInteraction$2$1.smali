...
# instance fields
.field final synthetic $interactionSource:Ls/i;
...
.method public constructor <init>(Landroidx/compose/foundation/gestures/i;JLs/i;Landroidx/compose/foundation/AbstractClickableNode;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->$interactionSource:Ls/i;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v4, p0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->$interactionSource:Ls/i;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->invoke(Lkotlinx/coroutines/o0;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v14, v0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->$interactionSource:Ls/i;

    const/4 v15, 0x0

    move-object v10, v2

    invoke-direct/range {v10 .. v15}, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1$delayJob$1;-><init>(Landroidx/compose/foundation/AbstractClickableNode;JLs/i;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-interface {v9, v0}, Landroidx/compose/foundation/gestures/i;->k0(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-interface {v2}, Lkotlinx/coroutines/v1;->isActive()Z
    ...
    invoke-static {v2, v0}, Lkotlinx/coroutines/x1;->g(Lkotlinx/coroutines/v1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v6, v7, v8}, Ls/k$b;-><init>(JLkotlin/jvm/internal/DefaultConstructorMarker;)V

    new-instance v3, Ls/k$c;

    invoke-direct {v3, v2}, Ls/k$c;-><init>(Ls/k$b;)V

    iget-object v6, v0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->$interactionSource:Ls/i;
    ...
    invoke-interface {v6, v2, v0}, Ls/i;->c(Ls/f;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_3
    iget-object v3, v0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->$interactionSource:Ls/i;

    iput-object v8, v0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->L$0:Ljava/lang/Object;

    iput v4, v0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->label:I

    invoke-interface {v3, v2, v0}, Ls/i;->c(Ls/f;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Landroidx/compose/foundation/AbstractClickableNode;->R1(Landroidx/compose/foundation/AbstractClickableNode;)Ls/k$b;

    move-result-object v2

    if-eqz v2, :cond_b

    iget-object v4, v0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1;->$interactionSource:Ls/i;

    if-eqz v7, :cond_a

    new-instance v5, Ls/k$c;

    invoke-direct {v5, v2}, Ls/k$c;-><init>(Ls/k$b;)V

    goto :goto_4

    :cond_a
    new-instance v5, Ls/k$a;

    invoke-direct {v5, v2}, Ls/k$a;-><init>(Ls/k$b;)V
    ...
    invoke-interface {v4, v5, v0}, Ls/i;->c(Ls/f;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {v1, v8}, Landroidx/compose/foundation/AbstractClickableNode;->S1(Landroidx/compose/foundation/AbstractClickableNode;Ls/k$b;)V
