...
.method public constructor <init>(Landroidx/compose/foundation/AbstractClickableNode;JLs/i;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1$delayJob$1;->$interactionSource:Ls/i;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v4, p0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1$delayJob$1;->$interactionSource:Ls/i;

    move-object v0, p1

    move-object v5, p2

    invoke-direct/range {v0 .. v5}, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1$delayJob$1;-><init>(Landroidx/compose/foundation/AbstractClickableNode;JLs/i;Lkotlin/coroutines/Continuation;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1$delayJob$1;->invoke(Lkotlinx/coroutines/o0;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Landroidx/compose/foundation/AbstractClickableNode;->N1(Landroidx/compose/foundation/AbstractClickableNode;)Z
    ...
    invoke-static {v4, v5, p0}, Lkotlinx/coroutines/v0;->a(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :cond_3
    :goto_0
    new-instance p1, Ls/k$b;

    iget-wide v3, p0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1$delayJob$1;->$offset:J

    const/4 v1, 0x0

    invoke-direct {p1, v3, v4, v1}, Ls/k$b;-><init>(JLkotlin/jvm/internal/DefaultConstructorMarker;)V

    iget-object v1, p0, Landroidx/compose/foundation/AbstractClickableNode$handlePressInteraction$2$1$delayJob$1;->$interactionSource:Ls/i;
    ...
    invoke-interface {v1, p1, p0}, Ls/i;->c(Ls/f;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {p1, v0}, Landroidx/compose/foundation/AbstractClickableNode;->S1(Landroidx/compose/foundation/AbstractClickableNode;Ls/k$b;)V
