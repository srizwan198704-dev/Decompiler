...
.method private final containsInclusive-Uv8p0NA(Lc0/i;J)Z
    .locals 3
    ...
    invoke-static {p2, p3}, Lc0/g;->m(J)F
    ...
    invoke-static {p2, p3}, Lc0/g;->n(J)F
...
# virtual methods
.method public abstract compare-3MmeM6k$foundation_release(JLc0/i;)I
.end method

.method public final isSelected-2x9bVx0$foundation_release(Lc0/i;JJ)Z
    .locals 2

    invoke-direct {p0, p1, p2, p3}, Landroidx/compose/foundation/text/selection/SelectionMode;->containsInclusive-Uv8p0NA(Lc0/i;J)Z
    ...
    invoke-direct {p0, p1, p4, p5}, Landroidx/compose/foundation/text/selection/SelectionMode;->containsInclusive-Uv8p0NA(Lc0/i;J)Z
    ...
    :cond_0
    invoke-virtual {p0, p2, p3, p1}, Landroidx/compose/foundation/text/selection/SelectionMode;->compare-3MmeM6k$foundation_release(JLc0/i;)I

    move-result p2

    invoke-virtual {p0, p4, p5, p1}, Landroidx/compose/foundation/text/selection/SelectionMode;->compare-3MmeM6k$foundation_release(JLc0/i;)I
