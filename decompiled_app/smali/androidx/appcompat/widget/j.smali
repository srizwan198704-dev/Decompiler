...
.method public final a(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/j;->d:Landroidx/appcompat/widget/i0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/j;->d:Landroidx/appcompat/widget/i0;
    ...
    iput-boolean v2, v0, Landroidx/appcompat/widget/i0;->d:Z

    iput-object v1, v0, Landroidx/appcompat/widget/i0;->a:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v2, v0, Landroidx/appcompat/widget/i0;->c:Z

    iput-object v1, v0, Landroidx/appcompat/widget/i0;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v1, v0, Landroidx/appcompat/widget/i0;->d:Z

    if-nez v1, :cond_4

    iget-boolean v1, v0, Landroidx/appcompat/widget/i0;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroidx/appcompat/widget/f;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/i0;[I)V
...
.method public c()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/j;->l()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/j;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/j;->c:Landroidx/appcompat/widget/i0;
    ...
    invoke-static {v0, v1, v2}, Landroidx/appcompat/widget/f;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/i0;[I)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Landroidx/appcompat/widget/j;->b:Landroidx/appcompat/widget/i0;
...
.method public d()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/j;->c:Landroidx/appcompat/widget/i0;
...
.method public g(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v1, p2, v2}, Landroidx/appcompat/widget/k0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/k0;
    ...
    invoke-virtual {v0, v1, p2}, Landroidx/appcompat/widget/k0;->n(II)I
    ...
    invoke-static {p1, v1}, Landroidx/core/widget/h;->c(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v1, p2}, Landroidx/appcompat/widget/k0;->k(II)I
    ...
    invoke-static {p1, p2}, Landroidx/core/widget/h;->d(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method public j(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/j;->c:Landroidx/appcompat/widget/i0;
...
.method public final l()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/j;->b:Landroidx/appcompat/widget/i0;
