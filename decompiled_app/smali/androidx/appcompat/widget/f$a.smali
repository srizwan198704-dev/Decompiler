...
# interfaces
.implements Landroidx/appcompat/widget/b0$f;
...
# virtual methods
.method public a(Landroidx/appcompat/widget/b0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/b0;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Landroidx/appcompat/R$drawable;->abc_cab_background_top_mtrl_alpha:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/b0;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/appcompat/widget/f$a;->l(Landroidx/appcompat/widget/b0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/f$a;->k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/f$a;->j(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/f$a;->g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/f$a;->i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/appcompat/widget/f$a;->f([II)Z
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/f0;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/f$a;->f([II)Z
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/f0;->c(Landroid/content/Context;I)I
    ...
    invoke-virtual {p0, p2, v0, v4}, Landroidx/appcompat/widget/f$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p2, v0, v3}, Landroidx/appcompat/widget/f$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/f0;->c(Landroid/content/Context;I)I
    ...
    invoke-virtual {p0, p2, p1, p3}, Landroidx/appcompat/widget/f$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/f0;->b(Landroid/content/Context;I)I
...
.method public final g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/f$a;->h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public final h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/f0;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Landroidx/appcompat/R$attr;->colorButtonNormal:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/f0;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/f0;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/f0;->e:[I

    const/4 v3, 0x1

    aput-object p1, v1, v3

    invoke-static {v2, p2}, Lf1/b;->k(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Landroidx/appcompat/widget/f0;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/f0;->i:[I
...
.method public final k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/f0;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroidx/appcompat/widget/f0;->b:[I
    ...
    sget-object v5, Landroidx/appcompat/widget/f0;->f:[I

    aput-object v5, v1, v4

    sget v5, Landroidx/appcompat/R$attr;->colorControlActivated:I

    invoke-static {p1, v5}, Landroidx/appcompat/widget/f0;->c(Landroid/content/Context;I)I
    ...
    :cond_0
    sget-object v2, Landroidx/appcompat/widget/f0;->b:[I

    aput-object v2, v1, v5

    sget v2, Landroidx/appcompat/R$attr;->colorSwitchThumbNormal:I

    invoke-static {p1, v2}, Landroidx/appcompat/widget/f0;->b(Landroid/content/Context;I)I

    move-result v2

    aput v2, v0, v5

    sget-object v2, Landroidx/appcompat/widget/f0;->f:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/f0;->i:[I
...
.method public final l(Landroidx/appcompat/widget/b0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 6
    .param p1    # Landroidx/appcompat/widget/b0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p1, p2, v2}, Landroidx/appcompat/widget/b0;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    sget v3, Landroidx/appcompat/R$drawable;->abc_star_half_black_48dp:I

    invoke-virtual {p1, p2, v3}, Landroidx/appcompat/widget/b0;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
