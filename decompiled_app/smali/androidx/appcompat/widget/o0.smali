...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;Z)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Landroidx/appcompat/widget/o0;-><init>(Landroidx/appcompat/widget/Toolbar;ZII)V
...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;ZII)V
    ...
    iput p4, p0, Landroidx/appcompat/widget/o0;->o:I

    iput p4, p0, Landroidx/appcompat/widget/o0;->p:I

    iput-object p1, p0, Landroidx/appcompat/widget/o0;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {p1}, Landroidx/appcompat/widget/Toolbar;->getTitle()Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/o0;->i:Ljava/lang/CharSequence;

    invoke-virtual {p1}, Landroidx/appcompat/widget/Toolbar;->getSubtitle()Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/o0;->j:Ljava/lang/CharSequence;

    iget-object v0, p0, Landroidx/appcompat/widget/o0;->i:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/o0;->g:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v2, v0, v1, p4}, Landroidx/appcompat/widget/k0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/k0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/o0;->q:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/o0;->B(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/o0;->A(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/o0;->w(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/o0;->setIcon(Landroid/graphics/drawable/Drawable;)V

    :cond_4
    iget-object p2, p0, Landroidx/appcompat/widget/o0;->g:Landroid/graphics/drawable/Drawable;

    if-nez p2, :cond_5

    iget-object p2, p0, Landroidx/appcompat/widget/o0;->q:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_5

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/o0;->z(Landroid/graphics/drawable/Drawable;)V

    :cond_5
    sget p2, Landroidx/appcompat/R$styleable;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Landroidx/appcompat/widget/k0;->k(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/o0;->b(I)V

    sget p2, Landroidx/appcompat/R$styleable;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Landroidx/appcompat/widget/k0;->n(II)I

    move-result p2

    if-eqz p2, :cond_6

    iget-object v0, p0, Landroidx/appcompat/widget/o0;->a:Landroidx/appcompat/widget/Toolbar;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/o0;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p2, v1, p4}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object p2

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/o0;->u(Landroid/view/View;)V
    ...
    invoke-virtual {p1, p2, p4}, Landroidx/appcompat/widget/k0;->m(II)I
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/o0;->a:Landroidx/appcompat/widget/Toolbar;
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/k0;->e(II)I

    move-result p2

    sget v1, Landroidx/appcompat/R$styleable;->ActionBar_contentInsetEnd:I

    invoke-virtual {p1, v1, v0}, Landroidx/appcompat/widget/k0;->e(II)I
    ...
    iget-object p4, p0, Landroidx/appcompat/widget/o0;->a:Landroidx/appcompat/widget/Toolbar;
    ...
    :cond_c
    invoke-virtual {p0}, Landroidx/appcompat/widget/o0;->t()I
    ...
    invoke-virtual {p0, p3}, Landroidx/appcompat/widget/o0;->v(I)V

    iget-object p1, p0, Landroidx/appcompat/widget/o0;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {p1}, Landroidx/appcompat/widget/Toolbar;->getNavigationContentDescription()Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/o0;->k:Ljava/lang/CharSequence;
...
.method public A(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/o0;->j:Ljava/lang/CharSequence;
...
.method public B(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/o0;->C(Ljava/lang/CharSequence;)V
...
.method public final C(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/o0;->i:Ljava/lang/CharSequence;
...
.method public final D()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/o0;->k:Ljava/lang/CharSequence;
    ...
    iget v1, p0, Landroidx/appcompat/widget/o0;->p:I
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/o0;->k:Ljava/lang/CharSequence;
...
.method public final E()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/o0;->g:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/widget/o0;->q:Landroid/graphics/drawable/Drawable;
...
.method public b(I)V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/o0;->i:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/Toolbar;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/appcompat/widget/o0;->a:Landroidx/appcompat/widget/Toolbar;

    iget-object v2, p0, Landroidx/appcompat/widget/o0;->j:Ljava/lang/CharSequence;
...
.method public e(IJ)Landroidx/core/view/ViewPropertyAnimatorCompat;
    ...
    new-instance p3, Landroidx/appcompat/widget/o0$b;

    invoke-direct {p3, p0, p1}, Landroidx/appcompat/widget/o0$b;-><init>(Landroidx/appcompat/widget/o0;I)V
...
.method public l(Landroidx/appcompat/widget/ScrollingTabContainerView;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/o0;->c:Landroid/view/View;
    ...
    :cond_0
    iput-object p1, p0, Landroidx/appcompat/widget/o0;->c:Landroid/view/View;
...
.method public n(I)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/o0;->getContext()Landroid/content/Context;
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/o0;->w(Landroid/graphics/drawable/Drawable;)V
...
.method public setIcon(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/o0;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/l$a;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/o0;->n:Landroidx/appcompat/widget/ActionMenuPresenter;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/o0;->n:Landroidx/appcompat/widget/ActionMenuPresenter;
...
.method public setMenuPrepared()V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/o0;->m:Z
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/o0;->l:Landroid/view/Window$Callback;
...
.method public v(I)V
    ...
    iget p1, p0, Landroidx/appcompat/widget/o0;->p:I

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/o0;->x(I)V
...
.method public x(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/o0;->y(Ljava/lang/CharSequence;)V
...
.method public z(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/o0;->g:Landroid/graphics/drawable/Drawable;
