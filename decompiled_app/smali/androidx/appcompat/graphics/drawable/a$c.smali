...
# instance fields
.field public K:Landroidx/collection/x;
...
.field public L:Landroidx/collection/y0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroidx/appcompat/graphics/drawable/a$c;Landroidx/appcompat/graphics/drawable/a;Landroid/content/res/Resources;)V
    ...
    iget-object p2, p1, Landroidx/appcompat/graphics/drawable/a$c;->K:Landroidx/collection/x;

    iput-object p2, p0, Landroidx/appcompat/graphics/drawable/a$c;->K:Landroidx/collection/x;

    iget-object p1, p1, Landroidx/appcompat/graphics/drawable/a$c;->L:Landroidx/collection/y0;

    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/a$c;->L:Landroidx/collection/y0;
    ...
    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/a$c;->K:Landroidx/collection/x;
...
.method public C([ILandroid/graphics/drawable/Drawable;I)I
    ...
    iget-object p2, p0, Landroidx/appcompat/graphics/drawable/a$c;->L:Landroidx/collection/y0;

    invoke-static {p3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p3

    invoke-virtual {p2, p1, p3}, Landroidx/collection/y0;->o(ILjava/lang/Object;)V
...
.method public D(IILandroid/graphics/drawable/Drawable;Z)I
    ...
    :goto_0
    iget-object v4, p0, Landroidx/appcompat/graphics/drawable/a$c;->K:Landroidx/collection/x;
    ...
    invoke-virtual {v4, v0, v1, v7}, Landroidx/collection/x;->a(JLjava/lang/Object;)V
    ...
    iget-object p4, p0, Landroidx/appcompat/graphics/drawable/a$c;->K:Landroidx/collection/x;
    ...
    invoke-virtual {p4, p1, p2, v0}, Landroidx/collection/x;->a(JLjava/lang/Object;)V
...
.method public F(I)I
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/graphics/drawable/a$c;->L:Landroidx/collection/y0;

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-virtual {v1, p1, v0}, Landroidx/collection/y0;->k(ILjava/lang/Object;)Ljava/lang/Object;
...
.method public H(II)I
    ...
    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/a$c;->K:Landroidx/collection/x;
    ...
    invoke-virtual {v0, p1, p2, v1}, Landroidx/collection/x;->i(JLjava/lang/Object;)Ljava/lang/Object;
...
.method public s()V
    ...
    invoke-virtual {v0}, Landroidx/collection/x;->e()Landroidx/collection/x;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/a$c;->K:Landroidx/collection/x;

    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/a$c;->L:Landroidx/collection/y0;

    invoke-virtual {v0}, Landroidx/collection/y0;->e()Landroidx/collection/y0;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/a$c;->L:Landroidx/collection/y0;
