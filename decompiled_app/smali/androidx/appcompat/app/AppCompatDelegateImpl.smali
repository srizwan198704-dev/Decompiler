...
# static fields
.field public static final j0:Landroidx/collection/x0;
...
.field public X:Landroidx/appcompat/app/AppCompatDelegateImpl$n;
...
.field public f0:Landroidx/appcompat/app/x;

.field public g0:Landroidx/appcompat/app/y;
...
.field public final n:Landroidx/appcompat/app/d;
...
.field public r:Landroidx/appcompat/widget/s;

.field public s:Landroidx/appcompat/app/AppCompatDelegateImpl$f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->j0:Landroidx/collection/x0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroidx/appcompat/app/d;Ljava/lang/Object;)V
    ...
    iput-object p3, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->n:Landroidx/appcompat/app/d;
    ...
    sget-object p1, Landroidx/appcompat/app/AppCompatDelegateImpl;->j0:Landroidx/collection/x0;
    ...
    invoke-virtual {p1, p3}, Landroidx/collection/x0;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p3}, Landroidx/collection/x0;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public C()V
    ...
    sget-object v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->j0:Landroidx/collection/x0;
    ...
    invoke-virtual {v0, v1}, Landroidx/collection/x0;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final C0(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;)Z
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;
...
.method public G0()Z
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->u:Lk/b;
...
.method public final L0(ILandroid/view/KeyEvent;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;

    if-eqz p1, :cond_2

    invoke-interface {p1}, Landroidx/appcompat/widget/s;->canShowOverflowMenu()Z
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/s;->isOverflowMenuShowing()Z
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/s;->showOverflowMenu()Z
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/s;->hideOverflowMenu()Z
...
.method public Q(Landroidx/appcompat/widget/Toolbar;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->m:Landroidx/appcompat/app/AppCompatDelegateImpl$l;
...
.method public final R0(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
    ...
    iget-object p3, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;
...
.method public final S(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;
...
.method public final S0(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;

    if-eqz v4, :cond_6

    invoke-interface {v4}, Landroidx/appcompat/widget/s;->setMenuPrepared()V
    ...
    invoke-interface {v4, v6, v7}, Landroidx/appcompat/widget/s;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/l$a;)V
    ...
    invoke-interface {p1, v5, p2}, Landroidx/appcompat/widget/s;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/l$a;)V
    ...
    iget-object p2, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;

    if-eqz p2, :cond_11

    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->s:Landroidx/appcompat/app/AppCompatDelegateImpl$f;

    invoke-interface {p2, v5, v0}, Landroidx/appcompat/widget/s;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/l$a;)V
...
.method public T(Lk/b$a;)Lk/b;
    ...
    invoke-direct {v0, p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$g;-><init>(Landroidx/appcompat/app/AppCompatDelegateImpl;Lk/b$a;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/app/a;->v(Lk/b$a;)Lk/b;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->u:Lk/b;

    if-eqz p1, :cond_1

    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->n:Landroidx/appcompat/app/d;

    if-eqz v1, :cond_1

    invoke-interface {v1, p1}, Landroidx/appcompat/app/d;->onSupportActionModeStarted(Lk/b;)V

    :cond_1
    iget-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->u:Lk/b;

    if-nez p1, :cond_2

    invoke-virtual {p0, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->a1(Lk/b$a;)Lk/b;
...
.method public final T0(Z)V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/s;->canShowOverflowMenu()Z
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/s;->isOverflowMenuShowPending()Z
    ...
    iget-object v3, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;

    invoke-interface {v3}, Landroidx/appcompat/widget/s;->isOverflowMenuShowing()Z
...
.method public V0(Landroid/content/res/Configuration;Landroidx/core/os/i;)V
    .locals 2
    .param p2    # Landroidx/core/os/i;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public W0(Landroidx/core/os/i;)V
    .locals 2
...
.method public final X(ZZ)Z
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->v0(Landroid/content/res/Configuration;)Landroidx/core/os/i;

    move-result-object v2

    :cond_2
    invoke-virtual {p0, v1, v2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->e1(ILandroidx/core/os/i;Z)Z
...
.method public final Z(Landroid/view/Window;)V
    ...
    invoke-static {v0, v2, v1}, Landroidx/appcompat/widget/k0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/k0;
    ...
    :cond_0
    invoke-virtual {v0}, Landroidx/appcompat/widget/k0;->x()V
...
.method public a0(Landroid/content/Context;)Landroidx/core/os/i;
    .locals 3
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_0
    invoke-static {}, Landroidx/appcompat/app/f;->u()Landroidx/core/os/i;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->v0(Landroid/content/res/Configuration;)Landroidx/core/os/i;
...
.method public a1(Lk/b$a;)Lk/b;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->n:Landroidx/appcompat/app/d;
    ...
    :try_start_0
    invoke-interface {v0, p1}, Landroidx/appcompat/app/d;->onWindowStartingSupportActionMode(Lk/b$a;)Lk/b;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->u:Lk/b;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionBarContextView;->initForMode(Lk/b;)V
    ...
    :cond_a
    iput-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->u:Lk/b;
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/app/d;->onSupportActionModeStarted(Lk/b;)V
...
.method public d0(Landroidx/appcompat/view/menu/f;)V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/s;->dismissPopups()V
...
.method public final e1(ILandroidx/core/os/i;Z)Z
    .locals 9
    .param p2    # Landroidx/core/os/i;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/appcompat/app/AppCompatDelegateImpl;->h0(Landroid/content/Context;ILandroidx/core/os/i;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->v0(Landroid/content/res/Configuration;)Landroidx/core/os/i;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->v0(Landroid/content/res/Configuration;)Landroidx/core/os/i;
    ...
    invoke-virtual {v2, v6}, Landroidx/core/os/i;->equals(Ljava/lang/Object;)Z
    ...
    sget-boolean p3, Landroidx/appcompat/app/AppCompatDelegateImpl;->m0:Z
    ...
    :cond_7
    invoke-virtual {p0, v4, v6, v7, v5}, Landroidx/appcompat/app/AppCompatDelegateImpl;->g1(ILandroidx/core/os/i;ZLandroid/content/res/Configuration;)V
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/app/AppCompatActivity;->onLocalesChanged(Landroidx/core/os/i;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->W0(Landroidx/core/os/i;)V
...
.method public g0(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/s;->isOverflowMenuShowing()Z
...
.method public final g1(ILandroidx/core/os/i;ZLandroid/content/res/Configuration;)V
    .locals 3
    .param p2    # Landroidx/core/os/i;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->V0(Landroid/content/res/Configuration;Landroidx/core/os/i;)V
...
.method public final h0(Landroid/content/Context;ILandroidx/core/os/i;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    .locals 1
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p3    # Landroidx/core/os/i;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .param p4    # Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, p2, p3}, Landroidx/appcompat/app/AppCompatDelegateImpl;->V0(Landroid/content/res/Configuration;Landroidx/core/os/i;)V
...
.method public final h1(Landroidx/core/view/WindowInsetsCompat;Landroid/graphics/Rect;)I
    ...
    invoke-static {p1, v4, v6}, Landroidx/appcompat/widget/v0;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public i(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/appcompat/app/AppCompatDelegateImpl;->h0(Landroid/content/Context;ILandroidx/core/os/i;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    :catch_1
    :cond_2
    sget-boolean v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->m0:Z
    ...
    invoke-static {p1}, Le1/h$f;->a(Landroid/content/res/Resources$Theme;)V
...
.method public final i0()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->r:Landroidx/appcompat/widget/s;

    invoke-virtual {p0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->y0()Landroid/view/Window$Callback;

    move-result-object v3

    invoke-interface {v1, v3}, Landroidx/appcompat/widget/s;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v4}, Landroidx/appcompat/widget/s;->initFeature(I)V
    ...
    invoke-interface {v1, v3}, Landroidx/appcompat/widget/s;->initFeature(I)V
...
.method public l(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->f0:Landroidx/appcompat/app/x;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->f0:Landroidx/appcompat/app/x;
    ...
    :cond_1
    :goto_0
    sget-boolean v7, Landroidx/appcompat/app/AppCompatDelegateImpl;->k0:Z

    const/4 v0, 0x0

    if-eqz v7, :cond_5

    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->g0:Landroidx/appcompat/app/y;
    ...
    iput-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->g0:Landroidx/appcompat/app/y;
    ...
    :goto_2
    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->f0:Landroidx/appcompat/app/x;

    const/4 v8, 0x1

    invoke-static {}, Landroidx/appcompat/widget/u0;->c()Z
    ...
    invoke-virtual/range {v1 .. v9}, Landroidx/appcompat/app/x;->r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
...
.method public v0(Landroid/content/res/Configuration;)Landroidx/core/os/i;
    .locals 2
