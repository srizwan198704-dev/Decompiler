...
.field public static final h:Landroidx/collection/x0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/x;->b:[Ljava/lang/Class;
    ...
    sput-object v0, Landroidx/appcompat/app/x;->d:[I
    ...
    sput-object v0, Landroidx/appcompat/app/x;->e:[I
    ...
    sput-object v0, Landroidx/appcompat/app/x;->f:[I
    ...
    sput-object v0, Landroidx/appcompat/app/x;->g:[Ljava/lang/String;

    new-instance v0, Landroidx/collection/x0;

    invoke-direct {v0}, Landroidx/collection/x0;-><init>()V

    sput-object v0, Landroidx/appcompat/app/x;->h:Landroidx/collection/x0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/app/x;->a:[Ljava/lang/Object;
...
.method public final a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    sget-object v0, Landroidx/appcompat/app/x;->d:[I
    ...
    sget-object v0, Landroidx/appcompat/app/x;->e:[I
    ...
    sget-object v0, Landroidx/appcompat/app/x;->f:[I
...
.method public final b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    sget-object v1, Landroidx/appcompat/app/x;->c:[I
    ...
    new-instance v1, Landroidx/appcompat/app/x$a;

    invoke-direct {v1, p1, v0}, Landroidx/appcompat/app/x$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Landroidx/appcompat/app/x;->u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/x;->q(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;

    move-result-object p5

    invoke-virtual {p0, p5, p2}, Landroidx/appcompat/app/x;->v(Landroid/view/View;Ljava/lang/String;)V

    goto/16 :goto_2

    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatToggleButton;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/x;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/x;->t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {p0, p5, p4}, Landroidx/appcompat/app/x;->b(Landroid/view/View;Landroid/util/AttributeSet;)V

    invoke-virtual {p0, p1, p5, p4}, Landroidx/appcompat/app/x;->a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
...
.method public final s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/x;->h:Landroidx/collection/x0;
    ...
    sget-object p3, Landroidx/appcompat/app/x;->b:[Ljava/lang/Class;
    ...
    iget-object p1, p0, Landroidx/appcompat/app/x;->a:[Ljava/lang/Object;
...
.method public final t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/appcompat/app/x;->a:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Landroidx/appcompat/app/x;->g:[Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, v3}, Landroidx/appcompat/app/x;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-virtual {p0, p1, p2, v1}, Landroidx/appcompat/app/x;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
