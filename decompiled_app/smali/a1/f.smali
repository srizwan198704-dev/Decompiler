...
.method public static g(Ljava/lang/String;Landroid/util/SparseArray;)La1/f;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, La1/f$b;-><init>(Ljava/lang/String;Landroid/util/SparseArray;)V

    return-object v0
.end method

.method public static h(Ljava/lang/String;J)La1/f;
    .locals 2
    ...
    :pswitch_1
    new-instance p0, La1/f$d;

    invoke-direct {p0}, La1/f$d;-><init>()V

    goto :goto_1

    :pswitch_2
    new-instance p0, La1/f$c;

    invoke-direct {p0}, La1/f$c;-><init>()V

    goto :goto_1

    :pswitch_3
    new-instance p0, La1/f$f;

    invoke-direct {p0}, La1/f$f;-><init>()V

    goto :goto_1

    :pswitch_4
    new-instance p0, La1/f$j;

    invoke-direct {p0}, La1/f$j;-><init>()V

    goto :goto_1

    :pswitch_5
    new-instance p0, La1/f$i;

    invoke-direct {p0}, La1/f$i;-><init>()V

    goto :goto_1

    :pswitch_6
    new-instance p0, La1/f$e;

    invoke-direct {p0}, La1/f$e;-><init>()V

    goto :goto_1

    :pswitch_7
    new-instance p0, La1/f$m;

    invoke-direct {p0}, La1/f$m;-><init>()V

    goto :goto_1

    :pswitch_8
    new-instance p0, La1/f$l;

    invoke-direct {p0}, La1/f$l;-><init>()V

    goto :goto_1

    :pswitch_9
    new-instance p0, La1/f$k;

    invoke-direct {p0}, La1/f$k;-><init>()V

    goto :goto_1

    :pswitch_a
    new-instance p0, La1/f$h;

    invoke-direct {p0}, La1/f$h;-><init>()V

    goto :goto_1

    :pswitch_b
    new-instance p0, La1/f$g;

    invoke-direct {p0}, La1/f$g;-><init>()V
