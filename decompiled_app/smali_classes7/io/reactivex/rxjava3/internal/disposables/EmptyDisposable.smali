...
.method public static complete(Lio/reactivex/rxjava3/core/b;)V
    ...
    invoke-interface {p0, v0}, Lio/reactivex/rxjava3/core/b;->onSubscribe(Lio/reactivex/rxjava3/disposables/c;)V
...
.method public static complete(Lio/reactivex/rxjava3/core/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lio/reactivex/rxjava3/core/h;->onSubscribe(Lio/reactivex/rxjava3/disposables/c;)V

    .line 4
    invoke-interface {p0}, Lio/reactivex/rxjava3/core/h;->onComplete()V

    return-void
.end method

.method public static complete(Lio/reactivex/rxjava3/core/o;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lio/reactivex/rxjava3/core/o;->onSubscribe(Lio/reactivex/rxjava3/disposables/c;)V

    .line 2
    invoke-interface {p0}, Lio/reactivex/rxjava3/core/o;->onComplete()V
...
.method public static error(Ljava/lang/Throwable;Lio/reactivex/rxjava3/core/b;)V
    ...
    invoke-interface {p1, v0}, Lio/reactivex/rxjava3/core/b;->onSubscribe(Lio/reactivex/rxjava3/disposables/c;)V
...
.method public static error(Ljava/lang/Throwable;Lio/reactivex/rxjava3/core/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lio/reactivex/rxjava3/core/h;->onSubscribe(Lio/reactivex/rxjava3/disposables/c;)V

    .line 8
    invoke-interface {p1, p0}, Lio/reactivex/rxjava3/core/h;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lio/reactivex/rxjava3/core/o;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-interface {p1, p0}, Lio/reactivex/rxjava3/core/o;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lio/reactivex/rxjava3/core/q;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lio/reactivex/rxjava3/core/q;->onSubscribe(Lio/reactivex/rxjava3/disposables/c;)V

    .line 6
    invoke-interface {p1, p0}, Lio/reactivex/rxjava3/core/q;->onError(Ljava/lang/Throwable;)V
