...
.method constructor <init>(Lg00/c;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/core/Scheduler$Worker;I)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-direct/range {v0 .. v5}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed$AbstractWindowSubscriber;-><init>(Lg00/c;JLjava/util/concurrent/TimeUnit;I)V
...
.method createFirstWindow()V
    ...
    .line 46
    .line 47
    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed$AbstractWindowSubscriber;->downstream:Lg00/c;

    .line 48
    .line 49
    invoke-interface {v3, v2}, Lg00/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 63
    .line 64
    invoke-virtual {v3, v4, v5, v6, v7}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/c;
    ...
    .line 79
    invoke-virtual/range {v8 .. v14}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedulePeriodically(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/c;
    ...
    .line 96
    :cond_0
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed$AbstractWindowSubscriber;->upstream:Lg00/d;
    ...
    .line 111
    .line 112
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed$AbstractWindowSubscriber;->downstream:Lg00/c;
    ...
    .line 120
    invoke-interface {v0, v2}, Lg00/c;->onError(Ljava/lang/Throwable;)V
...
.method drain()V
    ...
    .line 9
    .line 10
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed$AbstractWindowSubscriber;->downstream:Lg00/c;
    ...
    .line 68
    :cond_4
    invoke-interface {v1, v5}, Lg00/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 150
    .line 151
    invoke-interface {v1, v6}, Lg00/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 164
    .line 165
    invoke-virtual {v8, v9, v10, v11, v7}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/c;
    ...
    .line 179
    :cond_8
    iget-object v7, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed$AbstractWindowSubscriber;->upstream:Lg00/d;

    .line 180
    .line 181
    invoke-interface {v7}, Lg00/d;->cancel()V
