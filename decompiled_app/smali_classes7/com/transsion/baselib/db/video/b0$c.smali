.class public Lcom/transsion/baselib/db/video/b0$c;
...
.method public constructor <init>(Lcom/transsion/baselib/db/video/b0;)V
    ...
    iput-object p1, p0, Lcom/transsion/baselib/db/video/b0$c;->a:Lcom/transsion/baselib/db/video/b0;
...
.method public bridge synthetic a(Lr4/e;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/transsion/baselib/db/video/b0$c;->d(Lr4/e;Lcom/transsion/baselib/db/video/UGCVideoDetailPlayBean;)V
...
.method public b()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `ugc_video_detail_play` SET `collectionId` = ?,`ugcVideoId` = ?,`progress` = ?,`title` = ?,`coverUrl` = ?,`thumbnail` = ?,`position` = ?,`type` = ?,`timeStamp` = ?,`subtitleSelectId` = ?,`totalDuration` = ?,`subjectDurationSeconds` = ?,`averageHueLight` = ?,`subjectType` = ?,`hasDelete` = ?,`playMode` = ?,`downloadUrl` = ?,`downloadResid` = ?,`downloadFilePath` = ?,`downloadSize` = ?,`lastAdStartTimeStamp` = ?,`lastAdEndTimeStamp` = ?,`rewardPlayed` = ?,`rewardUnlock` = ?,`rewardFree` = ?,`ops` = ? WHERE `collectionId` = ?"
