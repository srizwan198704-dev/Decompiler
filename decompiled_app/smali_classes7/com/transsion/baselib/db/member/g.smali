...
.method public static synthetic g(Lcom/transsion/baselib/db/member/g;Ljava/lang/String;IIZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p5}, Lcom/transsion/baselib/db/member/g;->q(Ljava/lang/String;IIZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static synthetic h(Ljava/lang/String;IILr4/b;)Lcom/transsion/baselib/db/member/MemberResolutionBean;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/transsion/baselib/db/member/g;->o(Ljava/lang/String;IILr4/b;)Lcom/transsion/baselib/db/member/MemberResolutionBean;
...
.method public static synthetic i(Lcom/transsion/baselib/db/member/g;Lcom/transsion/baselib/db/member/MemberResolutionBean;Lr4/b;)Lkotlin/Unit;
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/transsion/baselib/db/member/g;->n(Lcom/transsion/baselib/db/member/MemberResolutionBean;Lr4/b;)Lkotlin/Unit;
...
.method public static synthetic j(ZLjava/lang/String;IILr4/b;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/transsion/baselib/db/member/g;->r(ZLjava/lang/String;IILr4/b;)Ljava/lang/Integer;
...
.method public static synthetic k(Lcom/transsion/baselib/db/member/g;Ljava/lang/String;IIZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p5}, Lcom/transsion/baselib/db/member/g;->s(Ljava/lang/String;IIZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static synthetic l(ZLjava/lang/String;IILr4/b;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/transsion/baselib/db/member/g;->p(ZLjava/lang/String;IILr4/b;)Ljava/lang/Integer;
...
.method public static synthetic o(Ljava/lang/String;IILr4/b;)Lcom/transsion/baselib/db/member/MemberResolutionBean;
    .locals 11
    ...
    :try_start_0
    invoke-interface {p3, v0}, Lr4/e;->g(I)V
    ...
    :cond_0
    invoke-interface {p3, v0, p0}, Lr4/e;->i(ILjava/lang/String;)V
    ...
    invoke-interface {p3, p0, v1, v2}, Lr4/e;->c(IJ)V

    const/4 p0, 0x3

    int-to-long p1, p2

    invoke-interface {p3, p0, p1, p2}, Lr4/e;->c(IJ)V

    const-string p0, "subjectId"

    invoke-static {p3, p0}, Landroidx/room/util/j;->c(Lr4/e;Ljava/lang/String;)I

    move-result p0

    const-string p1, "ep"

    invoke-static {p3, p1}, Landroidx/room/util/j;->c(Lr4/e;Ljava/lang/String;)I

    move-result p1

    const-string p2, "se"

    invoke-static {p3, p2}, Landroidx/room/util/j;->c(Lr4/e;Ljava/lang/String;)I

    move-result p2

    const-string v1, "vipResolutionTip"

    invoke-static {p3, v1}, Landroidx/room/util/j;->c(Lr4/e;Ljava/lang/String;)I

    move-result v1

    const-string v2, "isUnlock"

    invoke-static {p3, v2}, Landroidx/room/util/j;->c(Lr4/e;Ljava/lang/String;)I
    ...
    invoke-interface {p3, p0}, Lr4/e;->isNull(I)Z
    ...
    :cond_1
    invoke-interface {p3, p0}, Lr4/e;->o0(I)Ljava/lang/String;
    ...
    :goto_1
    invoke-interface {p3, p1}, Lr4/e;->getLong(I)J

    move-result-wide p0

    long-to-int v7, p0

    invoke-interface {p3, p2}, Lr4/e;->getLong(I)J

    move-result-wide p0

    long-to-int v8, p0

    invoke-interface {p3, v1}, Lr4/e;->isNull(I)Z
    ...
    :cond_2
    invoke-interface {p3, v1}, Lr4/e;->getLong(I)J
    ...
    :goto_4
    invoke-interface {p3, v2}, Lr4/e;->isNull(I)Z
    ...
    :cond_5
    invoke-interface {p3, v2}, Lr4/e;->getLong(I)J
...
.method public static synthetic p(ZLjava/lang/String;IILr4/b;)Ljava/lang/Integer;
    .locals 4
    ...
    :try_start_0
    invoke-interface {v0, v1, v2, v3}, Lr4/e;->c(IJ)V

    const/4 p0, 0x2

    if-nez p1, :cond_0

    invoke-interface {v0, p0}, Lr4/e;->g(I)V
    ...
    :cond_0
    invoke-interface {v0, p0, p1}, Lr4/e;->i(ILjava/lang/String;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lr4/e;->c(IJ)V
    ...
    invoke-static {p4}, Landroidx/room/util/i;->b(Lr4/b;)I
    ...
    invoke-interface {v0}, Lr4/e;->close()V
...
.method public static synthetic r(ZLjava/lang/String;IILr4/b;)Ljava/lang/Integer;
    .locals 4
...
.method public d(Lcom/transsion/baselib/db/member/MemberResolutionBean;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    new-instance v1, Lcom/transsion/baselib/db/member/c;

    invoke-direct {v1, p0, p1}, Lcom/transsion/baselib/db/member/c;-><init>(Lcom/transsion/baselib/db/member/g;Lcom/transsion/baselib/db/member/MemberResolutionBean;)V
...
.method public f(Ljava/lang/String;IIZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    new-instance v7, Lcom/transsion/baselib/db/member/e;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/transsion/baselib/db/member/e;-><init>(Lcom/transsion/baselib/db/member/g;Ljava/lang/String;IIZ)V
...
.method public final synthetic n(Lcom/transsion/baselib/db/member/MemberResolutionBean;Lr4/b;)Lkotlin/Unit;
    .locals 1
...
.method public final synthetic q(Ljava/lang/String;IIZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 0
...
.method public final synthetic s(Ljava/lang/String;IIZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 0
