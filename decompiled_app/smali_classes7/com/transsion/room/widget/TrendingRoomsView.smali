...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0}, Lrs/i0;->a(Landroid/view/View;)Lrs/i0;
    ...
    iget-object p1, p1, Lrs/i0;->b:Landroid/view/View;

    if-eqz p1, :cond_0

    new-instance p2, Lgt/t;

    invoke-direct {p2, p0}, Lgt/t;-><init>(Lcom/transsion/room/widget/TrendingRoomsView;)V
    ...
    iget-object p1, p1, Lrs/i0;->e:Landroidx/appcompat/widget/AppCompatTextView;

    if-eqz p1, :cond_1

    new-instance p2, Lgt/u;

    invoke-direct {p2, p0}, Lgt/u;-><init>(Lcom/transsion/room/widget/TrendingRoomsView;)V
...
.method public static final A(Lcom/transsion/room/widget/TrendingRoomsView;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic x(Lcom/transsion/room/widget/TrendingRoomsView;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/room/widget/TrendingRoomsView;->A(Lcom/transsion/room/widget/TrendingRoomsView;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic y(Lcom/transsion/room/widget/TrendingRoomsView;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/room/widget/TrendingRoomsView;->z(Lcom/transsion/room/widget/TrendingRoomsView;Landroid/view/View;)V

    return-void
.end method

.method public static final z(Lcom/transsion/room/widget/TrendingRoomsView;Landroid/view/View;)V
    .locals 0

    invoke-virtual {p0}, Lcom/transsion/room/widget/RoomsBaseView;->u()V
...
.method public getRecyclerView()Landroidx/recyclerview/widget/RecyclerView;
    ...
    check-cast v0, Lrs/i0;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lrs/i0;->c:Landroidx/recyclerview/widget/RecyclerView;
...
.method public getTitleView()Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v0, v0, Lrs/i0;->f:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public initRecyclerView()V
    ...
    invoke-direct {v1, v3, v2, v5, v5}, Lci/a;-><init>(IIII)V
