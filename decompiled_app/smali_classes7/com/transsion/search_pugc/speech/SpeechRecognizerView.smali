...
.method public static synthetic c(Lcom/transsion/search_pugc/speech/SpeechRecognizerView;Lmh/f;Ljava/util/List;ZZ)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/transsion/search_pugc/speech/SpeechRecognizerView;->e(Lcom/transsion/search_pugc/speech/SpeechRecognizerView;Lmh/f;Ljava/util/List;ZZ)V

    return-void
.end method

.method public static final d(Lcom/transsion/search_pugc/speech/SpeechRecognizerView;)Lkotlin/Unit;
    .locals 3
    ...
    invoke-virtual {v1, v0}, Lih/c;->e(Landroidx/fragment/app/FragmentActivity;)Lih/a;
    ...
    invoke-virtual {v1, v2}, Lih/a;->b([Ljava/lang/String;)Lmh/h;

    move-result-object v1

    invoke-interface {v1}, Lmh/h;->a()Lmh/h;
    ...
    invoke-interface {v1, v2}, Lmh/h;->c(Ljh/b;)Lmh/h;
    ...
    invoke-interface {v1, v2}, Lmh/h;->d(Ljh/c;)V
...
.method public static final e(Lcom/transsion/search_pugc/speech/SpeechRecognizerView;Lmh/f;Ljava/util/List;ZZ)V
    .locals 9
    ...
    invoke-direct/range {v1 .. v8}, Llh/a;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-virtual {p1, p2, p3}, Lmh/f;->c(Ljava/util/List;Llh/a;)V

    return-void

    :cond_1
    invoke-virtual {p1, p2}, Lmh/f;->b(Ljava/util/List;)V

    return-void
.end method

.method public static final f(Lcom/transsion/search_pugc/speech/SpeechRecognizerView;Landroidx/appcompat/app/AppCompatActivity;ZLjava/util/List;Ljava/util/List;)V
    .locals 1
    ...
    invoke-virtual {p2, p0}, Lcom/transsion/search_pugc/speech/SpeechRecognizerDialog;->G0(Lkotlin/jvm/functions/Function1;)Lcom/transsion/search_pugc/speech/SpeechRecognizerDialog;
