...
.method public static final A(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V
    .locals 6
...
.method public static final B(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Lhk/f;->e(Z)V

    invoke-direct {p0}, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->C()V
...
.method private final C()V
    ...
    iget-object v0, p0, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->a:Lik/u;
    ...
    :cond_0
    iget-object v0, v0, Lik/u;->b:Landroid/widget/Button;

    sget-object v3, Lhk/f;->a:Lhk/f;

    invoke-virtual {v3}, Lhk/f;->d()Z
    ...
    :goto_1
    iget-object v0, v1, Lik/u;->d:Landroid/widget/Button;

    invoke-virtual {v3}, Lhk/f;->a()Z
...
.method public static synthetic v(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->B(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic w(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->z(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic x(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->A(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V

    return-void
.end method

.method public static final synthetic y(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;)Lik/u;
    .locals 0

    iget-object p0, p0, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->a:Lik/u;

    return-object p0
.end method

.method public static final z(Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;Landroid/view/View;)V
    .locals 1

    sget-object p1, Lhk/f;->a:Lhk/f;

    invoke-virtual {p1}, Lhk/f;->d()Z

    move-result v0

    xor-int/lit8 v0, v0, 0x1

    invoke-virtual {p1, v0}, Lhk/f;->h(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lik/u;->c(Landroid/view/LayoutInflater;)Lik/u;

    move-result-object p1

    iput-object p1, p0, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->a:Lik/u;
    ...
    :cond_0
    invoke-virtual {p1}, Lik/u;->b()Landroidx/appcompat/widget/LinearLayoutCompat;
    ...
    iget-object v2, p0, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->a:Lik/u;
    ...
    :cond_1
    iget-object v2, v2, Lik/u;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p0, Lcom/transsion/ad/test/ad_config/TestAdPsOfferActivity;->a:Lik/u;
    ...
    :cond_2
    iget-object p1, p1, Lik/u;->b:Landroid/widget/Button;
    ...
    :cond_3
    iget-object p1, p1, Lik/u;->c:Landroid/widget/Button;
    ...
    :goto_0
    iget-object p1, v1, Lik/u;->d:Landroid/widget/Button;
