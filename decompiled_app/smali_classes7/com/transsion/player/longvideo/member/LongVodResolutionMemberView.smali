...
# instance fields
.field public a:Lcom/transsion/baseui/widget/GradientTextView;
...
# virtual methods
.method public final setConfig(Lxq/b;Lxq/a;)V
    .locals 8
    ...
    iget-object v1, p0, Lcom/transsion/player/longvideo/member/LongVodResolutionMemberView;->b:Landroid/widget/ImageView;
    ...
    invoke-virtual {v2, v3}, Lcom/transsion/player/longvideo/member/g;->m(Ljava/lang/String;)Z

    move-result v2

    invoke-static {v1, v2}, Ldi/c;->j(Landroid/view/View;Z)V
    ...
    invoke-direct {v5, p2, p1, p0, v1}, Lcom/transsion/player/longvideo/member/LongVodResolutionMemberView$setConfig$1$1;-><init>(Lxq/a;Lxq/b;Lcom/transsion/player/longvideo/member/LongVodResolutionMemberView;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-virtual {p1}, Lxq/b;->c()Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-virtual {p0, p1}, Lcom/transsion/player/longvideo/member/LongVodResolutionMemberView;->setGradientColorsV2(Lxq/b;)V
    ...
    invoke-static {p2}, Ldi/a;->c(Landroid/content/Context;)Landroid/graphics/Typeface;
...
.method public final setGradientColorsV2(Lxq/b;)V
    .locals 4
    ...
    invoke-virtual {v0, p1}, Lcom/transsion/player/longvideo/member/g;->m(Ljava/lang/String;)Z
