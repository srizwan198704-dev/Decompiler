...
.field private k:Loo/f;

.field private volatile l:Z

.field private final m:Lko/c;
...
.method public constructor <init>(Lko/b;Lcom/transsion/http/impl/DownloadCallback;)V
    .locals 2
    ...
    iput-object v0, p0, Lcom/transsion/http/b/c;->f:Llo/e;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/transsion/http/b/c;->o:J

    iput-object p1, p0, Lcom/transsion/http/b/c;->a:Lko/b;
    ...
    invoke-virtual {p2}, Loo/e;->i()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Loo/e;->n()Ljava/lang/String;
    ...
    invoke-direct {p2, p1}, Lko/c;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, Lcom/transsion/http/b/c;->m:Lko/c;

    return-void
.end method

.method private a(Loo/f;)Ljava/io/File;
    .locals 18
    ...
    iget-object v1, v0, Lcom/transsion/http/b/c;->f:Llo/e;

    iget-object v2, v0, Lcom/transsion/http/b/c;->m:Lko/c;

    invoke-virtual {v1, v2}, Llo/e;->a(Lko/e;)V
    ...
    :cond_2
    :goto_0
    iget-object v1, v0, Lcom/transsion/http/b/c;->a:Lko/b;

    invoke-virtual {v1}, Lko/b;->c()Loo/e;

    move-result-object v1

    invoke-virtual {v1}, Loo/e;->f()Ljava/util/Map;
    ...
    :cond_3
    invoke-virtual/range {p1 .. p1}, Loo/f;->i()V

    invoke-virtual/range {p1 .. p1}, Loo/f;->c()J

    move-result-wide v3

    iput-wide v3, v0, Lcom/transsion/http/b/c;->i:J

    invoke-virtual/range {p1 .. p1}, Loo/f;->e()Ljava/io/InputStream;
    ...
    iget-object v8, v0, Lcom/transsion/http/b/c;->k:Loo/f;

    invoke-virtual {v8}, Loo/f;->g()I
    ...
    invoke-static {v8}, Lqo/d;->a(Ljava/io/Closeable;)V

    invoke-static {v1}, Lqo/d;->a(Ljava/io/Closeable;)V

    invoke-static {v6}, Lqo/d;->a(Ljava/io/Closeable;)V

    iget-object v1, v0, Lcom/transsion/http/b/c;->f:Llo/e;

    iget-object v2, v0, Lcom/transsion/http/b/c;->m:Lko/c;

    invoke-virtual {v1, v2}, Llo/e;->b(Lko/e;)V
...
.method public static synthetic a(Lcom/transsion/http/b/c;)Loo/f;
    .locals 0

    iget-object p0, p0, Lcom/transsion/http/b/c;->k:Loo/f;
...
.method private e()V
    ...
    iget-object v0, p0, Lcom/transsion/http/b/c;->k:Loo/f;
...
.method private declared-synchronized f()V
    ...
    invoke-virtual {v0}, Lcom/transsion/http/impl/p;->e()V
    :try_end_0
...
.method private declared-synchronized g()V
    ...
    invoke-virtual {v0}, Lcom/transsion/http/impl/p;->u()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public run()V
    ...
    invoke-virtual {v0}, Lcom/transsion/http/impl/p;->a()V

    :cond_1
    iget-object v0, p0, Lcom/transsion/http/b/c;->a:Lko/b;

    invoke-virtual {v0}, Lko/b;->d()Loo/f;

    move-result-object v0

    iput-object v0, p0, Lcom/transsion/http/b/c;->k:Loo/f;

    const-wide/16 v1, 0x0

    :try_start_0
    invoke-direct {p0, v0}, Lcom/transsion/http/b/c;->a(Loo/f;)Ljava/io/File;
    ...
    invoke-virtual {v0}, Lcom/transsion/http/impl/p;->b()V
