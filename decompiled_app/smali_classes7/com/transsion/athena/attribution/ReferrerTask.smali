...
.field private referrerClient:Lg6/a;
...
.method public static synthetic access$000(Lcom/transsion/athena/attribution/ReferrerTask;)Lg6/a;
    .locals 0

    iget-object p0, p0, Lcom/transsion/athena/attribution/ReferrerTask;->referrerClient:Lg6/a;

    return-object p0
.end method

.method public static synthetic access$100(Lcom/transsion/athena/attribution/ReferrerTask;Lg6/d;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/transsion/athena/attribution/ReferrerTask;->trackGpReferrer(Lg6/d;)V

    return-void
.end method

.method public static synthetic access$200(Lcom/transsion/athena/attribution/ReferrerTask;)V
    .locals 0
...
.method private checkGpReferrer()V
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lcom/transsion/athena/attribution/ReferrerTask;->referrerClient:Lg6/a;

    if-nez v0, :cond_2

    iget-object v0, p0, Lcom/transsion/athena/attribution/ReferrerTask;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lg6/a;->c(Landroid/content/Context;)Lg6/a$b;
    ...
    iput-object v0, p0, Lcom/transsion/athena/attribution/ReferrerTask;->referrerClient:Lg6/a;
    ...
    invoke-virtual {v0, v1}, Lg6/a;->d(Lg6/c;)V
    :try_end_1
...
.method private isGpReferrerValid(Lg6/d;)Z
    .locals 8
    ...
    invoke-virtual {p1}, Lg6/d;->f()J

    move-result-wide v2

    invoke-virtual {p1}, Lg6/d;->b()J
...
.method private trackGpReferrer(Lg6/d;)V
    .locals 23
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, Lg6/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-virtual/range {p1 .. p1}, Lg6/d;->e()Ljava/lang/String;

    move-result-object v2

    invoke-virtual/range {p1 .. p1}, Lg6/d;->f()J

    move-result-wide v3

    invoke-virtual/range {p1 .. p1}, Lg6/d;->g()J

    move-result-wide v5

    invoke-virtual/range {p1 .. p1}, Lg6/d;->b()J

    move-result-wide v7

    invoke-virtual/range {p1 .. p1}, Lg6/d;->c()J

    move-result-wide v9

    invoke-virtual/range {p1 .. p1}, Lg6/d;->a()Z
    ...
    invoke-direct {v4, v11, v9}, Lxk/a;-><init>(Ljava/lang/String;I)V

    const/4 v9, 0x0

    invoke-virtual {v4, v12, v9}, Lxk/a;->c(Landroid/os/Bundle;Landroid/os/Bundle;)Lxk/a;

    move-result-object v4

    invoke-virtual {v4}, Lxk/a;->b()V
...
.method private trackGpReferrer(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2}, Lxk/a;-><init>(Ljava/lang/String;I)V

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Lxk/a;->c(Landroid/os/Bundle;Landroid/os/Bundle;)Lxk/a;
...
.method private trackPsReferrer(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v6, v7}, Lxk/a;-><init>(Ljava/lang/String;I)V

    const/4 v6, 0x0

    invoke-virtual {v5, v0, v6}, Lxk/a;->c(Landroid/os/Bundle;Landroid/os/Bundle;)Lxk/a;
