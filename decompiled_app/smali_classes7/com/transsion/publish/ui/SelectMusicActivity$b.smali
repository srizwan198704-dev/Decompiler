...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/transsion/publish/ui/SelectMusicActivity$b",
        "Lyr/x;",
        "Lcom/transsion/publish/api/AudioEntity;",
        "info",
        "",
        "a",
        "(Lcom/transsion/publish/api/AudioEntity;)V",
        "Publish_psRelease"
    }
    k = 0x1
    mv = {
...
.method public static final c(Lcom/transsion/publish/ui/SelectMusicActivity;Lcom/transsion/publish/api/AudioEntity;Landroid/media/MediaPlayer;)V
    ...
    invoke-static {p0}, Lcom/transsion/publish/ui/SelectMusicActivity;->I(Lcom/transsion/publish/ui/SelectMusicActivity;)Lyr/b0;
    ...
    invoke-virtual {p2}, Lyr/b0;->h()Ljava/util/List;
...
.method public a(Lcom/transsion/publish/api/AudioEntity;)V
    ...
    invoke-static {v0}, Lcom/transsion/publish/ui/SelectMusicActivity;->H(Lcom/transsion/publish/ui/SelectMusicActivity;)Lhs/d;
    ...
    invoke-direct {v1}, Lhs/d;-><init>()V

    invoke-static {v0, v1}, Lcom/transsion/publish/ui/SelectMusicActivity;->P(Lcom/transsion/publish/ui/SelectMusicActivity;Lhs/d;)V
    ...
    invoke-static {v0}, Lcom/transsion/publish/ui/SelectMusicActivity;->K(Lcom/transsion/publish/ui/SelectMusicActivity;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/transsion/publish/ui/SelectMusicActivity;->H(Lcom/transsion/publish/ui/SelectMusicActivity;)Lhs/d;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lhs/d;->c()V
    ...
    invoke-static {v1}, Lcom/transsion/publish/ui/SelectMusicActivity;->L(Lcom/transsion/publish/ui/SelectMusicActivity;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-static {v1}, Lcom/transsion/publish/ui/SelectMusicActivity;->H(Lcom/transsion/publish/ui/SelectMusicActivity;)Lhs/d;
    ...
    invoke-direct {v4, v1, p1}, Lgs/d1;-><init>(Lcom/transsion/publish/ui/SelectMusicActivity;Lcom/transsion/publish/api/AudioEntity;)V

    const/4 v1, 0x0

    invoke-virtual {v3, v2, v0, v1, v4}, Lhs/d;->d(Landroid/content/Context;Ljava/lang/String;ZLandroid/media/MediaPlayer$OnCompletionListener;)V
    ...
    invoke-static {v0, p1}, Lcom/transsion/publish/ui/SelectMusicActivity;->Q(Lcom/transsion/publish/ui/SelectMusicActivity;Ljava/lang/String;)V
    :try_end_0
