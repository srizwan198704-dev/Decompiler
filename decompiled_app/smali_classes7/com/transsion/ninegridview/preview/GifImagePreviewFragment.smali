...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "inflater",
        "Z",
        "(Landroid/view/LayoutInflater;)Lfq/c;",
        "Landroid/view/View;",
        "view",
        "initView",
...
.method public static synthetic W(Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;->b0(Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic X(Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;->a0(Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;Landroid/view/View;)V

    return-void
.end method

.method public static final synthetic Y(Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;)Lcom/transsion/moviedetailapi/bean/Image;
    .locals 0
...
.method public static final a0(Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;Landroid/view/View;)V
    .locals 0
...
.method public static final b0(Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;Landroid/view/View;)V
    .locals 0
...
# virtual methods
.method public Z(Landroid/view/LayoutInflater;)Lfq/c;
    .locals 1
    ...
    invoke-static {p1}, Lfq/c;->c(Landroid/view/LayoutInflater;)Lfq/c;
...
.method public bridge synthetic getViewBinding(Landroid/view/LayoutInflater;)La5/a;
    ...
    invoke-virtual {p0, p1}, Lcom/transsion/ninegridview/preview/GifImagePreviewFragment;->Z(Landroid/view/LayoutInflater;)Lfq/c;
...
.method public initView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iget-object p1, p1, Lfq/c;->b:Landroid/widget/FrameLayout;
    ...
    iget-object p1, p1, Lfq/c;->e:Lcom/transsion/photoview/PhotoView;
    ...
    invoke-virtual {v1, v0}, Ldl/f$b;->m(I)Ldl/f$b;

    move-result-object v0

    float-to-int p2, p2

    invoke-virtual {v0, p2}, Ldl/f$b;->c(I)Ldl/f$b;

    move-result-object p2

    const/4 v0, 0x0

    invoke-virtual {p2, v0}, Ldl/f$b;->j(I)Ldl/f$b;

    move-result-object p2

    const/4 v1, 0x1

    invoke-virtual {p2, v1}, Ldl/f$b;->f(Z)Ldl/f$b;

    move-result-object p2

    invoke-virtual {p2, v1}, Ldl/f$b;->e(Z)Ldl/f$b;

    move-result-object p2

    invoke-virtual {p2, v0}, Ldl/f$b;->k(Z)Ldl/f$b;

    move-result-object p2

    invoke-virtual {p2, v0}, Ldl/f$b;->h(Z)Ldl/f$b;
