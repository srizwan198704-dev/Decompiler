...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lxa/m;->d:Lcom/google/common/base/o;
    ...
    sput-object v0, Lxa/m;->e:Lcom/google/common/base/o;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lxa/m;->a:Ljava/util/List;

    const/4 v0, 0x0

    iput v0, p0, Lxa/m;->b:I
...
.method public static f(Lcom/google/android/exoplayer2/util/d0;I)Lcom/google/android/exoplayer2/metadata/mp4/SlowMotionData;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    sget-object p1, Lxa/m;->e:Lcom/google/common/base/o;
    ...
    sget-object v2, Lxa/m;->d:Lcom/google/common/base/o;
...
# virtual methods
.method public final a(Lpa/m;Lpa/a0;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-interface {p1, v2, v3, v1}, Lpa/m;->readFully([BII)V
...
.method public c(Lpa/m;Lpa/a0;Ljava/util/List;)I
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p3}, Lxa/m;->e(Lpa/m;Ljava/util/List;)V

    iput-wide v1, p2, Lpa/a0;->a:J
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lxa/m;->d(Lpa/m;Lpa/a0;)V

    goto :goto_1

    :cond_2
    invoke-virtual {p0, p1, p2}, Lxa/m;->a(Lpa/m;Lpa/a0;)V
    ...
    iput v3, p0, Lxa/m;->b:I

    :goto_1
    return v3
.end method

.method public final d(Lpa/m;Lpa/a0;)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, v4, v5, v2}, Lpa/m;->readFully([BII)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/exoplayer2/util/d0;->Q(I)V

    invoke-virtual {v3}, Lcom/google/android/exoplayer2/util/d0;->s()S
    ...
    :cond_0
    iget v6, p0, Lxa/m;->c:I

    int-to-long v6, v6

    sub-long v6, v0, v6

    invoke-virtual {v3}, Lcom/google/android/exoplayer2/util/d0;->q()I
    ...
    iget-object v9, p0, Lxa/m;->a:Ljava/util/List;

    new-instance v10, Lxa/m$a;

    invoke-direct {v10, v4, v6, v7, v8}, Lxa/m$a;-><init>(IJI)V
    ...
    :cond_1
    iget-object p1, p0, Lxa/m;->a:Ljava/util/List;
    ...
    check-cast p1, Lxa/m$a;

    iget-wide v0, p1, Lxa/m$a;->b:J
...
.method public final e(Lpa/m;Ljava/util/List;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3, v2}, Lcom/google/android/exoplayer2/util/d0;->Q(I)V

    invoke-virtual {v3}, Lcom/google/android/exoplayer2/util/d0;->q()I

    move-result v2

    invoke-virtual {v3, v2}, Lcom/google/android/exoplayer2/util/d0;->A(I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, Lxa/m;->b(Ljava/lang/String;)I

    move-result v4

    iget p1, p1, Lxa/m$a;->c:I
    ...
    :cond_1
    invoke-static {v3, p1}, Lxa/m;->f(Lcom/google/android/exoplayer2/util/d0;I)Lcom/google/android/exoplayer2/metadata/mp4/SlowMotionData;
...
.method public g()V
    ...
    iget-object v0, p0, Lxa/m;->a:Ljava/util/List;
