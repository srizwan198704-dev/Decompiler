...
.method public constructor <init>(Landroid/content/Context;Lka/a;Lka/a;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lz9/d;-><init>(Landroid/content/Context;Lka/a;Lka/a;I)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lka/a;Lka/a;I)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-static {}, Laa/j;->b()Lzd/a;

    move-result-object v0

    iput-object v0, p0, Lz9/d;->a:Lzd/a;

    iput-object p1, p0, Lz9/d;->c:Landroid/content/Context;
    ...
    iput-object p1, p0, Lz9/d;->b:Landroid/net/ConnectivityManager;

    sget-object p1, Lz9/a;->c:Ljava/lang/String;

    invoke-static {p1}, Lz9/d;->o(Ljava/lang/String;)Ljava/net/URL;

    move-result-object p1

    iput-object p1, p0, Lz9/d;->d:Ljava/net/URL;

    iput-object p3, p0, Lz9/d;->e:Lka/a;

    iput-object p2, p0, Lz9/d;->f:Lka/a;

    iput p4, p0, Lz9/d;->g:I

    return-void
.end method

.method public static synthetic c(Lz9/d;Lz9/d$a;)Lz9/d$b;
    .locals 0

    invoke-virtual {p0, p1}, Lz9/d;->e(Lz9/d$a;)Lz9/d$b;
...
.method public static synthetic d(Lz9/d$a;Lz9/d$b;)Lz9/d$a;
    .locals 0

    invoke-static {p0, p1}, Lz9/d;->m(Lz9/d$a;Lz9/d$b;)Lz9/d$a;
...
.method public static f(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lz9/d;->k(Landroid/content/Context;)Landroid/telephony/TelephonyManager;

    move-result-object p0

    invoke-virtual {p0}, Landroid/telephony/TelephonyManager;->getSimOperator()Ljava/lang/String;

    const-string p0, "51502"
...
.method public static i(Landroid/content/Context;)I
    ...
    invoke-static {v0, v1, p0}, Lea/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static synthetic m(Lz9/d$a;Lz9/d$b;)Lz9/d$a;
    .locals 3

    iget-object v0, p1, Lz9/d$b;->b:Ljava/net/URL;
    ...
    invoke-static {v1, v2, v0}, Lea/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    iget-object p1, p1, Lz9/d$b;->b:Ljava/net/URL;

    invoke-virtual {p0, p1}, Lz9/d$a;->a(Ljava/net/URL;)Lz9/d$a;
...
.method public a(Lcom/google/android/datatransport/runtime/i;)Lcom/google/android/datatransport/runtime/i;
    ...
    iget-object v0, p0, Lz9/d;->b:Landroid/net/ConnectivityManager;
    ...
    invoke-static {v0}, Lz9/d;->h(Landroid/net/NetworkInfo;)I
    ...
    invoke-static {v0}, Lz9/d;->g(Landroid/net/NetworkInfo;)I
    ...
    iget-object v0, p0, Lz9/d;->c:Landroid/content/Context;

    invoke-static {v0}, Lz9/d;->f(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lz9/d;->i(Landroid/content/Context;)I
...
.method public b(Lba/e;)Lcom/google/android/datatransport/runtime/backends/BackendResponse;
    .locals 4

    invoke-virtual {p0, p1}, Lz9/d;->j(Lba/e;)Laa/j;

    move-result-object v0

    iget-object v1, p0, Lz9/d;->d:Ljava/net/URL;

    invoke-virtual {p1}, Lba/e;->c()[B
    ...
    invoke-static {p1}, Lz9/a;->c([B)Lz9/a;
    ...
    :goto_0
    :try_start_1
    new-instance p1, Lz9/d$a;

    invoke-direct {p1, v1, v0, v3}, Lz9/d$a;-><init>(Ljava/net/URL;Laa/j;Ljava/lang/String;)V

    new-instance v0, Lz9/b;

    invoke-direct {v0, p0}, Lz9/b;-><init>(Lz9/d;)V
    ...
    invoke-static {v2, p1, v0, v1}, Lfa/b;->a(ILjava/lang/Object;Lfa/a;Lfa/c;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lz9/d$b;

    iget v0, p1, Lz9/d$b;->a:I

    const/16 v1, 0xc8

    if-ne v0, v1, :cond_2

    iget-wide v0, p1, Lz9/d$b;->c:J
    ...
    invoke-static {v0, v1, p1}, Lea/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final e(Lz9/d$a;)Lz9/d$b;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v0, p1, Lz9/d$a;->a:Ljava/net/URL;

    const-string v1, "CctTransportBackend"

    const-string v2, "Making request to: %s"

    invoke-static {v1, v2, v0}, Lea/a;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v3, p1, Lz9/d$a;->c:Ljava/lang/String;
    ...
    :try_start_2
    iget-object v9, p0, Lz9/d;->a:Lzd/a;

    iget-object p1, p1, Lz9/d$a;->b:Laa/j;
    ...
    invoke-interface {v9, p1, v10}, Lzd/a;->a(Ljava/lang/Object;Ljava/io/Writer;)V
    :try_end_2
    ...
    invoke-static {v1, v8, v7}, Lea/a;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v7, v5}, Lea/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v5, v7}, Lea/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p1, v6, v3, v4}, Lz9/d$b;-><init>(ILjava/net/URL;J)V
    ...
    invoke-static {v1, v0}, Lz9/d;->n(Ljava/io/InputStream;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-static {v2}, Laa/p;->b(Ljava/io/Reader;)Laa/p;

    move-result-object v2

    invoke-virtual {v2}, Laa/p;->c()J

    move-result-wide v2

    new-instance v4, Lz9/d$b;

    invoke-direct {v4, p1, v6, v2, v3}, Lz9/d$b;-><init>(ILjava/net/URL;J)V
    :try_end_6
    ...
    invoke-direct {v1, p1, v2, v3, v4}, Lz9/d$b;-><init>(ILjava/net/URL;J)V
    ...
    invoke-static {v1, v0, p1}, Lea/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    new-instance p1, Lz9/d$b;

    const/16 v0, 0x190

    invoke-direct {p1, v0, v6, v3, v4}, Lz9/d$b;-><init>(ILjava/net/URL;J)V
...
.method public final j(Lba/e;)Laa/j;
    .locals 10
    ...
    invoke-virtual {p1}, Lba/e;->b()Ljava/lang/Iterable;
    ...
    invoke-virtual {v3, v4}, Laa/o$a;->f(Lcom/google/android/datatransport/cct/internal/QosTier;)Laa/o$a;

    move-result-object v3

    iget-object v4, p0, Lz9/d;->f:Lka/a;

    invoke-interface {v4}, Lka/a;->getTime()J

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Laa/o$a;->g(J)Laa/o$a;

    move-result-object v3

    iget-object v4, p0, Lz9/d;->e:Lka/a;

    invoke-interface {v4}, Lka/a;->getTime()J

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Laa/o$a;->h(J)Laa/o$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->m(Ljava/lang/Integer;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->j(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->f(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->d(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->l(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->k(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->h(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->e(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->c(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->g(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v6}, Laa/a$a;->i(Ljava/lang/String;)Laa/a$a;
    ...
    invoke-virtual {v5, v2}, Laa/a$a;->b(Ljava/lang/String;)Laa/a$a;

    move-result-object v2

    invoke-virtual {v2}, Laa/a$a;->a()Laa/a;

    move-result-object v2

    invoke-virtual {v4, v2}, Lcom/google/android/datatransport/cct/internal/ClientInfo$a;->b(Laa/a;)Lcom/google/android/datatransport/cct/internal/ClientInfo$a;
    ...
    invoke-virtual {v3, v2}, Laa/o$a;->b(Lcom/google/android/datatransport/cct/internal/ClientInfo;)Laa/o$a;
    ...
    invoke-virtual {v2, v3}, Laa/o$a;->i(I)Laa/o$a;
    :try_end_0
    ...
    invoke-virtual {v2, v3}, Laa/o$a;->j(Ljava/lang/String;)Laa/o$a;
    ...
    invoke-virtual {v5}, Lcom/google/android/datatransport/runtime/h;->b()Ly9/c;

    move-result-object v6

    const-string v7, "proto"

    invoke-static {v7}, Ly9/c;->b(Ljava/lang/String;)Ly9/c;

    move-result-object v7

    invoke-virtual {v6, v7}, Ly9/c;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v5}, Laa/n;->l([B)Laa/n$a;
    ...
    invoke-static {v6}, Laa/n;->k(Ljava/lang/String;)Laa/n$a;
    ...
    invoke-virtual {v5, v6, v7}, Laa/n$a;->d(J)Laa/n$a;
    ...
    invoke-virtual {v6, v7, v8}, Laa/n$a;->e(J)Laa/n$a;
    ...
    invoke-virtual {v6, v7, v8}, Laa/n$a;->j(J)Laa/n$a;
    ...
    invoke-virtual {v6, v7}, Laa/n$a;->g(Lcom/google/android/datatransport/cct/internal/NetworkConnectionInfo;)Laa/n$a;
    ...
    invoke-virtual {v5, v6}, Laa/n$a;->c(Ljava/lang/Integer;)Laa/n$a;
    ...
    invoke-static {}, Laa/m;->a()Laa/m$a;

    move-result-object v7

    invoke-static {}, Laa/l;->a()Laa/l$a;
    ...
    invoke-virtual {v8, v9}, Laa/l$a;->b(Ljava/lang/Integer;)Laa/l$a;

    move-result-object v8

    invoke-virtual {v8}, Laa/l$a;->a()Laa/l;

    move-result-object v8

    invoke-virtual {v7, v8}, Laa/m$a;->b(Laa/l;)Laa/m$a;

    move-result-object v7

    invoke-virtual {v7}, Laa/m$a;->a()Laa/m;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/google/android/datatransport/cct/internal/ComplianceData$a;->b(Laa/m;)Lcom/google/android/datatransport/cct/internal/ComplianceData$a;
    ...
    invoke-virtual {v5, v6}, Laa/n$a;->b(Lcom/google/android/datatransport/cct/internal/ComplianceData;)Laa/n$a;
    ...
    invoke-virtual {v6, v7}, Laa/k$a;->b([B)Laa/k$a;
    ...
    invoke-virtual {v6, v4}, Laa/k$a;->c([B)Laa/k$a;

    :cond_7
    invoke-virtual {v6}, Laa/k$a;->a()Laa/k;

    move-result-object v4

    invoke-virtual {v5, v4}, Laa/n$a;->f(Laa/k;)Laa/n$a;

    :cond_8
    invoke-virtual {v5}, Laa/n$a;->a()Laa/n;
    ...
    invoke-static {v4, v5, v6}, Lea/a;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    goto/16 :goto_3

    :cond_a
    invoke-virtual {v2, v3}, Laa/o$a;->c(Ljava/util/List;)Laa/o$a;

    invoke-virtual {v2}, Laa/o$a;->a()Laa/o;
    ...
    :cond_b
    invoke-static {p1}, Laa/j;->a(Ljava/util/List;)Laa/j;
