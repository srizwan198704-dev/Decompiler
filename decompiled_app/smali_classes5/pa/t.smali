...
.method public static a(Lpa/m;)Z
    .locals 6
    ...
    invoke-interface {p0, v2, v3, v1}, Lpa/m;->peekFully([BII)V
...
.method public static b(Lpa/m;)I
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static c(Lpa/m;Z)Lcom/google/android/exoplayer2/metadata/Metadata;
    .locals 2
    ...
    :cond_0
    sget-object p1, Lgb/b;->b:Lgb/b$a;

    :goto_0
    new-instance v1, Lpa/y;

    invoke-direct {v1}, Lpa/y;-><init>()V

    invoke-virtual {v1, p0, p1}, Lpa/y;->a(Lpa/m;Lgb/b$a;)Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method public static d(Lpa/m;Z)Lcom/google/android/exoplayer2/metadata/Metadata;
    .locals 4
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {p0, p1}, Lpa/t;->c(Lpa/m;Z)Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method public static e(Lpa/m;Lpa/t$a;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p0}, Lpa/t;->h(Lpa/m;)Lpa/v;

    move-result-object p0

    iput-object p0, p1, Lpa/t$a;->a:Lpa/v;

    goto :goto_0

    :cond_0
    iget-object v5, p1, Lpa/t$a;->a:Lpa/v;
    ...
    invoke-static {p0, v0}, Lpa/t;->g(Lpa/m;I)Lpa/v$a;

    move-result-object p0

    invoke-virtual {v5, p0}, Lpa/v;->b(Lpa/v$a;)Lpa/v;
    ...
    invoke-static {p0, v0}, Lpa/t;->j(Lpa/m;I)Ljava/util/List;

    move-result-object p0

    invoke-virtual {v5, p0}, Lpa/v;->c(Ljava/util/List;)Lpa/v;
    ...
    invoke-interface {p0, v6, v3, v0}, Lpa/m;->readFully([BII)V
    ...
    invoke-virtual {v5, p0}, Lpa/v;->a(Ljava/util/List;)Lpa/v;
...
.method public static f(Lcom/google/android/exoplayer2/util/d0;)Lpa/v$a;
    .locals 10
    ...
    new-instance p0, Lpa/v$a;

    invoke-direct {p0, v3, v4}, Lpa/v$a;-><init>([J[J)V

    return-object p0
.end method

.method public static g(Lpa/m;I)Lpa/v$a;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0, v1, v2, p1}, Lpa/m;->readFully([BII)V

    invoke-static {v0}, Lpa/t;->f(Lcom/google/android/exoplayer2/util/d0;)Lpa/v$a;
...
.method public static h(Lpa/m;)Lpa/v;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0, v1, v2, v0}, Lpa/m;->readFully([BII)V

    new-instance p0, Lpa/v;

    const/4 v0, 0x4

    invoke-direct {p0, v1, v0}, Lpa/v;-><init>([BI)V

    return-object p0
.end method

.method public static i(Lpa/m;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0, v2, v3, v1}, Lpa/m;->readFully([BII)V
...
.method public static j(Lpa/m;I)Ljava/util/List;
    .locals 3
    ...
    invoke-static {v0, v2, v2}, Lpa/h0;->j(Lcom/google/android/exoplayer2/util/d0;ZZ)Lpa/h0$b;

    move-result-object p0

    iget-object p0, p0, Lpa/h0$b;->b:[Ljava/lang/String;
