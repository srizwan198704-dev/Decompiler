...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lza/y;->a:Lcom/google/android/exoplayer2/util/l0;

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Lza/y;->f:J

    iput-wide v0, p0, Lza/y;->g:J

    iput-wide v0, p0, Lza/y;->h:J

    new-instance v0, Lcom/google/android/exoplayer2/util/d0;

    invoke-direct {v0}, Lcom/google/android/exoplayer2/util/d0;-><init>()V

    iput-object v0, p0, Lza/y;->b:Lcom/google/android/exoplayer2/util/d0;
...
.method public static l(Lcom/google/android/exoplayer2/util/d0;)J
    .locals 6
    ...
    invoke-virtual {p0, v1, v5, v4}, Lcom/google/android/exoplayer2/util/d0;->j([BII)V

    invoke-virtual {p0, v0}, Lcom/google/android/exoplayer2/util/d0;->P(I)V

    invoke-static {v1}, Lza/y;->a([B)Z
...
# virtual methods
.method public final b(Lpa/m;)I
    .locals 2

    iget-object v0, p0, Lza/y;->b:Lcom/google/android/exoplayer2/util/d0;
...
.method public d()Lcom/google/android/exoplayer2/util/l0;
    ...
    iget-object v0, p0, Lza/y;->a:Lcom/google/android/exoplayer2/util/l0;
...
.method public g(Lpa/m;Lpa/a0;)I
    .locals 6
    ...
    iget-boolean v0, p0, Lza/y;->e:Z

    if-nez v0, :cond_0

    invoke-virtual {p0, p1, p2}, Lza/y;->j(Lpa/m;Lpa/a0;)I
    ...
    invoke-virtual {p0, p1}, Lza/y;->b(Lpa/m;)I
    ...
    :cond_1
    iget-boolean v0, p0, Lza/y;->d:Z

    if-nez v0, :cond_2

    invoke-virtual {p0, p1, p2}, Lza/y;->h(Lpa/m;Lpa/a0;)I
    ...
    :cond_3
    iget-object p2, p0, Lza/y;->a:Lcom/google/android/exoplayer2/util/l0;
...
.method public final h(Lpa/m;Lpa/a0;)I
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    iget-object p2, p0, Lza/y;->b:Lcom/google/android/exoplayer2/util/d0;
    ...
    iget-object p1, p0, Lza/y;->b:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {p0, p1}, Lza/y;->i(Lcom/google/android/exoplayer2/util/d0;)J

    move-result-wide p1

    iput-wide p1, p0, Lza/y;->f:J

    iput-boolean v2, p0, Lza/y;->d:Z
...
.method public final i(Lcom/google/android/exoplayer2/util/d0;)J
    ...
    invoke-virtual {p0, v2, v0}, Lza/y;->f([BI)I
...
.method public final j(Lpa/m;Lpa/a0;)I
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p1}, Lza/y;->k(Lcom/google/android/exoplayer2/util/d0;)J

    move-result-wide p1

    iput-wide p1, p0, Lza/y;->g:J

    iput-boolean v4, p0, Lza/y;->e:Z

    return v0
.end method

.method public final k(Lcom/google/android/exoplayer2/util/d0;)J
    .locals 6
    ...
    invoke-virtual {p0, v4, v1}, Lza/y;->f([BI)I
