...
.field public k:Lcom/google/android/exoplayer2/p1;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lza/f;-><init>(Ljava/lang/String;)V
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lza/f;->a:Lcom/google/android/exoplayer2/util/c0;
    ...
    iput-object v1, p0, Lza/f;->b:Lcom/google/android/exoplayer2/util/d0;

    const/4 v0, 0x0

    iput v0, p0, Lza/f;->f:I

    iput v0, p0, Lza/f;->g:I

    iput-boolean v0, p0, Lza/f;->h:Z

    iput-boolean v0, p0, Lza/f;->i:Z

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Lza/f;->m:J

    iput-object p1, p0, Lza/f;->c:Ljava/lang/String;

    return-void
.end method

.method private a(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    .locals 2
    ...
    iget p1, p0, Lza/f;->g:I

    add-int/2addr p1, v0

    iput p1, p0, Lza/f;->g:I
...
.method private e()V
    ...
    iget-object v0, p0, Lza/f;->a:Lcom/google/android/exoplayer2/util/c0;
    ...
    iget-object v1, p0, Lza/f;->k:Lcom/google/android/exoplayer2/p1;
    ...
    iget v4, v1, Lcom/google/android/exoplayer2/p1;->y:I

    if-ne v3, v4, :cond_0

    iget v3, v0, Lcom/google/android/exoplayer2/audio/c$b;->b:I

    iget v4, v1, Lcom/google/android/exoplayer2/p1;->z:I
    ...
    iget-object v3, p0, Lza/f;->d:Ljava/lang/String;

    invoke-virtual {v1, v3}, Lcom/google/android/exoplayer2/p1$b;->S(Ljava/lang/String;)Lcom/google/android/exoplayer2/p1$b;
    ...
    iget-object v2, p0, Lza/f;->c:Ljava/lang/String;
    ...
    iput-object v1, p0, Lza/f;->k:Lcom/google/android/exoplayer2/p1;

    iget-object v2, p0, Lza/f;->e:Lpa/e0;
    ...
    iget-object v2, p0, Lza/f;->k:Lcom/google/android/exoplayer2/p1;
...
.method public b(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    iget-object v0, p0, Lza/f;->e:Lpa/e0;
    ...
    iget v2, p0, Lza/f;->l:I

    iget v3, p0, Lza/f;->g:I
    ...
    invoke-interface {v2, p1, v0}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget v2, p0, Lza/f;->g:I

    add-int/2addr v2, v0

    iput v2, p0, Lza/f;->g:I

    iget v7, p0, Lza/f;->l:I

    if-ne v2, v7, :cond_0

    iget-wide v4, p0, Lza/f;->m:J
    ...
    iget-object v3, p0, Lza/f;->e:Lpa/e0;
    ...
    iget-wide v2, p0, Lza/f;->m:J

    iget-wide v4, p0, Lza/f;->j:J

    add-long/2addr v2, v4

    iput-wide v2, p0, Lza/f;->m:J
    ...
    :cond_3
    iget-object v0, p0, Lza/f;->b:Lcom/google/android/exoplayer2/util/d0;
    ...
    invoke-direct {p0, p1, v0, v3}, Lza/f;->a(Lcom/google/android/exoplayer2/util/d0;[BI)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lza/f;->e()V
    ...
    iget-object v1, p0, Lza/f;->b:Lcom/google/android/exoplayer2/util/d0;

    invoke-interface {v0, v1, v3}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iput v2, p0, Lza/f;->f:I

    goto :goto_0

    :cond_4
    invoke-direct {p0, p1}, Lza/f;->f(Lcom/google/android/exoplayer2/util/d0;)Z
...
.method public d(Lpa/n;Lza/i0$d;)V
    ...
    iput-object p1, p0, Lza/f;->e:Lpa/e0;
