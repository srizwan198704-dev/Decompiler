...
.method public constructor <init>(Z)V
    ...
    invoke-direct {p0, p1, v0}, Lza/i;-><init>(ZLjava/lang/String;)V
...
.method public constructor <init>(ZLjava/lang/String;)V
    ...
    iput-object v0, p0, Lza/i;->b:Lcom/google/android/exoplayer2/util/c0;

    new-instance v0, Lcom/google/android/exoplayer2/util/d0;

    sget-object v1, Lza/i;->v:[B
    ...
    iput-object v0, p0, Lza/i;->c:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {p0}, Lza/i;->q()V

    const/4 v0, -0x1

    iput v0, p0, Lza/i;->m:I

    iput v0, p0, Lza/i;->n:I

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Lza/i;->q:J

    iput-wide v0, p0, Lza/i;->s:J

    iput-boolean p1, p0, Lza/i;->a:Z

    iput-object p2, p0, Lza/i;->d:Ljava/lang/String;
...
.method private g(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    iget p1, p0, Lza/i;->i:I

    add-int/2addr p1, v0

    iput p1, p0, Lza/i;->i:I
...
.method public final a()V
    ...
    iget-object v0, p0, Lza/i;->f:Lpa/e0;

    invoke-static {v0}, Lcom/google/android/exoplayer2/util/a;->e(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lza/i;->t:Lpa/e0;

    invoke-static {v0}, Lcom/google/android/exoplayer2/util/p0;->j(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lza/i;->g:Lpa/e0;
...
.method public b(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    invoke-virtual {p0, p1}, Lza/i;->n(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    :goto_1
    iget-object v1, p0, Lza/i;->b:Lcom/google/android/exoplayer2/util/c0;

    iget-object v1, v1, Lcom/google/android/exoplayer2/util/c0;->a:[B

    invoke-direct {p0, p1, v1, v0}, Lza/i;->g(Lcom/google/android/exoplayer2/util/d0;[BI)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lza/i;->l()V

    goto :goto_0

    :cond_4
    iget-object v0, p0, Lza/i;->c:Lcom/google/android/exoplayer2/util/d0;
    ...
    invoke-direct {p0, p1, v0, v1}, Lza/i;->g(Lcom/google/android/exoplayer2/util/d0;[BI)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lza/i;->m()V

    goto :goto_0

    :cond_5
    invoke-virtual {p0, p1}, Lza/i;->e(Lcom/google/android/exoplayer2/util/d0;)V

    goto :goto_0

    :cond_6
    invoke-virtual {p0, p1}, Lza/i;->h(Lcom/google/android/exoplayer2/util/d0;)V
...
.method public d(Lpa/n;Lza/i0$d;)V
    ...
    iput-object v0, p0, Lza/i;->e:Ljava/lang/String;
    ...
    iput-object v0, p0, Lza/i;->f:Lpa/e0;

    iput-object v0, p0, Lza/i;->t:Lpa/e0;

    iget-boolean v0, p0, Lza/i;->a:Z
    ...
    iput-object p1, p0, Lza/i;->g:Lpa/e0;
...
.method public final e(Lcom/google/android/exoplayer2/util/d0;)V
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Lza/i;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    iget-object p1, p0, Lza/i;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    invoke-virtual {p0}, Lza/i;->o()V

    return-void

    :cond_1
    iget-boolean v0, p0, Lza/i;->l:Z

    if-nez v0, :cond_2

    const/4 v0, 0x1

    iput-boolean v0, p0, Lza/i;->l:Z

    iget v0, p0, Lza/i;->o:I

    iput v0, p0, Lza/i;->m:I

    iput p1, p0, Lza/i;->n:I
...
.method public final f(Lcom/google/android/exoplayer2/util/d0;I)Z
    .locals 8
    ...
    invoke-virtual {p0, p1, v0, v1}, Lza/i;->u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    :cond_1
    iget v4, p0, Lza/i;->n:I

    const/4 v6, 0x2

    if-eq v4, v5, :cond_4

    iget-object v4, p0, Lza/i;->b:Lcom/google/android/exoplayer2/util/c0;

    iget-object v4, v4, Lcom/google/android/exoplayer2/util/c0;->a:[B

    invoke-virtual {p0, p1, v4, v1}, Lza/i;->u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    invoke-virtual {p0, p1, v4, v3}, Lza/i;->u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    :cond_5
    iget-object v3, p0, Lza/i;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    invoke-virtual {p0, v5, p1}, Lza/i;->j(BB)Z
...
.method public final h(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    invoke-virtual {p0, v8, v6}, Lza/i;->j(BB)Z

    move-result v6

    if-eqz v6, :cond_3

    iget-boolean v6, p0, Lza/i;->l:Z

    if-nez v6, :cond_0

    add-int/lit8 v6, v1, -0x1

    invoke-virtual {p0, p1, v6}, Lza/i;->f(Lcom/google/android/exoplayer2/util/d0;I)Z
    ...
    :goto_1
    iput-boolean v0, p0, Lza/i;->k:Z

    iget-boolean v0, p0, Lza/i;->l:Z

    if-nez v0, :cond_2

    invoke-virtual {p0}, Lza/i;->p()V
    ...
    iput v5, p0, Lza/i;->j:I

    goto :goto_0

    :cond_4
    invoke-virtual {p0}, Lza/i;->s()V
...
.method public final l()V
    ...
    iget-object v4, p0, Lza/i;->e:Ljava/lang/String;
    ...
    iget-object v1, p0, Lza/i;->d:Ljava/lang/String;
    ...
    iput-wide v5, p0, Lza/i;->q:J

    iget-object v1, p0, Lza/i;->f:Lpa/e0;

    invoke-interface {v1, v0}, Lpa/e0;->d(Lcom/google/android/exoplayer2/p1;)V

    iput-boolean v2, p0, Lza/i;->p:Z
    ...
    iget-object v3, p0, Lza/i;->f:Lpa/e0;

    iget-wide v4, p0, Lza/i;->q:J

    const/4 v6, 0x0

    move-object v2, p0

    invoke-virtual/range {v2 .. v7}, Lza/i;->t(Lpa/e0;JII)V
...
.method public final m()V
    ...
    iget-object v1, p0, Lza/i;->c:Lcom/google/android/exoplayer2/util/d0;
    ...
    iget-object v4, p0, Lza/i;->g:Lpa/e0;
    ...
    invoke-virtual/range {v3 .. v8}, Lza/i;->t(Lpa/e0;JII)V
...
.method public final n(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    iget v1, p0, Lza/i;->r:I

    iget v2, p0, Lza/i;->i:I
    ...
    iget-object v1, p0, Lza/i;->t:Lpa/e0;

    invoke-interface {v1, p1, v0}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V
    ...
    iget v4, p0, Lza/i;->r:I

    if-ne p1, v4, :cond_1

    iget-wide v1, p0, Lza/i;->s:J
    ...
    iget-wide v0, p0, Lza/i;->s:J

    iget-wide v2, p0, Lza/i;->u:J
...
.method public final t(Lpa/e0;JII)V
    .locals 1
    ...
    iput p4, p0, Lza/i;->i:I

    iput-object p1, p0, Lza/i;->t:Lpa/e0;

    iput-wide p2, p0, Lza/i;->u:J

    iput p5, p0, Lza/i;->r:I

    return-void
.end method

.method public final u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    .locals 2
