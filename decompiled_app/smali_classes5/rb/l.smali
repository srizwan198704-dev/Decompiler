...
.field public g:Lpa/n;

.field public h:Lpa/e0;
...
.method public constructor <init>(Lrb/j;Lcom/google/android/exoplayer2/p1;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lrb/l;->a:Lrb/j;

    new-instance p1, Lrb/d;

    invoke-direct {p1}, Lrb/d;-><init>()V

    iput-object p1, p0, Lrb/l;->b:Lrb/d;

    new-instance p1, Lcom/google/android/exoplayer2/util/d0;

    invoke-direct {p1}, Lcom/google/android/exoplayer2/util/d0;-><init>()V

    iput-object p1, p0, Lrb/l;->c:Lcom/google/android/exoplayer2/util/d0;
    ...
    iput-object p1, p0, Lrb/l;->d:Lcom/google/android/exoplayer2/p1;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lrb/l;->e:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lrb/l;->f:Ljava/util/List;

    const/4 p1, 0x0

    iput p1, p0, Lrb/l;->j:I

    const-wide p1, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide p1, p0, Lrb/l;->k:J
...
.method public final a()V
    ...
    :try_start_0
    iget-object v0, p0, Lrb/l;->a:Lrb/j;
    ...
    iget-object v4, p0, Lrb/l;->c:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v4}, Lcom/google/android/exoplayer2/util/d0;->d()[B

    move-result-object v4

    iget v5, p0, Lrb/l;->i:I
    ...
    iget v4, p0, Lrb/l;->i:I

    invoke-virtual {v3, v4}, Ljava/nio/ByteBuffer;->limit(I)Ljava/nio/Buffer;

    iget-object v3, p0, Lrb/l;->a:Lrb/j;
    ...
    :cond_1
    :goto_2
    invoke-virtual {v0}, Lrb/n;->getEventTimeCount()I

    move-result v1

    if-ge v6, v1, :cond_2

    invoke-virtual {v0, v6}, Lrb/n;->getEventTime(I)J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lrb/n;->getCues(J)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Lrb/l;->b:Lrb/d;

    invoke-virtual {v2, v1}, Lrb/d;->a(Ljava/util/List;)[B

    move-result-object v1

    iget-object v2, p0, Lrb/l;->e:Ljava/util/List;
    ...
    iget-object v2, p0, Lrb/l;->f:Ljava/util/List;
...
.method public b(Lpa/n;)V
    ...
    iput-object p1, p0, Lrb/l;->g:Lpa/n;

    const/4 v0, 0x3

    invoke-interface {p1, v1, v0}, Lpa/n;->track(II)Lpa/e0;

    move-result-object p1

    iput-object p1, p0, Lrb/l;->h:Lpa/e0;

    iget-object p1, p0, Lrb/l;->g:Lpa/n;
    ...
    invoke-direct {v0, v5, v6, v3, v4}, Lpa/z;-><init>([J[JJ)V

    invoke-interface {p1, v0}, Lpa/n;->d(Lpa/b0;)V

    iget-object p1, p0, Lrb/l;->h:Lpa/e0;

    iget-object v0, p0, Lrb/l;->d:Lcom/google/android/exoplayer2/p1;

    invoke-interface {p1, v0}, Lpa/e0;->d(Lcom/google/android/exoplayer2/p1;)V

    iput v2, p0, Lrb/l;->j:I
...
.method public c(Lpa/m;Lpa/a0;)I
    ...
    iget-object p2, p0, Lrb/l;->c:Lcom/google/android/exoplayer2/util/d0;
    ...
    invoke-virtual {p0, p1}, Lrb/l;->e(Lpa/m;)Z

    move-result p2

    if-eqz p2, :cond_3

    invoke-virtual {p0}, Lrb/l;->a()V

    invoke-virtual {p0}, Lrb/l;->g()V

    iput v0, p0, Lrb/l;->j:I
    ...
    invoke-virtual {p0, p1}, Lrb/l;->f(Lpa/m;)Z
...
.method public final e(Lpa/m;)Z
    ...
    iget-object v0, p0, Lrb/l;->c:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v0}, Lcom/google/android/exoplayer2/util/d0;->b()I

    move-result v0

    iget v1, p0, Lrb/l;->i:I
    ...
    iget-object v2, p0, Lrb/l;->c:Lcom/google/android/exoplayer2/util/d0;
    ...
    invoke-interface {p1, v0, v1, v2}, Lpa/m;->read([BII)I
    ...
    iget v2, p0, Lrb/l;->i:I

    add-int/2addr v2, v0

    iput v2, p0, Lrb/l;->i:I
...
.method public final f(Lpa/m;)Z
    ...
    :goto_0
    invoke-interface {p1, v0}, Lpa/m;->skip(I)I
...
.method public final g()V
    ...
    iget-object v0, p0, Lrb/l;->h:Lpa/e0;

    invoke-static {v0}, Lcom/google/android/exoplayer2/util/a;->i(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lrb/l;->e:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->size()I

    move-result v0

    iget-object v1, p0, Lrb/l;->f:Ljava/util/List;
    ...
    :cond_1
    iget-object v4, p0, Lrb/l;->e:Ljava/util/List;
    ...
    iget-object v3, p0, Lrb/l;->h:Lpa/e0;

    invoke-interface {v3, v1, v8}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget-object v4, p0, Lrb/l;->h:Lpa/e0;

    iget-object v1, p0, Lrb/l;->e:Ljava/util/List;
