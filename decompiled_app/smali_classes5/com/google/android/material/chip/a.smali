...
.field public W:Lec/i;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field public X:Lec/i;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field public final n0:Lcom/google/android/material/internal/y;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p0, p1}, Luc/i;->S(Landroid/content/Context;)V
...
.method public static D1(Lrc/d;)Z
    .locals 1
    .param p0    # Lrc/d;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0}, Lrc/d;->i()Landroid/content/res/ColorStateList;
...
.method public B2(Lec/i;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/chip/a;->X:Lec/i;
...
.method public C2(I)V
    ...
    invoke-static {v0, p1}, Lec/i;->d(Landroid/content/Context;I)Lec/i;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/chip/a;->B2(Lec/i;)V
...
.method public final E1(Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p3, p2, v0}, Lrc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p3, p2, v1}, Lrc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p3, p2, v1}, Lrc/c;->h(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lrc/d;

    move-result-object p3

    sget v1, Lcom/google/android/material/R$styleable;->Chip_android_textSize:I

    invoke-virtual {p3}, Lrc/d;->j()F
    ...
    invoke-virtual {p3, v1}, Lrc/d;->l(F)V

    invoke-virtual {p0, p3}, Lcom/google/android/material/chip/a;->O2(Lrc/d;)V
    ...
    invoke-static {v1, p2, v2}, Lrc/c;->e(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1, p2, v2}, Lrc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2, p3}, Lrc/c;->e(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2, p3}, Lec/i;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lec/i;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/chip/a;->L2(Lec/i;)V
...
.method public final G1([I[I)Z
    ...
    :goto_0
    invoke-virtual {p0, v1}, Luc/i;->l(I)I
    ...
    :goto_1
    invoke-virtual {p0, v3}, Luc/i;->l(I)I
    ...
    :goto_2
    invoke-virtual {p0}, Luc/i;->z()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0}, Luc/i;->d0(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/internal/y;->e()Lrc/d;
    ...
    invoke-virtual {v1}, Lrc/d;->i()Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0, v3}, Lkc/d;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final K0(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v0, p2}, Luc/i;->h(Landroid/graphics/RectF;Landroid/graphics/Path;)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Luc/i;->r(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/Path;Landroid/graphics/RectF;)V
...
.method public final L0(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-static {v1, v2}, Lf1/b;->p(II)I
...
.method public L2(Lec/i;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/chip/a;->W:Lec/i;
...
.method public final M0(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/material/internal/y;->e()Lrc/d;
...
.method public P2(I)V
    ...
    invoke-direct {v0, v1, p1}, Lrc/d;-><init>(Landroid/content/Context;I)V

    invoke-virtual {p0, v0}, Lcom/google/android/material/chip/a;->O2(Lrc/d;)V
...
.method public S2(F)V
    ...
    invoke-virtual {p0}, Lcom/google/android/material/chip/a;->q1()Lrc/d;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, Lrc/d;->l(F)V
...
.method public final b3()V
    ...
    invoke-static {v0}, Lsc/b;->d(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public final c3()V
    ...
    invoke-static {v1}, Lsc/b;->d(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static/range {v2 .. v7}, Lfc/a;->a(Landroid/graphics/Canvas;FFFFI)I
...
.method public getOutline(Landroid/graphics/Outline;)V
    ...
    invoke-super {p0, p1}, Luc/i;->getOutline(Landroid/graphics/Outline;)V
...
.method public isStateful()Z
    ...
    invoke-virtual {v0}, Lcom/google/android/material/internal/y;->e()Lrc/d;

    move-result-object v0

    invoke-static {v0}, Lcom/google/android/material/chip/a;->D1(Lrc/d;)Z
...
.method public j2(F)V
    ...
    invoke-super {p0, p1}, Luc/i;->o0(F)V
...
.method public k1()Lec/i;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object v0, p0, Lcom/google/android/material/chip/a;->X:Lec/i;
...
.method public o1()Lec/i;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object v0, p0, Lcom/google/android/material/chip/a;->W:Lec/i;
...
.method public onLayoutDirectionChanged(I)Z
    ...
    invoke-static {v1, p1}, Lg1/a;->m(Landroid/graphics/drawable/Drawable;I)Z
...
.method public final s0(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v0, v1}, Lg1/a;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, v0, p1}, Lkc/d;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
