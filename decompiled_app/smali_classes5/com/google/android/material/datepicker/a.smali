...
.method public constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILuc/n;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/a;->f:Luc/n;
...
.method public static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/a;
    ...
    invoke-static {p0, p1, v1}, Lrc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Luc/n;->b(Landroid/content/Context;II)Luc/n$b;

    move-result-object p0

    invoke-virtual {p0}, Luc/n$b;->m()Luc/n;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILuc/n;Landroid/graphics/Rect;)V
...
.method public e(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Luc/n;

    invoke-virtual {v0, v2}, Luc/i;->setShapeAppearanceModel(Luc/n;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Luc/n;

    invoke-virtual {v1, v2}, Luc/i;->setShapeAppearanceModel(Luc/n;)V
    ...
    invoke-virtual {v0, p2, v2}, Luc/i;->m0(FLandroid/content/res/ColorStateList;)V
