...
.method public static c(Landroid/content/Context;FFLhc/a;)Lcom/google/android/material/carousel/b;
    .locals 19
    ...
    iget v8, v2, Lhc/a;->b:F

    iget v9, v2, Lhc/a;->c:I

    invoke-static {v6, v8, v9}, Lcom/google/android/material/carousel/a;->b(FFI)F

    move-result v8

    iget v9, v2, Lhc/a;->b:F

    iget v10, v2, Lhc/a;->c:I
    ...
    iget v11, v2, Lhc/a;->e:F

    iget v12, v2, Lhc/a;->d:I

    invoke-static {v6, v10, v11, v12}, Lcom/google/android/material/carousel/a;->j(FFFI)F

    move-result v6

    iget v10, v2, Lhc/a;->f:F

    iget v11, v2, Lhc/a;->g:I
    ...
    iget v11, v2, Lhc/a;->f:F

    iget v12, v2, Lhc/a;->g:I
    ...
    iget v12, v2, Lhc/a;->e:F

    iget v14, v2, Lhc/a;->d:I

    invoke-static {v6, v11, v12, v14}, Lcom/google/android/material/carousel/a;->j(FFFI)F

    move-result v6

    iget v11, v2, Lhc/a;->b:F

    iget v12, v2, Lhc/a;->c:I
    ...
    invoke-static {v3, v11, v0}, Lhc/f;->b(FFF)F

    move-result v11

    iget v12, v2, Lhc/a;->b:F

    iget v14, v2, Lhc/a;->f:F

    invoke-static {v12, v14, v0}, Lhc/f;->b(FFF)F
    ...
    :goto_0
    iget v4, v2, Lhc/a;->d:I

    if-lez v4, :cond_1

    iget v5, v2, Lhc/a;->e:F
    ...
    :goto_1
    iget v0, v2, Lhc/a;->c:I

    if-lez v0, :cond_3

    iget v2, v2, Lhc/a;->b:F
...
.method public static d(Landroid/content/Context;FFLhc/a;I)Lcom/google/android/material/carousel/b;
    .locals 1
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/google/android/material/carousel/a;->c(Landroid/content/Context;FFLhc/a;)Lcom/google/android/material/carousel/b;
    ...
    :cond_0
    invoke-static {p0, p1, p2, p3}, Lcom/google/android/material/carousel/a;->e(Landroid/content/Context;FFLhc/a;)Lcom/google/android/material/carousel/b;
...
.method public static e(Landroid/content/Context;FFLhc/a;)Lcom/google/android/material/carousel/b;
    .locals 12
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget v3, p3, Lhc/a;->f:F

    iget v4, p3, Lhc/a;->g:I
    ...
    iget v4, p3, Lhc/a;->f:F

    iget v5, p3, Lhc/a;->g:I

    invoke-static {v1, v3, v4, v5}, Lcom/google/android/material/carousel/a;->j(FFFI)F

    move-result v1

    iget v3, p3, Lhc/a;->e:F

    iget v4, p3, Lhc/a;->d:I

    invoke-static {v1, v3, v4}, Lcom/google/android/material/carousel/a;->b(FFI)F

    move-result v3

    iget v4, p3, Lhc/a;->e:F

    iget v5, p3, Lhc/a;->d:I

    invoke-static {v1, v3, v4, v5}, Lcom/google/android/material/carousel/a;->j(FFFI)F

    move-result v1

    iget v4, p3, Lhc/a;->b:F

    iget v5, p3, Lhc/a;->c:I
    ...
    invoke-static {p0, v4, p1}, Lhc/f;->b(FFF)F

    move-result v4

    iget v5, p3, Lhc/a;->b:F

    iget v7, p3, Lhc/a;->f:F

    invoke-static {v5, v7, p1}, Lhc/f;->b(FFF)F

    move-result v11

    iget v5, p3, Lhc/a;->e:F
    ...
    iget v8, p3, Lhc/a;->f:F

    iget v9, p3, Lhc/a;->g:I
