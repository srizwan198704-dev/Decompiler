...
.method private a(Lcom/mbridge/msdk/foundation/entity/CampaignEx;Ljava/lang/String;Lcom/mbridge/msdk/videocommon/download/a;)Lcom/mbridge/msdk/videocommon/download/a;
    ...
    .line 27
    invoke-virtual {p3}, Lcom/mbridge/msdk/videocommon/download/a;->x()V

    .line 28
    iget-object p1, p0, Lcom/mbridge/msdk/videocommon/download/k;->h:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private a(ZLjava/util/List;Lcom/mbridge/msdk/foundation/entity/CampaignEx;Lcom/mbridge/msdk/videocommon/download/a;I)V
    ...
    const-string v11, "RewardVideoRefactorManager"
    ...
    .line 29
    :try_start_0
    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/foundation/entity/CampaignEx;->getLoadTimeoutState()I
    ...
    invoke-direct {p0, v9}, Lcom/mbridge/msdk/videocommon/download/k;->c(Lcom/mbridge/msdk/foundation/entity/CampaignEx;)I
    ...
    invoke-direct/range {v1 .. v6}, Lcom/mbridge/msdk/videocommon/download/k;->a(Lcom/mbridge/msdk/foundation/entity/CampaignEx;Lcom/mbridge/msdk/videocommon/download/a;IZI)Z
    ...
    :goto_2
    :try_start_1
    invoke-virtual {v10, v1}, Lcom/mbridge/msdk/videocommon/download/a;->e(Z)V

    .line 32
    invoke-virtual/range {p4 .. p4}, Lcom/mbridge/msdk/videocommon/download/a;->p()Z

    move-result v2

    if-nez v2, :cond_4

    invoke-direct {p0, v9}, Lcom/mbridge/msdk/videocommon/download/k;->b(Lcom/mbridge/msdk/foundation/entity/CampaignEx;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v2, v9, v10}, Lcom/mbridge/msdk/videocommon/download/k;->a(Ljava/lang/String;Lcom/mbridge/msdk/foundation/entity/CampaignEx;Lcom/mbridge/msdk/videocommon/download/a;)Z
    ...
    .line 33
    :try_start_2
    invoke-virtual {v10, v12}, Lcom/mbridge/msdk/videocommon/download/a;->c(Z)V
    ...
    :cond_5
    :goto_5
    invoke-virtual/range {p4 .. p4}, Lcom/mbridge/msdk/videocommon/download/a;->s()Z

    move-result v3

    if-nez v3, :cond_7

    invoke-direct {p0, v9}, Lcom/mbridge/msdk/videocommon/download/k;->e(Lcom/mbridge/msdk/foundation/entity/CampaignEx;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v9, v3, v10}, Lcom/mbridge/msdk/videocommon/download/k;->b(Lcom/mbridge/msdk/foundation/entity/CampaignEx;Ljava/lang/String;Lcom/mbridge/msdk/videocommon/download/a;)Z
    ...
    .line 35
    :try_start_3
    invoke-virtual {v10, v12}, Lcom/mbridge/msdk/videocommon/download/a;->f(Z)V
    :try_end_3
    ...
    const-string v5, " checkResourceReadyState error"
    ...
    invoke-static {v11, v4, v0}, Lcom/mbridge/msdk/foundation/tools/o0;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    .line 38
    :cond_8
    :goto_9
    invoke-virtual/range {p4 .. p4}, Lcom/mbridge/msdk/videocommon/download/a;->n()Z
    ...
    .line 42
    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/foundation/entity/CampaignEx;->getRsIgnoreCheckRule()Ljava/util/ArrayList;
    ...
    const-string v6, "  campaign name = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/out/Campaign;->getAppName()Ljava/lang/String;
    ...
    .line 45
    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/out/Campaign;->getId()Ljava/lang/String;
    ...
    .line 49
    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/foundation/entity/CampaignEx;->isDynamicView()Z
    ...
    .line 50
    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/foundation/entity/CampaignEx;->getCMPTEntryUrl()Ljava/lang/String;
    ...
    iget-object v0, v7, Lcom/mbridge/msdk/videocommon/download/k;->g:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 53
    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/foundation/entity/CampaignEx;->getLinkType()I
    ...
    .line 59
    invoke-direct {p0, v9}, Lcom/mbridge/msdk/videocommon/download/k;->d(Lcom/mbridge/msdk/foundation/entity/CampaignEx;)I
    ...
    .line 60
    invoke-virtual/range {p4 .. p4}, Lcom/mbridge/msdk/videocommon/download/a;->j()I
    ...
    .line 63
    invoke-direct {p0, v9}, Lcom/mbridge/msdk/videocommon/download/k;->g(Lcom/mbridge/msdk/foundation/entity/CampaignEx;)Z
    ...
    .line 64
    invoke-virtual/range {p3 .. p3}, Lcom/mbridge/msdk/foundation/entity/CampaignEx;->getendcard_url()Ljava/lang/String;
