...
.method public a(IIIIZLcom/mbridge/msdk/thrid/okhttp/d;Lcom/mbridge/msdk/thrid/okhttp/n;)V
    ...
    .line 1
    iget-object v0, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->g:Lcom/mbridge/msdk/thrid/okhttp/u;

    if-nez v0, :cond_b

    .line 2
    iget-object v0, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->c:Lcom/mbridge/msdk/thrid/okhttp/a0;
    ...
    .line 3
    new-instance v10, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/b;

    invoke-direct {v10, v0}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/b;-><init>(Ljava/util/List;)V

    .line 4
    iget-object v1, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->c:Lcom/mbridge/msdk/thrid/okhttp/a0;
    ...
    .line 8
    :cond_0
    new-instance v1, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;
    ...
    invoke-direct {v1, v2}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;-><init>(Ljava/io/IOException;)V

    throw v1

    .line 9
    :cond_1
    new-instance v0, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;
    ...
    invoke-direct {v0, v1}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;-><init>(Ljava/io/IOException;)V
    ...
    .line 13
    iget-object v0, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->d:Ljava/net/Socket;
    :try_end_0
    ...
    .line 14
    :try_start_1
    invoke-direct {v7, v13, v14, v8, v9}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->a(IILcom/mbridge/msdk/thrid/okhttp/d;Lcom/mbridge/msdk/thrid/okhttp/n;)V
    :try_end_1
    ...
    :goto_4
    :try_start_2
    invoke-direct {v7, v10, v15, v8, v9}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->a(Lcom/mbridge/msdk/thrid/okhttp/internal/connection/b;ILcom/mbridge/msdk/thrid/okhttp/d;Lcom/mbridge/msdk/thrid/okhttp/n;)V
    ...
    iget-object v2, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->g:Lcom/mbridge/msdk/thrid/okhttp/u;

    invoke-virtual {v9, v8, v0, v1, v2}, Lcom/mbridge/msdk/thrid/okhttp/n;->connectEnd(Lcom/mbridge/msdk/thrid/okhttp/d;Ljava/net/InetSocketAddress;Ljava/net/Proxy;Lcom/mbridge/msdk/thrid/okhttp/u;)V
    :try_end_2
    ...
    invoke-direct {v1, v0}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;-><init>(Ljava/io/IOException;)V
    ...
    :cond_6
    :goto_6
    iget-object v0, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->h:Lcom/mbridge/msdk/thrid/okhttp/internal/http2/g;

    if-eqz v0, :cond_7

    .line 21
    iget-object v1, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->b:Lcom/mbridge/msdk/thrid/okhttp/h;
    ...
    invoke-virtual {v0}, Lcom/mbridge/msdk/thrid/okhttp/internal/http2/g;->k()I

    move-result v0

    iput v0, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->m:I
    ...
    .line 24
    :goto_8
    iget-object v1, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->e:Ljava/net/Socket;

    invoke-static {v1}, Lcom/mbridge/msdk/thrid/okhttp/internal/c;->a(Ljava/net/Socket;)V

    .line 25
    iget-object v1, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->d:Ljava/net/Socket;

    invoke-static {v1}, Lcom/mbridge/msdk/thrid/okhttp/internal/c;->a(Ljava/net/Socket;)V

    .line 26
    iput-object v11, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->e:Ljava/net/Socket;

    .line 27
    iput-object v11, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->d:Ljava/net/Socket;

    .line 28
    iput-object v11, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->i:Lcom/mbridge/msdk/thrid/okio/e;

    .line 29
    iput-object v11, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->j:Lcom/mbridge/msdk/thrid/okio/d;

    .line 30
    iput-object v11, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->f:Lcom/mbridge/msdk/thrid/okhttp/o;

    .line 31
    iput-object v11, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->g:Lcom/mbridge/msdk/thrid/okhttp/u;

    .line 32
    iput-object v11, v7, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/c;->h:Lcom/mbridge/msdk/thrid/okhttp/internal/http2/g;
    ...
    .line 34
    new-instance v12, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;

    invoke-direct {v12, v0}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;-><init>(Ljava/io/IOException;)V

    goto :goto_9

    .line 35
    :cond_8
    invoke-virtual {v12, v0}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/e;->a(Ljava/io/IOException;)V

    :goto_9
    if-eqz p5, :cond_9

    .line 36
    invoke-virtual {v10, v0}, Lcom/mbridge/msdk/thrid/okhttp/internal/connection/b;->a(Ljava/io/IOException;)Z
