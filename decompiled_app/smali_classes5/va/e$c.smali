...
.method public constructor <init>()V
    ...
    iput v0, p0, Lva/e$c;->m:I

    iput v0, p0, Lva/e$c;->n:I

    iput v0, p0, Lva/e$c;->o:I

    iput v0, p0, Lva/e$c;->p:I

    const/4 v1, 0x0

    iput v1, p0, Lva/e$c;->q:I

    iput v0, p0, Lva/e$c;->r:I

    const/4 v2, 0x0

    iput v2, p0, Lva/e$c;->s:F

    iput v2, p0, Lva/e$c;->t:F

    iput v2, p0, Lva/e$c;->u:F

    const/4 v2, 0x0

    iput-object v2, p0, Lva/e$c;->v:[B

    iput v0, p0, Lva/e$c;->w:I

    iput-boolean v1, p0, Lva/e$c;->x:Z

    iput v0, p0, Lva/e$c;->y:I

    iput v0, p0, Lva/e$c;->z:I

    iput v0, p0, Lva/e$c;->A:I

    const/16 v1, 0x3e8

    iput v1, p0, Lva/e$c;->B:I

    const/16 v1, 0xc8

    iput v1, p0, Lva/e$c;->C:I

    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, Lva/e$c;->D:F

    iput v1, p0, Lva/e$c;->E:F

    iput v1, p0, Lva/e$c;->F:F

    iput v1, p0, Lva/e$c;->G:F

    iput v1, p0, Lva/e$c;->H:F

    iput v1, p0, Lva/e$c;->I:F

    iput v1, p0, Lva/e$c;->J:F

    iput v1, p0, Lva/e$c;->K:F

    iput v1, p0, Lva/e$c;->L:F

    iput v1, p0, Lva/e$c;->M:F

    const/4 v1, 0x1

    iput v1, p0, Lva/e$c;->O:I

    iput v0, p0, Lva/e$c;->P:I

    const/16 v0, 0x1f40

    iput v0, p0, Lva/e$c;->Q:I

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lva/e$c;->R:J

    iput-wide v2, p0, Lva/e$c;->S:J

    iput-boolean v1, p0, Lva/e$c;->V:Z

    const-string v0, "eng"

    iput-object v0, p0, Lva/e$c;->W:Ljava/lang/String;

    return-void
.end method

.method public static synthetic a(Lva/e$c;)V
    .locals 0

    invoke-virtual {p0}, Lva/e$c;->f()V

    return-void
.end method

.method public static synthetic b(Lva/e$c;)I
    .locals 0

    iget p0, p0, Lva/e$c;->g:I

    return p0
.end method

.method public static synthetic c(Lva/e$c;I)I
    .locals 0

    iput p1, p0, Lva/e$c;->g:I

    return p1
.end method

.method public static synthetic d(Lva/e$c;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lva/e$c;->W:Ljava/lang/String;

    return-object p1
.end method

.method public static synthetic e(Lva/e$c;Z)Z
    .locals 0

    invoke-virtual {p0, p1}, Lva/e$c;->o(Z)Z
...
.method public static k(Lcom/google/android/exoplayer2/util/d0;)Landroid/util/Pair;
    .locals 6
...
.method public static l(Lcom/google/android/exoplayer2/util/d0;)Z
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    invoke-static {}, Lva/e;->g()Ljava/util/UUID;
...
.method public final f()V
    ...
    iget-object v0, p0, Lva/e$c;->X:Lpa/e0;
...
.method public final h()[B
    ...
    iget v0, p0, Lva/e$c;->E:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->F:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->G:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->H:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->I:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->J:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->K:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->L:F

    cmpl-float v0, v0, v1

    if-eqz v0, :cond_1

    iget v0, p0, Lva/e$c;->M:F
    ...
    iget v2, p0, Lva/e$c;->B:I

    int-to-short v2, v2

    invoke-virtual {v1, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget v2, p0, Lva/e$c;->C:I
...
.method public i(Lpa/n;I)V
    ...
    iget-object v5, v0, Lva/e$c;->b:Ljava/lang/String;
    ...
    iget-object v2, v0, Lva/e$c;->b:Ljava/lang/String;

    invoke-virtual {v0, v2}, Lva/e$c;->g(Ljava/lang/String;)[B
    ...
    :pswitch_1
    iget-object v1, v0, Lva/e$c;->b:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lva/e$c;->g(Ljava/lang/String;)[B
    ...
    iget-object v3, v0, Lva/e$c;->b:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lva/e$c;->g(Ljava/lang/String;)[B
    ...
    invoke-static {v1}, Lva/e$c;->k(Lcom/google/android/exoplayer2/util/d0;)Landroid/util/Pair;
    ...
    invoke-static {v1}, Lva/e$c;->m([B)Ljava/util/List;
    ...
    new-instance v1, Lpa/f0;

    invoke-direct {v1}, Lpa/f0;-><init>()V

    iput-object v1, v0, Lva/e$c;->T:Lpa/f0;
    ...
    invoke-static {v1}, Lva/e$c;->l(Lcom/google/android/exoplayer2/util/d0;)Z
    ...
    iget-boolean v14, v0, Lva/e$c;->V:Z

    iget-boolean v5, v0, Lva/e$c;->U:Z
    ...
    iget v3, v0, Lva/e$c;->q:I

    if-nez v3, :cond_2d

    iget v3, v0, Lva/e$c;->o:I

    const/4 v7, -0x1

    if-ne v3, v7, :cond_2b

    iget v3, v0, Lva/e$c;->m:I

    :cond_2b
    iput v3, v0, Lva/e$c;->o:I

    iget v3, v0, Lva/e$c;->p:I

    if-ne v3, v7, :cond_2c

    iget v3, v0, Lva/e$c;->n:I

    :cond_2c
    iput v3, v0, Lva/e$c;->p:I
    ...
    iget v8, v0, Lva/e$c;->p:I

    if-eq v8, v7, :cond_2e

    iget v9, v0, Lva/e$c;->n:I

    mul-int/2addr v9, v3

    int-to-float v3, v9

    iget v9, v0, Lva/e$c;->m:I
    ...
    :goto_13
    iget-boolean v8, v0, Lva/e$c;->x:Z

    if-eqz v8, :cond_2f

    invoke-virtual/range {p0 .. p0}, Lva/e$c;->h()[B

    move-result-object v8

    new-instance v13, Lcom/google/android/exoplayer2/video/c;

    iget v9, v0, Lva/e$c;->y:I

    iget v10, v0, Lva/e$c;->A:I

    iget v11, v0, Lva/e$c;->z:I

    invoke-direct {v13, v9, v10, v11, v8}, Lcom/google/android/exoplayer2/video/c;-><init>(III[B)V

    :cond_2f
    iget-object v8, v0, Lva/e$c;->a:Ljava/lang/String;

    if-eqz v8, :cond_30

    invoke-static {}, Lva/e;->f()Ljava/util/Map;

    move-result-object v8

    iget-object v9, v0, Lva/e$c;->a:Ljava/lang/String;
    ...
    :cond_30
    iget v8, v0, Lva/e$c;->r:I

    if-nez v8, :cond_35

    iget v8, v0, Lva/e$c;->s:F
    ...
    :goto_17
    iget-object v7, v0, Lva/e$c;->a:Ljava/lang/String;
    ...
    iget-object v6, v0, Lva/e$c;->W:Ljava/lang/String;
    ...
    iget-object v2, v0, Lva/e$c;->l:Lcom/google/android/exoplayer2/drm/DrmInitData;
    ...
    iget v2, v0, Lva/e$c;->c:I

    move-object/from16 v4, p1

    invoke-interface {v4, v2, v3}, Lpa/n;->track(II)Lpa/e0;

    move-result-object v2

    iput-object v2, v0, Lva/e$c;->X:Lpa/e0;

    invoke-interface {v2, v1}, Lpa/e0;->d(Lcom/google/android/exoplayer2/p1;)V
...
.method public j()V
    ...
    iget-object v0, p0, Lva/e$c;->T:Lpa/f0;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lva/e$c;->X:Lpa/e0;

    iget-object v2, p0, Lva/e$c;->j:Lpa/e0$a;

    invoke-virtual {v0, v1, v2}, Lpa/f0;->a(Lpa/e0;Lpa/e0$a;)V
...
.method public final o(Z)Z
    ...
    iget-object v1, p0, Lva/e$c;->b:Ljava/lang/String;
