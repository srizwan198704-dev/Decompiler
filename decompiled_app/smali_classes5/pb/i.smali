...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/rtsp/j;)V
    ...
    iput-object p1, p0, Lpb/i;->a:Lcom/google/android/exoplayer2/source/rtsp/j;

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lpb/i;->c:J
...
.method public a(Lcom/google/android/exoplayer2/util/d0;JIZ)V
    ...
    iget-object v4, v0, Lpb/i;->b:Lpa/e0;

    invoke-static {v4}, Lcom/google/android/exoplayer2/util/a;->i(Ljava/lang/Object;)Ljava/lang/Object;

    iget-boolean v4, v0, Lpb/i;->f:Z

    const/4 v5, 0x1

    if-nez v4, :cond_0

    invoke-static/range {p1 .. p1}, Lpb/i;->e(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    iget-object v3, v0, Lpb/i;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
    ...
    iget-object v1, v0, Lpb/i;->b:Lpa/e0;

    invoke-virtual {v3}, Lcom/google/android/exoplayer2/p1$b;->E()Lcom/google/android/exoplayer2/p1;

    move-result-object v3

    invoke-interface {v1, v3}, Lpa/e0;->d(Lcom/google/android/exoplayer2/p1;)V

    iput-boolean v5, v0, Lpb/i;->f:Z

    goto :goto_0

    :cond_0
    iget-boolean v4, v0, Lpb/i;->g:Z
    ...
    iput-boolean v5, v0, Lpb/i;->g:Z

    goto :goto_0

    :cond_2
    iget v4, v0, Lpb/i;->e:I
    ...
    iget-object v3, v0, Lpb/i;->b:Lpa/e0;

    invoke-interface {v3, v1, v9}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget-wide v10, v0, Lpb/i;->d:J

    iget-wide v14, v0, Lpb/i;->c:J

    move-wide/from16 v12, p2

    invoke-static/range {v10 .. v15}, Lpb/i;->d(JJJ)J

    move-result-wide v6

    iget-object v5, v0, Lpb/i;->b:Lpa/e0;
...
.method public c(Lpa/n;I)V
    ...
    iput-object p1, p0, Lpb/i;->b:Lpa/e0;

    iget-object p2, p0, Lpb/i;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
