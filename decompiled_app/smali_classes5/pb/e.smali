...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/rtsp/j;)V
    ...
    iput-object p1, p0, Lpb/e;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
...
.method public a(Lcom/google/android/exoplayer2/util/d0;JIZ)V
    ...
    iget-object v3, v0, Lpb/e;->b:Lpa/e0;
    ...
    :cond_4
    :goto_1
    iget v3, v0, Lpb/e;->d:I

    if-nez v3, :cond_7

    iget-boolean v3, v0, Lpb/e;->i:Z

    invoke-virtual {v0, v1, v3}, Lpb/e;->d(Lcom/google/android/exoplayer2/util/d0;Z)V

    iget-boolean v3, v0, Lpb/e;->i:Z

    if-nez v3, :cond_7

    iget-boolean v3, v0, Lpb/e;->h:Z

    if-eqz v3, :cond_7

    iget v3, v0, Lpb/e;->f:I

    iget-object v4, v0, Lpb/e;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
    ...
    invoke-interface {v3, v4}, Lpa/e0;->d(Lcom/google/android/exoplayer2/p1;)V

    :cond_6
    iput-boolean v6, v0, Lpb/e;->i:Z
    ...
    iget-object v4, v0, Lpb/e;->b:Lpa/e0;

    invoke-interface {v4, v1, v3}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget v1, v0, Lpb/e;->d:I

    add-int/2addr v1, v3

    iput v1, v0, Lpb/e;->d:I

    if-eqz p5, :cond_9

    iget-wide v3, v0, Lpb/e;->c:J
    ...
    iput-wide v3, v0, Lpb/e;->c:J

    :cond_8
    iget-wide v8, v0, Lpb/e;->j:J

    iget-wide v12, v0, Lpb/e;->c:J

    move-wide/from16 v10, p2

    invoke-static/range {v8 .. v13}, Lpb/e;->e(JJJ)J

    move-result-wide v15

    iget-object v14, v0, Lpb/e;->b:Lpa/e0;

    iget-boolean v1, v0, Lpb/e;->h:Z
    ...
    invoke-interface/range {v14 .. v20}, Lpa/e0;->f(JIIILpa/e0$a;)V

    iput v7, v0, Lpb/e;->d:I

    iput-boolean v7, v0, Lpb/e;->h:Z

    :cond_9
    iput v2, v0, Lpb/e;->e:I
...
.method public c(Lpa/n;I)V
    ...
    iput-object p1, p0, Lpb/e;->b:Lpa/e0;

    iget-object p2, p0, Lpb/e;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
...
.method public final d(Lcom/google/android/exoplayer2/util/d0;Z)V
    .locals 5
    ...
    iput p2, p0, Lpb/e;->f:I

    const/16 p2, 0x60

    iput p2, p0, Lpb/e;->g:I
...
.method public seek(JJ)V
    ...
    iput-wide p1, p0, Lpb/e;->c:J

    const/4 p1, 0x0

    iput p1, p0, Lpb/e;->d:I

    iput-wide p3, p0, Lpb/e;->j:J
