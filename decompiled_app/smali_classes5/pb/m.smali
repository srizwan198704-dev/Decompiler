...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/rtsp/j;)V
    ...
    iput-object p1, p0, Lpb/m;->a:Lcom/google/android/exoplayer2/source/rtsp/j;

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Lpb/m;->c:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lpb/m;->d:J

    const/4 p1, -0x1

    iput p1, p0, Lpb/m;->e:I

    iput p1, p0, Lpb/m;->g:I

    iput p1, p0, Lpb/m;->h:I

    const/4 p1, 0x0

    iput-boolean p1, p0, Lpb/m;->i:Z

    iput-boolean p1, p0, Lpb/m;->j:Z
...
.method public a(Lcom/google/android/exoplayer2/util/d0;JIZ)V
    ...
    iget-object v3, v0, Lpb/m;->b:Lpa/e0;

    invoke-static {v3}, Lcom/google/android/exoplayer2/util/a;->i(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {v0, v1, v2}, Lpb/m;->e(Lcom/google/android/exoplayer2/util/d0;I)Z

    move-result v3

    if-eqz v3, :cond_6

    iget v3, v0, Lpb/m;->f:I
    ...
    :goto_0
    iget-boolean v3, v0, Lpb/m;->j:Z

    if-nez v3, :cond_3

    iget v3, v0, Lpb/m;->g:I

    const/4 v6, -0x1

    if-eq v3, v6, :cond_3

    iget v7, v0, Lpb/m;->h:I

    if-eq v7, v6, :cond_3

    iget-object v6, v0, Lpb/m;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
    ...
    invoke-interface {v3, v6}, Lpa/e0;->d(Lcom/google/android/exoplayer2/p1;)V

    :cond_2
    iput-boolean v4, v0, Lpb/m;->j:Z
    ...
    iget-object v4, v0, Lpb/m;->b:Lpa/e0;

    invoke-interface {v4, v1, v3}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget v1, v0, Lpb/m;->f:I

    add-int/2addr v1, v3

    iput v1, v0, Lpb/m;->f:I

    if-eqz p5, :cond_5

    iget-wide v3, v0, Lpb/m;->c:J
    ...
    iput-wide v3, v0, Lpb/m;->c:J

    :cond_4
    iget-wide v10, v0, Lpb/m;->d:J

    iget-wide v14, v0, Lpb/m;->c:J

    move-wide/from16 v12, p2

    invoke-static/range {v10 .. v15}, Lpb/m;->d(JJJ)J

    move-result-wide v7

    iget-object v6, v0, Lpb/m;->b:Lpa/e0;

    iget v10, v0, Lpb/m;->f:I
    ...
    iput v5, v0, Lpb/m;->f:I

    iput-boolean v5, v0, Lpb/m;->i:Z

    :cond_5
    iput v2, v0, Lpb/m;->e:I
...
.method public c(Lpa/n;I)V
    ...
    iput-object p1, p0, Lpb/m;->b:Lpa/e0;

    iget-object p2, p0, Lpb/m;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
...
.method public final e(Lcom/google/android/exoplayer2/util/d0;I)Z
    .locals 6
    ...
    :cond_0
    iput-boolean v4, p0, Lpb/m;->i:Z

    goto :goto_0

    :cond_1
    iget v2, p0, Lpb/m;->e:I
    ...
    iput v3, p0, Lpb/m;->g:I

    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/d0;->J()I

    move-result v3

    iput v3, p0, Lpb/m;->h:I
...
.method public seek(JJ)V
    ...
    iput-wide p1, p0, Lpb/m;->c:J

    const/4 p1, 0x0

    iput p1, p0, Lpb/m;->f:I

    iput-wide p3, p0, Lpb/m;->d:J
