...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/rtsp/j;)V
    ...
    iput-object p1, p0, Lpb/c;->a:Lcom/google/android/exoplayer2/source/rtsp/j;

    new-instance p1, Lcom/google/android/exoplayer2/util/c0;

    invoke-direct {p1}, Lcom/google/android/exoplayer2/util/c0;-><init>()V

    iput-object p1, p0, Lpb/c;->b:Lcom/google/android/exoplayer2/util/c0;

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Lpb/c;->e:J
...
.method public a(Lcom/google/android/exoplayer2/util/d0;JIZ)V
    ...
    iget-wide v7, v6, Lpb/c;->g:J

    iget-wide v11, v6, Lpb/c;->e:J

    iget-object v4, v6, Lpb/c;->a:Lcom/google/android/exoplayer2/source/rtsp/j;

    iget v13, v4, Lcom/google/android/exoplayer2/source/rtsp/j;->b:I

    move-wide/from16 v9, p2

    invoke-static/range {v7 .. v13}, Lpb/c;->i(JJJI)J
    ...
    invoke-virtual/range {v0 .. v5}, Lpb/c;->f(Lcom/google/android/exoplayer2/util/d0;ZIJ)V
    ...
    invoke-virtual {p0, p1, v4, v5}, Lpb/c;->h(Lcom/google/android/exoplayer2/util/d0;J)V

    goto :goto_1

    :cond_3
    invoke-virtual {p0, p1, v0, v4, v5}, Lpb/c;->g(Lcom/google/android/exoplayer2/util/d0;IJ)V
...
.method public c(Lpa/n;I)V
    ...
    iput-object p1, p0, Lpb/c;->c:Lpa/e0;

    iget-object p2, p0, Lpb/c;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
...
.method public final e()V
    ...
    iget-object v0, p0, Lpb/c;->c:Lpa/e0;
    ...
    iget-wide v2, p0, Lpb/c;->f:J

    iget v5, p0, Lpb/c;->d:I
...
.method public final f(Lcom/google/android/exoplayer2/util/d0;ZIJ)V
    .locals 2
    ...
    iget-object v1, p0, Lpb/c;->c:Lpa/e0;
    ...
    iget p1, p0, Lpb/c;->d:I

    add-int/2addr p1, v0

    iput p1, p0, Lpb/c;->d:I

    iput-wide p4, p0, Lpb/c;->f:J
...
.method public final g(Lcom/google/android/exoplayer2/util/d0;IJ)V
    .locals 9

    iget-object v0, p0, Lpb/c;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    iget-object v1, p0, Lpb/c;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    invoke-interface {v1, p1, v2}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V
...
.method public final h(Lcom/google/android/exoplayer2/util/d0;J)V
    .locals 7
    ...
    invoke-interface {v0, p1, v4}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget-object p1, p0, Lpb/c;->c:Lpa/e0;
