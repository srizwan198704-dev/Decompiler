...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/rtsp/j;)V
    ...
    iput-object p1, p0, Lpb/l;->a:Lcom/google/android/exoplayer2/source/rtsp/j;

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Lpb/l;->c:J

    const/4 p1, -0x1

    iput p1, p0, Lpb/l;->d:I

    iput p1, p0, Lpb/l;->e:I

    iput-wide v0, p0, Lpb/l;->f:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lpb/l;->g:J

    const/4 p1, 0x0

    iput-boolean p1, p0, Lpb/l;->h:Z

    iput-boolean p1, p0, Lpb/l;->i:Z

    iput-boolean p1, p0, Lpb/l;->j:Z
...
.method private d()V
    ...
    iget-object v0, p0, Lpb/l;->b:Lpa/e0;
    ...
    iget-wide v2, p0, Lpb/l;->f:J

    iget-boolean v4, p0, Lpb/l;->i:Z

    iget v5, p0, Lpb/l;->e:I
    ...
    iput v0, p0, Lpb/l;->e:I

    const-wide v1, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v1, p0, Lpb/l;->f:J

    iput-boolean v0, p0, Lpb/l;->h:Z
...
.method public a(Lcom/google/android/exoplayer2/util/d0;JIZ)V
    ...
    invoke-virtual {p0, p1, p4}, Lpb/l;->f(Lcom/google/android/exoplayer2/util/d0;I)Z

    move-result v0

    if-eqz v0, :cond_7

    iget v0, p0, Lpb/l;->e:I
    ...
    :goto_0
    iput-boolean v0, p0, Lpb/l;->i:Z

    :cond_1
    iget-boolean v0, p0, Lpb/l;->j:Z
    ...
    iget-object v0, p0, Lpb/l;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
    ...
    :cond_2
    iget-object v5, p0, Lpb/l;->b:Lpa/e0;
    ...
    invoke-interface {v5, v0}, Lpa/e0;->d(Lcom/google/android/exoplayer2/p1;)V

    :cond_3
    iput-boolean v2, p0, Lpb/l;->j:Z
    ...
    :goto_1
    iget-wide v0, p0, Lpb/l;->g:J

    iget-wide v4, p0, Lpb/l;->c:J

    move-wide v2, p2

    invoke-static/range {v0 .. v5}, Lpb/l;->e(JJJ)J

    move-result-wide p1

    iput-wide p1, p0, Lpb/l;->f:J

    if-eqz p5, :cond_6

    invoke-direct {p0}, Lpb/l;->d()V

    :cond_6
    iput p4, p0, Lpb/l;->d:I
...
.method public c(Lpa/n;I)V
    ...
    iput-object p1, p0, Lpb/l;->b:Lpa/e0;

    iget-object p2, p0, Lpb/l;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
...
.method public final f(Lcom/google/android/exoplayer2/util/d0;I)Z
    ...
    iget-boolean p2, p0, Lpb/l;->h:Z

    if-eqz p2, :cond_0

    iget p2, p0, Lpb/l;->e:I
    ...
    :cond_0
    iput-boolean v4, p0, Lpb/l;->h:Z

    goto :goto_0

    :cond_1
    iget-boolean v3, p0, Lpb/l;->h:Z

    const-string v5, "RtpVP8Reader"

    if-eqz v3, :cond_7

    iget v3, p0, Lpb/l;->d:I
