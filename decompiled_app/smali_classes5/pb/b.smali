...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/rtsp/j;)V
    ...
    iput-object p1, p0, Lpb/b;->a:Lcom/google/android/exoplayer2/source/rtsp/j;

    new-instance v0, Lcom/google/android/exoplayer2/util/c0;

    invoke-direct {v0}, Lcom/google/android/exoplayer2/util/c0;-><init>()V

    iput-object v0, p0, Lpb/b;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    iput p1, p0, Lpb/b;->d:I

    const/4 p1, 0x3

    iput p1, p0, Lpb/b;->e:I
    ...
    :goto_0
    iget p1, p0, Lpb/b;->e:I

    iget v0, p0, Lpb/b;->d:I

    add-int/2addr p1, v0

    iput p1, p0, Lpb/b;->f:I
...
.method public static d(Lpa/e0;JI)V
    .locals 7
...
.method public a(Lcom/google/android/exoplayer2/util/d0;JIZ)V
    ...
    iget-object p4, p0, Lpb/b;->h:Lpa/e0;
    ...
    iget-wide v1, p0, Lpb/b;->i:J

    iget-wide v5, p0, Lpb/b;->g:J

    iget v7, p0, Lpb/b;->c:I

    move-wide v3, p2

    invoke-static/range {v1 .. v7}, Lpb/b;->e(JJJI)J

    move-result-wide p2

    iget-object v1, p0, Lpb/b;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    iget-object p4, p0, Lpb/b;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    iget-object v0, p0, Lpb/b;->b:Lcom/google/android/exoplayer2/util/c0;

    iget v1, p0, Lpb/b;->e:I

    invoke-virtual {v0, v1}, Lcom/google/android/exoplayer2/util/c0;->r(I)V

    iget-object v0, p0, Lpb/b;->h:Lpa/e0;

    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/d0;->a()I

    move-result v1

    invoke-interface {v0, p1, v1}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    if-eqz p5, :cond_1

    iget-object p1, p0, Lpb/b;->h:Lpa/e0;

    invoke-static {p1, p2, p3, p4}, Lpb/b;->d(Lpa/e0;JI)V
    ...
    iget-object p5, p0, Lpb/b;->b:Lcom/google/android/exoplayer2/util/c0;

    iget v1, p0, Lpb/b;->d:I
    ...
    iget v2, p0, Lpb/b;->e:I

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/c0;->r(I)V

    iget-object v1, p0, Lpb/b;->h:Lpa/e0;

    invoke-interface {v1, p1, p5}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V

    iget-object v1, p0, Lpb/b;->h:Lpa/e0;

    invoke-static {v1, p2, p3, p5}, Lpb/b;->d(Lpa/e0;JI)V

    int-to-long v2, v0

    iget p5, p0, Lpb/b;->c:I
...
.method public c(Lpa/n;I)V
    ...
    iput-object p1, p0, Lpb/b;->h:Lpa/e0;

    iget-object p2, p0, Lpb/b;->a:Lcom/google/android/exoplayer2/source/rtsp/j;
