...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/rtsp/j;)V
    ...
    iput-object v0, p0, Lpb/f;->b:Lcom/google/android/exoplayer2/util/d0;

    iput-object p1, p0, Lpb/f;->c:Lcom/google/android/exoplayer2/source/rtsp/j;

    new-instance p1, Lcom/google/android/exoplayer2/util/d0;

    invoke-direct {p1}, Lcom/google/android/exoplayer2/util/d0;-><init>()V

    iput-object p1, p0, Lpb/f;->a:Lcom/google/android/exoplayer2/util/d0;

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Lpb/f;->f:J

    const/4 p1, -0x1

    iput p1, p0, Lpb/f;->g:I
...
.method public a(Lcom/google/android/exoplayer2/util/d0;JIZ)V
    ...
    iget-object v5, v1, Lpb/f;->d:Lpa/e0;
    ...
    invoke-virtual/range {p0 .. p1}, Lpb/f;->f(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    invoke-virtual/range {p0 .. p1}, Lpb/f;->g(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    invoke-virtual {v1, v5, v0}, Lpb/f;->e(Lcom/google/android/exoplayer2/util/d0;I)V

    :goto_0
    if-eqz p5, :cond_3

    iget-wide v3, v1, Lpb/f;->f:J
    ...
    iput-wide v6, v1, Lpb/f;->f:J

    :cond_2
    iget-wide v4, v1, Lpb/f;->i:J

    iget-wide v8, v1, Lpb/f;->f:J

    move-wide/from16 v6, p2

    invoke-static/range {v4 .. v9}, Lpb/f;->h(JJJ)J

    move-result-wide v11

    iget-object v10, v1, Lpb/f;->d:Lpa/e0;

    iget v13, v1, Lpb/f;->e:I

    iget v14, v1, Lpb/f;->h:I
    ...
    iput v2, v1, Lpb/f;->h:I

    :cond_3
    iput v0, v1, Lpb/f;->g:I
...
.method public c(Lpa/n;I)V
    ...
    iput-object p1, p0, Lpb/f;->d:Lpa/e0;
    ...
    iget-object p2, p0, Lpb/f;->c:Lcom/google/android/exoplayer2/source/rtsp/j;
...
.method public final e(Lcom/google/android/exoplayer2/util/d0;I)V
    ...
    iget p2, p0, Lpb/f;->h:I

    invoke-virtual {p0}, Lpb/f;->i()I

    move-result v0

    add-int/2addr p2, v0

    iput p2, p0, Lpb/f;->h:I
    ...
    iget-object p2, p0, Lpb/f;->a:Lcom/google/android/exoplayer2/util/d0;
    ...
    iget-object p1, p0, Lpb/f;->a:Lcom/google/android/exoplayer2/util/d0;
    ...
    iget-object p2, p0, Lpb/f;->d:Lpa/e0;

    iget-object v0, p0, Lpb/f;->a:Lcom/google/android/exoplayer2/util/d0;

    invoke-interface {p2, v0, p1}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V
    ...
    invoke-static {p1}, Lpb/f;->d(I)I

    move-result p1

    iput p1, p0, Lpb/f;->e:I
...
.method public final f(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    iput v1, p0, Lpb/f;->h:I

    iget-object v1, p0, Lpb/f;->d:Lpa/e0;
...
.method public final i()I
    ...
    iget-object v0, p0, Lpb/f;->b:Lcom/google/android/exoplayer2/util/d0;
    ...
    iget-object v2, p0, Lpb/f;->b:Lcom/google/android/exoplayer2/util/d0;

    invoke-interface {v1, v2, v0}, Lpa/e0;->c(Lcom/google/android/exoplayer2/util/d0;I)V
...
.method public seek(JJ)V
    ...
    iput-wide p1, p0, Lpb/f;->f:J

    const/4 p1, 0x0

    iput p1, p0, Lpb/f;->h:I

    iput-wide p3, p0, Lpb/f;->i:J
